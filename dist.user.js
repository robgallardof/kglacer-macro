...
`;class K{bot;image;width;exactColor;static async fromJSON(o,a){let r=new Image;return r.src=a.url.startsWith("http")?await fetch(a.url,{cache:"no-store"}).then((l)=>l.blob()).then((l)=>URL.createObjectURL(l)):a.url,await Q(r,["load"],["error"]),new K(o,r,a.width,a.exactColor)}canvas=document.createElement("canvas");context=this.canvas.getContext("2d");pixels;colors=new Map;resolution;get height(){return this.width/this.resolution|0}set height(o){this.width=o*this.resolution|0}constructor(o,a,r=a.naturalWidth,l=!1){this.bot=o;this.image=a;this.width=r;this.exactColor=l;if(l)this.resolution=1,this.width=1000;else this.resolution=this.image.naturalWidth/this.image.naturalHeight;this.update()}update(){this.canvas.width=this.width,this.canvas.height=this.height,this.colors.clear();let o=new Map;for(let r=1;r<64;r++)o.set(G[r],[r,r]);this.context.imageSmoothingEnabled=!1,this.context.imageSmoothingQuality="low",this.context.drawImage(this.image,0,0,this.canvas.width,this.canvas.height),this.pixels=Array.from({length:this.canvas.height},()=>new Array(this.canvas.width));let a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(let r=0;r<this.canvas.height;r++)for(let l=0;l<this.canvas.width;l++){let s=(r*this.canvas.width+l)*4,p=a[s],c=a[s+1],i=a[s+2],g=a[s+3],n=p,f=c,t=i,u=`${n},${f},${t}`;if(this.exactColor){this.pixels[r][l]=g<100?0:G.indexOf(u);continue}let w,e;if(g<100)w=e=0;else if(o.has(u))[w,e]=o.get(u);else{let m=1/0,b=1/0;for(let z=0;z<L.length;z++){let A=L[z],P=Ho(Mo(n,f,t),A,0);if(P<m)m=P,w=z;if(P<b)b=P,e=z}o.set(u,[w,e])}if(w!==0)this.context.fillStyle=`oklab(${L[w][0]*100}% ${L[w][1]} ${L[w][2]})`,this.context.fillRect(l,r,1,1);this.pixels[r][l]=w;let h=this.colors.get(e);if(h)h.amount++;else this.colors.set(e,{color:e,amount:1,realColor:e})}}toJSON(){let o=document.createElement("canvas");return o.width=this.image.naturalWidth,o.height=this.image.naturalHeight,o.getContext("2d").drawImage(this.image,0,0),{url:o.toDataURL("image/webp",1),width:this.width,exactColor:this.exactColor}}}var Z="kglacer-macro-settings",Po=["kglacermacro","wbot"],X="kgm";function ra(){let o=[Z,...Po];for(let a=0;a<o.length;a++){let r=o[a],l=localStorage.getItem(r);if(!l)continue;return{json:l,key:r}}return}function No(){let o=ra();if(!o)return;let a;try{if(a=JSON.parse(o.json),typeof a!=="object")throw new Error("NOT VALID SAVE");if(a.version===1){let r=a.widget;if(r)a.images=r.images,a.strategy=r.strategy,delete a.widget}if(o.key!==Z)localStorage.setItem(Z,o.json)}catch{localStorage.removeItem(o.key),a=void 0}return a}var Fo;function M(o,a=!1){if(clearTimeout(Fo),a)localStorage.setItem(Z,JSON.stringify(o));else Fo=setTimeout(()=>{localStorage.setItem(Z,JSON.stringify(o))},600)}var H=1000,sa=2048,B=H*sa,C=[],E=[],la=Date.now();function v(o){C.push(o),E.push({id:la++,latitude:(2*Math.atan(Math.exp(-(o.y/B*(2*Math.PI)-Math.PI)))-Math.PI/2)*180/Math.PI,longitude:(o.x/B*(2*Math.PI)-Math.PI)*180/Math.PI,name:"KGLACER_MACRO_FAVORITE"})}v({x:B/3|0,y:B/3|0});v({x:B/3*2|0,y:B/3*2|0});function R(o){let[a,r]=o.style.transform.slice(32,-31).split(", ").map((l)=>Number.parseFloat(l));return{x:a,y:r}}class k{bot;static fromJSON(o,a){return new k(o,...a)}static fromScreenPosition(o,a){let{anchorScreenPosition:r,pixelSize:l,anchorWorldPosition:s}=o.findAnchorsForScreen(a);return new k(o,s.x+(a.x-r.x)/l|0,s.y+(a.y-r.y)/l|0)}globalX=0;globalY=0;get tileX(){return this.globalX/H|0}set tileX(o){this.globalX=o*H+this.x}get tileY(){return this.globalY/H|0}set tileY(o){this.globalY=o*H+this.y}get x(){return this.globalX%H}set x(o){this.globalX=this.tileX*H+o}get y(){return this.globalY%H}set y(o){this.globalY=this.tileY*H+o}anchor1Index;anchor2Index;get pixelSize(){return(R(this.bot.$stars[this.anchor2Index]).x-R(this.bot.$stars[this.anchor1Index]).x)/(C[this.anchor2Index].x-C[this.anchor1Index].x)}constructor(o,a,r,l,s){this.bot=o;if(l===void 0||s===void 0)this.globalX=a,this.globalY=r;else this.globalX=a*H+l,this.globalY=r*H+s;this.updateAnchor()}updateAnchor(){this.anchor1Index=0,this.anchor2Index=1;let o=1/0,a=1/0;for(let r=0;r<C.length;r++){let{x:l,y:s}=C[r];if(l<this.globalX&&s<this.globalY){let p=this.globalX-l+(this.globalY-s);if(p<o)o=p,this.anchor1Index=r}else if(l>this.globalX&&s>this.globalY){let p=l-this.globalX+(s-this.globalY);if(p<a)a=p,this.anchor2Index=r}}}toScreenPosition(){let o=C[this.anchor1Index],a=R(this.bot.$stars[this.anchor1Index]);return{x:(this.globalX-o.x)*this.pixelSize+a.x,y:(this.globalY-o.y)*this.pixelSize+a.y}}getMapColor(){return this.bot.mapsCache.get(this.tileX+"/"+this.tileY).pixels[this.y][this.x]}setMapColor(o){let a=this.bot.mapsCache.get(this.tileX+"/"+this.tileY);if(!a)return;let r=a.pixels[this.y];if(!r)return;r[this.x]=o}scrollScreenTo(){let{x:o,y:a}=this.toScreenPosition();this.bot.moveMap({x:o-window.innerWidth/3,y:a-window.innerHeight/3})}clone(){return new k(this.bot,this.tileX,this.tileY,this.x,this.y)}toJSON(){return[this.globalX,this.globalY]}}function pa(o){let a=[];for(let{x:r,y:l}of o.iterate){let s=o.pixels[l]?.[r]??0;if(o.disabledColors.has(s))continue;let p=o.readMapColor(r,l);if(s!==p&&(o.drawTransparentPixels||s!==0))a.push({x:r,y:l,color:s})}return a}class U extends _{bot;position;pixels;strategy;opacity;drawTransparentPixels;drawColorsInOrder;skipUnavailableColors;colors;lock;static PREVIEW_MASK_BASE_WIDTH=96;static PREVIEW_MASK_BASE_HEIGHT=96;static async fromJSON(o,a){return new U(o,k.fromJSON(o,a.position),await K.fromJSON(o,a.pixels),a.strategy,a.opacity,a.drawTransparentPixels,a.drawColorsInOrder,a.skipUnavailableColors,a.colors,a.lock)}element=document.createElement("div");tasks=[];moveInfo;$canvas;$colorsDialog;$colorsDialogList;$colorSearch;$openColors;$openPreview;$enableAllColors;$disableAllColors;$closeColors;$closePreview;$delete;$drawColorsInOrder;$drawTransparent;$skipUnavailable;$export;$lock;$opacity;$progressLine;$progressText;$previewDialog;$previewDialogList;$resetSize;$resetSizeSpan;$settings;$strategy;$topbar;$wrapper;colorDialogDragState;suppressNextColorDialogBackdropClick=!1;previewCacheSignature;previewSequenceCache=new Map;previewAnimations=new WeakMap;previewAnimationHandles=new Set;constructor(o,a,r,l="SPIRAL_FROM_CENTER",s=50,p=!1,c=!1,i=!0,g=[],n=!1){super();this.bot=o;this.position=a;this.pixels=r;this.strategy=l;this.opacity=s;this.drawTransparentPixels=p;this.drawColorsInOrder=c;this.skipUnavailableColors=i;this.colors=g;this.lock=n;this.element.innerHTML=ko,this.element.classList.add("wimage"),F(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$colorsDialog:".colors-dialog",$colorsDialogList:".colors-dialog-list",$colorSearch:".color-search",$openColors:".open-colors",$openPreview:".open-preview",$enableAllColors:".enable-all-colors",$disableAllColors:".disable-all-colors",$closeColors:".close-colors",$closePreview:".close-preview",$delete:".delete",$drawColorsInOrder:".draw-colors-in-order",$drawTransparent:".draw-transparent",$skipUnavailable:".skip-unavailable",$export:".export",$lock:".lock",$opacity:".opacity",$progressLine:".wprogress div",$progressText:".wprogress span",$previewDialog:".preview-dialog",$previewDialogList:".preview-dialog-list",$resetSize:".reset-size",$settings:".wform",$strategy:".strategy",$topbar:".wtopbar",$wrapper:".wrapper"}),this.$resetSizeSpan=this.$resetSize.querySelector("span"),this.$canvas=this.pixels.canvas,this.$wrapper.prepend(this.pixels.canvas),document.body.append(this.$colorsDialog,this.$previewDialog),this.registerEvent(this.$strategy,"change",()=>{if(this.strategy=this.$strategy.value,this.$previewDialog.open)this.renderStrategyPreviewSamples();M(this.bot)}),this.registerEvent(this.$opacity,"input",()=>{this.opacity=this.$opacity.valueAsNumber,this.$opacity.style.setProperty("--val",this.opacity+"%"),this.update(),M(this.bot)}),this.$opacity.style.setProperty("--val",this.opacity+"%"),this.registerEvent(this.$resetSize,"click",()=>{this.pixels.width=this.pixels.image.naturalWidth,this.pixels.update(),this.updateColors(),this.update(),M(this.bot)}),this.registerEvent(this.$drawTransparent,"click",()=>{this.drawTransparentPixels=this.$drawTransparent.checked,M(this.bot)}),this.registerEvent(this.$skipUnavailable,"click",()=>{this.skipUnavailableColors=this.$skipUnavailable.checked,this.updateTasks(),M(this.bot)}),this.registerEvent(this.$drawColorsInOrder,"click",()=>{this.drawColorsInOrder=this.$drawColorsInOrder.checked,M(this.bot)}),this.registerEvent(this.$lock,"click",()=>{this.lock=!this.lock,this.update(),M(this.bot)}),this.registerEvent(this.$delete,"click",this.destroy.bind(this)),this.registerEvent(this.$openColors,"click",()=>{this.openColorPanel()}),this.registerEvent(this.$openPreview,"click",()=>{this.openPreviewPanel()}),this.registerEvent(this.$closeColors,"click",()=>{this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$closePreview,"click",()=>{this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorsDialog.querySelector(".colors-dialog-head"),"pointerdown",this.startColorDialogDrag.bind(this)),this.registerEvent(document,"pointermove",this.moveColorDialog.bind(this),{passive:!1}),this.registerEvent(document,"pointerup",this.stopColorDialogDrag.bind(this)),this.registerEvent(document,"pointercancel",this.stopColorDialogDrag.bind(this)),this.registerEvent(this.$colorsDialog,"click",(f)=>{if(this.suppressNextColorDialogBackdropClick){this.suppressNextColorDialogBackdropClick=!1;return}if(f.target===this.$colorsDialog)this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$previewDialog,"click",(f)=>{if(f.target===this.$previewDialog)this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorSearch,"input",()=>{this.updateColors()}),this.registerEvent(this.$enableAllColors,"click",()=>{for(let f of this.colors)f.disabled=void 0;this.updateTasks(),this.updateColors(),M(this.bot)}),this.registerEvent(this.$disableAllColors,"click",()=>{for(let f of this.colors)f.disabled=!0;this.updateTasks(),this.updateColors(),M(this.bot)}),this.registerEvent(this.$export,"click",this.export.bind(this)),this.registerEvent(this.$topbar,"mousedown",this.moveStart.bind(this)),this.registerEvent(this.$canvas,"mousedown",this.moveStart.bind(this)),this.registerEvent(document,"mouseup",this.moveStop.bind(this)),this.registerEvent(document,"mousemove",this.move.bind(this));for(let f of this.element.querySelectorAll(".resize"))this.registerEvent(f,"mousedown",this.resizeStart.bind(this));this.update(),this.updateColors()}toJSON(){return{pixels:this.pixels.toJSON(),position:this.position.toJSON(),strategy:this.strategy,opacity:this.opacity,drawTransparentPixels:this.drawTransparentPixels,drawColorsInOrder:this.drawColorsInOrder,skipUnavailableColors:this.skipUnavailableColors,colors:this.colors,lock:this.lock}}updateTasks(){this.tasks.length=0;let o=this.position.clone(),a=new Set,r=new Map;for(let s=0;s<this.colors.length;s++){let p=this.colors[s];if(p.disabled)a.add(p.realColor);r.set(p.realColor,s)}let l=pa({pixels:this.pixels.pixels,drawTransparentPixels:this.drawTransparentPixels,disabledColors:a,iterate:this.strategyPositionIterator(),readMapColor:(s,p)=>{return o.globalX=this.position.globalX+s,o.globalY=this.position.globalY+p,o.getMapColor()}});for(let s=0;s<l.length;s++){let p=l[s];o.globalX=this.position.globalX+p.x,o.globalY=this.position.globalY+p.y,this.tasks.push({position:o.clone(),color:p.color})}if(this.drawColorsInOrder)this.tasks.sort((s,p)=>(r.get(s.color)??0)-(r.get(p.color)??0));this.update(),this.bot.widget.update()}update(){let{x:o,y:a}=this.position.toScreenPosition(),r=this.position.pixelSize*this.pixels.width,l=this.position.pixelSize*this.pixels.height;this.element.style.transform=`translate3d(${o.toFixed(3)}px, ${a.toFixed(3)}px, 0)`,this.element.style.width=`${r}px`,this.element.style.height=`${l}px`,this.$canvas.style.opacity=`${this.opacity}%`,this.element.classList.remove("hidden"),this.$resetSizeSpan.textContent=this.pixels.width.toString(),this.$strategy.value=this.strategy,this.$opacity.valueAsNumber=this.opacity,this.$drawTransparent.checked=this.drawTransparentPixels,this.$drawColorsInOrder.checked=this.drawColorsInOrder,this.$skipUnavailable.checked=this.skipUnavailableColors;let s=this.pixels.pixels.length*this.pixels.pixels[0].length,p=Math.max(0,s-this.tasks.length),c=s>0?p/s*100|0:0;this.$progressText.textContent=`${p}/${s} ${c}% ETA: ${this.tasks.length/120|0}h`,this.$progressLine.style.transform=`scaleX(${c/100})`,this.$canvas.classList[this.lock?"add":"remove"]("no-pointer-events");for(let i of this.element.querySelectorAll(".resize"))i.classList[this.lock?"add":"remove"]("no-pointer-events");this.$lock.classList[this.lock?"add":"remove"]("locked")}exportImage(){this.export()}destroy(){super.destroy(),this.element.remove(),this.$colorsDialog.remove(),this.$previewDialog.remove(),co(this.bot.images,this),this.bot.widget.update(),M(this.bot)}openColorPanel(){if(this.$colorsDialog.open){this.$colorSearch.focus();return}this.$colorsDialog.style.position="fixed",this.$colorsDialog.style.left="",this.$colorsDialog.style.top="",this.$colorsDialog.style.margin="auto",this.$colorsDialog.showModal(),this.$colorSearch.focus()}openPreviewPanel(){if(this.$previewDialog.open){this.renderStrategyPreviewSamples();return}this.$previewDialog.style.position="fixed",this.$previewDialog.style.left="",this.$previewDialog.style.top="",this.$previewDialog.style.margin="auto",this.$previewDialog.showModal(),this.renderStrategyPreviewSamples()}closeDialog(o){if(!o.open)return;if(o===this.$previewDialog)this.stopPreviewAnimations();if(typeof o.requestClose==="function")o.requestClose();else o.close()}stopPreviewAnimations(){for(let o of this.previewAnimationHandles)cancelAnimationFrame(o);this.previewAnimationHandles.clear()}startColorDialogDrag(o){if(o.button!==0)return;if(o.target?.closest("button,input,select,textarea,a,label"))return;let r=this.$colorsDialog.getBoundingClientRect();this.colorDialogDragState={pointerId:o.pointerId,offsetX:o.clientX-r.left,offsetY:o.clientY-r.top,moved:!1},o.preventDefault()}moveColorDialog(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;let a=this.$colorsDialog.getBoundingClientRect(),r=Math.max(8,window.innerWidth-a.width-8),l=Math.max(8,window.innerHeight-a.height-8),s=Math.min(r,Math.max(8,o.clientX-this.colorDialogDragState.offsetX)),p=Math.min(l,Math.max(8,o.clientY-this.colorDialogDragState.offsetY));if(!this.colorDialogDragState.moved&&(Math.abs(o.movementX)>0||Math.abs(o.movementY)>0))this.colorDialogDragState.moved=!0;this.$colorsDialog.style.left=`${Math.round(s)}px`,this.$colorsDialog.style.top=`${Math.round(p)}px`,o.preventDefault()}stopColorDialogDrag(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;if(this.colorDialogDragState.moved)this.suppressNextColorDialogBackdropClick=!0;this.colorDialogDragState=void 0}renderStrategyPreviewSamples(){this.stopPreviewAnimations(),this.invalidatePreviewCacheIfNeeded();let o=this.$strategy.value;this.$previewDialogList.innerHTML="";let a=document.createDocumentFragment(),r=document.createElement("article");r.className="preview-card";let l=document.createElement("strong");l.textContent=this.getStrategyLabel(o);let s=document.createElement("canvas");s.className="preview-canvas",s.width=156,s.height=156,this.paintStrategyPreview(s,o),r.append(l,s),a.append(r),this.$previewDialogList.append(a)}invalidatePreviewCacheIfNeeded(){let o=this.colors.map((r,l)=>`${l}:${r.realColor}:${r.disabled?1:0}`).join("|"),a=`${this.pixels.width}x${this.pixels.height}:${this.pixels.image.src.length}:${this.drawColorsInOrder?1:0}:${o}`;if(this.previewCacheSignature===a)return;this.previewCacheSignature=a,this.previewSequenceCache.clear()}getStrategyLabel(o){switch(o){case"RANDOM":return d("random");case"HUMANIZED":return d("humanized");case"HUMAN_SOFT_DITHER":return d("humanSoftDither");case"HUMAN_PATCHY":return d("humanPatchy");case"HUMAN_SWEEP_ARCS":return d("humanSweepArcs");case"HUMAN_MICRO_CORRECTIONS":return d("humanMicroCorrections");case"HUMAN_JITTER_FILL":return d("humanJitterFill");case"HUMAN_CORNER_BIAS":return d("humanCornerBias");case"HUMAN_LONG_STROKES":return d("humanLongStrokes");case"HUMAN_TAP_CLUSTERS":return d("humanTapClusters");case"HUMAN_MESSY_SPIRAL":return d("humanMessySpiral");case"HUMAN_DRUNK_WALK":return d("humanDrunkWalk");case"HUMAN_NOISE_CLOUD":return d("humanNoiseCloud");case"HUMAN_PATCH_JUMP":return d("humanPatchJump");case"HUMAN_HESITANT_LINES":return d("humanHesitantLines");case"HUMAN_OVERLAP_SWEEPS":return d("humanOverlapSweeps");case"HUMAN_WOBBLE_DRIFT":return d("humanWobbleDrift");case"HUMAN_GAP_RECOVERY":return d("humanGapRecovery");case"HUMAN_STAIRCASE":return d("humanStaircase");case"HUMAN_EDGE_HUGGER":return d("humanEdgeHugger");case"HUMAN_BLOBS":return d("humanBlobs");case"HUMAN_BACKTRACK":return d("humanBacktrack");case"HUMAN_SHAKY_DIAGONAL":return d("humanShakyDiagonal");case"HUMAN_LATE_FIXES":return d("humanLateFixes");case"ZIGZAG":return d("zigzag");case"BRUSH_STROKES":return d("brushStrokes");case"DIAGONAL_BRUSH":return d("diagonalBrush");case"DOWN":return d("down");case"UP":return d("up");case"LEFT":return d("left");case"RIGHT":return d("right");case"SPIRAL_FROM_CENTER":return d("spiralOut");case"SPIRAL_TO_CENTER":return d("spiralIn");case"SCRIBBLE":return d("scribble");case"CROSSHATCH":return d("crosshatch");case"WAVE_SWEEP":return d("waveSweep");case"SCATTERED_LINES":return d("scatteredLines");case"CONTOUR_JITTER":return d("contourJitter");case"SPIRAL_WOBBLE":return d("spiralWobble");case"CLUSTER_BURSTS":return d("clusterBursts");case"ORBITAL":return d("orbital");case"FLOW_FIELD":return d("flowField");case"EDGE_IN":return d("edgeIn");default:return o}}paintStrategyPreview(o,a){let r=o.getContext("2d");if(!r)return;r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);let l=this.getSampledImagePreviewData(),s=this.getCachedPreviewSequence(a,l.mask,l.width,l.height),p=Math.min(o.width/l.width,o.height/l.height),c=(o.width-l.width*p)/2,i=(o.height-l.height*p)/2,g=this.previewAnimations.get(o);if(g)cancelAnimationFrame(g),this.previewAnimationHandles.delete(g);let n=(m)=>{let b=requestAnimationFrame((z)=>{this.previewAnimationHandles.delete(b),m(z)});return this.previewAnimationHandles.add(b),b},f=(m)=>{r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);for(let b=0;b<Math.min(m,s.length);b++){let z=s[b],A=l.colors.get(`${z.x}:${z.y}`)??0;if(!A)continue;r.fillStyle=fo(A),r.fillRect(c+z.x*p,i+z.y*p,Math.max(1,p),Math.max(1,p))}},t=Math.min(3400,Math.max(900,s.length*8)),w=t+220,e=(m,b)=>{if(!this.$previewDialog.open)return;let z=(b-m)%w,A=Math.min(1,z/t),P=A*A*(3-2*A);f(Math.floor(s.length*P));let J=n((q)=>{e(m,q)});this.previewAnimations.set(o,J)},h=performance.now();e(h,h)}getCachedPreviewSequence(o,a,r=this.pixels.width,l=this.pixels.height){let s=this.colors.map((g,n)=>`${n}:${g.realColor}:${g.disabled?1:0}`).join("|"),p=`${o}:${r}x${l}:${a.length}:${this.drawColorsInOrder?1:0}:${s}`,c=this.previewSequenceCache.get(p);if(c)return c;let i=r===this.pixels.width&&l===this.pixels.height?this.getExactPreviewSequence(o,a):this.getApproxPreviewSequence(o,a,r);if(this.drawColorsInOrder){let g=new Map;for(let n=0;n<this.colors.length;n++)g.set(this.colors[n].realColor,n);i.sort((n,f)=>(g.get(this.pixels.pixels[n.y]?.[n.x]??0)??0)-(g.get(this.pixels.pixels[f.y]?.[f.x]??0)??0))}return this.previewSequenceCache.set(p,i),i}getExactPreviewSequence(o,a){let r=this.strategy;this.strategy=o;let l=[...this.strategyPositionIterator()];this.strategy=r;let s=new Set(a.map(({x:p,y:c})=>`${p}:${c}`));return l.filter(({x:p,y:c})=>s.has(`${p}:${c}`))}getApproxPreviewSequence(o,a,r){let l=[...a],s=(i,g,n)=>{return(i*73856093+g*19349663+n*83492791>>>0)/4294967296},p=(i,g)=>l.sort((n,f)=>n.x*i+n.y*g-(f.x*i+f.y*g)||n.y-f.y||n.x-f.x),c=l.sort((i,g)=>{if(i.y!==g.y)return i.y-g.y;let n=i.y%2===0?i.x:r-i.x,f=g.y%2===0?g.x:r-g.x;return n-f});switch(o){case"UP":return p(0,-1);case"LEFT":return p(-1,0);case"RIGHT":return p(1,0);case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let i=r/2,g=Math.max(1,Math.round(l.reduce((n,f)=>n+f.y,0)/Math.max(1,l.length)));return l.sort((n,f)=>{let t=(n.x-i)**2+(n.y-g)**2,u=(f.x-i)**2+(f.y-g)**2;return o==="SPIRAL_FROM_CENTER"?t-u:u-t}),l}case"RANDOM":case"HUMANIZED":case"HUMAN_SOFT_DITHER":case"HUMAN_PATCHY":case"HUMAN_SWEEP_ARCS":case"HUMAN_MICRO_CORRECTIONS":case"HUMAN_JITTER_FILL":case"HUMAN_CORNER_BIAS":case"HUMAN_LONG_STROKES":case"HUMAN_TAP_CLUSTERS":case"HUMAN_MESSY_SPIRAL":case"HUMAN_DRUNK_WALK":case"HUMAN_NOISE_CLOUD":case"HUMAN_PATCH_JUMP":case"HUMAN_HESITANT_LINES":case"HUMAN_OVERLAP_SWEEPS":case"HUMAN_WOBBLE_DRIFT":case"HUMAN_GAP_RECOVERY":case"HUMAN_STAIRCASE":case"HUMAN_EDGE_HUGGER":case"HUMAN_BLOBS":case"HUMAN_BACKTRACK":case"HUMAN_SHAKY_DIAGONAL":case"HUMAN_LATE_FIXES":return l.sort((i,g)=>s(i.x,i.y,o.length)-s(g.x,g.y,o.length));default:return c}}getSampledImagePreviewData(){let o=this.pixels.width,a=this.pixels.height,r=U.PREVIEW_MASK_BASE_WIDTH,l=U.PREVIEW_MASK_BASE_HEIGHT,s=Math.min(1,r/Math.max(1,o),l/Math.max(1,a)),p=Math.max(1,Math.round(o*s)),c=Math.max(1,Math.round(a*s)),i=new Set;for(let t=0;t<this.colors.length;t++){let u=this.colors[t];if(u.disabled)i.add(u.realColor)}let g=new Map,n=new Map;for(let t=0;t<a;t++)for(let u=0;u<o;u++){let w=this.pixels.pixels[t]?.[u]??0;if(!w||i.has(w))continue;let e=Math.min(p-1,Math.floor(u/o*p)),h=Math.min(c-1,Math.floor(t/a*c)),m=`${e}:${h}`;if(!g.has(m))g.set(m,{x:e,y:h});if(!n.has(m))n.set(m,w)}let f=[...g.values()];if(!f.length){let t=this.fallbackPreviewMask();return{width:o,height:a,mask:t,colors:new Map(t.map((u)=>[`${u.x}:${u.y}`,this.pixels.pixels[u.y]?.[u.x]??0]))}}return{width:p,height:c,mask:f,colors:n}}getImagePreviewMask(){let o=this.pixels.width,a=this.pixels.height,r=new Set;for(let s=0;s<this.colors.length;s++){let p=this.colors[s];if(p.disabled)r.add(p.realColor)}let l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=this.pixels.pixels[s]?.[p]??0;if(c!==0&&!r.has(c))l.push({x:p,y:s})}return l.length?l:this.fallbackPreviewMask()}fallbackPreviewMask(){let o=[],a=this.pixels.width/2,r=this.pixels.height/2,l=Math.max(4,Math.min(this.pixels.width,this.pixels.height)/2.5);for(let s=0;s<this.pixels.height;s++)for(let p=0;p<this.pixels.width;p++)if((p-a)**2+(s-r)**2<=l**2)o.push({x:p,y:s});return o}applyLocale(){if(F(this.element),this.updateColors(),this.$previewDialog.open)this.renderStrategyPreviewSamples()}colorHex(o){let a=G[o]??"0,0,0",[r=0,l=0,s=0]=a.split(",").map((p)=>Number.parseInt(p,10));return`#${[r,l,s].map((p)=>p.toString(16).padStart(2,"0")).join("")}`}colorKeywords(o){let a=G[o]??"0,0,0",[r=0,l=0,s=0]=a.split(",").map((g)=>Number.parseInt(g,10)),p=Math.max(r,l,s),c=Math.min(r,l,s);if(p-c<15)return["gray","grey","gris","neutral","neutro"];if(r>l+30&&r>s+30)return["red","rojo"];if(l>r+30&&l>s+30)return["green","verde"];if(s>r+30&&s>l+30)return["blue","azul"];if(r>170&&l>120&&s<130)return["orange","naranja"];if(r>170&&l>110&&s>140)return["pink","rosa"];if(r>120&&l<100&&s>120)return["purple","violet","morado"];if(r>130&&l>130&&s<90)return["yellow","amarillo"];return["brown","cafe","marron"]}updateColors(){this.$colorsDialogList.innerHTML="";let o=this.pixels.pixels.length*this.pixels.pixels[0].length;this.$colorsDialogList.setAttribute("aria-label",d("colorPanelResults"));let a=this.$colorSearch.value.trim().toLowerCase();if(this.colors.length!==this.pixels.colors.size||this.colors.some((r)=>!this.pixels.colors.has(r.realColor))){let r=new Map(this.colors.map((l)=>[l.realColor,l]));this.colors=this.pixels.colors.values().toArray().sort((l,s)=>s.amount-l.amount).map((l)=>({realColor:l.realColor,disabled:r.get(l.realColor)?.disabled})),M(this.bot)}for(let r=0;r<this.colors.length;r++){let l=this.colors[r],s=this.pixels.colors.get(l.realColor),p=!1,c=s.amount/o*100,i=this.colorHex(s.realColor),g=this.colorKeywords(s.realColor),n=()=>{l.disabled=l.disabled?void 0:!0,f.classList.toggle("disabled",Boolean(l.disabled));let w=f.querySelector(".state");if(w)w.textContent=l.disabled?d("disabled"):d("enabled");M(this.bot)},f=document.createElement("button");f.className=`color-chip ${l.disabled?"disabled":""}`,f.draggable=!0,f.setAttribute("aria-label",`${d("overlayColors")} #${r+1}: ${i.toUpperCase()}`),f.innerHTML=`<span class="order-index">#${r+1}</span>
...
<span class="premium"></span>`,f.querySelector(".swatch").style.setProperty("--swatch-color",fo(s.realColor)),f.addEventListener("click",()=>{if(p){p=!1;return}n(),this.updateTasks()}),f.addEventListener("dragstart",(w)=>{p=!0,f.classList.add("dragging"),w.dataTransfer?.setData("text/plain",String(r)),w.dataTransfer.effectAllowed="move"}),f.addEventListener("dragend",()=>{f.classList.remove("dragging")}),f.addEventListener("dragover",(w)=>{w.preventDefault(),f.classList.add("drag-target")}),f.addEventListener("dragleave",()=>{f.classList.remove("drag-target")}),f.addEventListener("drop",(w)=>{w.preventDefault(),f.classList.remove("drag-target");let e=Number.parseInt(w.dataTransfer?.getData("text/plain")??"-1",10);if(e<0||e===r||e>=this.colors.length)return;this.colors.splice(r,0,...this.colors.splice(e,1)),M(this.bot),this.updateColors()});let t=document.createElement("button");t.textContent=d("buy"),t.className="buy-chip",t.addEventListener("click",(w)=>{w.stopPropagation(),document.getElementById("color-"+s.realColor)?.click()}),f.append(t);let u=`${i} ${g.join(" ")} ${s.realColor} ${G[s.realColor]}`;if(!a||u.toLowerCase().includes(a))this.$colorsDialogList.append(f)}}*strategyPositionIterator(){let o=this.pixels.pixels[0].length,a=this.pixels.pixels.length;switch(this.strategy){case"DOWN":{for(let r=0;r<a;r++)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"UP":{for(let r=a-1;r>=0;r--)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"LEFT":{for(let r=0;r<o;r++)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RIGHT":{for(let r=o-1;r>=0;r--)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RANDOM":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++)r.push({x:s,y:l});for(let l=r.length-1;l>=0;l--){let s=Math.floor(Math.random()*(l+1)),p=r[l];r[l]=r[s],r[s]=p}yield*r;break}case"ZIGZAG":{for(let r=0;r<a;r++)if(r%2===0)for(let l=0;l<o;l++)yield{x:l,y:r};else for(let l=o-1;l>=0;l--)yield{x:l,y:r};break}case"HUMANIZED":{let r=Math.max(4,Math.floor(Math.min(o,a)/10)),l=[];for(let s=0;s<a;s+=r)for(let p=0;p<o;p+=r)l.push({x:p,y:s});for(let s=l.length-1;s>=0;s--){let p=Math.floor(Math.random()*(s+1)),c=l[s];l[s]=l[p],l[p]=c}for(let s=0;s<l.length;s++){let p=l[s],c=Math.min(a,p.y+r),i=Math.min(o,p.x+r);for(let g=p.y;g<c;g++)if(Math.random()>0.35)for(let f=p.x;f<i;f++)yield{x:f,y:g};else for(let f=i-1;f>=p.x;f--)yield{x:f,y:g}}break}case"HUMAN_SOFT_DITHER":{let r=new Set;for(let l=0;l<a;l++){let s=Math.floor(Math.random()*3)-1;if((l+s)%2===0)for(let c=0;c<o;c+=2)r.add(`${c},${l}`),yield{x:c,y:l};else for(let c=1;c<o;c+=2)r.add(`${c},${l}`),yield{x:c,y:l}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=`${s},${l}`;if(r.has(p))continue;yield{x:s,y:l}}break}case"HUMAN_PATCHY":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*5);for(let i=p-c;i<=p+c;i++)for(let g=s-c;g<=s+c;g++){if(g<0||g>=o||i<0||i>=a)continue;if(Math.hypot(g-s,i-p)>c+Math.random()*1.2)continue;let n=`${g},${i}`;if(r.has(n))continue;r.add(n),yield{x:g,y:i}}}break}case"HUMAN_SWEEP_ARCS":{let r=new Set,l=(o-1)/2,s=(a-1)/2,p=Math.hypot(l,s);for(let c=0;c<4;c++){let i=Math.random()*Math.PI*2;for(let g=0;g<=p;g+=0.35){let n=Math.PI/2+Math.random()*(Math.PI/1.5),f=Math.max(10,Math.floor(g*8));for(let t=0;t<f;t++){let u=i+n*t/f+Math.sin(g)*0.08,w=Math.round(l+Math.cos(u)*g),e=Math.round(s+Math.sin(u)*g);if(w<0||w>=o||e<0||e>=a)continue;let h=`${w},${e}`;if(r.has(h))continue;r.add(h),yield{x:w,y:e}}}}for(let c=0;c<a;c++)for(let i=0;i<o;i++){let g=`${i},${c}`;if(r.has(g))continue;yield{x:i,y:c}}break}case"HUMAN_MICRO_CORRECTIONS":{let r=new Set;for(let l=0;l<a;l++){let s=l%2===0?1:-1,p=s>0?0:o-1;for(let c=0;c<o;c++){let i=p+(Math.random()>0.82?s:0),g=l+(Math.random()>0.9?1:0);for(let n of[{x:p,y:l},{x:i,y:l},{x:p,y:g}]){if(n.x<0||n.x>=o||n.y<0||n.y>=a)continue;let f=`${n.x},${n.y}`;if(r.has(f))continue;r.add(f),yield n}p+=s}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=`${s},${l}`;if(r.has(p))continue;yield{x:s,y:l}}break}case"HUMAN_JITTER_FILL":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++)r.push({x:s,y:l});r.sort((l,s)=>{let p=l.y+(Math.random()-0.5)*1.8,c=s.y+(Math.random()-0.5)*1.8;if(p!==c)return p-c;return l.x+(Math.random()-0.5)*2-(s.x+(Math.random()-0.5)*2)}),yield*r;break}case"HUMAN_CORNER_BIAS":{let r=[{x:0,y:0},{x:o-1,y:0},{x:0,y:a-1},{x:o-1,y:a-1}],l=r[Math.floor(Math.random()*r.length)],s=[];for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=Math.hypot(c-l.x,p-l.y)+Math.random()*3.5;s.push({point:{x:c,y:p},score:g})}s.sort((p,c)=>p.score-c.score);for(let p of s)yield p.point;break}case"HUMAN_LONG_STROKES":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=Math.random()*Math.PI*2,i=Math.sign(Math.cos(c)),g=Math.sign(Math.sin(c)),n=10+Math.floor(Math.random()*40);for(let f=0;f<n;f++){if(s<0||s>=o||p<0||p>=a)break;let t=`${s},${p}`;if(!r.has(t))r.add(t),yield{x:s,y:p};if(Math.random()>0.78)s+=g,p+=i;else s+=i,p+=g}}break}case"HUMAN_TAP_CLUSTERS":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=3+Math.floor(Math.random()*10);for(let i=0;i<c;i++){let g=Math.round(s+(Math.random()-0.5)*6),n=Math.round(p+(Math.random()-0.5)*6);if(g<0||g>=o||n<0||n>=a)continue;let f=`${g},${n}`;if(r.has(f))continue;r.add(f),yield{x:g,y:n}}}break}case"HUMAN_MESSY_SPIRAL":{let r=new Set,l=(o-1)/2,s=(a-1)/2,p=Math.hypot(l,s)+2;for(let c=0;r.size<o*a;c++){let i=c/3,g=Math.min(p,i*0.18),n=i*0.29+Math.sin(i*0.13)*0.8,f=Math.round(l+Math.cos(n)*g+Math.sin(i)*0.7),t=Math.round(s+Math.sin(n)*g+Math.cos(i)*0.7);if(f<0||f>=o||t<0||t>=a){if(c>o*a*18)break;continue}let u=`${f},${t}`;if(r.has(u)){if(Math.random()>0.9)continue}else r.add(u),yield{x:f,y:t};if(c>o*a*18)break}for(let c=0;c<a;c++)for(let i=0;i<o;i++){let g=`${i},${c}`;if(r.has(g))continue;yield{x:i,y:c}}break}case"HUMAN_DRUNK_WALK":{let r=new Set,l=Math.floor(Math.random()*o),s=Math.floor(Math.random()*a),p=[{x:-1,y:0},{x:1,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:-1},{x:1,y:-1},{x:-1,y:1},{x:1,y:1}];while(r.size<o*a){let c=`${l},${s}`;if(!r.has(c))r.add(c),yield{x:l,y:s};let i=[];for(let f of p){let t=l+f.x,u=s+f.y;if(t<0||t>=o||u<0||u>=a)continue;i.push({x:t,y:u})}if(!i.length)break;let g=i.filter((f)=>{return!r.has(`${f.x},${f.y}`)});if(g.length&&Math.random()>0.2){let f=g[Math.floor(Math.random()*g.length)];l=f.x,s=f.y;continue}let n=i[Math.floor(Math.random()*i.length)];l=n.x,s=n.y}for(let c=0;c<a;c++)for(let i=0;i<o;i++){let g=`${i},${c}`;if(r.has(g))continue;yield{x:i,y:c}}break}case"HUMAN_NOISE_CLOUD":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=Math.sin((s+1)*0.93+Math.random()*0.8)+Math.cos((l+1)*1.17+Math.random()*0.8),c=(Math.random()-0.5)*2.6,i=Math.hypot(s-o/2,l-a/2)*0.08;r.push({point:{x:s,y:l},score:p+c+i})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_PATCH_JUMP":{let r=new Set,l=[];for(let s=0;s<Math.max(6,o*a/18);s++)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});while(r.size<o*a){let s=l[Math.floor(Math.random()*l.length)],p=1+Math.floor(Math.random()*3),c=1+Math.floor(Math.random()*3);for(let i=s.y-c;i<=s.y+c;i++)for(let g=s.x-p;g<=s.x+p;g++){if(g<0||g>=o||i<0||i>=a)continue;if(Math.random()>0.86)continue;let n=`${g},${i}`;if(r.has(n))continue;r.add(n),yield{x:g,y:i}}if(Math.random()>0.72&&l.length<o*a/2)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});if(r.size>o*a*0.92)break}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;yield{x:p,y:s}}break}case"HUMAN_HESITANT_LINES":{let r=new Set;for(let l=0;l<a;l++){let s=l%2===0;for(let p=0;p<o;p++){let c=s?p:o-1-p,i=`${c},${l}`;if(!r.has(i))r.add(i),yield{x:c,y:l};if(Math.random()>0.7){let g=Math.max(0,Math.min(o-1,c+(Math.random()>0.5?1:-1))),n=Math.max(0,Math.min(a-1,l+(Math.random()>0.65?1:0))),f=`${g},${n}`;if(!r.has(f))r.add(f),yield{x:g,y:n}}}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=`${s},${l}`;if(r.has(p))continue;yield{x:s,y:l}}break}case"HUMAN_OVERLAP_SWEEPS":{let r=[],l=Math.random()*Math.PI*2;for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=Math.sin((p+s)*0.42+l)*2.2,i=Math.cos((p-s)*0.3+l)*1.4;r.push({point:{x:p,y:s},score:s+c+i+(Math.random()-0.5)*3.4})}r.sort((s,p)=>s.score-p.score);for(let s of r)yield s.point;break}case"HUMAN_WOBBLE_DRIFT":{let r=[],l=o/2,s=a/2;for(let p=0;p<a;p++)for(let c=0;c<o;c++){let i=Math.hypot(c-l,p-s)*0.25,g=Math.sin((c+1)*0.9)*1.8+Math.cos((p+1)*1.1)*1.8+Math.sin((c+p)*0.35)*1.4;r.push({point:{x:c,y:p},score:i+g+(Math.random()-0.5)*2.8})}r.sort((p,c)=>p.score-c.score);for(let p of r)yield p.point;break}case"HUMAN_GAP_RECOVERY":{let r=new Set,l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++){if(Math.random()>0.87){l.push({x:p,y:s});continue}r.add(`${p},${s}`),yield{x:p,y:s}}l.sort((s,p)=>Math.hypot(s.x-o/2,s.y-a/2)-Math.hypot(p.x-o/2,p.y-a/2));for(let s of l){let p=`${s.x},${s.y}`;if(r.has(p))continue;r.add(p),yield s}break}case"HUMAN_STAIRCASE":{let r=new Set,l=o+a-1;for(let s=0;s<l;s++){let p=Math.max(0,s-o+1),c=Math.min(a-1,s);for(let i=p;i<=c;i++){let g=s-i,n=[{x:g,y:i},{x:g+(Math.random()>0.5?1:-1),y:i},{x:g,y:i+(Math.random()>0.5?1:-1)}];for(let f of n){if(f.x<0||f.x>=o||f.y<0||f.y>=a)continue;let t=`${f.x},${f.y}`;if(r.has(t))continue;r.add(t),yield f}}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;yield{x:p,y:s}}break}case"HUMAN_EDGE_HUGGER":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=Math.min(s,l,o-1-s,a-1-l);r.push({point:{x:s,y:l},score:p*3.5+(Math.random()-0.5)*5.5})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_BLOBS":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*4);for(let i=p-c;i<=p+c;i++)for(let g=s-c;g<=s+c;g++){if(g<0||g>=o||i<0||i>=a)continue;let n=Math.atan2(i-p,g-s),f=c+Math.sin(n*3+Math.random())*0.8;if(Math.hypot(g-s,i-p)>f)continue;let t=`${g},${i}`;if(r.has(t))continue;r.add(t),yield{x:g,y:i}}}break}case"HUMAN_BACKTRACK":{let r=new Set,l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++)l.push({x:p,y:s});l.sort((s,p)=>s.y-p.y+(Math.random()-0.5)*2.2+(s.x-p.x)*0.04);for(let s=0;s<l.length;s++){let p=l[s],c=`${p.x},${p.y}`;if(r.has(c))continue;if(r.add(c),yield p,s>1&&Math.random()>0.74){let i=l[s-1],g=`${i.x},${i.y}`;if(!r.has(g))r.add(g),yield i}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;yield{x:p,y:s}}break}case"HUMAN_SHAKY_DIAGONAL":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=Math.abs(s-l)*0.6,c=Math.sin(s*1.4+l*0.8)*1.8+Math.cos(l*1.1+s*0.5)*1.5;r.push({point:{x:s,y:l},score:p+c+(Math.random()-0.5)*3.2})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_LATE_FIXES":{let r=[],l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++)if(Math.random()>0.9)l.push({x:p,y:s});else r.push({x:p,y:s});r.sort((s,p)=>s.y-p.y+(Math.random()-0.5)*1.5+(Math.random()>0.85?s.x-p.x:0)),l.sort((s,p)=>Math.hypot(p.x-o/2,p.y-a/2)-Math.hypot(s.x-o/2,s.y-a/2)),yield*r,yield*l;break}case"DIAGONAL_BRUSH":{for(let r=0;r<o+a-1;r++){let l=r%2===0,s=[],p=Math.max(0,r-o+1),c=Math.min(a-1,r);for(let i=p;i<=c;i++){let g=r-i;if(g>=0&&g<o)s.push({x:g,y:i})}if(Math.random()>0.55)s.reverse();if(l)for(let i=s.length-1;i>=0;i--)yield s[i];else yield*s}break}case"BRUSH_STROKES":{let r=Array.from({length:a},()=>Array(o).fill(!1)),l=[{x:1,y:0},{x:-1,y:0},{x:0,y:1},{x:0,y:-1},{x:1,y:1},{x:1,y:-1},{x:-1,y:1},{x:-1,y:-1}],s=(i,g)=>i>=0&&i<o&&g>=0&&g<a,p=0,c=o*a;for(let i=0;i<c*6&&p<c;i++){let g=Math.floor(Math.random()*o),n=Math.floor(Math.random()*a),f=l[Math.floor(Math.random()*l.length)],t=3+Math.floor(Math.random()*16);for(let u=0;u<t;u++){if(!s(g,n))break;if(!r[n][g])r[n][g]=!0,p++,yield{x:g,y:n};if(Math.random()>0.72)f=l[Math.floor(Math.random()*l.length)];g+=f.x,n+=f.y}}for(let i=0;i<a;i++)for(let g=0;g<o;g++)if(!r[i][g])yield{x:g,y:i};break}case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let r=new Set,l=o*a,s=Math.floor(o/2),p=Math.floor(a/2),c=[[1,0],[0,1],[-1,0],[0,-1]],i=0,g=1,n=(t,u)=>t>=0&&t<o&&u>=0&&u<a,f=function*(){let t=0;while(t<l){for(let u=0;u<2;u++){for(let w=0;w<g;w++){if(n(s,p)){let e=`${s},${p}`;if(!r.has(e)){if(r.add(e),yield{x:s,y:p},t++,t>=l)return}}s+=c[i][0],p+=c[i][1]}i=(i+1)%4}g++}};if(this.strategy==="SPIRAL_FROM_CENTER")yield*f();else{let t=[...f()];for(let u=t.length-1;u>=0;u--)yield t[u]}break}case"SCRIBBLE":{let r=new Set,l=o*a,s=Math.floor(o/2),p=Math.floor(a/2);for(let c=0;r.size<l&&c<l*24;c++){let i=`${s},${p}`;if(!r.has(i))r.add(i),yield{x:s,y:p};if(s+=Math.floor(Math.random()*3)-1,p+=Math.floor(Math.random()*3)-1,s<0||s>=o||p<0||p>=a)s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a)}for(let c=0;c<a;c++)for(let i=0;i<o;i++){let g=`${i},${c}`;if(r.has(g))continue;r.add(g),yield{x:i,y:c}}break}case"CROSSHATCH":{let r=[];for(let p=0;p<o+a-1;p++)for(let c=Math.max(0,p-o+1);c<=Math.min(a-1,p);c++){let i=p-c;r.push({x:i,y:c})}let l=[];for(let p=-a+1;p<o;p++)for(let c=0;c<a;c++){let i=c+p;if(i>=0&&i<o)l.push({x:i,y:c})}let s=new Set;for(let p of[...r,...l]){let c=`${p.x},${p.y}`;if(s.has(c))continue;s.add(c),yield p}break}case"WAVE_SWEEP":{let r=new Set;for(let l=0;l<o;l++){let p=(Math.sin(l/Math.max(1,o-1)*Math.PI*4)+1)*0.5*(a-1)|0;for(let c=0;c<a;c++){let i=p+c,g=p-c;for(let n of[i,g]){if(n<0||n>=a)continue;let f=`${l},${n}`;if(r.has(f))continue;r.add(f),yield{x:l,y:n}}}}break}case"SCATTERED_LINES":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*14;s++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),i=Math.random()*Math.PI*2,g=Math.round(Math.cos(i)),n=Math.round(Math.sin(i)),f=6+Math.floor(Math.random()*28);for(let t=0;t<f;t++){if(p<0||p>=o||c<0||c>=a)break;let u=`${p},${c}`;if(!r.has(u))r.add(u),yield{x:p,y:c};p+=g,c+=n}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;r.add(c),yield{x:p,y:s}}break}case"CONTOUR_JITTER":{let r=new Set;for(let l=0;l<Math.ceil(Math.min(o,a)/2);l++){let s=[],p=l,c=l,i=o-l-1,g=a-l-1;for(let n=p;n<=i;n++)s.push({x:n,y:c});for(let n=c+1;n<=g;n++)s.push({x:i,y:n});for(let n=i-1;n>=p;n--)s.push({x:n,y:g});for(let n=g-1;n>c;n--)s.push({x:p,y:n});for(let n=s.length-1;n>0;n--){let f=Math.floor(Math.random()*(n+1)),t=s[n];s[n]=s[f],s[f]=t}for(let n of s){let f=`${n.x},${n.y}`;if(r.has(f))continue;r.add(f),yield n}}break}case"SPIRAL_WOBBLE":{let r=new Set,l=o/2,s=a/2,p=Math.hypot(l,s);for(let c=0;r.size<o*a&&c<o*a*9;c++){let i=c/(o*a*9)*p,g=c*0.31+Math.sin(c*0.07)*0.7,n=Math.round(l+Math.cos(g)*i),f=Math.round(s+Math.sin(g)*i);if(n<0||n>=o||f<0||f>=a)continue;let t=`${n},${f}`;if(r.has(t))continue;r.add(t),yield{x:n,y:f}}for(let c=0;c<a;c++)for(let i=0;i<o;i++){let g=`${i},${c}`;if(r.has(g))continue;yield{x:i,y:c}}break}case"CLUSTER_BURSTS":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*12;s++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),i=2+Math.floor(Math.random()*10);for(let g=c-i;g<=c+i;g++)for(let n=p-i;n<=p+i;n++){if(n<0||n>=o||g<0||g>=a)continue;if(Math.hypot(n-p,g-c)>i)continue;let f=`${n},${g}`;if(r.has(f))continue;r.add(f),yield{x:n,y:g}}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;r.add(c),yield{x:p,y:s}}break}case"ORBITAL":{let r=new Set,l=(o-1)/2,s=(a-1)/2,p=Math.ceil(Math.max(l,s));for(let c=0;c<=p;c++){let i=Math.max(16,Math.ceil(2*Math.PI*Math.max(1,c)*2));for(let g=0;g<i;g++){let n=g/i*Math.PI*2+(c%2?0.3:-0.3),f=Math.round(l+Math.cos(n)*c),t=Math.round(s+Math.sin(n)*c);if(f<0||f>=o||t<0||t>=a)continue;let u=`${f},${t}`;if(r.has(u))continue;r.add(u),yield{x:f,y:t}}}for(let c=0;c<a;c++)for(let i=0;i<o;i++){let g=`${i},${c}`;if(r.has(g))continue;yield{x:i,y:c}}break}case"FLOW_FIELD":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*18;s++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a);for(let i=0;i<120;i++){if(p<0||p>=o||c<0||c>=a)break;let g=`${p},${c}`;if(!r.has(g))r.add(g),yield{x:p,y:c};let n=Math.sin(p*0.09)*1.8+Math.cos(c*0.08)*1.6+Math.sin((p+c)*0.05);p+=Math.round(Math.cos(n)),c+=Math.round(Math.sin(n))}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;r.add(c),yield{x:p,y:s}}break}case"EDGE_IN":{let r=new Set,l=Math.ceil(Math.min(o,a)/2);for(let s=0;s<l;s++){let p=s,c=o-1-s,i=s,g=a-1-s;for(let n=p;n<=c;n++)for(let f of[i,g]){let t=`${n},${f}`;if(r.has(t))continue;r.add(t),yield{x:n,y:f}}for(let n=i+1;n<=g-1;n++)for(let f of[p,c]){let t=`${f},${n}`;if(r.has(t))continue;r.add(t),yield{x:f,y:n}}}break}}}moveStart(o){if(o.button!==0)return;if(o.preventDefault(),o.stopPropagation(),!this.lock)this.moveInfo={globalX:this.position.globalX,globalY:this.position.globalY,clientX:o.clientX,clientY:o.clientY}}moveStop(){if(this.moveInfo)this.moveInfo=void 0,this.position.updateAnchor(),this.pixels.update(),this.updateColors(),M(this.bot)}move(o){if(!this.moveInfo)return;let a=Math.round((o.clientX-this.moveInfo.clientX)/this.position.pixelSize),r=Math.round((o.clientY-this.moveInfo.clientY)/this.position.pixelSize);if(this.moveInfo.globalX!==void 0){if(this.position.globalX=a+this.moveInfo.globalX,this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,this.moveInfo.width-a)}else if(this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,a+this.moveInfo.width);if(this.moveInfo.globalY!==void 0){if(this.position.globalY=r+this.moveInfo.globalY,this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,this.moveInfo.height-r)}else if(this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,r+this.moveInfo.height);this.update(),M(this.bot)}resizeStart(o){if(this.lock||o.button!==0)return;o.preventDefault(),o.stopPropagation(),this.moveInfo={clientX:o.clientX,clientY:o.clientY};let a=o.target;if(a.classList.contains("n"))this.moveInfo.height=this.pixels.height,this.moveInfo.globalY=this.position.globalY;if(a.classList.contains("e"))this.moveInfo.width=this.pixels.width;if(a.classList.contains("s"))this.moveInfo.height=this.pixels.height;if(a.classList.contains("w"))this.moveInfo.width=this.pixels.width,this.moveInfo.globalX=this.position.globalX}export(){let o=document.createElement("a");document.body.append(o),o.href=URL.createObjectURL(new Blob([JSON.stringify(this.toJSON())],{type:"application/json"})),o.download=`${this.pixels.width}x${this.pixels.height}.${X}`,o.click(),URL.revokeObjectURL(o.href),o.href=this.pixels.canvas.toDataURL("image/webp",1),o.download=`${this.pixels.width}x${this.pixels.height}.webp`,o.click(),URL.revokeObjectURL(o.href),o.remove()}}function to(){let o=localStorage.getItem("kglacer-macro:shield-config");if(!o)return!1;try{return JSON.parse(o).enabled!==!1}catch{return!1}}function So(o){localStorage.setItem("kglacer-macro:shield-config",JSON.stringify({enabled:o}))}function ca(o){let a=`${o?.host??""} ${o?.username??""}`.toLowerCase(),r=/(mx|mex|mexico)/.test(a)?"MX":"AUTO";localStorage.setItem("__afm_proxy_hint",r)}function Do(o){if(!to())return;if(document.getElementById("kgm-shield-full"))return;ca(o);let a=document.createElement("script");a.id="kgm-shield-full",a.textContent=`// ==UserScript==
...
.wwidget .challenge-button {
  position: relative;
  overflow: hidden;
  border-color: rgb(143 162 255 / 34%);
  background: linear-gradient(135deg, #24365d 0%, #18243f 55%, #111b31 100%);
  color: #e6eeff;
  box-shadow:
    inset 0 1px 0 rgb(255 255 255 / 10%),
    0 8px 18px rgb(3 8 18 / 26%);
}
...
.wwidget .challenge-button:hover {
  border-color: rgb(143 216 255 / 55%);
  box-shadow:
    0 12px 24px rgb(3 8 18 / 34%),
    0 0 0 1px rgb(143 216 255 / 18%);
}
...
</form>`,document.body.append(o),F(o);let s=o.querySelector(".autofarm-unit");s.value=a;let p=o.querySelector(".autofarm-value"),c=o.querySelector(".autofarm-pixels"),i=()=>{let g=Math.max(1,Number.parseInt(p.value||"1",10));if(s.value==="hours")return g*3600000;if(s.value==="minutes")return g*60000;return g*1000};o.querySelector(".autooverlay-start").onclick=()=>{this.saveAutoOverlayConfig({value:Math.max(1,Number.parseInt(p.value||"1",10)),pixels:Math.max(1,Number.parseInt(c.value||"60",10)),unit:s.value,timerMs:i()}),this.startAutoOverlay(),o.close(),o.remove()},o.querySelector(".autooverlay-stop").onclick=()=>{this.stopAutoOverlay(),o.close(),o.remove()},o.querySelector(".modal-close").onclick=()=>{o.close(),o.remove()},o.addEventListener("close",()=>{o.remove()}),o.showModal()}setDisabled(o,a){this.element.querySelector("."+o).disabled=a}async run(o,a,r,l="..."){console.log("[KGM][Widget] Task started",{status:o});let s=this.status;this.status=`${l} ${o}`;try{let p=await a();return this.status=s,console.log("[KGM][Widget] Task completed",{status:o}),p}catch(p){if(!(p instanceof so))console.error(p),this.status=`${d("taskErrorPrefix")}: ${o}`;throw console.error("[KGM][Widget] Task failed",{status:o,error:p}),p}finally{await r?.()}}handleKeyboard(o){if(Uo(o.target))return;if(S(o,N.toggleWidget)){o.preventDefault(),this.open=!this.open;return}if(S(o,N.showShortcuts)){o.preventDefault(),this.open=!0,this.openSettingsModal();return}if(S(o,N.toggleOverlay)){o.preventDefault(),this.toggleOverlay();return}if(S(o,N.focusNextImage)){o.preventDefault(),this.focusImageByStep(1);return}if(S(o,N.focusPreviousImage)){o.preventDefault(),this.focusImageByStep(-1);return}if(S(o,N.openColorPanel)){o.preventDefault(),this.openColorPanelForActiveImage();return}if(S(o,N.toggleImageLock)){o.preventDefault(),this.toggleLockForActiveImage();return}if(S(o,N.clickPaintWhenReady)){o.preventDefault(),this.drawAndClickPaintWhenReady();return}if(S(o,N.startAutoFarm)){o.preventDefault(),this.startAutoFarm();return}if(S(o,N.stopAutoFarm)){o.preventDefault(),this.stopAutoFarm();return}if(S(o,N.addImage)&&!this.$addImage.disabled){o.preventDefault(),this.addImage();return}if(S(o,N.draw)&&!this.$draw.disabled)o.preventDefault(),this.bot.draw()}focusImageByStep(o){if(!this.bot.images.length)return;if(this.activeImageIndex<0||this.activeImageIndex>=this.bot.images.length)this.activeImageIndex=o>0?0:this.bot.images.length-1;else this.activeImageIndex=(this.activeImageIndex+o+this.bot.images.length)%this.bot.images.length;this.bot.images[this.activeImageIndex].position.scrollScreenTo()}getActiveImage(){if(!this.bot.images.length)return;if(this.activeImageIndex<0||this.activeImageIndex>=this.bot.images.length)this.activeImageIndex=0;return this.bot.images[this.activeImageIndex]}openColorPanelForActiveImage(){let o=this.getActiveImage();if(!o)return;o.openColorPanel()}toggleLockForActiveImage(){let o=this.getActiveImage();if(!o)return;o.lock=!o.lock,o.update(),M(this.bot)}async waitAndClickPaintButton(){await this.run(d("taskWaitingPaintButton"),async()=>{for(;;){if(this.isChallengeBlockingPaint()){await this.waitForChallengeToResolve(),await new Promise((a)=>setTimeout(a,250));continue}let o=this.findNativePaintButton();if(o&&!o.disabled&&o.ariaDisabled!=="true"){await this.triggerNativePaintClickWithChallengeRecovery(o);return}await new Promise((a)=>setTimeout(a,500))}})}async drawAndClickPaintWhenReady(){if(!this.$draw.disabled)await this.bot.draw();await this.waitAndClickPaintButton()}findNativePaintButton(){return["button.btn.btn-primary.btn-lg.sm\\:btn-xl.relative","button.btn.btn-primary.btn-lg.relative","button.btn.btn-primary.btn-lg.relative.z-30","button.btn.btn-primary.btn-lg.sm\\:btn-xl.relative.z-30","div.absolute.bottom-0.left-1\\/2.-translate-x-1\\/2 button.btn.btn-primary"].flatMap((r)=>Array.from(document.querySelectorAll(r))).find((r)=>/pintar|paint/i.test(r.textContent))}triggerNativePaintClick(o){o.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,cancelable:!0,pointerType:"mouse",button:0})),o.dispatchEvent(new MouseEvent("mousedown",{bubbles:!0,cancelable:!0,button:0})),o.dispatchEvent(new PointerEvent("pointerup",{bubbles:!0,cancelable:!0,pointerType:"mouse",button:0})),o.dispatchEvent(new MouseEvent("mouseup",{bubbles:!0,cancelable:!0,button:0})),o.click()}async triggerNativePaintClickWithChallengeRecovery(o){for(let r=0;r<3;r++){let l=r===0?o:this.findNativePaintButton();if(!l)return;if(l.disabled||l.ariaDisabled==="true")return;this.triggerNativePaintClick(l);let s=await this.waitForPaintAttemptOutcome(6000);if(s==="painted")return;if(s==="challenge"){await this.waitForChallengeToResolve(),await new Promise((p)=>setTimeout(p,350));continue}await new Promise((p)=>setTimeout(p,350))}console.log("[KGM][Widget] Paint click finished without a clear success signal after retries")}async waitForPaintAttemptOutcome(o){let a=Date.now();while(Date.now()-a<=o){if(this.isChallengeBlockingPaint())return"challenge";let r=this.findNativePaintButton();if(r&&(r.disabled||r.ariaDisabled==="true"))return await this.waitForDelayedChallenge(1200)?"challenge":"painted";await new Promise((l)=>setTimeout(l,200))}return"unknown"}async waitForDelayedChallenge(o){let a=Date.now();while(Date.now()-a<=o){if(this.isChallengeBlockingPaint())return!0;await new Promise((r)=>setTimeout(r,150))}return!1}async waitForChallengeToResolve(){await this.run(d("taskWaitingChallengeResolve"),async()=>{let o=Date.now(),a=90000;while(this.isChallengeBlockingPaint()&&Date.now()-o<=90000)await new Promise((r)=>setTimeout(r,500))})}isChallengeBlockingPaint(){let r=Array.from(document.querySelectorAll('h-captcha, .h-captcha, iframe[src*="hcaptcha.com"], iframe[src*="newassets.hcaptcha.com"], iframe[src*="captcha"], [data-hcaptcha-widget-id]')).filter((p)=>{if(p.closest("dialog")?.matches("dialog:not([open])"))return!1;let c=globalThis.getComputedStyle(p);if(c.display==="none"||c.visibility==="hidden")return!1;let i=p.getBoundingClientRect();return i.width>0&&i.height>0});if(!r.length)return!1;let l=document.querySelector("dialog.modal[open], dialog[open]");if(l?.querySelector('h-captcha, .h-captcha, iframe[src*="hcaptcha.com"], iframe[src*="newassets.hcaptcha.com"], iframe[src*="captcha"], [data-hcaptcha-widget-id]')){if(!l)return!1;if(!Array.from(l.querySelectorAll('textarea[name="h-captcha-response"], textarea[name^="h-captcha-response-"]')).some((c)=>c.value.trim().length>0))return!0}return r.some((p)=>{let c=p.closest("h-captcha")??p.parentElement??document.documentElement,i=Array.from(c.querySelectorAll('textarea[name="h-captcha-response"], textarea[name^="h-captcha-response-"]'));if(!i.length)return!0;return i.every((g)=>g.value.trim().length===0)})}}var fa=2;function da(){let o=globalThis;if(typeof o.fp_assemble_injection!=="function")o.fp_assemble_injection=()=>({});if(!o.__kgmUnhandledRejectionPatched)o.__kgmUnhandledRejectionPatched=!0,o.addEventListener("unhandledrejection",(a)=>{let r=a.reason,l=typeof r==="object"&&r!==null&&"name"in r&&typeof r.name==="string"?r.name:"",s=r instanceof Error?r.message:r;if(l==="NotAllowedError"&&s.includes("play() failed"))a.preventDefault()});if(!o.__kgmMediaPlayPatched&&"HTMLMediaElement"in o){o.__kgmMediaPlayPatched=!0;let a=Reflect.get(o.HTMLMediaElement.prototype,"play");o.HTMLMediaElement.prototype.play=function r(){return Reflect.apply(a,this,[]).catch((s)=>{let p=s instanceof Error?s.message:s;if((typeof s==="object"&&s!==null&&"name"in s&&typeof s.name==="string"?s.name:"")==="NotAllowedError"&&p.includes("play() failed"))return;throw s})}}}var qo="[KGM]",Lo="kglacer-macro:access-ok",eo="S0dNLXlZUjhTMW81bEhVemVjS1RFMEhxRVB4OVFkcjgxaEVz",Ro="kgm-access-locked";class Wo{unavailableColors=new Set;mapsCache=new Map;me;$stars=[];strategy="SEQUENTIAL";images=[];_widget;get widget(){if(!this._widget)throw new Error("Widget is not initialized yet");return this._widget}markerPixelPositionResolvers=[];lastColor;log(o,a){if(a===void 0)console.log(`${qo} ${o}`);else console.log(`${qo} ${o}`,a)}constructor(){this.log("Boot sequence started"),document.body.classList.add(Ro);let o=No();if(this.log("Save loaded",{hasSave:Boolean(o),imageCount:o?.images.length??0,strategy:o?.strategy}),o){for(let l=0;l<o.images.length;l++){let s=o.images[l];v({x:s.position[0]-1000,y:s.position[1]-1000}),v({x:s.position[0]+1000,y:s.position[1]+1000})}this.strategy=o.strategy}let a=JSON.parse(localStorage.getItem("kglacer-macro:proxy-config")??"{}");Do(a),this.registerFetchInterceptor(),this.log("Fetch interceptor registered");let r=document.createElement("style");r.textContent=Jo.replace("FAKE_FAVORITE_LOCATIONS",E.length.toString()),document.head.append(r),this.log("Styles injected",{fakeFavoriteLocations:E.length}),(async()=>{this.log("Widget initialization flow started"),await this.ensureAccessKey(),document.body.classList.remove(Ro),this._widget=new wo(this),await this.widget.run(d("taskInitializing"),async()=>{await this.waitForElement("login",".avatar.center-absolute.absolute"),await this.waitForElement("pixel count",".btn.btn-primary.btn-lg.relative.z-30 canvas");let l=await this.waitForElement("canvas",".maplibregl-canvas-container");if(new MutationObserver((s)=>{for(let p=0;p<s.length;p++)if(s[p].removedNodes.length!==0){this.updateStars();break}this.updateImages()}).observe(l,{attributes:!0,childList:!0,subtree:!0}),this.updateStars(),this.log("Stars updated after boot",{stars:this.$stars.length}),await D(500),await this.updateColors(),o)for(let s=0;s<o.images.length;s++){let p=await U.fromJSON(this,o.images[s]);this.images.push(p),p.update()}this.log("Saved images restored",{images:this.images.length}),await this.readMap(),this.updateTasks(),this.widget.setDisabled("draw",!1),this.widget.setDisabled("draw-and-paint",!1),this.widget.setDisabled("add-image",!1),this.widget.setDisabled("capture-template",!1),this.log("Initialization completed; controls enabled")})})()}async ensureAccessKey(){if(localStorage.getItem(Lo)===eo)return;await new Promise((o)=>{let a=document.createElement("dialog");a.className="kgm-modal access-dialog",a.innerHTML=`<form method="dialog" class="access-form">
  <div class="kgm-modal-head">
