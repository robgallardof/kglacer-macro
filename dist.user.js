...
`;class G{bot;image;width;exactColor;static async fromJSON(o,a){let s=new Image;return s.src=a.url.startsWith("http")?await fetch(a.url,{cache:"no-store"}).then((r)=>r.blob()).then((r)=>URL.createObjectURL(r)):a.url,await q(s,["load"],["error"]),new G(o,s,a.width,a.exactColor)}canvas=document.createElement("canvas");context=this.canvas.getContext("2d");pixels;colors=new Map;resolution;get height(){return this.width/this.resolution|0}set height(o){this.width=o*this.resolution|0}constructor(o,a,s=a.naturalWidth,r=!1){this.bot=o;this.image=a;this.width=s;this.exactColor=r;if(r)this.resolution=1,this.width=1000;else this.resolution=this.image.naturalWidth/this.image.naturalHeight;this.update()}update(){this.canvas.width=this.width,this.canvas.height=this.height,this.colors.clear();let o=new Map;for(let s=1;s<64;s++)if(this.exactColor||!this.bot.unavailableColors.has(s))o.set(U[s],[s,s]);this.context.imageSmoothingEnabled=!1,this.context.imageSmoothingQuality="low",this.context.drawImage(this.image,0,0,this.canvas.width,this.canvas.height),this.pixels=Array.from({length:this.canvas.height},()=>new Array(this.canvas.width));let a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(let s=0;s<this.canvas.height;s++)for(let r=0;r<this.canvas.width;r++){let p=(s*this.canvas.width+r)*4,l=a[p],c=a[p+1],g=a[p+2],n=a[p+3],f=l,i=c,u=g,t=`${f},${i},${u}`;if(this.exactColor){this.pixels[s][r]=n<100?0:U.indexOf(t);continue}let m,b;if(n<100)m=b=0;else if(o.has(t))[m,b]=o.get(t);else{let h=1/0,z=1/0;for(let e=0;e<Z.length;e++){let A=Z[e],N=Ao(Mo(f,i,u),A,0);if(!this.bot.unavailableColors.has(e)&&N<h)h=N,m=e;if(N<z)z=N,b=e}o.set(t,[m,b])}if(m!==0)this.context.fillStyle=`oklab(${Z[m][0]*100}% ${Z[m][1]} ${Z[m][2]})`,this.context.fillRect(r,s,1,1);this.pixels[s][r]=m;let d=this.colors.get(b);if(d)d.amount++;else this.colors.set(b,{color:m,amount:1,realColor:b})}}toJSON(){let o=document.createElement("canvas");return o.width=this.image.naturalWidth,o.height=this.image.naturalHeight,o.getContext("2d").drawImage(this.image,0,0),{url:o.toDataURL("image/webp",1),width:this.width,exactColor:this.exactColor}}}var B="kglacer-macro-settings",No=["kglacermacro","wbot"],X="kgm";function sa(){let o=[B,...No];for(let a=0;a<o.length;a++){let s=o[a],r=localStorage.getItem(s);if(!r)continue;return{json:r,key:s}}return}function Fo(){let o=sa();if(!o)return;let a;try{if(a=JSON.parse(o.json),typeof a!=="object")throw new Error("NOT VALID SAVE");if(a.version===1){let s=a;a.images=s.widget.images,a.strategy=s.widget.strategy,delete s.widget}if(o.key!==B)localStorage.setItem(B,o.json)}catch{localStorage.removeItem(o.key),a=void 0}return a}var Po;function H(o,a=!1){if(clearTimeout(Po),a)localStorage.setItem(B,JSON.stringify(o));else Po=setTimeout(()=>{localStorage.setItem(B,JSON.stringify(o))},600)}var M=1000,ra=2048,T=M*ra,Q=[],E=[],pa=Date.now();function v(o){Q.push(o),E.push({id:pa++,latitude:(2*Math.atan(Math.exp(-(o.y/T*(2*Math.PI)-Math.PI)))-Math.PI/2)*180/Math.PI,longitude:(o.x/T*(2*Math.PI)-Math.PI)*180/Math.PI,name:"KGLACER_MACRO_FAVORITE"})}v({x:T/3|0,y:T/3|0});v({x:T/3*2|0,y:T/3*2|0});function L(o){let[a,s]=o.style.transform.slice(32,-31).split(", ").map((r)=>Number.parseFloat(r));return{x:a,y:s}}class k{bot;static fromJSON(o,a){return new k(o,...a)}static fromScreenPosition(o,a){let{anchorScreenPosition:s,pixelSize:r,anchorWorldPosition:p}=o.findAnchorsForScreen(a);return new k(o,p.x+(a.x-s.x)/r|0,p.y+(a.y-s.y)/r|0)}globalX=0;globalY=0;get tileX(){return this.globalX/M|0}set tileX(o){this.globalX=o*M+this.x}get tileY(){return this.globalY/M|0}set tileY(o){this.globalY=o*M+this.y}get x(){return this.globalX%M}set x(o){this.globalX=this.tileX*M+o}get y(){return this.globalY%M}set y(o){this.globalY=this.tileY*M+o}anchor1Index;anchor2Index;get pixelSize(){return(L(this.bot.$stars[this.anchor2Index]).x-L(this.bot.$stars[this.anchor1Index]).x)/(Q[this.anchor2Index].x-Q[this.anchor1Index].x)}constructor(o,a,s,r,p){this.bot=o;if(r===void 0||p===void 0)this.globalX=a,this.globalY=s;else this.globalX=a*M+r,this.globalY=s*M+p;this.updateAnchor()}updateAnchor(){this.anchor1Index=0,this.anchor2Index=1;let o=1/0,a=1/0;for(let s=0;s<Q.length;s++){let{x:r,y:p}=Q[s];if(r<this.globalX&&p<this.globalY){let l=this.globalX-r+(this.globalY-p);if(l<o)o=l,this.anchor1Index=s}else if(r>this.globalX&&p>this.globalY){let l=r-this.globalX+(p-this.globalY);if(l<a)a=l,this.anchor2Index=s}}}toScreenPosition(){let o=Q[this.anchor1Index],a=L(this.bot.$stars[this.anchor1Index]);return{x:(this.globalX-o.x)*this.pixelSize+a.x,y:(this.globalY-o.y)*this.pixelSize+a.y}}getMapColor(){return this.bot.mapsCache.get(this.tileX+"/"+this.tileY).pixels[this.y][this.x]}scrollScreenTo(){let{x:o,y:a}=this.toScreenPosition();this.bot.moveMap({x:o-window.innerWidth/3,y:a-window.innerHeight/3})}clone(){return new k(this.bot,this.tileX,this.tileY,this.x,this.y)}toJSON(){return[this.globalX,this.globalY]}}class K extends Y{bot;position;pixels;strategy;opacity;drawTransparentPixels;drawColorsInOrder;skipUnavailableColors;smartReplaceMode;colors;lock;static PREVIEW_MASK_BASE_WIDTH=96;static PREVIEW_MASK_BASE_HEIGHT=96;static async fromJSON(o,a){return new K(o,k.fromJSON(o,a.position),await G.fromJSON(o,a.pixels),a.strategy,a.opacity,a.drawTransparentPixels,a.drawColorsInOrder,a.skipUnavailableColors,a.smartReplaceMode,a.colors,a.lock)}element=document.createElement("div");tasks=[];moveInfo;$canvas;$colorsDialog;$colorsDialogList;$colorSearch;$openColors;$openPreview;$enableAllColors;$disableAllColors;$closeColors;$closePreview;$delete;$drawColorsInOrder;$drawTransparent;$skipUnavailable;$smartReplaceMode;$export;$lock;$opacity;$progressLine;$progressText;$previewDialog;$previewDialogList;$resetSize;$resetSizeSpan;$settings;$strategy;$topbar;$wrapper;colorDialogDragState;suppressNextColorDialogBackdropClick=!1;previewCacheSignature;previewSequenceCache=new Map;previewAnimations=new WeakMap;previewAnimationHandles=new Set;$replacementDialog;constructor(o,a,s,r="SPIRAL_FROM_CENTER",p=50,l=!1,c=!1,g=!1,n=!1,f=[],i=!1){super();this.bot=o;this.position=a;this.pixels=s;this.strategy=r;this.opacity=p;this.drawTransparentPixels=l;this.drawColorsInOrder=c;this.skipUnavailableColors=g;this.smartReplaceMode=n;this.colors=f;this.lock=i;this.element.innerHTML=ko,this.element.classList.add("wimage"),P(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$colorsDialog:".colors-dialog",$colorsDialogList:".colors-dialog-list",$colorSearch:".color-search",$openColors:".open-colors",$openPreview:".open-preview",$enableAllColors:".enable-all-colors",$disableAllColors:".disable-all-colors",$closeColors:".close-colors",$closePreview:".close-preview",$delete:".delete",$drawColorsInOrder:".draw-colors-in-order",$drawTransparent:".draw-transparent",$skipUnavailable:".skip-unavailable",$smartReplaceMode:".smart-replace-mode",$export:".export",$lock:".lock",$opacity:".opacity",$progressLine:".wprogress div",$progressText:".wprogress span",$previewDialog:".preview-dialog",$previewDialogList:".preview-dialog-list",$resetSize:".reset-size",$settings:".wform",$strategy:".strategy",$topbar:".wtopbar",$wrapper:".wrapper"}),this.$resetSizeSpan=this.$resetSize.querySelector("span"),this.$canvas=this.pixels.canvas,this.$wrapper.prepend(this.pixels.canvas),document.body.append(this.$colorsDialog,this.$previewDialog),this.registerEvent(this.$strategy,"change",()=>{if(this.strategy=this.$strategy.value,this.$previewDialog.open)this.renderStrategyPreviewSamples();H(this.bot)}),this.registerEvent(this.$opacity,"input",()=>{this.opacity=this.$opacity.valueAsNumber,this.$opacity.style.setProperty("--val",this.opacity+"%"),this.update(),H(this.bot)}),this.$opacity.style.setProperty("--val",this.opacity+"%"),this.registerEvent(this.$resetSize,"click",()=>{this.pixels.width=this.pixels.image.naturalWidth,this.pixels.update(),this.updateColors(),this.update(),H(this.bot)}),this.registerEvent(this.$drawTransparent,"click",()=>{this.drawTransparentPixels=this.$drawTransparent.checked,H(this.bot)}),this.registerEvent(this.$skipUnavailable,"click",()=>{this.skipUnavailableColors=this.$skipUnavailable.checked,this.updateTasks(),H(this.bot)}),this.registerEvent(this.$drawColorsInOrder,"click",()=>{this.drawColorsInOrder=this.$drawColorsInOrder.checked,H(this.bot)}),this.registerEvent(this.$lock,"click",()=>{this.lock=!this.lock,this.update(),H(this.bot)}),this.registerEvent(this.$delete,"click",this.destroy.bind(this)),this.registerEvent(this.$openColors,"click",()=>{this.openColorPanel()}),this.registerEvent(this.$openPreview,"click",()=>{this.openPreviewPanel()}),this.registerEvent(this.$closeColors,"click",()=>{this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$closePreview,"click",()=>{this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorsDialog.querySelector(".colors-dialog-head"),"pointerdown",this.startColorDialogDrag.bind(this)),this.registerEvent(document,"pointermove",this.moveColorDialog.bind(this),{passive:!1}),this.registerEvent(document,"pointerup",this.stopColorDialogDrag.bind(this)),this.registerEvent(document,"pointercancel",this.stopColorDialogDrag.bind(this)),this.registerEvent(this.$colorsDialog,"click",(u)=>{if(this.suppressNextColorDialogBackdropClick){this.suppressNextColorDialogBackdropClick=!1;return}if(u.target===this.$colorsDialog)this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$previewDialog,"click",(u)=>{if(u.target===this.$previewDialog)this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorSearch,"input",()=>{this.updateColors()}),this.registerEvent(this.$enableAllColors,"change",()=>{if(!this.$enableAllColors.checked)return;for(let u of this.colors)u.disabled=void 0;this.$enableAllColors.checked=!1,this.$disableAllColors.checked=!1,this.updateTasks(),this.updateColors(),H(this.bot)}),this.registerEvent(this.$disableAllColors,"change",()=>{if(!this.$disableAllColors.checked)return;for(let u of this.colors)u.disabled=!0;this.$enableAllColors.checked=!1,this.$disableAllColors.checked=!1,this.updateTasks(),this.updateColors(),H(this.bot)}),this.registerEvent(this.$export,"click",this.export.bind(this)),this.registerEvent(this.$topbar,"mousedown",this.moveStart.bind(this)),this.registerEvent(this.$canvas,"mousedown",this.moveStart.bind(this)),this.registerEvent(document,"mouseup",this.moveStop.bind(this)),this.registerEvent(document,"mousemove",this.move.bind(this));for(let u of this.element.querySelectorAll(".resize"))this.registerEvent(u,"mousedown",this.resizeStart.bind(this));this.update(),this.updateColors()}toJSON(){return{pixels:this.pixels.toJSON(),position:this.position.toJSON(),strategy:this.strategy,opacity:this.opacity,drawTransparentPixels:this.drawTransparentPixels,drawColorsInOrder:this.drawColorsInOrder,skipUnavailableColors:this.skipUnavailableColors,smartReplaceMode:this.smartReplaceMode,colors:this.colors,lock:this.lock}}updateTasks(){this.tasks.length=0;let o=this.position.clone(),a=new Set,s=new Map;for(let r=0;r<this.colors.length;r++){let p=this.colors[r];if(p.disabled)a.add(p.realColor);s.set(p.replacementColor??p.realColor,r)}for(let{x:r,y:p}of this.strategyPositionIterator()){let l=this.pixels.pixels[p][r],g=this.colors.find((f)=>f.realColor===l)?.replacementColor??l;if(a.has(l))continue;o.globalX=this.position.globalX+r,o.globalY=this.position.globalY+p;let n=o.getMapColor();if(g!==n&&(this.drawTransparentPixels||g!==0))this.tasks.push({position:o.clone(),color:g})}if(this.drawColorsInOrder)this.tasks.sort((r,p)=>(s.get(r.color)??0)-(s.get(p.color)??0));this.update(),this.bot.widget.update()}update(){let{x:o,y:a}=this.position.toScreenPosition(),s=this.position.pixelSize*this.pixels.width,r=this.position.pixelSize*this.pixels.height;this.element.style.transform=`translate3d(${o.toFixed(3)}px, ${a.toFixed(3)}px, 0)`,this.element.style.width=`${s}px`,this.element.style.height=`${r}px`,this.$canvas.style.opacity=`${this.opacity}%`,this.element.classList.remove("hidden"),this.$resetSizeSpan.textContent=this.pixels.width.toString(),this.$strategy.value=this.strategy,this.$opacity.valueAsNumber=this.opacity,this.$drawTransparent.checked=this.drawTransparentPixels,this.$drawColorsInOrder.checked=this.drawColorsInOrder,this.$skipUnavailable.checked=this.skipUnavailableColors,this.$smartReplaceMode.checked=this.smartReplaceMode;let p=this.pixels.pixels.length*this.pixels.pixels[0].length,l=Math.max(0,p-this.tasks.length),c=p>0?l/p*100|0:0;this.$progressText.textContent=`${l}/${p} ${c}% ETA: ${this.tasks.length/120|0}h`,this.$progressLine.style.transform=`scaleX(${c/100})`,this.$canvas.classList[this.lock?"add":"remove"]("no-pointer-events");for(let g of this.element.querySelectorAll(".resize"))g.classList[this.lock?"add":"remove"]("no-pointer-events");this.$lock.classList[this.lock?"add":"remove"]("locked")}exportImage(){this.export()}destroy(){super.destroy(),this.element.remove(),this.$colorsDialog.remove(),this.$previewDialog.remove(),go(this.bot.images,this),this.bot.widget.update(),H(this.bot)}openColorPanel(){if(this.$colorsDialog.open){this.$colorSearch.focus();return}this.$colorsDialog.style.position="fixed",this.$colorsDialog.style.left="",this.$colorsDialog.style.top="",this.$colorsDialog.style.margin="auto",this.$colorsDialog.showModal(),this.$colorSearch.focus()}openPreviewPanel(){if(this.$previewDialog.open){this.renderStrategyPreviewSamples();return}this.$previewDialog.style.position="fixed",this.$previewDialog.style.left="",this.$previewDialog.style.top="",this.$previewDialog.style.margin="auto",this.$previewDialog.showModal(),this.renderStrategyPreviewSamples()}closeDialog(o){if(!o.open)return;if(o===this.$previewDialog)this.stopPreviewAnimations();if(typeof o.requestClose==="function")o.requestClose();else o.close()}stopPreviewAnimations(){for(let o of this.previewAnimationHandles)cancelAnimationFrame(o);this.previewAnimationHandles.clear()}startColorDialogDrag(o){if(o.button!==0)return;if(o.target?.closest("button,input,select,textarea,a,label"))return;let s=this.$colorsDialog.getBoundingClientRect();this.colorDialogDragState={pointerId:o.pointerId,offsetX:o.clientX-s.left,offsetY:o.clientY-s.top,moved:!1},o.preventDefault()}moveColorDialog(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;let a=this.$colorsDialog.getBoundingClientRect(),s=Math.max(8,window.innerWidth-a.width-8),r=Math.max(8,window.innerHeight-a.height-8),p=Math.min(s,Math.max(8,o.clientX-this.colorDialogDragState.offsetX)),l=Math.min(r,Math.max(8,o.clientY-this.colorDialogDragState.offsetY));if(!this.colorDialogDragState.moved&&(Math.abs(o.movementX)>0||Math.abs(o.movementY)>0))this.colorDialogDragState.moved=!0;this.$colorsDialog.style.left=`${Math.round(p)}px`,this.$colorsDialog.style.top=`${Math.round(l)}px`,o.preventDefault()}stopColorDialogDrag(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;if(this.colorDialogDragState.moved)this.suppressNextColorDialogBackdropClick=!0;this.colorDialogDragState=void 0}renderStrategyPreviewSamples(){this.stopPreviewAnimations(),this.invalidatePreviewCacheIfNeeded();let o=this.$strategy.value;this.$previewDialogList.innerHTML="";let a=document.createDocumentFragment(),s=document.createElement("article");s.className="preview-card";let r=document.createElement("strong");r.textContent=this.getStrategyLabel(o);let p=document.createElement("canvas");p.className="preview-canvas",p.width=156,p.height=156,this.paintStrategyPreview(p,o),s.append(r,p),a.append(s),this.$previewDialogList.append(a)}invalidatePreviewCacheIfNeeded(){let o=this.colors.map((s,r)=>`${r}:${s.realColor}:${s.disabled?1:0}`).join("|"),a=`${this.pixels.width}x${this.pixels.height}:${this.pixels.image.src.length}:${this.drawColorsInOrder?1:0}:${o}`;if(this.previewCacheSignature===a)return;this.previewCacheSignature=a,this.previewSequenceCache.clear()}getStrategyLabel(o){switch(o){case"RANDOM":return w("random");case"HUMANIZED":return w("humanized");case"HUMAN_SOFT_DITHER":return w("humanSoftDither");case"HUMAN_PATCHY":return w("humanPatchy");case"HUMAN_SWEEP_ARCS":return w("humanSweepArcs");case"HUMAN_MICRO_CORRECTIONS":return w("humanMicroCorrections");case"HUMAN_JITTER_FILL":return w("humanJitterFill");case"HUMAN_CORNER_BIAS":return w("humanCornerBias");case"HUMAN_LONG_STROKES":return w("humanLongStrokes");case"HUMAN_TAP_CLUSTERS":return w("humanTapClusters");case"HUMAN_MESSY_SPIRAL":return w("humanMessySpiral");case"HUMAN_DRUNK_WALK":return w("humanDrunkWalk");case"HUMAN_NOISE_CLOUD":return w("humanNoiseCloud");case"HUMAN_PATCH_JUMP":return w("humanPatchJump");case"HUMAN_HESITANT_LINES":return w("humanHesitantLines");case"HUMAN_OVERLAP_SWEEPS":return w("humanOverlapSweeps");case"HUMAN_WOBBLE_DRIFT":return w("humanWobbleDrift");case"HUMAN_GAP_RECOVERY":return w("humanGapRecovery");case"HUMAN_STAIRCASE":return w("humanStaircase");case"HUMAN_EDGE_HUGGER":return w("humanEdgeHugger");case"HUMAN_BLOBS":return w("humanBlobs");case"HUMAN_BACKTRACK":return w("humanBacktrack");case"HUMAN_SHAKY_DIAGONAL":return w("humanShakyDiagonal");case"HUMAN_LATE_FIXES":return w("humanLateFixes");case"ZIGZAG":return w("zigzag");case"BRUSH_STROKES":return w("brushStrokes");case"DIAGONAL_BRUSH":return w("diagonalBrush");case"DOWN":return w("down");case"UP":return w("up");case"LEFT":return w("left");case"RIGHT":return w("right");case"SPIRAL_FROM_CENTER":return w("spiralOut");case"SPIRAL_TO_CENTER":return w("spiralIn");case"SCRIBBLE":return w("scribble");case"CROSSHATCH":return w("crosshatch");case"WAVE_SWEEP":return w("waveSweep");case"SCATTERED_LINES":return w("scatteredLines");case"CONTOUR_JITTER":return w("contourJitter");case"SPIRAL_WOBBLE":return w("spiralWobble");case"CLUSTER_BURSTS":return w("clusterBursts");case"ORBITAL":return w("orbital");case"FLOW_FIELD":return w("flowField");case"EDGE_IN":return w("edgeIn");default:return o}}paintStrategyPreview(o,a){let s=o.getContext("2d");if(!s)return;s.fillStyle="#0f1526",s.fillRect(0,0,o.width,o.height);let r=this.getSampledImagePreviewData(),p=this.getCachedPreviewSequence(a,r.mask,r.width,r.height),l=Math.min(o.width/r.width,o.height/r.height),c=(o.width-r.width*l)/2,g=(o.height-r.height*l)/2,n=this.previewAnimations.get(o);if(n)cancelAnimationFrame(n),this.previewAnimationHandles.delete(n);let f=(h)=>{let z=requestAnimationFrame((e)=>{this.previewAnimationHandles.delete(z),h(e)});return this.previewAnimationHandles.add(z),z},i=(h)=>{s.fillStyle="#0f1526",s.fillRect(0,0,o.width,o.height);for(let z=0;z<Math.min(h,p.length);z++){let e=p[z],A=r.colors.get(`${e.x}:${e.y}`)??0;if(!A)continue;s.fillStyle=ro(A),s.fillRect(c+e.x*l,g+e.y*l,Math.max(1,l),Math.max(1,l))}},u=Math.min(3400,Math.max(900,p.length*8)),m=u+220,b=(h,z)=>{if(!this.$previewDialog.open)return;let e=(z-h)%m,A=Math.min(1,e/u),N=A*A*(3-2*A);i(Math.floor(p.length*N));let S=f((W)=>{b(h,W)});this.previewAnimations.set(o,S)},d=performance.now();b(d,d)}getCachedPreviewSequence(o,a,s=this.pixels.width,r=this.pixels.height){let p=this.colors.map((n,f)=>`${f}:${n.realColor}:${n.disabled?1:0}`).join("|"),l=`${o}:${s}x${r}:${a.length}:${this.drawColorsInOrder?1:0}:${p}`,c=this.previewSequenceCache.get(l);if(c)return c;let g=s===this.pixels.width&&r===this.pixels.height?this.getExactPreviewSequence(o,a):this.getApproxPreviewSequence(o,a,s);if(this.drawColorsInOrder){let n=new Map;for(let f=0;f<this.colors.length;f++)n.set(this.colors[f].realColor,f);g.sort((f,i)=>(n.get(this.pixels.pixels[f.y]?.[f.x]??0)??0)-(n.get(this.pixels.pixels[i.y]?.[i.x]??0)??0))}return this.previewSequenceCache.set(l,g),g}getExactPreviewSequence(o,a){let s=this.strategy;this.strategy=o;let r=[...this.strategyPositionIterator()];this.strategy=s;let p=new Set(a.map(({x:l,y:c})=>`${l}:${c}`));return r.filter(({x:l,y:c})=>p.has(`${l}:${c}`))}getApproxPreviewSequence(o,a,s){let r=[...a],p=(g,n,f)=>{return(g*73856093+n*19349663+f*83492791>>>0)/4294967296},l=(g,n)=>r.sort((f,i)=>f.x*g+f.y*n-(i.x*g+i.y*n)||f.y-i.y||f.x-i.x),c=r.sort((g,n)=>{if(g.y!==n.y)return g.y-n.y;let f=g.y%2===0?g.x:s-g.x,i=n.y%2===0?n.x:s-n.x;return f-i});switch(o){case"UP":return l(0,-1);case"LEFT":return l(-1,0);case"RIGHT":return l(1,0);case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let g=s/2,n=Math.max(1,Math.round(r.reduce((f,i)=>f+i.y,0)/Math.max(1,r.length)));return r.sort((f,i)=>{let u=(f.x-g)**2+(f.y-n)**2,t=(i.x-g)**2+(i.y-n)**2;return o==="SPIRAL_FROM_CENTER"?u-t:t-u}),r}case"RANDOM":case"HUMANIZED":case"HUMAN_SOFT_DITHER":case"HUMAN_PATCHY":case"HUMAN_SWEEP_ARCS":case"HUMAN_MICRO_CORRECTIONS":case"HUMAN_JITTER_FILL":case"HUMAN_CORNER_BIAS":case"HUMAN_LONG_STROKES":case"HUMAN_TAP_CLUSTERS":case"HUMAN_MESSY_SPIRAL":case"HUMAN_DRUNK_WALK":case"HUMAN_NOISE_CLOUD":case"HUMAN_PATCH_JUMP":case"HUMAN_HESITANT_LINES":case"HUMAN_OVERLAP_SWEEPS":case"HUMAN_WOBBLE_DRIFT":case"HUMAN_GAP_RECOVERY":case"HUMAN_STAIRCASE":case"HUMAN_EDGE_HUGGER":case"HUMAN_BLOBS":case"HUMAN_BACKTRACK":case"HUMAN_SHAKY_DIAGONAL":case"HUMAN_LATE_FIXES":return r.sort((g,n)=>p(g.x,g.y,o.length)-p(n.x,n.y,o.length));default:return c}}getSampledImagePreviewData(){let o=this.pixels.width,a=this.pixels.height,s=K.PREVIEW_MASK_BASE_WIDTH,r=K.PREVIEW_MASK_BASE_HEIGHT,p=Math.min(1,s/Math.max(1,o),r/Math.max(1,a)),l=Math.max(1,Math.round(o*p)),c=Math.max(1,Math.round(a*p)),g=new Set;for(let u=0;u<this.colors.length;u++){let t=this.colors[u];if(t.disabled)g.add(t.realColor)}let n=new Map,f=new Map;for(let u=0;u<a;u++)for(let t=0;t<o;t++){let m=this.pixels.pixels[u]?.[t]??0;if(!m||g.has(m))continue;let b=Math.min(l-1,Math.floor(t/o*l)),d=Math.min(c-1,Math.floor(u/a*c)),h=`${b}:${d}`;if(!n.has(h))n.set(h,{x:b,y:d});if(!f.has(h))f.set(h,m)}let i=[...n.values()];if(!i.length){let u=this.fallbackPreviewMask();return{width:o,height:a,mask:u,colors:new Map(u.map((t)=>[`${t.x}:${t.y}`,this.pixels.pixels[t.y]?.[t.x]??0]))}}return{width:l,height:c,mask:i,colors:f}}getImagePreviewMask(){let o=this.pixels.width,a=this.pixels.height,s=new Set;for(let p=0;p<this.colors.length;p++){let l=this.colors[p];if(l.disabled)s.add(l.realColor)}let r=[];for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=this.pixels.pixels[p]?.[l]??0;if(c!==0&&!s.has(c))r.push({x:l,y:p})}return r.length?r:this.fallbackPreviewMask()}fallbackPreviewMask(){let o=[],a=this.pixels.width/2,s=this.pixels.height/2,r=Math.max(4,Math.min(this.pixels.width,this.pixels.height)/2.5);for(let p=0;p<this.pixels.height;p++)for(let l=0;l<this.pixels.width;l++)if((l-a)**2+(p-s)**2<=r**2)o.push({x:l,y:p});return o}applyLocale(){if(P(this.element),this.updateColors(),this.$previewDialog.open)this.renderStrategyPreviewSamples()}colorHex(o){let a=U[o]??"0,0,0",[s=0,r=0,p=0]=a.split(",").map((l)=>Number.parseInt(l,10));return`#${[s,r,p].map((l)=>l.toString(16).padStart(2,"0")).join("")}`}colorKeywords(o){let a=U[o]??"0,0,0",[s=0,r=0,p=0]=a.split(",").map((n)=>Number.parseInt(n,10)),l=Math.max(s,r,p),c=Math.min(s,r,p);if(l-c<15)return["gray","grey","gris","neutral","neutro"];if(s>r+30&&s>p+30)return["red","rojo"];if(r>s+30&&r>p+30)return["green","verde"];if(p>s+30&&p>r+30)return["blue","azul"];if(s>170&&r>120&&p<130)return["orange","naranja"];if(s>170&&r>110&&p>140)return["pink","rosa"];if(s>120&&r<100&&p>120)return["purple","violet","morado"];if(s>130&&r>130&&p<90)return["yellow","amarillo"];return["brown","cafe","marron"]}colorFamily(o){let[a=0,s=0,r=0]=(U[o]??"0,0,0").split(",").map((p)=>Number.parseInt(p,10));if(a>s+35&&a>r+35)return"red";if(s>a+25&&s>r+20)return a>90?"olive":"green";if(r>a+25&&r>s+25)return"blue";if(a>120&&r>120)return"wine";return"neutral"}replacementCandidates(o){let a=this.colorFamily(o);return Array.from({length:U.length-1},(s,r)=>r+1).filter((s)=>!this.bot.unavailableColors.has(s)&&this.colorFamily(s)===a)}openReplacementPicker(o,a){this.$replacementDialog?.remove();let s=document.createElement("dialog");s.className="kgm-modal replacement-dialog";let r=this.pixels.colors.get(a)?.color??a,p=o.replacementColor??r,c=(this.smartReplaceMode?this.replacementCandidates(a):Array.from({length:U.length-1},(g,n)=>n+1)).filter((g)=>!this.bot.unavailableColors.has(g)).map((g)=>{let n=this.colorHex(g).toUpperCase();return`<button type="button" class="replacement-option ${g===p?"active":""}" data-color="${g}" style="--option-color:${ro(g)}"><span class="dot"></span><span>#${g}</span><span>${n}</span></button>`}).join("");s.innerHTML=`<div class="kgm-modal-head"><strong>${w("replaceWith")}</strong><button class="modal-close" type="button" aria-label="${w("close")}"><i class="icon fa-solid fa-xmark" aria-hidden="true"></i></button></div><div class="replacement-grid">${c}</div>`,document.body.append(s),this.$replacementDialog=s,s.querySelector(".modal-close").onclick=()=>{s.close(),s.remove()};for(let g of s.querySelectorAll(".replacement-option"))g.onclick=()=>{let n=Number.parseInt(g.dataset.color??"0",10);if(!n)return;o.replacementColor=n,this.updateTasks(),this.updateColors(),H(this.bot),s.close(),s.remove()};s.showModal()}updateColors(){this.$colorsDialogList.innerHTML="";let o=this.pixels.pixels.length*this.pixels.pixels[0].length;this.$colorsDialogList.setAttribute("aria-label",w("colorPanelResults"));let a=this.$colorSearch.value.trim().toLowerCase();if(this.colors.length!==this.pixels.colors.size||this.colors.some((s)=>!this.pixels.colors.has(s.realColor))){let s=new Map(this.colors.map((r)=>[r.realColor,r]));this.colors=this.pixels.colors.values().toArray().sort((r,p)=>p.amount-r.amount).map((r)=>({realColor:r.realColor,disabled:s.get(r.realColor)?.disabled,replacementColor:s.get(r.realColor)?.replacementColor})),H(this.bot)}for(let s=0;s<this.colors.length;s++){let r=this.colors[s],p=this.pixels.colors.get(r.realColor),l=!1,c=p.realColor!==p.color;if(this.skipUnavailableColors&&c)r.disabled=!0;let g=p.amount/o*100,n=this.colorHex(p.realColor),f=this.colorKeywords(p.realColor),i=()=>{r.disabled=r.disabled?void 0:!0,u.classList.toggle("disabled",Boolean(r.disabled));let d=u.querySelector(".state");if(d)d.textContent=r.disabled?w("disabled"):w("enabled");H(this.bot)},u=document.createElement("button");u.className=`color-chip ${r.disabled?"disabled":""}`,u.draggable=!0,u.setAttribute("aria-label",`${w("overlayColors")} #${s+1}: ${n.toUpperCase()}`);let t=r.replacementColor??p.color,m=`#${t} ${this.colorHex(t).toUpperCase()}`;if(u.innerHTML=`<span class="order-index">#${s+1}</span>
<span class="drag" title="${w("up")} / ${w("down")}">⋮⋮</span>
<span class="swatch"></span>
<span class="meta">
  <span class="coverage">${g.toFixed(1)}%</span>
  <span class="hex">${n.toUpperCase()}</span>
  <span class="state">${r.disabled?w("disabled"):w("enabled")}</span>
  <span class="replacement">${w("replaceWith")}: ${m}</span>
</span>
<span class="premium ${c?"on":""}">${c?w("premium"):""}</span>`,u.querySelector(".swatch").style.setProperty("--swatch-color",ro(p.realColor)),u.addEventListener("click",()=>{if(l){l=!1;return}i(),this.updateTasks()}),u.addEventListener("dragstart",(d)=>{l=!0,u.classList.add("dragging"),d.dataTransfer?.setData("text/plain",String(s)),d.dataTransfer.effectAllowed="move"}),u.addEventListener("dragend",()=>{u.classList.remove("dragging")}),u.addEventListener("dragover",(d)=>{d.preventDefault(),u.classList.add("drag-target")}),u.addEventListener("dragleave",()=>{u.classList.remove("drag-target")}),u.addEventListener("drop",(d)=>{d.preventDefault(),u.classList.remove("drag-target");let h=Number.parseInt(d.dataTransfer?.getData("text/plain")??"-1",10);if(h<0||h===s||h>=this.colors.length)return;this.colors.splice(s,0,...this.colors.splice(h,1)),H(this.bot),this.updateColors()}),c||this.smartReplaceMode){let d=document.createElement("button");d.className="replacement-select",d.type="button",d.textContent=`\uD83C\uDFA8 ${w("replaceWith")}`,d.addEventListener("click",(h)=>{h.stopPropagation(),this.openReplacementPicker(r,p.realColor)}),u.append(d)}if(c||this.smartReplaceMode){let d=document.createElement("button");d.textContent=w("buy"),d.className="buy-chip",d.addEventListener("click",(h)=>{h.stopPropagation(),document.getElementById("color-"+p.realColor)?.click()}),u.append(d)}let b=`${n} ${f.join(" ")} ${p.realColor} ${U[p.realColor]}`;if(!a||b.toLowerCase().includes(a))this.$colorsDialogList.append(u)}}*strategyPositionIterator(){let o=this.pixels.pixels[0].length,a=this.pixels.pixels.length;switch(this.strategy){case"DOWN":{for(let s=0;s<a;s++)for(let r=0;r<o;r++)yield{x:r,y:s};break}case"UP":{for(let s=a-1;s>=0;s--)for(let r=0;r<o;r++)yield{x:r,y:s};break}case"LEFT":{for(let s=0;s<o;s++)for(let r=0;r<a;r++)yield{x:s,y:r};break}case"RIGHT":{for(let s=o-1;s>=0;s--)for(let r=0;r<a;r++)yield{x:s,y:r};break}case"RANDOM":{let s=[];for(let r=0;r<a;r++)for(let p=0;p<o;p++)s.push({x:p,y:r});for(let r=s.length-1;r>=0;r--){let p=Math.floor(Math.random()*(r+1)),l=s[r];s[r]=s[p],s[p]=l}yield*s;break}case"ZIGZAG":{for(let s=0;s<a;s++)if(s%2===0)for(let r=0;r<o;r++)yield{x:r,y:s};else for(let r=o-1;r>=0;r--)yield{x:r,y:s};break}case"HUMANIZED":{let s=Math.max(4,Math.floor(Math.min(o,a)/10)),r=[];for(let p=0;p<a;p+=s)for(let l=0;l<o;l+=s)r.push({x:l,y:p});for(let p=r.length-1;p>=0;p--){let l=Math.floor(Math.random()*(p+1)),c=r[p];r[p]=r[l],r[l]=c}for(let p=0;p<r.length;p++){let l=r[p],c=Math.min(a,l.y+s),g=Math.min(o,l.x+s);for(let n=l.y;n<c;n++)if(Math.random()>0.35)for(let i=l.x;i<g;i++)yield{x:i,y:n};else for(let i=g-1;i>=l.x;i--)yield{x:i,y:n}}break}case"HUMAN_SOFT_DITHER":{let s=new Set;for(let r=0;r<a;r++){let p=Math.floor(Math.random()*3)-1;if((r+p)%2===0)for(let c=0;c<o;c+=2)s.add(`${c},${r}`),yield{x:c,y:r};else for(let c=1;c<o;c+=2)s.add(`${c},${r}`),yield{x:c,y:r}}for(let r=0;r<a;r++)for(let p=0;p<o;p++){let l=`${p},${r}`;if(s.has(l))continue;yield{x:p,y:r}}break}case"HUMAN_PATCHY":{let s=new Set,r=o*a;while(s.size<r){let p=Math.floor(Math.random()*o),l=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*5);for(let g=l-c;g<=l+c;g++)for(let n=p-c;n<=p+c;n++){if(n<0||n>=o||g<0||g>=a)continue;if(Math.hypot(n-p,g-l)>c+Math.random()*1.2)continue;let f=`${n},${g}`;if(s.has(f))continue;s.add(f),yield{x:n,y:g}}}break}case"HUMAN_SWEEP_ARCS":{let s=new Set,r=(o-1)/2,p=(a-1)/2,l=Math.hypot(r,p);for(let c=0;c<4;c++){let g=Math.random()*Math.PI*2;for(let n=0;n<=l;n+=0.35){let f=Math.PI/2+Math.random()*(Math.PI/1.5),i=Math.max(10,Math.floor(n*8));for(let u=0;u<i;u++){let t=g+f*u/i+Math.sin(n)*0.08,m=Math.round(r+Math.cos(t)*n),b=Math.round(p+Math.sin(t)*n);if(m<0||m>=o||b<0||b>=a)continue;let d=`${m},${b}`;if(s.has(d))continue;s.add(d),yield{x:m,y:b}}}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let n=`${g},${c}`;if(s.has(n))continue;yield{x:g,y:c}}break}case"HUMAN_MICRO_CORRECTIONS":{let s=new Set;for(let r=0;r<a;r++){let p=r%2===0?1:-1,l=p>0?0:o-1;for(let c=0;c<o;c++){let g=l+(Math.random()>0.82?p:0),n=r+(Math.random()>0.9?1:0);for(let f of[{x:l,y:r},{x:g,y:r},{x:l,y:n}]){if(f.x<0||f.x>=o||f.y<0||f.y>=a)continue;let i=`${f.x},${f.y}`;if(s.has(i))continue;s.add(i),yield f}l+=p}}for(let r=0;r<a;r++)for(let p=0;p<o;p++){let l=`${p},${r}`;if(s.has(l))continue;yield{x:p,y:r}}break}case"HUMAN_JITTER_FILL":{let s=[];for(let r=0;r<a;r++)for(let p=0;p<o;p++)s.push({x:p,y:r});s.sort((r,p)=>{let l=r.y+(Math.random()-0.5)*1.8,c=p.y+(Math.random()-0.5)*1.8;if(l!==c)return l-c;return r.x+(Math.random()-0.5)*2-(p.x+(Math.random()-0.5)*2)}),yield*s;break}case"HUMAN_CORNER_BIAS":{let s=[{x:0,y:0},{x:o-1,y:0},{x:0,y:a-1},{x:o-1,y:a-1}],r=s[Math.floor(Math.random()*s.length)],p=[];for(let l=0;l<a;l++)for(let c=0;c<o;c++){let n=Math.hypot(c-r.x,l-r.y)+Math.random()*3.5;p.push({point:{x:c,y:l},score:n})}p.sort((l,c)=>l.score-c.score);for(let l of p)yield l.point;break}case"HUMAN_LONG_STROKES":{let s=new Set,r=o*a;while(s.size<r){let p=Math.floor(Math.random()*o),l=Math.floor(Math.random()*a),c=Math.random()*Math.PI*2,g=Math.sign(Math.cos(c)),n=Math.sign(Math.sin(c)),f=10+Math.floor(Math.random()*40);for(let i=0;i<f;i++){if(p<0||p>=o||l<0||l>=a)break;let u=`${p},${l}`;if(!s.has(u))s.add(u),yield{x:p,y:l};if(Math.random()>0.78)p+=n,l+=g;else p+=g,l+=n}}break}case"HUMAN_TAP_CLUSTERS":{let s=new Set,r=o*a;while(s.size<r){let p=Math.floor(Math.random()*o),l=Math.floor(Math.random()*a),c=3+Math.floor(Math.random()*10);for(let g=0;g<c;g++){let n=Math.round(p+(Math.random()-0.5)*6),f=Math.round(l+(Math.random()-0.5)*6);if(n<0||n>=o||f<0||f>=a)continue;let i=`${n},${f}`;if(s.has(i))continue;s.add(i),yield{x:n,y:f}}}break}case"HUMAN_MESSY_SPIRAL":{let s=new Set,r=(o-1)/2,p=(a-1)/2,l=Math.hypot(r,p)+2;for(let c=0;s.size<o*a;c++){let g=c/3,n=Math.min(l,g*0.18),f=g*0.29+Math.sin(g*0.13)*0.8,i=Math.round(r+Math.cos(f)*n+Math.sin(g)*0.7),u=Math.round(p+Math.sin(f)*n+Math.cos(g)*0.7);if(i<0||i>=o||u<0||u>=a){if(c>o*a*18)break;continue}let t=`${i},${u}`;if(s.has(t)){if(Math.random()>0.9)continue}else s.add(t),yield{x:i,y:u};if(c>o*a*18)break}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let n=`${g},${c}`;if(s.has(n))continue;yield{x:g,y:c}}break}case"HUMAN_DRUNK_WALK":{let s=new Set,r=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),l=[{x:-1,y:0},{x:1,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:-1},{x:1,y:-1},{x:-1,y:1},{x:1,y:1}];while(s.size<o*a){let c=`${r},${p}`;if(!s.has(c))s.add(c),yield{x:r,y:p};let g=[];for(let i of l){let u=r+i.x,t=p+i.y;if(u<0||u>=o||t<0||t>=a)continue;g.push({x:u,y:t})}if(!g.length)break;let n=g.filter((i)=>{return!s.has(`${i.x},${i.y}`)});if(n.length&&Math.random()>0.2){let i=n[Math.floor(Math.random()*n.length)];r=i.x,p=i.y;continue}let f=g[Math.floor(Math.random()*g.length)];r=f.x,p=f.y}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let n=`${g},${c}`;if(s.has(n))continue;yield{x:g,y:c}}break}case"HUMAN_NOISE_CLOUD":{let s=[];for(let r=0;r<a;r++)for(let p=0;p<o;p++){let l=Math.sin((p+1)*0.93+Math.random()*0.8)+Math.cos((r+1)*1.17+Math.random()*0.8),c=(Math.random()-0.5)*2.6,g=Math.hypot(p-o/2,r-a/2)*0.08;s.push({point:{x:p,y:r},score:l+c+g})}s.sort((r,p)=>r.score-p.score);for(let r of s)yield r.point;break}case"HUMAN_PATCH_JUMP":{let s=new Set,r=[];for(let p=0;p<Math.max(6,o*a/18);p++)r.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});while(s.size<o*a){let p=r[Math.floor(Math.random()*r.length)],l=1+Math.floor(Math.random()*3),c=1+Math.floor(Math.random()*3);for(let g=p.y-c;g<=p.y+c;g++)for(let n=p.x-l;n<=p.x+l;n++){if(n<0||n>=o||g<0||g>=a)continue;if(Math.random()>0.86)continue;let f=`${n},${g}`;if(s.has(f))continue;s.add(f),yield{x:n,y:g}}if(Math.random()>0.72&&r.length<o*a/2)r.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});if(s.size>o*a*0.92)break}for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=`${l},${p}`;if(s.has(c))continue;yield{x:l,y:p}}break}case"HUMAN_HESITANT_LINES":{let s=new Set;for(let r=0;r<a;r++){let p=r%2===0;for(let l=0;l<o;l++){let c=p?l:o-1-l,g=`${c},${r}`;if(!s.has(g))s.add(g),yield{x:c,y:r};if(Math.random()>0.7){let n=Math.max(0,Math.min(o-1,c+(Math.random()>0.5?1:-1))),f=Math.max(0,Math.min(a-1,r+(Math.random()>0.65?1:0))),i=`${n},${f}`;if(!s.has(i))s.add(i),yield{x:n,y:f}}}}for(let r=0;r<a;r++)for(let p=0;p<o;p++){let l=`${p},${r}`;if(s.has(l))continue;yield{x:p,y:r}}break}case"HUMAN_OVERLAP_SWEEPS":{let s=[],r=Math.random()*Math.PI*2;for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=Math.sin((l+p)*0.42+r)*2.2,g=Math.cos((l-p)*0.3+r)*1.4;s.push({point:{x:l,y:p},score:p+c+g+(Math.random()-0.5)*3.4})}s.sort((p,l)=>p.score-l.score);for(let p of s)yield p.point;break}case"HUMAN_WOBBLE_DRIFT":{let s=[],r=o/2,p=a/2;for(let l=0;l<a;l++)for(let c=0;c<o;c++){let g=Math.hypot(c-r,l-p)*0.25,n=Math.sin((c+1)*0.9)*1.8+Math.cos((l+1)*1.1)*1.8+Math.sin((c+l)*0.35)*1.4;s.push({point:{x:c,y:l},score:g+n+(Math.random()-0.5)*2.8})}s.sort((l,c)=>l.score-c.score);for(let l of s)yield l.point;break}case"HUMAN_GAP_RECOVERY":{let s=new Set,r=[];for(let p=0;p<a;p++)for(let l=0;l<o;l++){if(Math.random()>0.87){r.push({x:l,y:p});continue}s.add(`${l},${p}`),yield{x:l,y:p}}r.sort((p,l)=>Math.hypot(p.x-o/2,p.y-a/2)-Math.hypot(l.x-o/2,l.y-a/2));for(let p of r){let l=`${p.x},${p.y}`;if(s.has(l))continue;s.add(l),yield p}break}case"HUMAN_STAIRCASE":{let s=new Set,r=o+a-1;for(let p=0;p<r;p++){let l=Math.max(0,p-o+1),c=Math.min(a-1,p);for(let g=l;g<=c;g++){let n=p-g,f=[{x:n,y:g},{x:n+(Math.random()>0.5?1:-1),y:g},{x:n,y:g+(Math.random()>0.5?1:-1)}];for(let i of f){if(i.x<0||i.x>=o||i.y<0||i.y>=a)continue;let u=`${i.x},${i.y}`;if(s.has(u))continue;s.add(u),yield i}}}for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=`${l},${p}`;if(s.has(c))continue;yield{x:l,y:p}}break}case"HUMAN_EDGE_HUGGER":{let s=[];for(let r=0;r<a;r++)for(let p=0;p<o;p++){let l=Math.min(p,r,o-1-p,a-1-r);s.push({point:{x:p,y:r},score:l*3.5+(Math.random()-0.5)*5.5})}s.sort((r,p)=>r.score-p.score);for(let r of s)yield r.point;break}case"HUMAN_BLOBS":{let s=new Set,r=o*a;while(s.size<r){let p=Math.floor(Math.random()*o),l=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*4);for(let g=l-c;g<=l+c;g++)for(let n=p-c;n<=p+c;n++){if(n<0||n>=o||g<0||g>=a)continue;let f=Math.atan2(g-l,n-p),i=c+Math.sin(f*3+Math.random())*0.8;if(Math.hypot(n-p,g-l)>i)continue;let u=`${n},${g}`;if(s.has(u))continue;s.add(u),yield{x:n,y:g}}}break}case"HUMAN_BACKTRACK":{let s=new Set,r=[];for(let p=0;p<a;p++)for(let l=0;l<o;l++)r.push({x:l,y:p});r.sort((p,l)=>p.y-l.y+(Math.random()-0.5)*2.2+(p.x-l.x)*0.04);for(let p=0;p<r.length;p++){let l=r[p],c=`${l.x},${l.y}`;if(s.has(c))continue;if(s.add(c),yield l,p>1&&Math.random()>0.74){let g=r[p-1],n=`${g.x},${g.y}`;if(!s.has(n))s.add(n),yield g}}for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=`${l},${p}`;if(s.has(c))continue;yield{x:l,y:p}}break}case"HUMAN_SHAKY_DIAGONAL":{let s=[];for(let r=0;r<a;r++)for(let p=0;p<o;p++){let l=Math.abs(p-r)*0.6,c=Math.sin(p*1.4+r*0.8)*1.8+Math.cos(r*1.1+p*0.5)*1.5;s.push({point:{x:p,y:r},score:l+c+(Math.random()-0.5)*3.2})}s.sort((r,p)=>r.score-p.score);for(let r of s)yield r.point;break}case"HUMAN_LATE_FIXES":{let s=[],r=[];for(let p=0;p<a;p++)for(let l=0;l<o;l++)if(Math.random()>0.9)r.push({x:l,y:p});else s.push({x:l,y:p});s.sort((p,l)=>p.y-l.y+(Math.random()-0.5)*1.5+(Math.random()>0.85?p.x-l.x:0)),r.sort((p,l)=>Math.hypot(l.x-o/2,l.y-a/2)-Math.hypot(p.x-o/2,p.y-a/2)),yield*s,yield*r;break}case"DIAGONAL_BRUSH":{for(let s=0;s<o+a-1;s++){let r=s%2===0,p=[],l=Math.max(0,s-o+1),c=Math.min(a-1,s);for(let g=l;g<=c;g++){let n=s-g;if(n>=0&&n<o)p.push({x:n,y:g})}if(Math.random()>0.55)p.reverse();if(r)for(let g=p.length-1;g>=0;g--)yield p[g];else yield*p}break}case"BRUSH_STROKES":{let s=Array.from({length:a},()=>Array(o).fill(!1)),r=[{x:1,y:0},{x:-1,y:0},{x:0,y:1},{x:0,y:-1},{x:1,y:1},{x:1,y:-1},{x:-1,y:1},{x:-1,y:-1}],p=(g,n)=>g>=0&&g<o&&n>=0&&n<a,l=0,c=o*a;for(let g=0;g<c*6&&l<c;g++){let n=Math.floor(Math.random()*o),f=Math.floor(Math.random()*a),i=r[Math.floor(Math.random()*r.length)],u=3+Math.floor(Math.random()*16);for(let t=0;t<u;t++){if(!p(n,f))break;if(!s[f][n])s[f][n]=!0,l++,yield{x:n,y:f};if(Math.random()>0.72)i=r[Math.floor(Math.random()*r.length)];n+=i.x,f+=i.y}}for(let g=0;g<a;g++)for(let n=0;n<o;n++)if(!s[g][n])yield{x:n,y:g};break}case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let s=new Set,r=o*a,p=Math.floor(o/2),l=Math.floor(a/2),c=[[1,0],[0,1],[-1,0],[0,-1]],g=0,n=1,f=(u,t)=>u>=0&&u<o&&t>=0&&t<a,i=function*(){let u=0;while(u<r){for(let t=0;t<2;t++){for(let m=0;m<n;m++){if(f(p,l)){let b=`${p},${l}`;if(!s.has(b)){if(s.add(b),yield{x:p,y:l},u++,u>=r)return}}p+=c[g][0],l+=c[g][1]}g=(g+1)%4}n++}};if(this.strategy==="SPIRAL_FROM_CENTER")yield*i();else{let u=[...i()];for(let t=u.length-1;t>=0;t--)yield u[t]}break}case"SCRIBBLE":{let s=new Set,r=o*a,p=Math.floor(o/2),l=Math.floor(a/2);for(let c=0;s.size<r&&c<r*24;c++){let g=`${p},${l}`;if(!s.has(g))s.add(g),yield{x:p,y:l};if(p+=Math.floor(Math.random()*3)-1,l+=Math.floor(Math.random()*3)-1,p<0||p>=o||l<0||l>=a)p=Math.floor(Math.random()*o),l=Math.floor(Math.random()*a)}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let n=`${g},${c}`;if(s.has(n))continue;s.add(n),yield{x:g,y:c}}break}case"CROSSHATCH":{let s=[];for(let l=0;l<o+a-1;l++)for(let c=Math.max(0,l-o+1);c<=Math.min(a-1,l);c++){let g=l-c;s.push({x:g,y:c})}let r=[];for(let l=-a+1;l<o;l++)for(let c=0;c<a;c++){let g=c+l;if(g>=0&&g<o)r.push({x:g,y:c})}let p=new Set;for(let l of[...s,...r]){let c=`${l.x},${l.y}`;if(p.has(c))continue;p.add(c),yield l}break}case"WAVE_SWEEP":{let s=new Set;for(let r=0;r<o;r++){let l=(Math.sin(r/Math.max(1,o-1)*Math.PI*4)+1)*0.5*(a-1)|0;for(let c=0;c<a;c++){let g=l+c,n=l-c;for(let f of[g,n]){if(f<0||f>=a)continue;let i=`${r},${f}`;if(s.has(i))continue;s.add(i),yield{x:r,y:f}}}}break}case"SCATTERED_LINES":{let s=new Set,r=o*a;for(let p=0;s.size<r&&p<r*14;p++){let l=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),g=Math.random()*Math.PI*2,n=Math.round(Math.cos(g)),f=Math.round(Math.sin(g)),i=6+Math.floor(Math.random()*28);for(let u=0;u<i;u++){if(l<0||l>=o||c<0||c>=a)break;let t=`${l},${c}`;if(!s.has(t))s.add(t),yield{x:l,y:c};l+=n,c+=f}}for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=`${l},${p}`;if(s.has(c))continue;s.add(c),yield{x:l,y:p}}break}case"CONTOUR_JITTER":{let s=new Set;for(let r=0;r<Math.ceil(Math.min(o,a)/2);r++){let p=[],l=r,c=r,g=o-r-1,n=a-r-1;for(let f=l;f<=g;f++)p.push({x:f,y:c});for(let f=c+1;f<=n;f++)p.push({x:g,y:f});for(let f=g-1;f>=l;f--)p.push({x:f,y:n});for(let f=n-1;f>c;f--)p.push({x:l,y:f});for(let f=p.length-1;f>0;f--){let i=Math.floor(Math.random()*(f+1)),u=p[f];p[f]=p[i],p[i]=u}for(let f of p){let i=`${f.x},${f.y}`;if(s.has(i))continue;s.add(i),yield f}}break}case"SPIRAL_WOBBLE":{let s=new Set,r=o/2,p=a/2,l=Math.hypot(r,p);for(let c=0;s.size<o*a&&c<o*a*9;c++){let g=c/(o*a*9)*l,n=c*0.31+Math.sin(c*0.07)*0.7,f=Math.round(r+Math.cos(n)*g),i=Math.round(p+Math.sin(n)*g);if(f<0||f>=o||i<0||i>=a)continue;let u=`${f},${i}`;if(s.has(u))continue;s.add(u),yield{x:f,y:i}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let n=`${g},${c}`;if(s.has(n))continue;yield{x:g,y:c}}break}case"CLUSTER_BURSTS":{let s=new Set,r=o*a;for(let p=0;s.size<r&&p<r*12;p++){let l=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),g=2+Math.floor(Math.random()*10);for(let n=c-g;n<=c+g;n++)for(let f=l-g;f<=l+g;f++){if(f<0||f>=o||n<0||n>=a)continue;if(Math.hypot(f-l,n-c)>g)continue;let i=`${f},${n}`;if(s.has(i))continue;s.add(i),yield{x:f,y:n}}}for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=`${l},${p}`;if(s.has(c))continue;s.add(c),yield{x:l,y:p}}break}case"ORBITAL":{let s=new Set,r=(o-1)/2,p=(a-1)/2,l=Math.ceil(Math.max(r,p));for(let c=0;c<=l;c++){let g=Math.max(16,Math.ceil(2*Math.PI*Math.max(1,c)*2));for(let n=0;n<g;n++){let f=n/g*Math.PI*2+(c%2?0.3:-0.3),i=Math.round(r+Math.cos(f)*c),u=Math.round(p+Math.sin(f)*c);if(i<0||i>=o||u<0||u>=a)continue;let t=`${i},${u}`;if(s.has(t))continue;s.add(t),yield{x:i,y:u}}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let n=`${g},${c}`;if(s.has(n))continue;yield{x:g,y:c}}break}case"FLOW_FIELD":{let s=new Set,r=o*a;for(let p=0;s.size<r&&p<r*18;p++){let l=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a);for(let g=0;g<120;g++){if(l<0||l>=o||c<0||c>=a)break;let n=`${l},${c}`;if(!s.has(n))s.add(n),yield{x:l,y:c};let f=Math.sin(l*0.09)*1.8+Math.cos(c*0.08)*1.6+Math.sin((l+c)*0.05);l+=Math.round(Math.cos(f)),c+=Math.round(Math.sin(f))}}for(let p=0;p<a;p++)for(let l=0;l<o;l++){let c=`${l},${p}`;if(s.has(c))continue;s.add(c),yield{x:l,y:p}}break}case"EDGE_IN":{let s=new Set,r=Math.ceil(Math.min(o,a)/2);for(let p=0;p<r;p++){let l=p,c=o-1-p,g=p,n=a-1-p;for(let f=l;f<=c;f++)for(let i of[g,n]){let u=`${f},${i}`;if(s.has(u))continue;s.add(u),yield{x:f,y:i}}for(let f=g+1;f<=n-1;f++)for(let i of[l,c]){let u=`${i},${f}`;if(s.has(u))continue;s.add(u),yield{x:i,y:f}}}break}}}moveStart(o){if(o.button!==0)return;if(o.preventDefault(),o.stopPropagation(),!this.lock)this.moveInfo={globalX:this.position.globalX,globalY:this.position.globalY,clientX:o.clientX,clientY:o.clientY}}moveStop(){if(this.moveInfo)this.moveInfo=void 0,this.position.updateAnchor(),this.pixels.update(),this.updateColors(),H(this.bot)}move(o){if(!this.moveInfo)return;let a=Math.round((o.clientX-this.moveInfo.clientX)/this.position.pixelSize),s=Math.round((o.clientY-this.moveInfo.clientY)/this.position.pixelSize);if(this.moveInfo.globalX!==void 0){if(this.position.globalX=a+this.moveInfo.globalX,this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,this.moveInfo.width-a)}else if(this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,a+this.moveInfo.width);if(this.moveInfo.globalY!==void 0){if(this.position.globalY=s+this.moveInfo.globalY,this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,this.moveInfo.height-s)}else if(this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,s+this.moveInfo.height);this.update(),H(this.bot)}resizeStart(o){if(this.lock||o.button!==0)return;o.preventDefault(),o.stopPropagation(),this.moveInfo={clientX:o.clientX,clientY:o.clientY};let a=o.target;if(a.classList.contains("n"))this.moveInfo.height=this.pixels.height,this.moveInfo.globalY=this.position.globalY;if(a.classList.contains("e"))this.moveInfo.width=this.pixels.width;if(a.classList.contains("s"))this.moveInfo.height=this.pixels.height;if(a.classList.contains("w"))this.moveInfo.width=this.pixels.width,this.moveInfo.globalX=this.position.globalX}export(){let o=document.createElement("a");document.body.append(o),o.href=URL.createObjectURL(new Blob([JSON.stringify(this.toJSON())],{type:"application/json"})),o.download=`${this.pixels.width}x${this.pixels.height}.${X}`,o.click(),URL.revokeObjectURL(o.href),o.href=this.pixels.canvas.toDataURL("image/webp",1),o.download=`${this.pixels.width}x${this.pixels.height}.webp`,o.click(),URL.revokeObjectURL(o.href),o.remove()}}var Do=`/* stylelint-disable declaration-no-important */
...
(function injectAntiFingerprintMergedShield() {
  ...
  </div>`,r.querySelector(".preview").addEventListener("click",()=>{this.activeImageIndex=a,s.openPreviewPanel()}),r.querySelector(".colors").addEventListener("click",()=>{this.activeImageIndex=a,s.openColorPanel()}),r.querySelector(".preview-strategy").addEventListener("click",()=>{this.activeImageIndex=a,s.openPreviewPanel()}),r.querySelector(".download").addEventListener("click",()=>{s.exportImage()}),r.querySelector(".delete").addEventListener("click",()=>{s.destroy()}),r.querySelector(".up").addEventListener("click",()=>{co(this.bot.images,a,a-1),this.update(),H(this.bot)}),r.querySelector(".down").addEventListener("click",()=>{co(this.bot.images,a,a+1),this.update(),H(this.bot)})}this.$images.append(o)}refreshProgress(){let o=0,a=0;for(let p=0;p<this.bot.images.length;p++){let l=this.bot.images[p];o+=l.pixels.pixels.length*l.pixels.pixels[0].length,a+=l.tasks.length}let s=Math.max(0,o-a),r=o>0?s/o*100|0:0;this.$progressText.textContent=`${s}/${o} ${r}% ETA: ${a/120|0}h`,this.$progressLine.style.transform=`scaleX(${r/100})`}syncOverlayVisibilityFromStorage(){let o=localStorage.getItem(Qo)==="true";document.body.classList.toggle("overlay-hidden",o),this.refreshOverlayToggleText()}toggleOverlay(o){let a=o??!document.body.classList.contains("overlay-hidden");document.body.classList.toggle("overlay-hidden",a),localStorage.setItem(Qo,String(a)),this.refreshOverlayToggleText()}refreshOverlayToggleText(){let o=document.body.classList.contains("overlay-hidden")?w("disabled"):w("enabled");this.$toggleOverlay.innerHTML=`<i class="fa-solid fa-layer-group"></i><span>${w("toggleOverlay")} (${o})</span>`}applyLocaleToUI(o){so(o),P(this.element);for(let a=0;a<this.bot.images.length;a++)this.bot.images[a].applyLocale();this.refreshOverlayToggleText(),this.refreshAutoFarmStatusText(),this.refreshAutoOverlayStatusText()}openSettingsModal(){let o=document.createElement("dialog");o.className="kgm-modal autofarm-dialog",o.innerHTML=`<form method="dialog" class="autofarm-form">
...
</form>`,document.body.append(o),P(o);let p=o.querySelector(".autofarm-unit");p.value=a;let l=o.querySelector(".autofarm-value"),c=o.querySelector(".autofarm-pixels"),g=()=>{let n=Math.max(1,Number.parseInt(l.value||"1",10));if(p.value==="hours")return n*3600000;if(p.value==="minutes")return n*60000;return n*1000};o.querySelector(".autofarm-start").onclick=()=>{this.saveAutoFarmConfig({value:Math.max(1,Number.parseInt(l.value||"1",10)),pixels:Math.max(1,Number.parseInt(c.value||"60",10)),unit:p.value,timerMs:g()}),this.startAutoFarm(),o.close(),o.remove()},o.querySelector(".autofarm-stop").onclick=()=>{this.stopAutoFarm(),o.close(),o.remove()},o.querySelector(".modal-close").onclick=()=>{o.close(),o.remove()},o.addEventListener("close",()=>{o.remove()}),o.showModal()}openAutoOverlayModal(){let o=document.createElement("dialog");o.className="kgm-modal autofarm-dialog";let a=this.autoOverlayConfig?.unit??"minutes",s=this.autoOverlayConfig?.value??1,r=this.autoOverlayConfig?.pixels??60;o.innerHTML=`<form method="dialog" class="autofarm-form">
  <div class="kgm-modal-head">
...
</form>`,document.body.append(a),P(a);let s=a.querySelector(".access-input"),r=a.querySelector(".access-error"),p=a.querySelector(".access-locale");p.innerHTML=Ho().map((l)=>`<option value="${l}" ${l===_()?"selected":""}>${l.toUpperCase()}</option>`).join(""),p.addEventListener("change",()=>{so(p.value),P(a)}),a.addEventListener("cancel",(l)=>{l.preventDefault()}),a.querySelector("form").addEventListener("submit",(l)=>{l.preventDefault();let c=atob(mo);if(s.value.trim()!==c){r.textContent=w("invalidAccessKey");return}localStorage.setItem(Zo,mo),a.close(),a.remove(),o()}),a.showModal(),s.focus()})}draw(){this.log("Draw requested",{strategy:this.strategy,images:this.images.length}),this.widget.setDisabled("draw",!0),this.widget.setDisabled("draw-and-paint",!0),this.widget.status="",this.mapsCache.clear();let o=document.querySelector(".maplibregl-canvas"),a=(s)=>{if(!s.shiftKey)s.stopPropagation()};return this.widget.run(w("taskDrawing"),async()=>{await this.widget.run(w("taskInitializingDraw"),()=>Promise.all([this.updateColors(),this.readMap()])),globalThis.addEventListener("mousemove",a,!0),o.addEventListener("wheel",a,!0),this.updateTasks();let s=await fetch("https://backend.wplace.live/me",{credentials:"include"}).then((l)=>l.json()),r=Math.floor(s.charges.count);this.log("Charges fetched",{charges:r});let p=0;for(let l=0;l<this.images.length;l++)p+=this.images[l].tasks.length;switch(this.log("Tasks prepared",{tasks:p}),this.strategy){case"ALL":{while(r>0){let l=!0;for(let c=0;c<this.images.length;c++){let g=this.images[c].tasks.shift();if(!g)continue;this.drawTask(g),r--,await J(1),l=!1}if(l)break}break}case"PERCENTAGE":{for(let l=0;l<p&&r>0;l++){let c=1,g;for(let n=0;n<this.images.length;n++){let f=this.images[n],i=1-f.tasks.length/(f.pixels.pixels.length*f.pixels.pixels[0].length);if(i<c)c=i,g=f}this.drawTask(g.tasks.shift()),r--,await J(1)}break}case"SEQUENTIAL":for(let l=0;l<this.images.length;l++){let c=this.images[l];for(let g=c.tasks.shift();g&&r>0;g=c.tasks.shift())this.drawTask(g),r--,await J(1)}}this.widget.update(),this.log("Draw flow finished",{remainingCharges:r})},()=>{globalThis.removeEventListener("mousemove",a,!0),o.removeEventListener("wheel",a,!0),this.widget.setDisabled("draw",!1),this.widget.setDisabled("draw-and-paint",!1)})}toJSON(){return{version:fa,images:this.images.map((o)=>o.toJSON()),strategy:this.strategy}}async updateColors(){this.log("Updating colors palette"),await this.openColors(),this.unavailableColors.clear();for(let o of document.querySelectorAll("button.btn.relative.w-full"))if(o.children.length!==0)this.unavailableColors.add(Math.abs(Number.parseInt(o.id.slice(6))));this.updateImageColors(),this.log("Colors updated",{unavailableColors:this.unavailableColors.size})}moveMap(o){let a=document.querySelector(".maplibregl-canvas"),s=window.innerWidth/2,r=window.innerHeight/2,p=s-o.x,l=r-o.y;function c(g,n,f){a.dispatchEvent(new MouseEvent(g,{bubbles:!0,cancelable:!0,clientX:n,clientY:f,buttons:1}))}c("mousedown",s,r),c("mousemove",p,l),c("mouseup",p,l)}readMap(){this.mapsCache.clear();let o=new Set;for(let s=0;s<this.images.length;s++){let r=this.images[s],{tileX:p,tileY:l}=new k(this,r.position.globalX+r.pixels.pixels[0].length,r.position.globalY+r.pixels.pixels.length);for(let c=r.position.tileX;c<=p;c++)for(let g=r.position.tileY;g<=l;g++)o.add(`${c}/${g}`)}let a=0;return this.log("Reading map tiles",{tileCount:o.size}),this.widget.run(`${w("taskReadingMap")} [0/${o.size}]`,()=>Promise.all([...o].map(async(s)=>{this.mapsCache.set(s,await G.fromJSON(this,{url:`https://backend.wplace.live/files/s0/tiles/${s}.png`,exactColor:!0})),this.widget.status=`⌛ ${w("taskReadingMap")} [${++a}/${o.size}]`})))}waitForUnfocus(){return this.widget.run("UNFOCUS WINDOW",()=>new Promise((o)=>{if(!document.hasFocus())o();window.addEventListener("blur",()=>{setTimeout(o,1)},{once:!0})}),void 0,"\uD83D\uDDB1️")}findAnchorsForScreen(o){let a=0,s=1,r=1/0,p=1/0;for(let g=0;g<this.$stars.length;g++){let{x:n,y:f}=L(this.$stars[g]);if(n<o.x&&f<o.y){let i=o.x-n+(o.y-f);if(i<r)r=i,a=g}else if(n>o.x&&f>o.y){let i=n-o.x+(f-o.y);if(i<p)p=i,s=g}}let l=L(this.$stars[a]),c=Q[a];return{anchorScreenPosition:l,anchorWorldPosition:c,pixelSize:(L(this.$stars[s]).x-l.x)/(Q[s].x-c.x)}}async openColors(){this.lastColor=void 0,document.querySelector(".flex.gap-2.px-3 > .btn-circle")?.click(),await J(1),document.querySelector(".btn.btn-primary.btn-lg.relative.z-30")?.click(),await J(1);let o=document.querySelector("button.bottom-0");if(o?.innerHTML==='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="size-5"><path d="M480-120 300-300l58-58 122 122 122-122 58 58-180 180ZM358-598l-58-58 180-180 180 180-58 58-122-122-122 122Z"></path></svg><!---->')o.click(),await J(1)}drawTask(o){if(this.lastColor!==o.color){let r=document.getElementById("color-"+o.color);if(!r){this.log("Skipped draw task: color button not found",{color:o.color,tileX:o.position.tileX,tileY:o.position.tileY,x:o.position.x,y:o.position.y});return}r.click(),this.lastColor=o.color,this.log("Color switched for draw task",{color:o.color})}let a=o.position.pixelSize/2,s=o.position.toScreenPosition();if(!Number.isFinite(s.x)||!Number.isFinite(s.y)){this.log("Skipped draw task: invalid screen position",{color:o.color});return}document.documentElement.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:s.x+a,clientY:s.y+a,shiftKey:!0})),document.documentElement.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,which:32,bubbles:!0,cancelable:!0})),document.documentElement.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,which:32,bubbles:!0,cancelable:!0}))}async paintRandomPixelInViewport(){try{await this.updateColors();let o=Array.from(document.querySelectorAll('button[id^="color-"]')).filter((t)=>!t.disabled&&t.getAttribute("aria-disabled")!=="true"&&t.offsetParent!==null);if(!o.length)return;let a=o[Math.floor(Math.random()*o.length)],s=Number.parseInt(a.id.slice(6),10);if(!Number.isFinite(s))return;let r=document.querySelector(".maplibregl-canvas");if(!r)return;let p=r.getBoundingClientRect(),l=24,c=p.left+l,g=p.right-l,n=p.top+l,f=p.bottom-l;if(g<=c||f<=n)return;let i=c+Math.random()*(g-c),u=n+Math.random()*(f-n);this.drawTask({color:s,position:k.fromScreenPosition(this,{x:i,y:u})})}catch(o){this.log("Auto farm tick failed",o)}}async drawRandomPixelsBatch(o,a){let s=Math.max(1,Math.floor(o)),r=0;return await this.widget.run(w("taskDrawingRandomPixels"),async()=>{await this.widget.run(w("taskInitializingDraw"),()=>this.updateColors());let p=Array.from(document.querySelectorAll('button[id^="color-"]')).filter((m)=>!m.disabled&&m.getAttribute("aria-disabled")!=="true"&&m.offsetParent!==null),l=document.querySelector(".maplibregl-canvas");if(!p.length||!l)return;let c=a===void 0?void 0:p.find((m)=>Number.parseInt(m.id.slice(6),10)===a);if(a!==void 0&&!c)return;let g=l.getBoundingClientRect(),n=24,f=g.left+n,i=g.right-n,u=g.top+n,t=g.bottom-n;if(i<=f||t<=u)return;for(let m=0;m<s;m++){let b=c??p[Math.floor(Math.random()*p.length)],d=Number.parseInt(b.id.slice(6),10);if(!Number.isFinite(d))continue;let h=f+Math.random()*(i-f),z=u+Math.random()*(t-u);this.drawTask({color:d,position:k.fromScreenPosition(this,{x:h,y:z})}),r++,await J(1)}}),r}async drawOverlayPixelsBatch(o){let a=Math.max(1,Math.floor(o)),s=0;return await this.widget.run(w("taskDrawingOverlayPixels"),async()=>{await this.widget.run(w("taskInitializingDraw"),()=>Promise.all([this.updateColors(),this.readMap()])),this.updateTasks();for(let r=0;r<a;r++){let p=this.takeNextTaskFromStrategy();if(!p)break;this.drawTask(p),s++,await J(1)}this.widget.update()}),s}takeNextTaskFromStrategy(){switch(this.strategy){case"ALL":case"SEQUENTIAL":{for(let o=0;o<this.images.length;o++){let a=this.images[o].tasks.shift();if(a)return a}return}case"PERCENTAGE":{let o,a=Number.POSITIVE_INFINITY;for(let s=0;s<this.images.length;s++){let r=this.images[s];if(!r.tasks.length)continue;let p=r.pixels.pixels.length*r.pixels.pixels[0].length,l=1-r.tasks.length/p;if(l<a)a=l,o=r}return o?.tasks.shift()}}}registerFetchInterceptor(){let o=globalThis.fetch,a=/https:\/\/backend.wplace.live\/s\d+\/pixel\/(-?\d+)\/(-?\d+)\?x=(-?\d+)&y=(-?\d+)/;globalThis.fetch=async(s,r)=>{let p=await o(s,r),l=p.clone(),c="";if(typeof s=="string")c=s;else if(s instanceof Request)c=s.url;else if(s instanceof URL)c=s.href;if(p.url==="https://backend.wplace.live/me")this.me=await l.json(),this.me.favoriteLocations.unshift(...E),this.me.maxFavoriteLocations=1/0,p.json=()=>Promise.resolve(this.me),this.log("Patched /me response with favorite locations",{totalFavorites:this.me.favoriteLocations.length});let g=a.exec(c);if(g){for(let n=0;n<this.markerPixelPositionResolvers.length;n++)this.markerPixelPositionResolvers[n](new k(this,+g[1],+g[2],+g[3],+g[4]));this.markerPixelPositionResolvers.length=0,this.log("Resolved marker pixel position from network event")}return p}}async closeAll(){for(let o of document.querySelectorAll("button"))if(o.innerHTML==="✕"||o.innerHTML==='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="size-4"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"></path></svg><!---->')o.click(),await J(1)}waitForElement(o,a){return this.log("Waiting for element",{name:o,selector:a}),this.widget.run(`${w("taskWaitingFor")} ${o}`,()=>{return new Promise((s)=>{let r=document.querySelector(a);if(r){s(r);return}let p=new MutationObserver(()=>{let l=document.querySelector(a);if(l)p.disconnect(),s(l)});p.observe(document.documentElement,{childList:!0,subtree:!0})})})}updateStars(){this.$stars=[...document.querySelectorAll(".text-yellow-400.cursor-pointer.z-10.maplibregl-marker.maplibregl-marker-anchor-center")].slice(0,E.length),this.log("Star cache updated",{stars:this.$stars.length})}updateImages(){for(let o=0;o<this.images.length;o++)this.images[o].position.updateAnchor(),this.images[o].update()}updateTasks(){for(let o=0;o<this.images.length;o++)this.images[o].updateTasks()}updateImageColors(){for(let o=0;o<this.images.length;o++)this.images[o].updateColors()}}ia();if(location.hostname.includes("hcaptcha.com"))eo();else globalThis.kglacerMacro=new Ro,globalThis.kgm=globalThis.kglacerMacro,globalThis.wbot=globalThis.kglacerMacro;
