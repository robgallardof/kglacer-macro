...
`;class G{bot;image;width;exactColor;static async fromJSON(o,a){let r=new Image;return r.src=a.url.startsWith("http")?await fetch(a.url,{cache:"no-store"}).then((s)=>s.blob()).then((s)=>URL.createObjectURL(s)):a.url,await q(r,["load"],["error"]),new G(o,r,a.width,a.exactColor)}canvas=document.createElement("canvas");context=this.canvas.getContext("2d");pixels;colors=new Map;resolution;get height(){return this.width/this.resolution|0}set height(o){this.width=o*this.resolution|0}constructor(o,a,r=a.naturalWidth,s=!1){this.bot=o;this.image=a;this.width=r;this.exactColor=s;if(s)this.resolution=1,this.width=1000;else this.resolution=this.image.naturalWidth/this.image.naturalHeight;this.update()}update(){this.canvas.width=this.width,this.canvas.height=this.height,this.colors.clear();let o=new Map;for(let r=1;r<64;r++)if(this.exactColor||!this.bot.unavailableColors.has(r))o.set(S[r],[r,r]);this.context.imageSmoothingEnabled=!1,this.context.imageSmoothingQuality="low",this.context.drawImage(this.image,0,0,this.canvas.width,this.canvas.height),this.pixels=Array.from({length:this.canvas.height},()=>new Array(this.canvas.width));let a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(let r=0;r<this.canvas.height;r++)for(let s=0;s<this.canvas.width;s++){let l=(r*this.canvas.width+s)*4,p=a[l],c=a[l+1],g=a[l+2],f=a[l+3],n=p,u=c,i=g,t=`${n},${u},${i}`;if(this.exactColor){this.pixels[r][s]=f<100?0:S.indexOf(t);continue}let m,b;if(f<100)m=b=0;else if(o.has(t))[m,b]=o.get(t);else{let z=1/0,A=1/0;for(let h=0;h<Z.length;h++){let M=Z[h],P=Mo(Ho(n,u,i),M,0);if(!this.bot.unavailableColors.has(h)&&P<z)z=P,m=h;if(P<A)A=P,b=h}o.set(t,[m,b])}if(m!==0)this.context.fillStyle=`oklab(${Z[m][0]*100}% ${Z[m][1]} ${Z[m][2]})`,this.context.fillRect(s,r,1,1);this.pixels[r][s]=m;let d=this.colors.get(b);if(d)d.amount++;else this.colors.set(b,{color:m,amount:1,realColor:b})}}toJSON(){let o=document.createElement("canvas");return o.width=this.image.naturalWidth,o.height=this.image.naturalHeight,o.getContext("2d").drawImage(this.image,0,0),{url:o.toDataURL("image/webp",1),width:this.width,exactColor:this.exactColor}}}var T="kglacer-macro-settings",Po=["kglacermacro","wbot"],X="kgm";function ra(){let o=[T,...Po];for(let a=0;a<o.length;a++){let r=o[a],s=localStorage.getItem(r);if(!s)continue;return{json:s,key:r}}return}function Fo(){let o=ra();if(!o)return;let a;try{if(a=JSON.parse(o.json),typeof a!=="object")throw new Error("NOT VALID SAVE");if(a.version===1){let r=a;a.images=r.widget.images,a.strategy=r.widget.strategy,delete r.widget}if(o.key!==T)localStorage.setItem(T,o.json)}catch{localStorage.removeItem(o.key),a=void 0}return a}var No;function e(o,a=!1){if(clearTimeout(No),a)localStorage.setItem(T,JSON.stringify(o));else No=setTimeout(()=>{localStorage.setItem(T,JSON.stringify(o))},600)}var H=1000,la=2048,V=H*la,Q=[],B=[],sa=Date.now();function v(o){Q.push(o),B.push({id:sa++,latitude:(2*Math.atan(Math.exp(-(o.y/V*(2*Math.PI)-Math.PI)))-Math.PI/2)*180/Math.PI,longitude:(o.x/V*(2*Math.PI)-Math.PI)*180/Math.PI,name:"KGLACER_MACRO_FAVORITE"})}v({x:V/3|0,y:V/3|0});v({x:V/3*2|0,y:V/3*2|0});function L(o){let[a,r]=o.style.transform.slice(32,-31).split(", ").map((s)=>Number.parseFloat(s));return{x:a,y:r}}class k{bot;static fromJSON(o,a){return new k(o,...a)}static fromScreenPosition(o,a){let{anchorScreenPosition:r,pixelSize:s,anchorWorldPosition:l}=o.findAnchorsForScreen(a);return new k(o,l.x+(a.x-r.x)/s|0,l.y+(a.y-r.y)/s|0)}globalX=0;globalY=0;get tileX(){return this.globalX/H|0}set tileX(o){this.globalX=o*H+this.x}get tileY(){return this.globalY/H|0}set tileY(o){this.globalY=o*H+this.y}get x(){return this.globalX%H}set x(o){this.globalX=this.tileX*H+o}get y(){return this.globalY%H}set y(o){this.globalY=this.tileY*H+o}anchor1Index;anchor2Index;get pixelSize(){return(L(this.bot.$stars[this.anchor2Index]).x-L(this.bot.$stars[this.anchor1Index]).x)/(Q[this.anchor2Index].x-Q[this.anchor1Index].x)}constructor(o,a,r,s,l){this.bot=o;if(s===void 0||l===void 0)this.globalX=a,this.globalY=r;else this.globalX=a*H+s,this.globalY=r*H+l;this.updateAnchor()}updateAnchor(){this.anchor1Index=0,this.anchor2Index=1;let o=1/0,a=1/0;for(let r=0;r<Q.length;r++){let{x:s,y:l}=Q[r];if(s<this.globalX&&l<this.globalY){let p=this.globalX-s+(this.globalY-l);if(p<o)o=p,this.anchor1Index=r}else if(s>this.globalX&&l>this.globalY){let p=s-this.globalX+(l-this.globalY);if(p<a)a=p,this.anchor2Index=r}}}toScreenPosition(){let o=Q[this.anchor1Index],a=L(this.bot.$stars[this.anchor1Index]);return{x:(this.globalX-o.x)*this.pixelSize+a.x,y:(this.globalY-o.y)*this.pixelSize+a.y}}getMapColor(){return this.bot.mapsCache.get(this.tileX+"/"+this.tileY).pixels[this.y][this.x]}scrollScreenTo(){let{x:o,y:a}=this.toScreenPosition();this.bot.moveMap({x:o-window.innerWidth/3,y:a-window.innerHeight/3})}clone(){return new k(this.bot,this.tileX,this.tileY,this.x,this.y)}toJSON(){return[this.globalX,this.globalY]}}class K extends Y{bot;position;pixels;strategy;opacity;drawTransparentPixels;drawColorsInOrder;skipUnavailableColors;smartReplaceMode;colors;lock;static PREVIEW_MASK_BASE_WIDTH=96;static PREVIEW_MASK_BASE_HEIGHT=96;static async fromJSON(o,a){return new K(o,k.fromJSON(o,a.position),await G.fromJSON(o,a.pixels),a.strategy,a.opacity,a.drawTransparentPixels,a.drawColorsInOrder,a.skipUnavailableColors,a.smartReplaceMode,a.colors,a.lock)}element=document.createElement("div");tasks=[];moveInfo;$canvas;$colorsDialog;$colorsDialogList;$colorSearch;$openColors;$openPreview;$enableAllColors;$disableAllColors;$closeColors;$closePreview;$delete;$drawColorsInOrder;$drawTransparent;$skipUnavailable;$smartReplaceMode;$export;$lock;$opacity;$progressLine;$progressText;$previewDialog;$previewDialogList;$resetSize;$resetSizeSpan;$settings;$strategy;$topbar;$wrapper;colorDialogDragState;suppressNextColorDialogBackdropClick=!1;previewCacheSignature;previewSequenceCache=new Map;previewAnimations=new WeakMap;previewAnimationHandles=new Set;constructor(o,a,r,s="SPIRAL_FROM_CENTER",l=50,p=!1,c=!1,g=!1,f=!1,n=[],u=!1){super();this.bot=o;this.position=a;this.pixels=r;this.strategy=s;this.opacity=l;this.drawTransparentPixels=p;this.drawColorsInOrder=c;this.skipUnavailableColors=g;this.smartReplaceMode=f;this.colors=n;this.lock=u;this.element.innerHTML=ko,this.element.classList.add("wimage"),N(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$colorsDialog:".colors-dialog",$colorsDialogList:".colors-dialog-list",$colorSearch:".color-search",$openColors:".open-colors",$openPreview:".open-preview",$enableAllColors:".enable-all-colors",$disableAllColors:".disable-all-colors",$closeColors:".close-colors",$closePreview:".close-preview",$delete:".delete",$drawColorsInOrder:".draw-colors-in-order",$drawTransparent:".draw-transparent",$skipUnavailable:".skip-unavailable",$smartReplaceMode:".smart-replace-mode",$export:".export",$lock:".lock",$opacity:".opacity",$progressLine:".wprogress div",$progressText:".wprogress span",$previewDialog:".preview-dialog",$previewDialogList:".preview-dialog-list",$resetSize:".reset-size",$settings:".wform",$strategy:".strategy",$topbar:".wtopbar",$wrapper:".wrapper"}),this.$resetSizeSpan=this.$resetSize.querySelector("span"),this.$canvas=this.pixels.canvas,this.$wrapper.prepend(this.pixels.canvas),document.body.append(this.$colorsDialog,this.$previewDialog),this.registerEvent(this.$strategy,"change",()=>{if(this.strategy=this.$strategy.value,this.$previewDialog.open)this.renderStrategyPreviewSamples();e(this.bot)}),this.registerEvent(this.$opacity,"input",()=>{this.opacity=this.$opacity.valueAsNumber,this.$opacity.style.setProperty("--val",this.opacity+"%"),this.update(),e(this.bot)}),this.$opacity.style.setProperty("--val",this.opacity+"%"),this.registerEvent(this.$resetSize,"click",()=>{this.pixels.width=this.pixels.image.naturalWidth,this.pixels.update(),this.updateColors(),this.update(),e(this.bot)}),this.registerEvent(this.$drawTransparent,"click",()=>{this.drawTransparentPixels=this.$drawTransparent.checked,e(this.bot)}),this.registerEvent(this.$skipUnavailable,"click",()=>{this.skipUnavailableColors=this.$skipUnavailable.checked,this.updateTasks(),e(this.bot)}),this.registerEvent(this.$drawColorsInOrder,"click",()=>{this.drawColorsInOrder=this.$drawColorsInOrder.checked,e(this.bot)}),this.registerEvent(this.$lock,"click",()=>{this.lock=!this.lock,this.update(),e(this.bot)}),this.registerEvent(this.$delete,"click",this.destroy.bind(this)),this.registerEvent(this.$openColors,"click",()=>{this.openColorPanel()}),this.registerEvent(this.$openPreview,"click",()=>{this.openPreviewPanel()}),this.registerEvent(this.$closeColors,"click",()=>{this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$closePreview,"click",()=>{this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorsDialog.querySelector(".colors-dialog-head"),"pointerdown",this.startColorDialogDrag.bind(this)),this.registerEvent(document,"pointermove",this.moveColorDialog.bind(this),{passive:!1}),this.registerEvent(document,"pointerup",this.stopColorDialogDrag.bind(this)),this.registerEvent(document,"pointercancel",this.stopColorDialogDrag.bind(this)),this.registerEvent(this.$colorsDialog,"click",(i)=>{if(this.suppressNextColorDialogBackdropClick){this.suppressNextColorDialogBackdropClick=!1;return}if(i.target===this.$colorsDialog)this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$previewDialog,"click",(i)=>{if(i.target===this.$previewDialog)this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorSearch,"input",()=>{this.updateColors()}),this.registerEvent(this.$enableAllColors,"click",()=>{for(let i of this.colors)i.disabled=void 0;this.updateTasks(),this.updateColors(),e(this.bot)}),this.registerEvent(this.$disableAllColors,"click",()=>{for(let i of this.colors)i.disabled=!0;this.updateTasks(),this.updateColors(),e(this.bot)}),this.registerEvent(this.$export,"click",this.export.bind(this)),this.registerEvent(this.$topbar,"mousedown",this.moveStart.bind(this)),this.registerEvent(this.$canvas,"mousedown",this.moveStart.bind(this)),this.registerEvent(document,"mouseup",this.moveStop.bind(this)),this.registerEvent(document,"mousemove",this.move.bind(this));for(let i of this.element.querySelectorAll(".resize"))this.registerEvent(i,"mousedown",this.resizeStart.bind(this));this.update(),this.updateColors()}toJSON(){return{pixels:this.pixels.toJSON(),position:this.position.toJSON(),strategy:this.strategy,opacity:this.opacity,drawTransparentPixels:this.drawTransparentPixels,drawColorsInOrder:this.drawColorsInOrder,skipUnavailableColors:this.skipUnavailableColors,smartReplaceMode:this.smartReplaceMode,colors:this.colors,lock:this.lock}}updateTasks(){this.tasks.length=0;let o=this.position.clone(),a=new Set,r=new Map;for(let s=0;s<this.colors.length;s++){let l=this.colors[s];if(l.disabled)a.add(l.realColor);r.set(l.replacementColor??l.realColor,s)}for(let{x:s,y:l}of this.strategyPositionIterator()){let p=this.pixels.pixels[l][s],g=this.colors.find((n)=>n.realColor===p)?.replacementColor??p;if(a.has(p))continue;o.globalX=this.position.globalX+s,o.globalY=this.position.globalY+l;let f=o.getMapColor();if(g!==f&&(this.drawTransparentPixels||g!==0))this.tasks.push({position:o.clone(),color:g})}if(this.drawColorsInOrder)this.tasks.sort((s,l)=>(r.get(s.color)??0)-(r.get(l.color)??0));this.update(),this.bot.widget.update()}update(){let{x:o,y:a}=this.position.toScreenPosition(),r=this.position.pixelSize*this.pixels.width,s=this.position.pixelSize*this.pixels.height;this.element.style.transform=`translate3d(${o.toFixed(3)}px, ${a.toFixed(3)}px, 0)`,this.element.style.width=`${r}px`,this.element.style.height=`${s}px`,this.$canvas.style.opacity=`${this.opacity}%`,this.element.classList.remove("hidden"),this.$resetSizeSpan.textContent=this.pixels.width.toString(),this.$strategy.value=this.strategy,this.$opacity.valueAsNumber=this.opacity,this.$drawTransparent.checked=this.drawTransparentPixels,this.$drawColorsInOrder.checked=this.drawColorsInOrder,this.$skipUnavailable.checked=this.skipUnavailableColors,this.$smartReplaceMode.checked=this.smartReplaceMode;let l=this.pixels.pixels.length*this.pixels.pixels[0].length,p=Math.max(0,l-this.tasks.length),c=l>0?p/l*100|0:0;this.$progressText.textContent=`${p}/${l} ${c}% ETA: ${this.tasks.length/120|0}h`,this.$progressLine.style.transform=`scaleX(${c/100})`,this.$canvas.classList[this.lock?"add":"remove"]("no-pointer-events");for(let g of this.element.querySelectorAll(".resize"))g.classList[this.lock?"add":"remove"]("no-pointer-events");this.$lock.classList[this.lock?"add":"remove"]("locked")}exportImage(){this.export()}destroy(){super.destroy(),this.element.remove(),this.$colorsDialog.remove(),this.$previewDialog.remove(),co(this.bot.images,this),this.bot.widget.update(),e(this.bot)}openColorPanel(){if(this.$colorsDialog.open){this.$colorSearch.focus();return}this.$colorsDialog.style.position="fixed",this.$colorsDialog.style.left="",this.$colorsDialog.style.top="",this.$colorsDialog.style.margin="auto",this.$colorsDialog.showModal(),this.$colorSearch.focus()}openPreviewPanel(){if(this.$previewDialog.open){this.renderStrategyPreviewSamples();return}this.$previewDialog.style.position="fixed",this.$previewDialog.style.left="",this.$previewDialog.style.top="",this.$previewDialog.style.margin="auto",this.$previewDialog.showModal(),this.renderStrategyPreviewSamples()}closeDialog(o){if(!o.open)return;if(o===this.$previewDialog)this.stopPreviewAnimations();if(typeof o.requestClose==="function")o.requestClose();else o.close()}stopPreviewAnimations(){for(let o of this.previewAnimationHandles)cancelAnimationFrame(o);this.previewAnimationHandles.clear()}startColorDialogDrag(o){if(o.button!==0)return;if(o.target?.closest("button,input,select,textarea,a,label"))return;let r=this.$colorsDialog.getBoundingClientRect();this.colorDialogDragState={pointerId:o.pointerId,offsetX:o.clientX-r.left,offsetY:o.clientY-r.top,moved:!1},o.preventDefault()}moveColorDialog(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;let a=this.$colorsDialog.getBoundingClientRect(),r=Math.max(8,window.innerWidth-a.width-8),s=Math.max(8,window.innerHeight-a.height-8),l=Math.min(r,Math.max(8,o.clientX-this.colorDialogDragState.offsetX)),p=Math.min(s,Math.max(8,o.clientY-this.colorDialogDragState.offsetY));if(!this.colorDialogDragState.moved&&(Math.abs(o.movementX)>0||Math.abs(o.movementY)>0))this.colorDialogDragState.moved=!0;this.$colorsDialog.style.left=`${Math.round(l)}px`,this.$colorsDialog.style.top=`${Math.round(p)}px`,o.preventDefault()}stopColorDialogDrag(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;if(this.colorDialogDragState.moved)this.suppressNextColorDialogBackdropClick=!0;this.colorDialogDragState=void 0}renderStrategyPreviewSamples(){this.stopPreviewAnimations(),this.invalidatePreviewCacheIfNeeded();let o=this.$strategy.value;this.$previewDialogList.innerHTML="";let a=document.createDocumentFragment(),r=document.createElement("article");r.className="preview-card";let s=document.createElement("strong");s.textContent=this.getStrategyLabel(o);let l=document.createElement("canvas");l.className="preview-canvas",l.width=156,l.height=156,this.paintStrategyPreview(l,o),r.append(s,l),a.append(r),this.$previewDialogList.append(a)}invalidatePreviewCacheIfNeeded(){let o=this.colors.map((r,s)=>`${s}:${r.realColor}:${r.disabled?1:0}`).join("|"),a=`${this.pixels.width}x${this.pixels.height}:${this.pixels.image.src.length}:${this.drawColorsInOrder?1:0}:${o}`;if(this.previewCacheSignature===a)return;this.previewCacheSignature=a,this.previewSequenceCache.clear()}getStrategyLabel(o){switch(o){case"RANDOM":return w("random");case"HUMANIZED":return w("humanized");case"HUMAN_SOFT_DITHER":return w("humanSoftDither");case"HUMAN_PATCHY":return w("humanPatchy");case"HUMAN_SWEEP_ARCS":return w("humanSweepArcs");case"HUMAN_MICRO_CORRECTIONS":return w("humanMicroCorrections");case"HUMAN_JITTER_FILL":return w("humanJitterFill");case"HUMAN_CORNER_BIAS":return w("humanCornerBias");case"HUMAN_LONG_STROKES":return w("humanLongStrokes");case"HUMAN_TAP_CLUSTERS":return w("humanTapClusters");case"HUMAN_MESSY_SPIRAL":return w("humanMessySpiral");case"HUMAN_DRUNK_WALK":return w("humanDrunkWalk");case"HUMAN_NOISE_CLOUD":return w("humanNoiseCloud");case"HUMAN_PATCH_JUMP":return w("humanPatchJump");case"HUMAN_HESITANT_LINES":return w("humanHesitantLines");case"HUMAN_OVERLAP_SWEEPS":return w("humanOverlapSweeps");case"HUMAN_WOBBLE_DRIFT":return w("humanWobbleDrift");case"HUMAN_GAP_RECOVERY":return w("humanGapRecovery");case"HUMAN_STAIRCASE":return w("humanStaircase");case"HUMAN_EDGE_HUGGER":return w("humanEdgeHugger");case"HUMAN_BLOBS":return w("humanBlobs");case"HUMAN_BACKTRACK":return w("humanBacktrack");case"HUMAN_SHAKY_DIAGONAL":return w("humanShakyDiagonal");case"HUMAN_LATE_FIXES":return w("humanLateFixes");case"ZIGZAG":return w("zigzag");case"BRUSH_STROKES":return w("brushStrokes");case"DIAGONAL_BRUSH":return w("diagonalBrush");case"DOWN":return w("down");case"UP":return w("up");case"LEFT":return w("left");case"RIGHT":return w("right");case"SPIRAL_FROM_CENTER":return w("spiralOut");case"SPIRAL_TO_CENTER":return w("spiralIn");case"SCRIBBLE":return w("scribble");case"CROSSHATCH":return w("crosshatch");case"WAVE_SWEEP":return w("waveSweep");case"SCATTERED_LINES":return w("scatteredLines");case"CONTOUR_JITTER":return w("contourJitter");case"SPIRAL_WOBBLE":return w("spiralWobble");case"CLUSTER_BURSTS":return w("clusterBursts");case"ORBITAL":return w("orbital");case"FLOW_FIELD":return w("flowField");case"EDGE_IN":return w("edgeIn");default:return o}}paintStrategyPreview(o,a){let r=o.getContext("2d");if(!r)return;r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);let s=this.getSampledImagePreviewData(),l=this.getCachedPreviewSequence(a,s.mask,s.width,s.height),p=Math.min(o.width/s.width,o.height/s.height),c=(o.width-s.width*p)/2,g=(o.height-s.height*p)/2,f=this.previewAnimations.get(o);if(f)cancelAnimationFrame(f),this.previewAnimationHandles.delete(f);let n=(z)=>{let A=requestAnimationFrame((h)=>{this.previewAnimationHandles.delete(A),z(h)});return this.previewAnimationHandles.add(A),A},u=(z)=>{r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);for(let A=0;A<Math.min(z,l.length);A++){let h=l[A],M=s.colors.get(`${h.x}:${h.y}`)??0;if(!M)continue;r.fillStyle=uo(M),r.fillRect(c+h.x*p,g+h.y*p,Math.max(1,p),Math.max(1,p))}},i=Math.min(3400,Math.max(900,l.length*8)),m=i+220,b=(z,A)=>{if(!this.$previewDialog.open)return;let h=(A-z)%m,M=Math.min(1,h/i),P=M*M*(3-2*M);u(Math.floor(l.length*P));let U=n((W)=>{b(z,W)});this.previewAnimations.set(o,U)},d=performance.now();b(d,d)}getCachedPreviewSequence(o,a,r=this.pixels.width,s=this.pixels.height){let l=this.colors.map((f,n)=>`${n}:${f.realColor}:${f.disabled?1:0}`).join("|"),p=`${o}:${r}x${s}:${a.length}:${this.drawColorsInOrder?1:0}:${l}`,c=this.previewSequenceCache.get(p);if(c)return c;let g=r===this.pixels.width&&s===this.pixels.height?this.getExactPreviewSequence(o,a):this.getApproxPreviewSequence(o,a,r);if(this.drawColorsInOrder){let f=new Map;for(let n=0;n<this.colors.length;n++)f.set(this.colors[n].realColor,n);g.sort((n,u)=>(f.get(this.pixels.pixels[n.y]?.[n.x]??0)??0)-(f.get(this.pixels.pixels[u.y]?.[u.x]??0)??0))}return this.previewSequenceCache.set(p,g),g}getExactPreviewSequence(o,a){let r=this.strategy;this.strategy=o;let s=[...this.strategyPositionIterator()];this.strategy=r;let l=new Set(a.map(({x:p,y:c})=>`${p}:${c}`));return s.filter(({x:p,y:c})=>l.has(`${p}:${c}`))}getApproxPreviewSequence(o,a,r){let s=[...a],l=(g,f,n)=>{return(g*73856093+f*19349663+n*83492791>>>0)/4294967296},p=(g,f)=>s.sort((n,u)=>n.x*g+n.y*f-(u.x*g+u.y*f)||n.y-u.y||n.x-u.x),c=s.sort((g,f)=>{if(g.y!==f.y)return g.y-f.y;let n=g.y%2===0?g.x:r-g.x,u=f.y%2===0?f.x:r-f.x;return n-u});switch(o){case"UP":return p(0,-1);case"LEFT":return p(-1,0);case"RIGHT":return p(1,0);case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let g=r/2,f=Math.max(1,Math.round(s.reduce((n,u)=>n+u.y,0)/Math.max(1,s.length)));return s.sort((n,u)=>{let i=(n.x-g)**2+(n.y-f)**2,t=(u.x-g)**2+(u.y-f)**2;return o==="SPIRAL_FROM_CENTER"?i-t:t-i}),s}case"RANDOM":case"HUMANIZED":case"HUMAN_SOFT_DITHER":case"HUMAN_PATCHY":case"HUMAN_SWEEP_ARCS":case"HUMAN_MICRO_CORRECTIONS":case"HUMAN_JITTER_FILL":case"HUMAN_CORNER_BIAS":case"HUMAN_LONG_STROKES":case"HUMAN_TAP_CLUSTERS":case"HUMAN_MESSY_SPIRAL":case"HUMAN_DRUNK_WALK":case"HUMAN_NOISE_CLOUD":case"HUMAN_PATCH_JUMP":case"HUMAN_HESITANT_LINES":case"HUMAN_OVERLAP_SWEEPS":case"HUMAN_WOBBLE_DRIFT":case"HUMAN_GAP_RECOVERY":case"HUMAN_STAIRCASE":case"HUMAN_EDGE_HUGGER":case"HUMAN_BLOBS":case"HUMAN_BACKTRACK":case"HUMAN_SHAKY_DIAGONAL":case"HUMAN_LATE_FIXES":return s.sort((g,f)=>l(g.x,g.y,o.length)-l(f.x,f.y,o.length));default:return c}}getSampledImagePreviewData(){let o=this.pixels.width,a=this.pixels.height,r=K.PREVIEW_MASK_BASE_WIDTH,s=K.PREVIEW_MASK_BASE_HEIGHT,l=Math.min(1,r/Math.max(1,o),s/Math.max(1,a)),p=Math.max(1,Math.round(o*l)),c=Math.max(1,Math.round(a*l)),g=new Set;for(let i=0;i<this.colors.length;i++){let t=this.colors[i];if(t.disabled)g.add(t.realColor)}let f=new Map,n=new Map;for(let i=0;i<a;i++)for(let t=0;t<o;t++){let m=this.pixels.pixels[i]?.[t]??0;if(!m||g.has(m))continue;let b=Math.min(p-1,Math.floor(t/o*p)),d=Math.min(c-1,Math.floor(i/a*c)),z=`${b}:${d}`;if(!f.has(z))f.set(z,{x:b,y:d});if(!n.has(z))n.set(z,m)}let u=[...f.values()];if(!u.length){let i=this.fallbackPreviewMask();return{width:o,height:a,mask:i,colors:new Map(i.map((t)=>[`${t.x}:${t.y}`,this.pixels.pixels[t.y]?.[t.x]??0]))}}return{width:p,height:c,mask:u,colors:n}}getImagePreviewMask(){let o=this.pixels.width,a=this.pixels.height,r=new Set;for(let l=0;l<this.colors.length;l++){let p=this.colors[l];if(p.disabled)r.add(p.realColor)}let s=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=this.pixels.pixels[l]?.[p]??0;if(c!==0&&!r.has(c))s.push({x:p,y:l})}return s.length?s:this.fallbackPreviewMask()}fallbackPreviewMask(){let o=[],a=this.pixels.width/2,r=this.pixels.height/2,s=Math.max(4,Math.min(this.pixels.width,this.pixels.height)/2.5);for(let l=0;l<this.pixels.height;l++)for(let p=0;p<this.pixels.width;p++)if((p-a)**2+(l-r)**2<=s**2)o.push({x:p,y:l});return o}applyLocale(){if(N(this.element),this.updateColors(),this.$previewDialog.open)this.renderStrategyPreviewSamples()}colorHex(o){let a=S[o]??"0,0,0",[r=0,s=0,l=0]=a.split(",").map((p)=>Number.parseInt(p,10));return`#${[r,s,l].map((p)=>p.toString(16).padStart(2,"0")).join("")}`}colorKeywords(o){let a=S[o]??"0,0,0",[r=0,s=0,l=0]=a.split(",").map((f)=>Number.parseInt(f,10)),p=Math.max(r,s,l),c=Math.min(r,s,l);if(p-c<15)return["gray","grey","gris","neutral","neutro"];if(r>s+30&&r>l+30)return["red","rojo"];if(s>r+30&&s>l+30)return["green","verde"];if(l>r+30&&l>s+30)return["blue","azul"];if(r>170&&s>120&&l<130)return["orange","naranja"];if(r>170&&s>110&&l>140)return["pink","rosa"];if(r>120&&s<100&&l>120)return["purple","violet","morado"];if(r>130&&s>130&&l<90)return["yellow","amarillo"];return["brown","cafe","marron"]}colorFamily(o){let[a=0,r=0,s=0]=(S[o]??"0,0,0").split(",").map((l)=>Number.parseInt(l,10));if(a>r+35&&a>s+35)return"red";if(r>a+25&&r>s+20)return a>90?"olive":"green";if(s>a+25&&s>r+25)return"blue";if(a>120&&s>120)return"wine";return"neutral"}replacementCandidates(o){let a=this.colorFamily(o);return Array.from({length:S.length-1},(r,s)=>s+1).filter((r)=>!this.bot.unavailableColors.has(r)&&this.colorFamily(r)===a)}updateColors(){this.$colorsDialogList.innerHTML="";let o=this.pixels.pixels.length*this.pixels.pixels[0].length;this.$colorsDialogList.setAttribute("aria-label",w("colorPanelResults"));let a=this.$colorSearch.value.trim().toLowerCase();if(this.colors.length!==this.pixels.colors.size||this.colors.some((r)=>!this.pixels.colors.has(r.realColor))){let r=new Map(this.colors.map((s)=>[s.realColor,s]));this.colors=this.pixels.colors.values().toArray().sort((s,l)=>l.amount-s.amount).map((s)=>({realColor:s.realColor,disabled:r.get(s.realColor)?.disabled,replacementColor:r.get(s.realColor)?.replacementColor})),e(this.bot)}for(let r=0;r<this.colors.length;r++){let s=this.colors[r],l=this.pixels.colors.get(s.realColor),p=!1,c=l.realColor!==l.color;if(this.skipUnavailableColors&&c)s.disabled=!0;let g=l.amount/o*100,f=this.colorHex(l.realColor),n=this.colorKeywords(l.realColor),u=()=>{s.disabled=s.disabled?void 0:!0,i.classList.toggle("disabled",Boolean(s.disabled));let d=i.querySelector(".state");if(d)d.textContent=s.disabled?w("disabled"):w("enabled");e(this.bot)},i=document.createElement("button");i.className=`color-chip ${s.disabled?"disabled":""}`,i.draggable=!0,i.setAttribute("aria-label",`${w("overlayColors")} #${r+1}: ${f.toUpperCase()}`);let t=s.replacementColor??l.color,m=`#${t} ${this.colorHex(t).toUpperCase()}`;if(i.innerHTML=`<span class="order-index">#${r+1}</span>
<span class="drag" title="${w("up")} / ${w("down")}">⋮⋮</span>
<span class="swatch"></span>
<span class="meta">
  <span class="coverage">${g.toFixed(1)}%</span>
  <span class="hex">${f.toUpperCase()}</span>
  <span class="state">${s.disabled?w("disabled"):w("enabled")}</span>
  <span class="replacement">${w("replaceWith")}: ${m}</span>
</span>
<span class="premium ${c?"on":""}">${c?w("premium"):""}</span>`,i.querySelector(".swatch").style.setProperty("--swatch-color",uo(l.realColor)),i.addEventListener("click",()=>{if(p){p=!1;return}u(),this.updateTasks()}),i.addEventListener("dragstart",(d)=>{p=!0,i.classList.add("dragging"),d.dataTransfer?.setData("text/plain",String(r)),d.dataTransfer.effectAllowed="move"}),i.addEventListener("dragend",()=>{i.classList.remove("dragging")}),i.addEventListener("dragover",(d)=>{d.preventDefault(),i.classList.add("drag-target")}),i.addEventListener("dragleave",()=>{i.classList.remove("drag-target")}),i.addEventListener("drop",(d)=>{d.preventDefault(),i.classList.remove("drag-target");let z=Number.parseInt(d.dataTransfer?.getData("text/plain")??"-1",10);if(z<0||z===r||z>=this.colors.length)return;this.colors.splice(r,0,...this.colors.splice(z,1)),e(this.bot),this.updateColors()}),c||this.smartReplaceMode){let d=document.createElement("select");d.className="replacement-select";let z=this.smartReplaceMode?this.replacementCandidates(l.realColor):Array.from({length:S.length-1},(A,h)=>h+1);for(let A of z){if(this.bot.unavailableColors.has(A))continue;let h=document.createElement("option");if(h.value=String(A),h.textContent=`#${A} ${this.colorHex(A).toUpperCase()}`,A===t)h.selected=!0;d.append(h)}d.addEventListener("click",(A)=>{A.stopPropagation()}),d.addEventListener("change",()=>{s.replacementColor=d.valueAsNumber||Number.parseInt(d.value,10),this.updateTasks(),this.updateColors(),e(this.bot)}),i.append(d)}if(c||this.smartReplaceMode){let d=document.createElement("button");d.textContent=w("buy"),d.className="buy-chip",d.addEventListener("click",(z)=>{z.stopPropagation(),document.getElementById("color-"+l.realColor)?.click()}),i.append(d)}let b=`${f} ${n.join(" ")} ${l.realColor} ${S[l.realColor]}`;if(!a||b.toLowerCase().includes(a))this.$colorsDialogList.append(i)}}*strategyPositionIterator(){let o=this.pixels.pixels[0].length,a=this.pixels.pixels.length;switch(this.strategy){case"DOWN":{for(let r=0;r<a;r++)for(let s=0;s<o;s++)yield{x:s,y:r};break}case"UP":{for(let r=a-1;r>=0;r--)for(let s=0;s<o;s++)yield{x:s,y:r};break}case"LEFT":{for(let r=0;r<o;r++)for(let s=0;s<a;s++)yield{x:r,y:s};break}case"RIGHT":{for(let r=o-1;r>=0;r--)for(let s=0;s<a;s++)yield{x:r,y:s};break}case"RANDOM":{let r=[];for(let s=0;s<a;s++)for(let l=0;l<o;l++)r.push({x:l,y:s});for(let s=r.length-1;s>=0;s--){let l=Math.floor(Math.random()*(s+1)),p=r[s];r[s]=r[l],r[l]=p}yield*r;break}case"ZIGZAG":{for(let r=0;r<a;r++)if(r%2===0)for(let s=0;s<o;s++)yield{x:s,y:r};else for(let s=o-1;s>=0;s--)yield{x:s,y:r};break}case"HUMANIZED":{let r=Math.max(4,Math.floor(Math.min(o,a)/10)),s=[];for(let l=0;l<a;l+=r)for(let p=0;p<o;p+=r)s.push({x:p,y:l});for(let l=s.length-1;l>=0;l--){let p=Math.floor(Math.random()*(l+1)),c=s[l];s[l]=s[p],s[p]=c}for(let l=0;l<s.length;l++){let p=s[l],c=Math.min(a,p.y+r),g=Math.min(o,p.x+r);for(let f=p.y;f<c;f++)if(Math.random()>0.35)for(let u=p.x;u<g;u++)yield{x:u,y:f};else for(let u=g-1;u>=p.x;u--)yield{x:u,y:f}}break}case"HUMAN_SOFT_DITHER":{let r=new Set;for(let s=0;s<a;s++){let l=Math.floor(Math.random()*3)-1;if((s+l)%2===0)for(let c=0;c<o;c+=2)r.add(`${c},${s}`),yield{x:c,y:s};else for(let c=1;c<o;c+=2)r.add(`${c},${s}`),yield{x:c,y:s}}for(let s=0;s<a;s++)for(let l=0;l<o;l++){let p=`${l},${s}`;if(r.has(p))continue;yield{x:l,y:s}}break}case"HUMAN_PATCHY":{let r=new Set,s=o*a;while(r.size<s){let l=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*5);for(let g=p-c;g<=p+c;g++)for(let f=l-c;f<=l+c;f++){if(f<0||f>=o||g<0||g>=a)continue;if(Math.hypot(f-l,g-p)>c+Math.random()*1.2)continue;let n=`${f},${g}`;if(r.has(n))continue;r.add(n),yield{x:f,y:g}}}break}case"HUMAN_SWEEP_ARCS":{let r=new Set,s=(o-1)/2,l=(a-1)/2,p=Math.hypot(s,l);for(let c=0;c<4;c++){let g=Math.random()*Math.PI*2;for(let f=0;f<=p;f+=0.35){let n=Math.PI/2+Math.random()*(Math.PI/1.5),u=Math.max(10,Math.floor(f*8));for(let i=0;i<u;i++){let t=g+n*i/u+Math.sin(f)*0.08,m=Math.round(s+Math.cos(t)*f),b=Math.round(l+Math.sin(t)*f);if(m<0||m>=o||b<0||b>=a)continue;let d=`${m},${b}`;if(r.has(d))continue;r.add(d),yield{x:m,y:b}}}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"HUMAN_MICRO_CORRECTIONS":{let r=new Set;for(let s=0;s<a;s++){let l=s%2===0?1:-1,p=l>0?0:o-1;for(let c=0;c<o;c++){let g=p+(Math.random()>0.82?l:0),f=s+(Math.random()>0.9?1:0);for(let n of[{x:p,y:s},{x:g,y:s},{x:p,y:f}]){if(n.x<0||n.x>=o||n.y<0||n.y>=a)continue;let u=`${n.x},${n.y}`;if(r.has(u))continue;r.add(u),yield n}p+=l}}for(let s=0;s<a;s++)for(let l=0;l<o;l++){let p=`${l},${s}`;if(r.has(p))continue;yield{x:l,y:s}}break}case"HUMAN_JITTER_FILL":{let r=[];for(let s=0;s<a;s++)for(let l=0;l<o;l++)r.push({x:l,y:s});r.sort((s,l)=>{let p=s.y+(Math.random()-0.5)*1.8,c=l.y+(Math.random()-0.5)*1.8;if(p!==c)return p-c;return s.x+(Math.random()-0.5)*2-(l.x+(Math.random()-0.5)*2)}),yield*r;break}case"HUMAN_CORNER_BIAS":{let r=[{x:0,y:0},{x:o-1,y:0},{x:0,y:a-1},{x:o-1,y:a-1}],s=r[Math.floor(Math.random()*r.length)],l=[];for(let p=0;p<a;p++)for(let c=0;c<o;c++){let f=Math.hypot(c-s.x,p-s.y)+Math.random()*3.5;l.push({point:{x:c,y:p},score:f})}l.sort((p,c)=>p.score-c.score);for(let p of l)yield p.point;break}case"HUMAN_LONG_STROKES":{let r=new Set,s=o*a;while(r.size<s){let l=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=Math.random()*Math.PI*2,g=Math.sign(Math.cos(c)),f=Math.sign(Math.sin(c)),n=10+Math.floor(Math.random()*40);for(let u=0;u<n;u++){if(l<0||l>=o||p<0||p>=a)break;let i=`${l},${p}`;if(!r.has(i))r.add(i),yield{x:l,y:p};if(Math.random()>0.78)l+=f,p+=g;else l+=g,p+=f}}break}case"HUMAN_TAP_CLUSTERS":{let r=new Set,s=o*a;while(r.size<s){let l=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=3+Math.floor(Math.random()*10);for(let g=0;g<c;g++){let f=Math.round(l+(Math.random()-0.5)*6),n=Math.round(p+(Math.random()-0.5)*6);if(f<0||f>=o||n<0||n>=a)continue;let u=`${f},${n}`;if(r.has(u))continue;r.add(u),yield{x:f,y:n}}}break}case"HUMAN_MESSY_SPIRAL":{let r=new Set,s=(o-1)/2,l=(a-1)/2,p=Math.hypot(s,l)+2;for(let c=0;r.size<o*a;c++){let g=c/3,f=Math.min(p,g*0.18),n=g*0.29+Math.sin(g*0.13)*0.8,u=Math.round(s+Math.cos(n)*f+Math.sin(g)*0.7),i=Math.round(l+Math.sin(n)*f+Math.cos(g)*0.7);if(u<0||u>=o||i<0||i>=a){if(c>o*a*18)break;continue}let t=`${u},${i}`;if(r.has(t)){if(Math.random()>0.9)continue}else r.add(t),yield{x:u,y:i};if(c>o*a*18)break}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"HUMAN_DRUNK_WALK":{let r=new Set,s=Math.floor(Math.random()*o),l=Math.floor(Math.random()*a),p=[{x:-1,y:0},{x:1,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:-1},{x:1,y:-1},{x:-1,y:1},{x:1,y:1}];while(r.size<o*a){let c=`${s},${l}`;if(!r.has(c))r.add(c),yield{x:s,y:l};let g=[];for(let u of p){let i=s+u.x,t=l+u.y;if(i<0||i>=o||t<0||t>=a)continue;g.push({x:i,y:t})}if(!g.length)break;let f=g.filter((u)=>{return!r.has(`${u.x},${u.y}`)});if(f.length&&Math.random()>0.2){let u=f[Math.floor(Math.random()*f.length)];s=u.x,l=u.y;continue}let n=g[Math.floor(Math.random()*g.length)];s=n.x,l=n.y}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"HUMAN_NOISE_CLOUD":{let r=[];for(let s=0;s<a;s++)for(let l=0;l<o;l++){let p=Math.sin((l+1)*0.93+Math.random()*0.8)+Math.cos((s+1)*1.17+Math.random()*0.8),c=(Math.random()-0.5)*2.6,g=Math.hypot(l-o/2,s-a/2)*0.08;r.push({point:{x:l,y:s},score:p+c+g})}r.sort((s,l)=>s.score-l.score);for(let s of r)yield s.point;break}case"HUMAN_PATCH_JUMP":{let r=new Set,s=[];for(let l=0;l<Math.max(6,o*a/18);l++)s.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});while(r.size<o*a){let l=s[Math.floor(Math.random()*s.length)],p=1+Math.floor(Math.random()*3),c=1+Math.floor(Math.random()*3);for(let g=l.y-c;g<=l.y+c;g++)for(let f=l.x-p;f<=l.x+p;f++){if(f<0||f>=o||g<0||g>=a)continue;if(Math.random()>0.86)continue;let n=`${f},${g}`;if(r.has(n))continue;r.add(n),yield{x:f,y:g}}if(Math.random()>0.72&&s.length<o*a/2)s.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});if(r.size>o*a*0.92)break}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=`${p},${l}`;if(r.has(c))continue;yield{x:p,y:l}}break}case"HUMAN_HESITANT_LINES":{let r=new Set;for(let s=0;s<a;s++){let l=s%2===0;for(let p=0;p<o;p++){let c=l?p:o-1-p,g=`${c},${s}`;if(!r.has(g))r.add(g),yield{x:c,y:s};if(Math.random()>0.7){let f=Math.max(0,Math.min(o-1,c+(Math.random()>0.5?1:-1))),n=Math.max(0,Math.min(a-1,s+(Math.random()>0.65?1:0))),u=`${f},${n}`;if(!r.has(u))r.add(u),yield{x:f,y:n}}}}for(let s=0;s<a;s++)for(let l=0;l<o;l++){let p=`${l},${s}`;if(r.has(p))continue;yield{x:l,y:s}}break}case"HUMAN_OVERLAP_SWEEPS":{let r=[],s=Math.random()*Math.PI*2;for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=Math.sin((p+l)*0.42+s)*2.2,g=Math.cos((p-l)*0.3+s)*1.4;r.push({point:{x:p,y:l},score:l+c+g+(Math.random()-0.5)*3.4})}r.sort((l,p)=>l.score-p.score);for(let l of r)yield l.point;break}case"HUMAN_WOBBLE_DRIFT":{let r=[],s=o/2,l=a/2;for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=Math.hypot(c-s,p-l)*0.25,f=Math.sin((c+1)*0.9)*1.8+Math.cos((p+1)*1.1)*1.8+Math.sin((c+p)*0.35)*1.4;r.push({point:{x:c,y:p},score:g+f+(Math.random()-0.5)*2.8})}r.sort((p,c)=>p.score-c.score);for(let p of r)yield p.point;break}case"HUMAN_GAP_RECOVERY":{let r=new Set,s=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++){if(Math.random()>0.87){s.push({x:p,y:l});continue}r.add(`${p},${l}`),yield{x:p,y:l}}s.sort((l,p)=>Math.hypot(l.x-o/2,l.y-a/2)-Math.hypot(p.x-o/2,p.y-a/2));for(let l of s){let p=`${l.x},${l.y}`;if(r.has(p))continue;r.add(p),yield l}break}case"HUMAN_STAIRCASE":{let r=new Set,s=o+a-1;for(let l=0;l<s;l++){let p=Math.max(0,l-o+1),c=Math.min(a-1,l);for(let g=p;g<=c;g++){let f=l-g,n=[{x:f,y:g},{x:f+(Math.random()>0.5?1:-1),y:g},{x:f,y:g+(Math.random()>0.5?1:-1)}];for(let u of n){if(u.x<0||u.x>=o||u.y<0||u.y>=a)continue;let i=`${u.x},${u.y}`;if(r.has(i))continue;r.add(i),yield u}}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=`${p},${l}`;if(r.has(c))continue;yield{x:p,y:l}}break}case"HUMAN_EDGE_HUGGER":{let r=[];for(let s=0;s<a;s++)for(let l=0;l<o;l++){let p=Math.min(l,s,o-1-l,a-1-s);r.push({point:{x:l,y:s},score:p*3.5+(Math.random()-0.5)*5.5})}r.sort((s,l)=>s.score-l.score);for(let s of r)yield s.point;break}case"HUMAN_BLOBS":{let r=new Set,s=o*a;while(r.size<s){let l=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*4);for(let g=p-c;g<=p+c;g++)for(let f=l-c;f<=l+c;f++){if(f<0||f>=o||g<0||g>=a)continue;let n=Math.atan2(g-p,f-l),u=c+Math.sin(n*3+Math.random())*0.8;if(Math.hypot(f-l,g-p)>u)continue;let i=`${f},${g}`;if(r.has(i))continue;r.add(i),yield{x:f,y:g}}}break}case"HUMAN_BACKTRACK":{let r=new Set,s=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++)s.push({x:p,y:l});s.sort((l,p)=>l.y-p.y+(Math.random()-0.5)*2.2+(l.x-p.x)*0.04);for(let l=0;l<s.length;l++){let p=s[l],c=`${p.x},${p.y}`;if(r.has(c))continue;if(r.add(c),yield p,l>1&&Math.random()>0.74){let g=s[l-1],f=`${g.x},${g.y}`;if(!r.has(f))r.add(f),yield g}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=`${p},${l}`;if(r.has(c))continue;yield{x:p,y:l}}break}case"HUMAN_SHAKY_DIAGONAL":{let r=[];for(let s=0;s<a;s++)for(let l=0;l<o;l++){let p=Math.abs(l-s)*0.6,c=Math.sin(l*1.4+s*0.8)*1.8+Math.cos(s*1.1+l*0.5)*1.5;r.push({point:{x:l,y:s},score:p+c+(Math.random()-0.5)*3.2})}r.sort((s,l)=>s.score-l.score);for(let s of r)yield s.point;break}case"HUMAN_LATE_FIXES":{let r=[],s=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++)if(Math.random()>0.9)s.push({x:p,y:l});else r.push({x:p,y:l});r.sort((l,p)=>l.y-p.y+(Math.random()-0.5)*1.5+(Math.random()>0.85?l.x-p.x:0)),s.sort((l,p)=>Math.hypot(p.x-o/2,p.y-a/2)-Math.hypot(l.x-o/2,l.y-a/2)),yield*r,yield*s;break}case"DIAGONAL_BRUSH":{for(let r=0;r<o+a-1;r++){let s=r%2===0,l=[],p=Math.max(0,r-o+1),c=Math.min(a-1,r);for(let g=p;g<=c;g++){let f=r-g;if(f>=0&&f<o)l.push({x:f,y:g})}if(Math.random()>0.55)l.reverse();if(s)for(let g=l.length-1;g>=0;g--)yield l[g];else yield*l}break}case"BRUSH_STROKES":{let r=Array.from({length:a},()=>Array(o).fill(!1)),s=[{x:1,y:0},{x:-1,y:0},{x:0,y:1},{x:0,y:-1},{x:1,y:1},{x:1,y:-1},{x:-1,y:1},{x:-1,y:-1}],l=(g,f)=>g>=0&&g<o&&f>=0&&f<a,p=0,c=o*a;for(let g=0;g<c*6&&p<c;g++){let f=Math.floor(Math.random()*o),n=Math.floor(Math.random()*a),u=s[Math.floor(Math.random()*s.length)],i=3+Math.floor(Math.random()*16);for(let t=0;t<i;t++){if(!l(f,n))break;if(!r[n][f])r[n][f]=!0,p++,yield{x:f,y:n};if(Math.random()>0.72)u=s[Math.floor(Math.random()*s.length)];f+=u.x,n+=u.y}}for(let g=0;g<a;g++)for(let f=0;f<o;f++)if(!r[g][f])yield{x:f,y:g};break}case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let r=new Set,s=o*a,l=Math.floor(o/2),p=Math.floor(a/2),c=[[1,0],[0,1],[-1,0],[0,-1]],g=0,f=1,n=(i,t)=>i>=0&&i<o&&t>=0&&t<a,u=function*(){let i=0;while(i<s){for(let t=0;t<2;t++){for(let m=0;m<f;m++){if(n(l,p)){let b=`${l},${p}`;if(!r.has(b)){if(r.add(b),yield{x:l,y:p},i++,i>=s)return}}l+=c[g][0],p+=c[g][1]}g=(g+1)%4}f++}};if(this.strategy==="SPIRAL_FROM_CENTER")yield*u();else{let i=[...u()];for(let t=i.length-1;t>=0;t--)yield i[t]}break}case"SCRIBBLE":{let r=new Set,s=o*a,l=Math.floor(o/2),p=Math.floor(a/2);for(let c=0;r.size<s&&c<s*24;c++){let g=`${l},${p}`;if(!r.has(g))r.add(g),yield{x:l,y:p};if(l+=Math.floor(Math.random()*3)-1,p+=Math.floor(Math.random()*3)-1,l<0||l>=o||p<0||p>=a)l=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a)}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;r.add(f),yield{x:g,y:c}}break}case"CROSSHATCH":{let r=[];for(let p=0;p<o+a-1;p++)for(let c=Math.max(0,p-o+1);c<=Math.min(a-1,p);c++){let g=p-c;r.push({x:g,y:c})}let s=[];for(let p=-a+1;p<o;p++)for(let c=0;c<a;c++){let g=c+p;if(g>=0&&g<o)s.push({x:g,y:c})}let l=new Set;for(let p of[...r,...s]){let c=`${p.x},${p.y}`;if(l.has(c))continue;l.add(c),yield p}break}case"WAVE_SWEEP":{let r=new Set;for(let s=0;s<o;s++){let p=(Math.sin(s/Math.max(1,o-1)*Math.PI*4)+1)*0.5*(a-1)|0;for(let c=0;c<a;c++){let g=p+c,f=p-c;for(let n of[g,f]){if(n<0||n>=a)continue;let u=`${s},${n}`;if(r.has(u))continue;r.add(u),yield{x:s,y:n}}}}break}case"SCATTERED_LINES":{let r=new Set,s=o*a;for(let l=0;r.size<s&&l<s*14;l++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),g=Math.random()*Math.PI*2,f=Math.round(Math.cos(g)),n=Math.round(Math.sin(g)),u=6+Math.floor(Math.random()*28);for(let i=0;i<u;i++){if(p<0||p>=o||c<0||c>=a)break;let t=`${p},${c}`;if(!r.has(t))r.add(t),yield{x:p,y:c};p+=f,c+=n}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=`${p},${l}`;if(r.has(c))continue;r.add(c),yield{x:p,y:l}}break}case"CONTOUR_JITTER":{let r=new Set;for(let s=0;s<Math.ceil(Math.min(o,a)/2);s++){let l=[],p=s,c=s,g=o-s-1,f=a-s-1;for(let n=p;n<=g;n++)l.push({x:n,y:c});for(let n=c+1;n<=f;n++)l.push({x:g,y:n});for(let n=g-1;n>=p;n--)l.push({x:n,y:f});for(let n=f-1;n>c;n--)l.push({x:p,y:n});for(let n=l.length-1;n>0;n--){let u=Math.floor(Math.random()*(n+1)),i=l[n];l[n]=l[u],l[u]=i}for(let n of l){let u=`${n.x},${n.y}`;if(r.has(u))continue;r.add(u),yield n}}break}case"SPIRAL_WOBBLE":{let r=new Set,s=o/2,l=a/2,p=Math.hypot(s,l);for(let c=0;r.size<o*a&&c<o*a*9;c++){let g=c/(o*a*9)*p,f=c*0.31+Math.sin(c*0.07)*0.7,n=Math.round(s+Math.cos(f)*g),u=Math.round(l+Math.sin(f)*g);if(n<0||n>=o||u<0||u>=a)continue;let i=`${n},${u}`;if(r.has(i))continue;r.add(i),yield{x:n,y:u}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"CLUSTER_BURSTS":{let r=new Set,s=o*a;for(let l=0;r.size<s&&l<s*12;l++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),g=2+Math.floor(Math.random()*10);for(let f=c-g;f<=c+g;f++)for(let n=p-g;n<=p+g;n++){if(n<0||n>=o||f<0||f>=a)continue;if(Math.hypot(n-p,f-c)>g)continue;let u=`${n},${f}`;if(r.has(u))continue;r.add(u),yield{x:n,y:f}}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=`${p},${l}`;if(r.has(c))continue;r.add(c),yield{x:p,y:l}}break}case"ORBITAL":{let r=new Set,s=(o-1)/2,l=(a-1)/2,p=Math.ceil(Math.max(s,l));for(let c=0;c<=p;c++){let g=Math.max(16,Math.ceil(2*Math.PI*Math.max(1,c)*2));for(let f=0;f<g;f++){let n=f/g*Math.PI*2+(c%2?0.3:-0.3),u=Math.round(s+Math.cos(n)*c),i=Math.round(l+Math.sin(n)*c);if(u<0||u>=o||i<0||i>=a)continue;let t=`${u},${i}`;if(r.has(t))continue;r.add(t),yield{x:u,y:i}}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"FLOW_FIELD":{let r=new Set,s=o*a;for(let l=0;r.size<s&&l<s*18;l++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a);for(let g=0;g<120;g++){if(p<0||p>=o||c<0||c>=a)break;let f=`${p},${c}`;if(!r.has(f))r.add(f),yield{x:p,y:c};let n=Math.sin(p*0.09)*1.8+Math.cos(c*0.08)*1.6+Math.sin((p+c)*0.05);p+=Math.round(Math.cos(n)),c+=Math.round(Math.sin(n))}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let c=`${p},${l}`;if(r.has(c))continue;r.add(c),yield{x:p,y:l}}break}case"EDGE_IN":{let r=new Set,s=Math.ceil(Math.min(o,a)/2);for(let l=0;l<s;l++){let p=l,c=o-1-l,g=l,f=a-1-l;for(let n=p;n<=c;n++)for(let u of[g,f]){let i=`${n},${u}`;if(r.has(i))continue;r.add(i),yield{x:n,y:u}}for(let n=g+1;n<=f-1;n++)for(let u of[p,c]){let i=`${u},${n}`;if(r.has(i))continue;r.add(i),yield{x:u,y:n}}}break}}}moveStart(o){if(o.button!==0)return;if(o.preventDefault(),o.stopPropagation(),!this.lock)this.moveInfo={globalX:this.position.globalX,globalY:this.position.globalY,clientX:o.clientX,clientY:o.clientY}}moveStop(){if(this.moveInfo)this.moveInfo=void 0,this.position.updateAnchor(),this.pixels.update(),this.updateColors(),e(this.bot)}move(o){if(!this.moveInfo)return;let a=Math.round((o.clientX-this.moveInfo.clientX)/this.position.pixelSize),r=Math.round((o.clientY-this.moveInfo.clientY)/this.position.pixelSize);if(this.moveInfo.globalX!==void 0){if(this.position.globalX=a+this.moveInfo.globalX,this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,this.moveInfo.width-a)}else if(this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,a+this.moveInfo.width);if(this.moveInfo.globalY!==void 0){if(this.position.globalY=r+this.moveInfo.globalY,this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,this.moveInfo.height-r)}else if(this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,r+this.moveInfo.height);this.update(),e(this.bot)}resizeStart(o){if(this.lock||o.button!==0)return;o.preventDefault(),o.stopPropagation(),this.moveInfo={clientX:o.clientX,clientY:o.clientY};let a=o.target;if(a.classList.contains("n"))this.moveInfo.height=this.pixels.height,this.moveInfo.globalY=this.position.globalY;if(a.classList.contains("e"))this.moveInfo.width=this.pixels.width;if(a.classList.contains("s"))this.moveInfo.height=this.pixels.height;if(a.classList.contains("w"))this.moveInfo.width=this.pixels.width,this.moveInfo.globalX=this.position.globalX}export(){let o=document.createElement("a");document.body.append(o),o.href=URL.createObjectURL(new Blob([JSON.stringify(this.toJSON())],{type:"application/json"})),o.download=`${this.pixels.width}x${this.pixels.height}.${X}`,o.click(),URL.revokeObjectURL(o.href),o.href=this.pixels.canvas.toDataURL("image/webp",1),o.download=`${this.pixels.width}x${this.pixels.height}.webp`,o.click(),URL.revokeObjectURL(o.href),o.remove()}}var Do=`/* stylelint-disable declaration-no-important */
