...
`;class K{bot;image;width;exactColor;static async fromJSON(o,a){let r=new Image;return r.src=a.url.startsWith("http")?await fetch(a.url,{cache:"no-store"}).then((l)=>l.blob()).then((l)=>URL.createObjectURL(l)):a.url,await Q(r,["load"],["error"]),new K(o,r,a.width,a.exactColor)}canvas=document.createElement("canvas");context=this.canvas.getContext("2d");pixels;colors=new Map;resolution;get height(){return this.width/this.resolution|0}set height(o){this.width=o*this.resolution|0}constructor(o,a,r=a.naturalWidth,l=!1){this.bot=o;this.image=a;this.width=r;this.exactColor=l;if(l)this.resolution=1,this.width=1000;else this.resolution=this.image.naturalWidth/this.image.naturalHeight;this.update()}update(){this.canvas.width=this.width,this.canvas.height=this.height,this.colors.clear();let o=new Map;for(let r=1;r<64;r++)o.set(q[r],[r,r]);this.context.imageSmoothingEnabled=!1,this.context.imageSmoothingQuality="low",this.context.drawImage(this.image,0,0,this.canvas.width,this.canvas.height),this.pixels=Array.from({length:this.canvas.height},()=>new Array(this.canvas.width));let a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(let r=0;r<this.canvas.height;r++)for(let l=0;l<this.canvas.width;l++){let s=(r*this.canvas.width+l)*4,i=a[s],p=a[s+1],c=a[s+2],g=a[s+3],n=i,f=p,t=c,u=`${n},${f},${t}`;if(this.exactColor){this.pixels[r][l]=g<100?0:q.indexOf(u);continue}let w,e;if(g<100)w=e=0;else if(o.has(u))[w,e]=o.get(u);else{let m=1/0,h=1/0;for(let b=0;b<L.length;b++){let M=L[b],A=Ho(Ao(n,f,t),M,0);if(A<m)m=A,w=b;if(A<h)h=A,e=b}o.set(u,[w,e])}if(w!==0)this.context.fillStyle=`oklab(${L[w][0]*100}% ${L[w][1]} ${L[w][2]})`,this.context.fillRect(l,r,1,1);this.pixels[r][l]=w;let z=this.colors.get(e);if(z)z.amount++;else this.colors.set(e,{color:e,amount:1,realColor:e})}}toJSON(){let o=document.createElement("canvas");return o.width=this.image.naturalWidth,o.height=this.image.naturalHeight,o.getContext("2d").drawImage(this.image,0,0),{url:o.toDataURL("image/webp",1),width:this.width,exactColor:this.exactColor}}}var B="kglacer-macro-settings",ko=["kglacermacro","wbot"],_="kgm";function sa(){let o=[B,...ko];for(let a=0;a<o.length;a++){let r=o[a],l=localStorage.getItem(r);if(!l)continue;return{json:l,key:r}}return}function No(){let o=sa();if(!o)return;let a;try{if(a=JSON.parse(o.json),typeof a!=="object")throw new Error("NOT VALID SAVE");if(a.version===1){let r=a.widget;if(r)a.images=r.images,a.strategy=r.strategy,delete a.widget}if(o.key!==B)localStorage.setItem(B,o.json)}catch{localStorage.removeItem(o.key),a=void 0}return a}var Fo;function H(o,a=!1){if(clearTimeout(Fo),a)localStorage.setItem(B,JSON.stringify(o));else Fo=setTimeout(()=>{localStorage.setItem(B,JSON.stringify(o))},600)}var P=1000,la=2048,T=P*la,G=[],E=[],ia=Date.now();function v(o){G.push(o),E.push({id:ia++,latitude:(2*Math.atan(Math.exp(-(o.y/T*(2*Math.PI)-Math.PI)))-Math.PI/2)*180/Math.PI,longitude:(o.x/T*(2*Math.PI)-Math.PI)*180/Math.PI,name:"KGLACER_MACRO_FAVORITE"})}v({x:T/3|0,y:T/3|0});v({x:T/3*2|0,y:T/3*2|0});function R(o){let[a,r]=o.style.transform.slice(32,-31).split(", ").map((l)=>Number.parseFloat(l));return{x:a,y:r}}class k{bot;static fromJSON(o,a){return new k(o,...a)}static fromScreenPosition(o,a){let{anchorScreenPosition:r,pixelSize:l,anchorWorldPosition:s}=o.findAnchorsForScreen(a);return new k(o,s.x+(a.x-r.x)/l|0,s.y+(a.y-r.y)/l|0)}globalX=0;globalY=0;get tileX(){return this.globalX/P|0}set tileX(o){this.globalX=o*P+this.x}get tileY(){return this.globalY/P|0}set tileY(o){this.globalY=o*P+this.y}get x(){return this.globalX%P}set x(o){this.globalX=this.tileX*P+o}get y(){return this.globalY%P}set y(o){this.globalY=this.tileY*P+o}anchor1Index;anchor2Index;get pixelSize(){return(R(this.bot.$stars[this.anchor2Index]).x-R(this.bot.$stars[this.anchor1Index]).x)/(G[this.anchor2Index].x-G[this.anchor1Index].x)}constructor(o,a,r,l,s){this.bot=o;if(l===void 0||s===void 0)this.globalX=a,this.globalY=r;else this.globalX=a*P+l,this.globalY=r*P+s;this.updateAnchor()}updateAnchor(){this.anchor1Index=0,this.anchor2Index=1;let o=1/0,a=1/0;for(let r=0;r<G.length;r++){let{x:l,y:s}=G[r];if(l<this.globalX&&s<this.globalY){let i=this.globalX-l+(this.globalY-s);if(i<o)o=i,this.anchor1Index=r}else if(l>this.globalX&&s>this.globalY){let i=l-this.globalX+(s-this.globalY);if(i<a)a=i,this.anchor2Index=r}}}toScreenPosition(){let o=G[this.anchor1Index],a=R(this.bot.$stars[this.anchor1Index]);return{x:(this.globalX-o.x)*this.pixelSize+a.x,y:(this.globalY-o.y)*this.pixelSize+a.y}}getMapColor(){return this.bot.mapsCache.get(this.tileX+"/"+this.tileY).pixels[this.y][this.x]}setMapColor(o){let a=this.bot.mapsCache.get(this.tileX+"/"+this.tileY);if(!a)return;let r=a.pixels[this.y];if(!r)return;r[this.x]=o}scrollScreenTo(){let{x:o,y:a}=this.toScreenPosition();this.bot.moveMap({x:o-window.innerWidth/3,y:a-window.innerHeight/3})}clone(){return new k(this.bot,this.tileX,this.tileY,this.x,this.y)}toJSON(){return[this.globalX,this.globalY]}}function pa(o){let a=[];for(let{x:r,y:l}of o.iterate){let s=o.pixels[l]?.[r]??0;if(o.disabledColors.has(s))continue;let i=o.readMapColor(r,l);if(s!==i&&(o.drawTransparentPixels||s!==0))a.push({x:r,y:l,color:s})}return a}class U extends X{bot;position;pixels;strategy;opacity;drawTransparentPixels;drawColorsInOrder;skipUnavailableColors;colors;lock;static PREVIEW_MASK_BASE_WIDTH=96;static PREVIEW_MASK_BASE_HEIGHT=96;static async fromJSON(o,a){return new U(o,k.fromJSON(o,a.position),await K.fromJSON(o,a.pixels),a.strategy,a.opacity,a.drawTransparentPixels,a.drawColorsInOrder,a.skipUnavailableColors,a.colors,a.lock)}element=document.createElement("div");tasks=[];moveInfo;$canvas;$colorsDialog;$colorsDialogList;$colorSearch;$openColors;$openPreview;$enableAllColors;$disableAllColors;$closeColors;$closePreview;$delete;$drawColorsInOrder;$drawTransparent;$skipUnavailable;$export;$lock;$opacity;$progressLine;$progressText;$previewDialog;$previewDialogList;$resetSize;$resetSizeSpan;$settings;$strategy;$topbar;$wrapper;colorDialogDragState;suppressNextColorDialogBackdropClick=!1;previewCacheSignature;previewSequenceCache=new Map;previewAnimations=new WeakMap;previewAnimationHandles=new Set;constructor(o,a,r,l="SPIRAL_FROM_CENTER",s=50,i=!1,p=!1,c=!0,g=[],n=!1){super();this.bot=o;this.position=a;this.pixels=r;this.strategy=l;this.opacity=s;this.drawTransparentPixels=i;this.drawColorsInOrder=p;this.skipUnavailableColors=c;this.colors=g;this.lock=n;this.element.innerHTML=Po,this.element.classList.add("wimage"),S(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$colorsDialog:".colors-dialog",$colorsDialogList:".colors-dialog-list",$colorSearch:".color-search",$openColors:".open-colors",$openPreview:".open-preview",$enableAllColors:".enable-all-colors",$disableAllColors:".disable-all-colors",$closeColors:".close-colors",$closePreview:".close-preview",$delete:".delete",$drawColorsInOrder:".draw-colors-in-order",$drawTransparent:".draw-transparent",$skipUnavailable:".skip-unavailable",$export:".export",$lock:".lock",$opacity:".opacity",$progressLine:".wprogress div",$progressText:".wprogress span",$previewDialog:".preview-dialog",$previewDialogList:".preview-dialog-list",$resetSize:".reset-size",$settings:".wform",$strategy:".strategy",$topbar:".wtopbar",$wrapper:".wrapper"}),this.$resetSizeSpan=this.$resetSize.querySelector("span"),this.$canvas=this.pixels.canvas,this.$wrapper.prepend(this.pixels.canvas),document.body.append(this.$colorsDialog,this.$previewDialog),this.registerEvent(this.$strategy,"change",()=>{if(this.strategy=this.$strategy.value,this.$previewDialog.open)this.renderStrategyPreviewSamples();H(this.bot)}),this.registerEvent(this.$opacity,"input",()=>{this.opacity=this.$opacity.valueAsNumber,this.$opacity.style.setProperty("--val",this.opacity+"%"),this.update(),H(this.bot)}),this.$opacity.style.setProperty("--val",this.opacity+"%"),this.registerEvent(this.$resetSize,"click",()=>{this.pixels.width=this.pixels.image.naturalWidth,this.pixels.update(),this.updateColors(),this.update(),H(this.bot)}),this.registerEvent(this.$drawTransparent,"click",()=>{this.drawTransparentPixels=this.$drawTransparent.checked,H(this.bot)}),this.registerEvent(this.$skipUnavailable,"click",()=>{this.skipUnavailableColors=this.$skipUnavailable.checked,this.updateTasks(),H(this.bot)}),this.registerEvent(this.$drawColorsInOrder,"click",()=>{this.drawColorsInOrder=this.$drawColorsInOrder.checked,H(this.bot)}),this.registerEvent(this.$lock,"click",()=>{this.lock=!this.lock,this.update(),H(this.bot)}),this.registerEvent(this.$delete,"click",this.destroy.bind(this)),this.registerEvent(this.$openColors,"click",()=>{this.openColorPanel()}),this.registerEvent(this.$openPreview,"click",()=>{this.openPreviewPanel()}),this.registerEvent(this.$closeColors,"click",()=>{this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$closePreview,"click",()=>{this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorsDialog.querySelector(".colors-dialog-head"),"pointerdown",this.startColorDialogDrag.bind(this)),this.registerEvent(document,"pointermove",this.moveColorDialog.bind(this),{passive:!1}),this.registerEvent(document,"pointerup",this.stopColorDialogDrag.bind(this)),this.registerEvent(document,"pointercancel",this.stopColorDialogDrag.bind(this)),this.registerEvent(this.$colorsDialog,"click",(f)=>{if(this.suppressNextColorDialogBackdropClick){this.suppressNextColorDialogBackdropClick=!1;return}if(f.target===this.$colorsDialog)this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$previewDialog,"click",(f)=>{if(f.target===this.$previewDialog)this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorSearch,"input",()=>{this.updateColors()}),this.registerEvent(this.$enableAllColors,"click",()=>{for(let f of this.colors)f.disabled=void 0;this.updateTasks(),this.updateColors(),H(this.bot)}),this.registerEvent(this.$disableAllColors,"click",()=>{for(let f of this.colors)f.disabled=!0;this.updateTasks(),this.updateColors(),H(this.bot)}),this.registerEvent(this.$export,"click",this.export.bind(this)),this.registerEvent(this.$topbar,"mousedown",this.moveStart.bind(this)),this.registerEvent(this.$canvas,"mousedown",this.moveStart.bind(this)),this.registerEvent(document,"mouseup",this.moveStop.bind(this)),this.registerEvent(document,"mousemove",this.move.bind(this));for(let f of this.element.querySelectorAll(".resize"))this.registerEvent(f,"mousedown",this.resizeStart.bind(this));this.update(),this.updateColors()}toJSON(){return{pixels:this.pixels.toJSON(),position:this.position.toJSON(),strategy:this.strategy,opacity:this.opacity,drawTransparentPixels:this.drawTransparentPixels,drawColorsInOrder:this.drawColorsInOrder,skipUnavailableColors:this.skipUnavailableColors,colors:this.colors,lock:this.lock}}updateTasks(){this.tasks.length=0;let o=this.position.clone(),a=new Set,r=new Map;for(let s=0;s<this.colors.length;s++){let i=this.colors[s];if(i.disabled)a.add(i.realColor);r.set(i.realColor,s)}let l=pa({pixels:this.pixels.pixels,drawTransparentPixels:this.drawTransparentPixels,disabledColors:a,iterate:this.strategyPositionIterator(),readMapColor:(s,i)=>{return o.globalX=this.position.globalX+s,o.globalY=this.position.globalY+i,o.getMapColor()}});for(let s=0;s<l.length;s++){let i=l[s];o.globalX=this.position.globalX+i.x,o.globalY=this.position.globalY+i.y,this.tasks.push({position:o.clone(),color:i.color})}if(this.drawColorsInOrder)this.tasks.sort((s,i)=>(r.get(s.color)??0)-(r.get(i.color)??0));this.update(),this.bot.widget.update()}update(){let{x:o,y:a}=this.position.toScreenPosition(),r=this.position.pixelSize*this.pixels.width,l=this.position.pixelSize*this.pixels.height;this.element.style.transform=`translate3d(${o.toFixed(3)}px, ${a.toFixed(3)}px, 0)`,this.element.style.width=`${r}px`,this.element.style.height=`${l}px`,this.$canvas.style.opacity=`${this.opacity}%`,this.element.classList.remove("hidden"),this.$resetSizeSpan.textContent=this.pixels.width.toString(),this.$strategy.value=this.strategy,this.$opacity.valueAsNumber=this.opacity,this.$drawTransparent.checked=this.drawTransparentPixels,this.$drawColorsInOrder.checked=this.drawColorsInOrder,this.$skipUnavailable.checked=this.skipUnavailableColors;let s=this.pixels.pixels.length*this.pixels.pixels[0].length,i=Math.max(0,s-this.tasks.length),p=s>0?i/s*100|0:0;this.$progressText.textContent=`${i}/${s} ${p}% ETA: ${this.tasks.length/120|0}h`,this.$progressLine.style.transform=`scaleX(${p/100})`,this.$canvas.classList[this.lock?"add":"remove"]("no-pointer-events");for(let c of this.element.querySelectorAll(".resize"))c.classList[this.lock?"add":"remove"]("no-pointer-events");this.$lock.classList[this.lock?"add":"remove"]("locked")}exportImage(){this.export()}destroy(){super.destroy(),this.element.remove(),this.$colorsDialog.remove(),this.$previewDialog.remove(),po(this.bot.images,this),this.bot.widget.update(),H(this.bot)}openColorPanel(){if(this.$colorsDialog.open){this.$colorSearch.focus();return}this.$colorsDialog.style.position="fixed",this.$colorsDialog.style.left="",this.$colorsDialog.style.top="",this.$colorsDialog.style.margin="auto",this.$colorsDialog.showModal(),this.$colorSearch.focus()}openPreviewPanel(){if(this.$previewDialog.open){this.renderStrategyPreviewSamples();return}this.$previewDialog.style.position="fixed",this.$previewDialog.style.left="",this.$previewDialog.style.top="",this.$previewDialog.style.margin="auto",this.$previewDialog.showModal(),this.renderStrategyPreviewSamples()}closeDialog(o){if(!o.open)return;if(o===this.$previewDialog)this.stopPreviewAnimations();if(typeof o.requestClose==="function")o.requestClose();else o.close()}stopPreviewAnimations(){for(let o of this.previewAnimationHandles)cancelAnimationFrame(o);this.previewAnimationHandles.clear()}startColorDialogDrag(o){if(o.button!==0)return;if(o.target?.closest("button,input,select,textarea,a,label"))return;let r=this.$colorsDialog.getBoundingClientRect();this.colorDialogDragState={pointerId:o.pointerId,offsetX:o.clientX-r.left,offsetY:o.clientY-r.top,moved:!1},o.preventDefault()}moveColorDialog(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;let a=this.$colorsDialog.getBoundingClientRect(),r=Math.max(8,window.innerWidth-a.width-8),l=Math.max(8,window.innerHeight-a.height-8),s=Math.min(r,Math.max(8,o.clientX-this.colorDialogDragState.offsetX)),i=Math.min(l,Math.max(8,o.clientY-this.colorDialogDragState.offsetY));if(!this.colorDialogDragState.moved&&(Math.abs(o.movementX)>0||Math.abs(o.movementY)>0))this.colorDialogDragState.moved=!0;this.$colorsDialog.style.left=`${Math.round(s)}px`,this.$colorsDialog.style.top=`${Math.round(i)}px`,o.preventDefault()}stopColorDialogDrag(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;if(this.colorDialogDragState.moved)this.suppressNextColorDialogBackdropClick=!0;this.colorDialogDragState=void 0}renderStrategyPreviewSamples(){this.stopPreviewAnimations(),this.invalidatePreviewCacheIfNeeded();let o=this.$strategy.value;this.$previewDialogList.innerHTML="";let a=document.createDocumentFragment(),r=document.createElement("article");r.className="preview-card";let l=document.createElement("strong");l.textContent=this.getStrategyLabel(o);let s=document.createElement("canvas");s.className="preview-canvas",s.width=156,s.height=156,this.paintStrategyPreview(s,o),r.append(l,s),a.append(r),this.$previewDialogList.append(a)}invalidatePreviewCacheIfNeeded(){let o=this.colors.map((r,l)=>`${l}:${r.realColor}:${r.disabled?1:0}`).join("|"),a=`${this.pixels.width}x${this.pixels.height}:${this.pixels.image.src.length}:${this.drawColorsInOrder?1:0}:${o}`;if(this.previewCacheSignature===a)return;this.previewCacheSignature=a,this.previewSequenceCache.clear()}getStrategyLabel(o){switch(o){case"RANDOM":return d("random");case"HUMANIZED":return d("humanized");case"HUMAN_SOFT_DITHER":return d("humanSoftDither");case"HUMAN_PATCHY":return d("humanPatchy");case"HUMAN_SWEEP_ARCS":return d("humanSweepArcs");case"HUMAN_MICRO_CORRECTIONS":return d("humanMicroCorrections");case"HUMAN_JITTER_FILL":return d("humanJitterFill");case"HUMAN_CORNER_BIAS":return d("humanCornerBias");case"HUMAN_LONG_STROKES":return d("humanLongStrokes");case"HUMAN_TAP_CLUSTERS":return d("humanTapClusters");case"HUMAN_MESSY_SPIRAL":return d("humanMessySpiral");case"HUMAN_DRUNK_WALK":return d("humanDrunkWalk");case"HUMAN_NOISE_CLOUD":return d("humanNoiseCloud");case"HUMAN_PATCH_JUMP":return d("humanPatchJump");case"HUMAN_HESITANT_LINES":return d("humanHesitantLines");case"HUMAN_OVERLAP_SWEEPS":return d("humanOverlapSweeps");case"HUMAN_WOBBLE_DRIFT":return d("humanWobbleDrift");case"HUMAN_GAP_RECOVERY":return d("humanGapRecovery");case"HUMAN_STAIRCASE":return d("humanStaircase");case"HUMAN_EDGE_HUGGER":return d("humanEdgeHugger");case"HUMAN_BLOBS":return d("humanBlobs");case"HUMAN_BACKTRACK":return d("humanBacktrack");case"HUMAN_SHAKY_DIAGONAL":return d("humanShakyDiagonal");case"HUMAN_LATE_FIXES":return d("humanLateFixes");case"ZIGZAG":return d("zigzag");case"BRUSH_STROKES":return d("brushStrokes");case"DIAGONAL_BRUSH":return d("diagonalBrush");case"DOWN":return d("down");case"UP":return d("up");case"LEFT":return d("left");case"RIGHT":return d("right");case"SPIRAL_FROM_CENTER":return d("spiralOut");case"SPIRAL_TO_CENTER":return d("spiralIn");case"SCRIBBLE":return d("scribble");case"CROSSHATCH":return d("crosshatch");case"WAVE_SWEEP":return d("waveSweep");case"SCATTERED_LINES":return d("scatteredLines");case"CONTOUR_JITTER":return d("contourJitter");case"SPIRAL_WOBBLE":return d("spiralWobble");case"CLUSTER_BURSTS":return d("clusterBursts");case"ORBITAL":return d("orbital");case"FLOW_FIELD":return d("flowField");case"EDGE_IN":return d("edgeIn");default:return o}}paintStrategyPreview(o,a){let r=o.getContext("2d");if(!r)return;r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);let l=this.getSampledImagePreviewData(),s=this.getCachedPreviewSequence(a,l.mask,l.width,l.height),i=Math.min(o.width/l.width,o.height/l.height),p=(o.width-l.width*i)/2,c=(o.height-l.height*i)/2,g=this.previewAnimations.get(o);if(g)cancelAnimationFrame(g),this.previewAnimationHandles.delete(g);let n=(m)=>{let h=requestAnimationFrame((b)=>{this.previewAnimationHandles.delete(h),m(b)});return this.previewAnimationHandles.add(h),h},f=(m)=>{r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);for(let h=0;h<Math.min(m,s.length);h++){let b=s[h],M=l.colors.get(`${b.x}:${b.y}`)??0;if(!M)continue;r.fillStyle=fo(M),r.fillRect(p+b.x*i,c+b.y*i,Math.max(1,i),Math.max(1,i))}},t=Math.min(3400,Math.max(900,s.length*8)),w=t+220,e=(m,h)=>{if(!this.$previewDialog.open)return;let b=(h-m)%w,M=Math.min(1,b/t),A=M*M*(3-2*M);f(Math.floor(s.length*A));let J=n((W)=>{e(m,W)});this.previewAnimations.set(o,J)},z=performance.now();e(z,z)}getCachedPreviewSequence(o,a,r=this.pixels.width,l=this.pixels.height){let s=this.colors.map((g,n)=>`${n}:${g.realColor}:${g.disabled?1:0}`).join("|"),i=`${o}:${r}x${l}:${a.length}:${this.drawColorsInOrder?1:0}:${s}`,p=this.previewSequenceCache.get(i);if(p)return p;let c=r===this.pixels.width&&l===this.pixels.height?this.getExactPreviewSequence(o,a):this.getApproxPreviewSequence(o,a,r);if(this.drawColorsInOrder){let g=new Map;for(let n=0;n<this.colors.length;n++)g.set(this.colors[n].realColor,n);c.sort((n,f)=>(g.get(this.pixels.pixels[n.y]?.[n.x]??0)??0)-(g.get(this.pixels.pixels[f.y]?.[f.x]??0)??0))}return this.previewSequenceCache.set(i,c),c}getExactPreviewSequence(o,a){let r=this.strategy;this.strategy=o;let l=[...this.strategyPositionIterator()];this.strategy=r;let s=new Set(a.map(({x:i,y:p})=>`${i}:${p}`));return l.filter(({x:i,y:p})=>s.has(`${i}:${p}`))}getApproxPreviewSequence(o,a,r){let l=[...a],s=(c,g,n)=>{return(c*73856093+g*19349663+n*83492791>>>0)/4294967296},i=(c,g)=>l.sort((n,f)=>n.x*c+n.y*g-(f.x*c+f.y*g)||n.y-f.y||n.x-f.x),p=l.sort((c,g)=>{if(c.y!==g.y)return c.y-g.y;let n=c.y%2===0?c.x:r-c.x,f=g.y%2===0?g.x:r-g.x;return n-f});switch(o){case"UP":return i(0,-1);case"LEFT":return i(-1,0);case"RIGHT":return i(1,0);case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let c=r/2,g=Math.max(1,Math.round(l.reduce((n,f)=>n+f.y,0)/Math.max(1,l.length)));return l.sort((n,f)=>{let t=(n.x-c)**2+(n.y-g)**2,u=(f.x-c)**2+(f.y-g)**2;return o==="SPIRAL_FROM_CENTER"?t-u:u-t}),l}case"RANDOM":case"HUMANIZED":case"HUMAN_SOFT_DITHER":case"HUMAN_PATCHY":case"HUMAN_SWEEP_ARCS":case"HUMAN_MICRO_CORRECTIONS":case"HUMAN_JITTER_FILL":case"HUMAN_CORNER_BIAS":case"HUMAN_LONG_STROKES":case"HUMAN_TAP_CLUSTERS":case"HUMAN_MESSY_SPIRAL":case"HUMAN_DRUNK_WALK":case"HUMAN_NOISE_CLOUD":case"HUMAN_PATCH_JUMP":case"HUMAN_HESITANT_LINES":case"HUMAN_OVERLAP_SWEEPS":case"HUMAN_WOBBLE_DRIFT":case"HUMAN_GAP_RECOVERY":case"HUMAN_STAIRCASE":case"HUMAN_EDGE_HUGGER":case"HUMAN_BLOBS":case"HUMAN_BACKTRACK":case"HUMAN_SHAKY_DIAGONAL":case"HUMAN_LATE_FIXES":return l.sort((c,g)=>s(c.x,c.y,o.length)-s(g.x,g.y,o.length));default:return p}}getSampledImagePreviewData(){let o=this.pixels.width,a=this.pixels.height,r=U.PREVIEW_MASK_BASE_WIDTH,l=U.PREVIEW_MASK_BASE_HEIGHT,s=Math.min(1,r/Math.max(1,o),l/Math.max(1,a)),i=Math.max(1,Math.round(o*s)),p=Math.max(1,Math.round(a*s)),c=new Set;for(let t=0;t<this.colors.length;t++){let u=this.colors[t];if(u.disabled)c.add(u.realColor)}let g=new Map,n=new Map;for(let t=0;t<a;t++)for(let u=0;u<o;u++){let w=this.pixels.pixels[t]?.[u]??0;if(!w||c.has(w))continue;let e=Math.min(i-1,Math.floor(u/o*i)),z=Math.min(p-1,Math.floor(t/a*p)),m=`${e}:${z}`;if(!g.has(m))g.set(m,{x:e,y:z});if(!n.has(m))n.set(m,w)}let f=[...g.values()];if(!f.length){let t=this.fallbackPreviewMask();return{width:o,height:a,mask:t,colors:new Map(t.map((u)=>[`${u.x}:${u.y}`,this.pixels.pixels[u.y]?.[u.x]??0]))}}return{width:i,height:p,mask:f,colors:n}}getImagePreviewMask(){let o=this.pixels.width,a=this.pixels.height,r=new Set;for(let s=0;s<this.colors.length;s++){let i=this.colors[s];if(i.disabled)r.add(i.realColor)}let l=[];for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=this.pixels.pixels[s]?.[i]??0;if(p!==0&&!r.has(p))l.push({x:i,y:s})}return l.length?l:this.fallbackPreviewMask()}fallbackPreviewMask(){let o=[],a=this.pixels.width/2,r=this.pixels.height/2,l=Math.max(4,Math.min(this.pixels.width,this.pixels.height)/2.5);for(let s=0;s<this.pixels.height;s++)for(let i=0;i<this.pixels.width;i++)if((i-a)**2+(s-r)**2<=l**2)o.push({x:i,y:s});return o}applyLocale(){if(S(this.element),this.updateColors(),this.$previewDialog.open)this.renderStrategyPreviewSamples()}colorHex(o){let a=q[o]??"0,0,0",[r=0,l=0,s=0]=a.split(",").map((i)=>Number.parseInt(i,10));return`#${[r,l,s].map((i)=>i.toString(16).padStart(2,"0")).join("")}`}colorKeywords(o){let a=q[o]??"0,0,0",[r=0,l=0,s=0]=a.split(",").map((g)=>Number.parseInt(g,10)),i=Math.max(r,l,s),p=Math.min(r,l,s);if(i-p<15)return["gray","grey","gris","neutral","neutro"];if(r>l+30&&r>s+30)return["red","rojo"];if(l>r+30&&l>s+30)return["green","verde"];if(s>r+30&&s>l+30)return["blue","azul"];if(r>170&&l>120&&s<130)return["orange","naranja"];if(r>170&&l>110&&s>140)return["pink","rosa"];if(r>120&&l<100&&s>120)return["purple","violet","morado"];if(r>130&&l>130&&s<90)return["yellow","amarillo"];return["brown","cafe","marron"]}updateColors(){this.$colorsDialogList.innerHTML="";let o=this.pixels.pixels.length*this.pixels.pixels[0].length;this.$colorsDialogList.setAttribute("aria-label",d("colorPanelResults"));let a=this.$colorSearch.value.trim().toLowerCase();if(this.colors.length!==this.pixels.colors.size||this.colors.some((r)=>!this.pixels.colors.has(r.realColor))){let r=new Map(this.colors.map((l)=>[l.realColor,l]));this.colors=this.pixels.colors.values().toArray().sort((l,s)=>s.amount-l.amount).map((l)=>({realColor:l.realColor,disabled:r.get(l.realColor)?.disabled})),H(this.bot)}for(let r=0;r<this.colors.length;r++){let l=this.colors[r],s=this.pixels.colors.get(l.realColor),i=!1,p=s.amount/o*100,c=this.colorHex(s.realColor),g=this.colorKeywords(s.realColor),n=()=>{l.disabled=l.disabled?void 0:!0,f.classList.toggle("disabled",Boolean(l.disabled));let w=f.querySelector(".state");if(w)w.textContent=l.disabled?d("disabled"):d("enabled");H(this.bot)},f=document.createElement("button");f.className=`color-chip ${l.disabled?"disabled":""}`,f.draggable=!0,f.setAttribute("aria-label",`${d("overlayColors")} #${r+1}: ${c.toUpperCase()}`),f.innerHTML=`<span class="order-index">#${r+1}</span>
<span class="drag" title="${d("up")} / ${d("down")}">⋮⋮</span>
<span class="swatch"></span>
<span class="meta">
  <span class="coverage">${p.toFixed(1)}%</span>
  <span class="hex">${c.toUpperCase()}</span>
  <span class="state">${l.disabled?d("disabled"):d("enabled")}</span>
</span>
<span class="premium"></span>`,f.querySelector(".swatch").style.setProperty("--swatch-color",fo(s.realColor)),f.addEventListener("click",()=>{if(i){i=!1;return}n(),this.updateTasks()}),f.addEventListener("dragstart",(w)=>{i=!0,f.classList.add("dragging"),w.dataTransfer?.setData("text/plain",String(r)),w.dataTransfer.effectAllowed="move"}),f.addEventListener("dragend",()=>{f.classList.remove("dragging")}),f.addEventListener("dragover",(w)=>{w.preventDefault(),f.classList.add("drag-target")}),f.addEventListener("dragleave",()=>{f.classList.remove("drag-target")}),f.addEventListener("drop",(w)=>{w.preventDefault(),f.classList.remove("drag-target");let e=Number.parseInt(w.dataTransfer?.getData("text/plain")??"-1",10);if(e<0||e===r||e>=this.colors.length)return;this.colors.splice(r,0,...this.colors.splice(e,1)),H(this.bot),this.updateColors()});let t=document.createElement("button");t.textContent=d("buy"),t.className="buy-chip",t.addEventListener("click",(w)=>{w.stopPropagation(),document.getElementById("color-"+s.realColor)?.click()}),f.append(t);let u=`${c} ${g.join(" ")} ${s.realColor} ${q[s.realColor]}`;if(!a||u.toLowerCase().includes(a))this.$colorsDialogList.append(f)}}*strategyPositionIterator(){let o=this.pixels.pixels[0].length,a=this.pixels.pixels.length;switch(this.strategy){case"DOWN":{for(let r=0;r<a;r++)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"UP":{for(let r=a-1;r>=0;r--)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"LEFT":{for(let r=0;r<o;r++)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RIGHT":{for(let r=o-1;r>=0;r--)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RANDOM":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++)r.push({x:s,y:l});for(let l=r.length-1;l>=0;l--){let s=Math.floor(Math.random()*(l+1)),i=r[l];r[l]=r[s],r[s]=i}yield*r;break}case"ZIGZAG":{for(let r=0;r<a;r++)if(r%2===0)for(let l=0;l<o;l++)yield{x:l,y:r};else for(let l=o-1;l>=0;l--)yield{x:l,y:r};break}case"HUMANIZED":{let r=Math.max(4,Math.floor(Math.min(o,a)/10)),l=[];for(let s=0;s<a;s+=r)for(let i=0;i<o;i+=r)l.push({x:i,y:s});for(let s=l.length-1;s>=0;s--){let i=Math.floor(Math.random()*(s+1)),p=l[s];l[s]=l[i],l[i]=p}for(let s=0;s<l.length;s++){let i=l[s],p=Math.min(a,i.y+r),c=Math.min(o,i.x+r);for(let g=i.y;g<p;g++)if(Math.random()>0.35)for(let f=i.x;f<c;f++)yield{x:f,y:g};else for(let f=c-1;f>=i.x;f--)yield{x:f,y:g}}break}case"HUMAN_SOFT_DITHER":{let r=new Set;for(let l=0;l<a;l++){let s=Math.floor(Math.random()*3)-1;if((l+s)%2===0)for(let p=0;p<o;p+=2)r.add(`${p},${l}`),yield{x:p,y:l};else for(let p=1;p<o;p+=2)r.add(`${p},${l}`),yield{x:p,y:l}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let i=`${s},${l}`;if(r.has(i))continue;yield{x:s,y:l}}break}case"HUMAN_PATCHY":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),i=Math.floor(Math.random()*a),p=1+Math.floor(Math.random()*5);for(let c=i-p;c<=i+p;c++)for(let g=s-p;g<=s+p;g++){if(g<0||g>=o||c<0||c>=a)continue;if(Math.hypot(g-s,c-i)>p+Math.random()*1.2)continue;let n=`${g},${c}`;if(r.has(n))continue;r.add(n),yield{x:g,y:c}}}break}case"HUMAN_SWEEP_ARCS":{let r=new Set,l=(o-1)/2,s=(a-1)/2,i=Math.hypot(l,s);for(let p=0;p<4;p++){let c=Math.random()*Math.PI*2;for(let g=0;g<=i;g+=0.35){let n=Math.PI/2+Math.random()*(Math.PI/1.5),f=Math.max(10,Math.floor(g*8));for(let t=0;t<f;t++){let u=c+n*t/f+Math.sin(g)*0.08,w=Math.round(l+Math.cos(u)*g),e=Math.round(s+Math.sin(u)*g);if(w<0||w>=o||e<0||e>=a)continue;let z=`${w},${e}`;if(r.has(z))continue;r.add(z),yield{x:w,y:e}}}}for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=`${c},${p}`;if(r.has(g))continue;yield{x:c,y:p}}break}case"HUMAN_MICRO_CORRECTIONS":{let r=new Set;for(let l=0;l<a;l++){let s=l%2===0?1:-1,i=s>0?0:o-1;for(let p=0;p<o;p++){let c=i+(Math.random()>0.82?s:0),g=l+(Math.random()>0.9?1:0);for(let n of[{x:i,y:l},{x:c,y:l},{x:i,y:g}]){if(n.x<0||n.x>=o||n.y<0||n.y>=a)continue;let f=`${n.x},${n.y}`;if(r.has(f))continue;r.add(f),yield n}i+=s}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let i=`${s},${l}`;if(r.has(i))continue;yield{x:s,y:l}}break}case"HUMAN_JITTER_FILL":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++)r.push({x:s,y:l});r.sort((l,s)=>{let i=l.y+(Math.random()-0.5)*1.8,p=s.y+(Math.random()-0.5)*1.8;if(i!==p)return i-p;return l.x+(Math.random()-0.5)*2-(s.x+(Math.random()-0.5)*2)}),yield*r;break}case"HUMAN_CORNER_BIAS":{let r=[{x:0,y:0},{x:o-1,y:0},{x:0,y:a-1},{x:o-1,y:a-1}],l=r[Math.floor(Math.random()*r.length)],s=[];for(let i=0;i<a;i++)for(let p=0;p<o;p++){let g=Math.hypot(p-l.x,i-l.y)+Math.random()*3.5;s.push({point:{x:p,y:i},score:g})}s.sort((i,p)=>i.score-p.score);for(let i of s)yield i.point;break}case"HUMAN_LONG_STROKES":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),i=Math.floor(Math.random()*a),p=Math.random()*Math.PI*2,c=Math.sign(Math.cos(p)),g=Math.sign(Math.sin(p)),n=10+Math.floor(Math.random()*40);for(let f=0;f<n;f++){if(s<0||s>=o||i<0||i>=a)break;let t=`${s},${i}`;if(!r.has(t))r.add(t),yield{x:s,y:i};if(Math.random()>0.78)s+=g,i+=c;else s+=c,i+=g}}break}case"HUMAN_TAP_CLUSTERS":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),i=Math.floor(Math.random()*a),p=3+Math.floor(Math.random()*10);for(let c=0;c<p;c++){let g=Math.round(s+(Math.random()-0.5)*6),n=Math.round(i+(Math.random()-0.5)*6);if(g<0||g>=o||n<0||n>=a)continue;let f=`${g},${n}`;if(r.has(f))continue;r.add(f),yield{x:g,y:n}}}break}case"HUMAN_MESSY_SPIRAL":{let r=new Set,l=(o-1)/2,s=(a-1)/2,i=Math.hypot(l,s)+2;for(let p=0;r.size<o*a;p++){let c=p/3,g=Math.min(i,c*0.18),n=c*0.29+Math.sin(c*0.13)*0.8,f=Math.round(l+Math.cos(n)*g+Math.sin(c)*0.7),t=Math.round(s+Math.sin(n)*g+Math.cos(c)*0.7);if(f<0||f>=o||t<0||t>=a){if(p>o*a*18)break;continue}let u=`${f},${t}`;if(r.has(u)){if(Math.random()>0.9)continue}else r.add(u),yield{x:f,y:t};if(p>o*a*18)break}for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=`${c},${p}`;if(r.has(g))continue;yield{x:c,y:p}}break}case"HUMAN_DRUNK_WALK":{let r=new Set,l=Math.floor(Math.random()*o),s=Math.floor(Math.random()*a),i=[{x:-1,y:0},{x:1,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:-1},{x:1,y:-1},{x:-1,y:1},{x:1,y:1}];while(r.size<o*a){let p=`${l},${s}`;if(!r.has(p))r.add(p),yield{x:l,y:s};let c=[];for(let f of i){let t=l+f.x,u=s+f.y;if(t<0||t>=o||u<0||u>=a)continue;c.push({x:t,y:u})}if(!c.length)break;let g=c.filter((f)=>{return!r.has(`${f.x},${f.y}`)});if(g.length&&Math.random()>0.2){let f=g[Math.floor(Math.random()*g.length)];l=f.x,s=f.y;continue}let n=c[Math.floor(Math.random()*c.length)];l=n.x,s=n.y}for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=`${c},${p}`;if(r.has(g))continue;yield{x:c,y:p}}break}case"HUMAN_NOISE_CLOUD":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let i=Math.sin((s+1)*0.93+Math.random()*0.8)+Math.cos((l+1)*1.17+Math.random()*0.8),p=(Math.random()-0.5)*2.6,c=Math.hypot(s-o/2,l-a/2)*0.08;r.push({point:{x:s,y:l},score:i+p+c})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_PATCH_JUMP":{let r=new Set,l=[];for(let s=0;s<Math.max(6,o*a/18);s++)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});while(r.size<o*a){let s=l[Math.floor(Math.random()*l.length)],i=1+Math.floor(Math.random()*3),p=1+Math.floor(Math.random()*3);for(let c=s.y-p;c<=s.y+p;c++)for(let g=s.x-i;g<=s.x+i;g++){if(g<0||g>=o||c<0||c>=a)continue;if(Math.random()>0.86)continue;let n=`${g},${c}`;if(r.has(n))continue;r.add(n),yield{x:g,y:c}}if(Math.random()>0.72&&l.length<o*a/2)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});if(r.size>o*a*0.92)break}for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=`${i},${s}`;if(r.has(p))continue;yield{x:i,y:s}}break}case"HUMAN_HESITANT_LINES":{let r=new Set;for(let l=0;l<a;l++){let s=l%2===0;for(let i=0;i<o;i++){let p=s?i:o-1-i,c=`${p},${l}`;if(!r.has(c))r.add(c),yield{x:p,y:l};if(Math.random()>0.7){let g=Math.max(0,Math.min(o-1,p+(Math.random()>0.5?1:-1))),n=Math.max(0,Math.min(a-1,l+(Math.random()>0.65?1:0))),f=`${g},${n}`;if(!r.has(f))r.add(f),yield{x:g,y:n}}}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let i=`${s},${l}`;if(r.has(i))continue;yield{x:s,y:l}}break}case"HUMAN_OVERLAP_SWEEPS":{let r=[],l=Math.random()*Math.PI*2;for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=Math.sin((i+s)*0.42+l)*2.2,c=Math.cos((i-s)*0.3+l)*1.4;r.push({point:{x:i,y:s},score:s+p+c+(Math.random()-0.5)*3.4})}r.sort((s,i)=>s.score-i.score);for(let s of r)yield s.point;break}case"HUMAN_WOBBLE_DRIFT":{let r=[],l=o/2,s=a/2;for(let i=0;i<a;i++)for(let p=0;p<o;p++){let c=Math.hypot(p-l,i-s)*0.25,g=Math.sin((p+1)*0.9)*1.8+Math.cos((i+1)*1.1)*1.8+Math.sin((p+i)*0.35)*1.4;r.push({point:{x:p,y:i},score:c+g+(Math.random()-0.5)*2.8})}r.sort((i,p)=>i.score-p.score);for(let i of r)yield i.point;break}case"HUMAN_GAP_RECOVERY":{let r=new Set,l=[];for(let s=0;s<a;s++)for(let i=0;i<o;i++){if(Math.random()>0.87){l.push({x:i,y:s});continue}r.add(`${i},${s}`),yield{x:i,y:s}}l.sort((s,i)=>Math.hypot(s.x-o/2,s.y-a/2)-Math.hypot(i.x-o/2,i.y-a/2));for(let s of l){let i=`${s.x},${s.y}`;if(r.has(i))continue;r.add(i),yield s}break}case"HUMAN_STAIRCASE":{let r=new Set,l=o+a-1;for(let s=0;s<l;s++){let i=Math.max(0,s-o+1),p=Math.min(a-1,s);for(let c=i;c<=p;c++){let g=s-c,n=[{x:g,y:c},{x:g+(Math.random()>0.5?1:-1),y:c},{x:g,y:c+(Math.random()>0.5?1:-1)}];for(let f of n){if(f.x<0||f.x>=o||f.y<0||f.y>=a)continue;let t=`${f.x},${f.y}`;if(r.has(t))continue;r.add(t),yield f}}}for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=`${i},${s}`;if(r.has(p))continue;yield{x:i,y:s}}break}case"HUMAN_EDGE_HUGGER":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let i=Math.min(s,l,o-1-s,a-1-l);r.push({point:{x:s,y:l},score:i*3.5+(Math.random()-0.5)*5.5})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_BLOBS":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),i=Math.floor(Math.random()*a),p=1+Math.floor(Math.random()*4);for(let c=i-p;c<=i+p;c++)for(let g=s-p;g<=s+p;g++){if(g<0||g>=o||c<0||c>=a)continue;let n=Math.atan2(c-i,g-s),f=p+Math.sin(n*3+Math.random())*0.8;if(Math.hypot(g-s,c-i)>f)continue;let t=`${g},${c}`;if(r.has(t))continue;r.add(t),yield{x:g,y:c}}}break}case"HUMAN_BACKTRACK":{let r=new Set,l=[];for(let s=0;s<a;s++)for(let i=0;i<o;i++)l.push({x:i,y:s});l.sort((s,i)=>s.y-i.y+(Math.random()-0.5)*2.2+(s.x-i.x)*0.04);for(let s=0;s<l.length;s++){let i=l[s],p=`${i.x},${i.y}`;if(r.has(p))continue;if(r.add(p),yield i,s>1&&Math.random()>0.74){let c=l[s-1],g=`${c.x},${c.y}`;if(!r.has(g))r.add(g),yield c}}for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=`${i},${s}`;if(r.has(p))continue;yield{x:i,y:s}}break}case"HUMAN_SHAKY_DIAGONAL":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let i=Math.abs(s-l)*0.6,p=Math.sin(s*1.4+l*0.8)*1.8+Math.cos(l*1.1+s*0.5)*1.5;r.push({point:{x:s,y:l},score:i+p+(Math.random()-0.5)*3.2})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_LATE_FIXES":{let r=[],l=[];for(let s=0;s<a;s++)for(let i=0;i<o;i++)if(Math.random()>0.9)l.push({x:i,y:s});else r.push({x:i,y:s});r.sort((s,i)=>s.y-i.y+(Math.random()-0.5)*1.5+(Math.random()>0.85?s.x-i.x:0)),l.sort((s,i)=>Math.hypot(i.x-o/2,i.y-a/2)-Math.hypot(s.x-o/2,s.y-a/2)),yield*r,yield*l;break}case"DIAGONAL_BRUSH":{for(let r=0;r<o+a-1;r++){let l=r%2===0,s=[],i=Math.max(0,r-o+1),p=Math.min(a-1,r);for(let c=i;c<=p;c++){let g=r-c;if(g>=0&&g<o)s.push({x:g,y:c})}if(Math.random()>0.55)s.reverse();if(l)for(let c=s.length-1;c>=0;c--)yield s[c];else yield*s}break}case"BRUSH_STROKES":{let r=Array.from({length:a},()=>Array(o).fill(!1)),l=[{x:1,y:0},{x:-1,y:0},{x:0,y:1},{x:0,y:-1},{x:1,y:1},{x:1,y:-1},{x:-1,y:1},{x:-1,y:-1}],s=(c,g)=>c>=0&&c<o&&g>=0&&g<a,i=0,p=o*a;for(let c=0;c<p*6&&i<p;c++){let g=Math.floor(Math.random()*o),n=Math.floor(Math.random()*a),f=l[Math.floor(Math.random()*l.length)],t=3+Math.floor(Math.random()*16);for(let u=0;u<t;u++){if(!s(g,n))break;if(!r[n][g])r[n][g]=!0,i++,yield{x:g,y:n};if(Math.random()>0.72)f=l[Math.floor(Math.random()*l.length)];g+=f.x,n+=f.y}}for(let c=0;c<a;c++)for(let g=0;g<o;g++)if(!r[c][g])yield{x:g,y:c};break}case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let r=new Set,l=o*a,s=Math.floor(o/2),i=Math.floor(a/2),p=[[1,0],[0,1],[-1,0],[0,-1]],c=0,g=1,n=(t,u)=>t>=0&&t<o&&u>=0&&u<a,f=function*(){let t=0;while(t<l){for(let u=0;u<2;u++){for(let w=0;w<g;w++){if(n(s,i)){let e=`${s},${i}`;if(!r.has(e)){if(r.add(e),yield{x:s,y:i},t++,t>=l)return}}s+=p[c][0],i+=p[c][1]}c=(c+1)%4}g++}};if(this.strategy==="SPIRAL_FROM_CENTER")yield*f();else{let t=[...f()];for(let u=t.length-1;u>=0;u--)yield t[u]}break}case"SCRIBBLE":{let r=new Set,l=o*a,s=Math.floor(o/2),i=Math.floor(a/2);for(let p=0;r.size<l&&p<l*24;p++){let c=`${s},${i}`;if(!r.has(c))r.add(c),yield{x:s,y:i};if(s+=Math.floor(Math.random()*3)-1,i+=Math.floor(Math.random()*3)-1,s<0||s>=o||i<0||i>=a)s=Math.floor(Math.random()*o),i=Math.floor(Math.random()*a)}for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=`${c},${p}`;if(r.has(g))continue;r.add(g),yield{x:c,y:p}}break}case"CROSSHATCH":{let r=[];for(let i=0;i<o+a-1;i++)for(let p=Math.max(0,i-o+1);p<=Math.min(a-1,i);p++){let c=i-p;r.push({x:c,y:p})}let l=[];for(let i=-a+1;i<o;i++)for(let p=0;p<a;p++){let c=p+i;if(c>=0&&c<o)l.push({x:c,y:p})}let s=new Set;for(let i of[...r,...l]){let p=`${i.x},${i.y}`;if(s.has(p))continue;s.add(p),yield i}break}case"WAVE_SWEEP":{let r=new Set;for(let l=0;l<o;l++){let i=(Math.sin(l/Math.max(1,o-1)*Math.PI*4)+1)*0.5*(a-1)|0;for(let p=0;p<a;p++){let c=i+p,g=i-p;for(let n of[c,g]){if(n<0||n>=a)continue;let f=`${l},${n}`;if(r.has(f))continue;r.add(f),yield{x:l,y:n}}}}break}case"SCATTERED_LINES":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*14;s++){let i=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=Math.random()*Math.PI*2,g=Math.round(Math.cos(c)),n=Math.round(Math.sin(c)),f=6+Math.floor(Math.random()*28);for(let t=0;t<f;t++){if(i<0||i>=o||p<0||p>=a)break;let u=`${i},${p}`;if(!r.has(u))r.add(u),yield{x:i,y:p};i+=g,p+=n}}for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=`${i},${s}`;if(r.has(p))continue;r.add(p),yield{x:i,y:s}}break}case"CONTOUR_JITTER":{let r=new Set;for(let l=0;l<Math.ceil(Math.min(o,a)/2);l++){let s=[],i=l,p=l,c=o-l-1,g=a-l-1;for(let n=i;n<=c;n++)s.push({x:n,y:p});for(let n=p+1;n<=g;n++)s.push({x:c,y:n});for(let n=c-1;n>=i;n--)s.push({x:n,y:g});for(let n=g-1;n>p;n--)s.push({x:i,y:n});for(let n=s.length-1;n>0;n--){let f=Math.floor(Math.random()*(n+1)),t=s[n];s[n]=s[f],s[f]=t}for(let n of s){let f=`${n.x},${n.y}`;if(r.has(f))continue;r.add(f),yield n}}break}case"SPIRAL_WOBBLE":{let r=new Set,l=o/2,s=a/2,i=Math.hypot(l,s);for(let p=0;r.size<o*a&&p<o*a*9;p++){let c=p/(o*a*9)*i,g=p*0.31+Math.sin(p*0.07)*0.7,n=Math.round(l+Math.cos(g)*c),f=Math.round(s+Math.sin(g)*c);if(n<0||n>=o||f<0||f>=a)continue;let t=`${n},${f}`;if(r.has(t))continue;r.add(t),yield{x:n,y:f}}for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=`${c},${p}`;if(r.has(g))continue;yield{x:c,y:p}}break}case"CLUSTER_BURSTS":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*12;s++){let i=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=2+Math.floor(Math.random()*10);for(let g=p-c;g<=p+c;g++)for(let n=i-c;n<=i+c;n++){if(n<0||n>=o||g<0||g>=a)continue;if(Math.hypot(n-i,g-p)>c)continue;let f=`${n},${g}`;if(r.has(f))continue;r.add(f),yield{x:n,y:g}}}for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=`${i},${s}`;if(r.has(p))continue;r.add(p),yield{x:i,y:s}}break}case"ORBITAL":{let r=new Set,l=(o-1)/2,s=(a-1)/2,i=Math.ceil(Math.max(l,s));for(let p=0;p<=i;p++){let c=Math.max(16,Math.ceil(2*Math.PI*Math.max(1,p)*2));for(let g=0;g<c;g++){let n=g/c*Math.PI*2+(p%2?0.3:-0.3),f=Math.round(l+Math.cos(n)*p),t=Math.round(s+Math.sin(n)*p);if(f<0||f>=o||t<0||t>=a)continue;let u=`${f},${t}`;if(r.has(u))continue;r.add(u),yield{x:f,y:t}}}for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=`${c},${p}`;if(r.has(g))continue;yield{x:c,y:p}}break}case"FLOW_FIELD":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*18;s++){let i=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a);for(let c=0;c<120;c++){if(i<0||i>=o||p<0||p>=a)break;let g=`${i},${p}`;if(!r.has(g))r.add(g),yield{x:i,y:p};let n=Math.sin(i*0.09)*1.8+Math.cos(p*0.08)*1.6+Math.sin((i+p)*0.05);i+=Math.round(Math.cos(n)),p+=Math.round(Math.sin(n))}}for(let s=0;s<a;s++)for(let i=0;i<o;i++){let p=`${i},${s}`;if(r.has(p))continue;r.add(p),yield{x:i,y:s}}break}case"EDGE_IN":{let r=new Set,l=Math.ceil(Math.min(o,a)/2);for(let s=0;s<l;s++){let i=s,p=o-1-s,c=s,g=a-1-s;for(let n=i;n<=p;n++)for(let f of[c,g]){let t=`${n},${f}`;if(r.has(t))continue;r.add(t),yield{x:n,y:f}}for(let n=c+1;n<=g-1;n++)for(let f of[i,p]){let t=`${f},${n}`;if(r.has(t))continue;r.add(t),yield{x:f,y:n}}}break}}}moveStart(o){if(o.button!==0)return;if(o.preventDefault(),o.stopPropagation(),!this.lock)this.moveInfo={globalX:this.position.globalX,globalY:this.position.globalY,clientX:o.clientX,clientY:o.clientY}}moveStop(){if(this.moveInfo)this.moveInfo=void 0,this.position.updateAnchor(),this.pixels.update(),this.updateColors(),H(this.bot)}move(o){if(!this.moveInfo)return;let a=Math.round((o.clientX-this.moveInfo.clientX)/this.position.pixelSize),r=Math.round((o.clientY-this.moveInfo.clientY)/this.position.pixelSize);if(this.moveInfo.globalX!==void 0){if(this.position.globalX=a+this.moveInfo.globalX,this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,this.moveInfo.width-a)}else if(this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,a+this.moveInfo.width);if(this.moveInfo.globalY!==void 0){if(this.position.globalY=r+this.moveInfo.globalY,this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,this.moveInfo.height-r)}else if(this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,r+this.moveInfo.height);this.update(),H(this.bot)}resizeStart(o){if(this.lock||o.button!==0)return;o.preventDefault(),o.stopPropagation(),this.moveInfo={clientX:o.clientX,clientY:o.clientY};let a=o.target;if(a.classList.contains("n"))this.moveInfo.height=this.pixels.height,this.moveInfo.globalY=this.position.globalY;if(a.classList.contains("e"))this.moveInfo.width=this.pixels.width;if(a.classList.contains("s"))this.moveInfo.height=this.pixels.height;if(a.classList.contains("w"))this.moveInfo.width=this.pixels.width,this.moveInfo.globalX=this.position.globalX}export(){let o=document.createElement("a");document.body.append(o),o.href=URL.createObjectURL(new Blob([JSON.stringify(this.toJSON())],{type:"application/json"})),o.download=`${this.pixels.width}x${this.pixels.height}.${_}`,o.click(),URL.revokeObjectURL(o.href),o.href=this.pixels.canvas.toDataURL("image/webp",1),o.download=`${this.pixels.width}x${this.pixels.height}.webp`,o.click(),URL.revokeObjectURL(o.href),o.remove()}}function to(){let o=localStorage.getItem("kglacer-macro:shield-config");if(!o)return!1;try{return JSON.parse(o).enabled!==!1}catch{return!1}}function So(o){localStorage.setItem("kglacer-macro:shield-config",JSON.stringify({enabled:o}))}function ca(o){let a=`${o?.host??""} ${o?.username??""}`.toLowerCase(),r=/(mx|mex|mexico)/.test(a)?"MX":"AUTO";localStorage.setItem("__afm_proxy_hint",r)}function Do(o){if(!to())return;if(document.getElementById("kgm-shield-full"))return;ca(o);let a=document.createElement("script");a.id="kgm-shield-full",a.textContent=`// ==UserScript==
...
`;var Qo="kglacer-macro:overlay-hidden",Ko="kglacer-macro:auto-farm-config",Go="kglacer-macro:auto-overlay-config",qo="kglacer-macro:proxy-config",Wo="__afm_proxy_hint",fa=["https://api.ipify.org?format=json","https://icanhazip.com"],da="https://raw.githubusercontent.com/robgallardof/kglacer-macro/refs/heads/main/src/img/logo.svg";class wo extends X{bot;element=document.createElement("div");get status(){return this.$status.innerHTML}set status(o){this.$status.innerHTML=o}get open(){return this.element.classList.contains("wopen")}set open(o){if(o)this.element.classList.add("wopen");else this.element.classList.remove("wopen")}$settings;$status;$openConfig;$topbar;$draw;$drawAndPaint;$addImage;$captureTemplate;$toggleOverlay;$autofarmConfig;$autofarmStart;$autofarmStop;$autofarmStatus;$autoOverlayConfig;$autoOverlayStart;$autoOverlayStop;$autoOverlayStatus;$strategy;$progressLine;$progressText;$images;$wopenButton;$widgetLogo;activeImageIndex=-1;autoFarmIntervalId;autoFarmConfig;autoFarmTickRunning=!1;autoFarmNextTickAt;autoOverlayIntervalId;autoOverlayConfig;autoOverlayTickRunning=!1;autoOverlayNextTickAt;statusRefreshIntervalId;challengeWatcherObserver;challengeWatcherRunning=!1;constructor(o){super();this.bot=o;this.element.classList.add("wwidget"),this.element.innerHTML=jo,S(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$wopenButton:".wopen-button",$widgetLogo:".widget-logo",$settings:".wform",$status:".wstatus",$openConfig:".open-config",$topbar:".wtopbar",$draw:".draw",$drawAndPaint:".draw-and-paint",$addImage:".add-image",$captureTemplate:".capture-template",$toggleOverlay:".toggle-overlay",$autofarmConfig:".autofarm-config",$autofarmStart:".autofarm-start",$autofarmStop:".autofarm-stop",$autofarmStatus:".autofarm-status",$autoOverlayConfig:".autooverlay-config",$autoOverlayStart:".autooverlay-start",$autoOverlayStop:".autooverlay-stop",$autoOverlayStatus:".autooverlay-status",$strategy:".strategy",$progressLine:".wprogress div",$progressText:".wprogress span",$images:".images"}),this.$widgetLogo.src=da,this.$wopenButton.addEventListener("click",()=>this.open=!this.open),this.$draw.addEventListener("click",()=>this.bot.draw()),this.$drawAndPaint.addEventListener("click",()=>{this.drawAndClickPaintWhenReady()}),this.$addImage.addEventListener("click",()=>this.addImage()),this.$openConfig.addEventListener("click",()=>{this.openSettingsModal()}),this.$captureTemplate.addEventListener("click",()=>{this.captureTemplate()}),this.$toggleOverlay.addEventListener("click",()=>{this.toggleOverlay()}),this.$autofarmConfig.addEventListener("click",()=>{this.openAutoFarmModal()}),this.$autofarmStart.addEventListener("click",()=>{this.startAutoFarm()}),this.$autofarmStop.addEventListener("click",()=>{this.stopAutoFarm()}),this.$autoOverlayConfig.addEventListener("click",()=>{this.openAutoOverlayModal()}),this.$autoOverlayStart.addEventListener("click",()=>{this.startAutoOverlay()}),this.$autoOverlayStop.addEventListener("click",()=>{this.stopAutoOverlay()}),this.$strategy.addEventListener("change",()=>{this.bot.strategy=this.$strategy.value}),this.registerEvent(document,"keydown",this.handleKeyboard.bind(this),{passive:!1}),this.update(),this.syncOverlayVisibilityFromStorage(),this.loadAutoFarmConfigFromStorage(),this.loadAutoOverlayConfigFromStorage(),this.refreshAutoFarmStatusText(),this.refreshAutoOverlayStatusText(),this.statusRefreshIntervalId=window.setInterval(()=>{this.refreshAutoFarmStatusText(),this.refreshAutoOverlayStatusText(),this.refreshProgress()},1000),this.open=!0,console.log("[KGM][Widget] Widget mounted and opened")}startChallengeWatcher(){let o=()=>{if(!this.isChallengeBlockingPaint())return;if(this.challengeWatcherRunning)return;this.challengeWatcherRunning=!0,this.status=`⌛ ${d("taskWaitingChallengeResolve")}`,this.waitForChallengeToResolve().finally(()=>{this.challengeWatcherRunning=!1})};this.challengeWatcherObserver=new MutationObserver(()=>{o()}),this.challengeWatcherObserver.observe(document.documentElement,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["open","style","class","value","aria-hidden"]});let a=window.setInterval(o,750);this.runOnDestroy.push(()=>{this.challengeWatcherObserver?.disconnect(),clearInterval(a)}),o()}addImage(){return console.log("[KGM][Widget] Add image flow started"),this.setDisabled("add-image",!0),this.run(d("taskAddingImage"),async()=>{await this.bot.updateColors();let o=document.createElement("input");o.type="file",o.accept=`image/*,.${_},.wplace`,o.click(),await Q(o,["change"],["cancel","error"]);let a=o.files?.[0];if(!a)throw new uo(this.bot);console.log("[KGM][Widget] File selected",{name:a.name,size:a.size,type:a.type});let r;if(a.name.endsWith(`.${_}`))r=await U.fromJSON(this.bot,JSON.parse(await a.text()));else if(a.name.endsWith(".wplace")){let l=JSON.parse(await a.text());if(!l.image?.dataUrl)throw new Error("Invalid .wplace file: image.dataUrl missing");let s=new Image;if(s.src=l.image.dataUrl,await Q(s,["load"],["error"]),await this.waitForStableViewportProjection(),r=new U(this.bot,k.fromScreenPosition(this.bot,this.defaultImageScreenPosition()),new K(this.bot,s)),typeof l.opacity==="number")r.opacity=Math.max(0,Math.min(1,l.opacity))}else{let l=new FileReader;l.readAsDataURL(a),await Q(l,["load"],["error"]);let s=await this.compressImageBeforeLoad(l.result),i=new Image;i.src=s,await Q(i,["load"],["error"]),await this.waitForStableViewportProjection(),r=new U(this.bot,k.fromScreenPosition(this.bot,this.defaultImageScreenPosition()),new K(this.bot,i))}this.bot.images.push(r),console.log("[KGM][Widget] Image instance added",{images:this.bot.images.length}),await this.bot.readMap(),r.updateTasks(),H(this.bot,!0),this.bot.updateTasks(),this.update(),window.setTimeout(()=>{globalThis.location.reload()},120)},()=>{this.setDisabled("add-image",!1)})}captureTemplate(){return this.setDisabled("capture-template",!0),this.run(d("taskCapturingMapImage"),async()=>{let o=await this.resolveCaptureBounds(),{minGlobalX:a,minGlobalY:r,maxGlobalX:l,maxGlobalY:s}=o,i=document.createElement("canvas");i.width=Math.max(1,l-a+1),i.height=Math.max(1,s-r+1);let p=i.getContext("2d");if(!p)throw new Error("Capture context unavailable");p.imageSmoothingEnabled=!1;let c=Math.floor(a/P),g=Math.floor(r/P),n=Math.floor(l/P),f=Math.floor(s/P),t=(n-c+1)*(f-g+1),u=0;for(let e=c;e<=n;e++)for(let z=g;z<=f;z++){this.status=`⌛ ${d("taskReadingTiles")} [${++u}/${t}]`;let m=await this.loadTileImage(e,z),h=e*P,b=z*P,M=Math.max(a,h),A=Math.min(l,h+P-1),J=Math.max(r,b),W=Math.min(s,b+P-1),V=M-h,x=J-b,O=A-M+1,j=W-J+1,I=M-a,$=J-r;p.drawImage(m,V,x,O,j,I,$,O,j)}let w=Date.now();await this.downloadCapture(i,"png",w)},()=>{this.setDisabled("capture-template",!1)})}async downloadCapture(o,a,r){let l=a==="webp"?"image/webp":"image/png",s=await new Promise((c,g)=>{o.toBlob((n)=>{if(!n){g(new Error(`Failed to create ${a.toUpperCase()} capture file`));return}c(n)},l)}),i=URL.createObjectURL(s),p=document.createElement("a");p.href=i,p.download=`wplace-capture-${r}.${a}`,p.click(),URL.revokeObjectURL(i)}async loadTileImage(o,a){let r;for(let l=1;l<=3;l++)try{let s=new Image;return s.crossOrigin="anonymous",s.referrerPolicy="no-referrer",s.src=`https://backend.wplace.live/files/s0/tiles/${o}/${a}.png?ts=${Date.now()}-${l}`,await Q(s,["load"],["error"]),s}catch(s){if(r=s,l<3)await new Promise((i)=>setTimeout(i,l*200))}throw r instanceof Error?r:new Error(`Tile fetch failed (${o}/${a})`)}async resolveCaptureBounds(){return this.selectCaptureBounds()}selectCaptureBounds(){return new Promise((o,a)=>{let r=document.createElement("div");r.className="kgm-capture-overlay",r.innerHTML=`<div class="kgm-capture-hint">${d("captureHintSelectArea")}: A → B</div><div class="kgm-capture-box"></div>`;let l=r.querySelector(".kgm-capture-box");document.body.append(r);let s,i,p=()=>{window.removeEventListener("keydown",t,!0),r.removeEventListener("pointermove",n),r.removeEventListener("pointerdown",f),r.remove()},c=(u)=>{let w=Math.min(s.x,u.x),e=Math.min(s.y,u.y),z=Math.abs(s.x-u.x)+1,m=Math.abs(s.y-u.y)+1;return{left:w,top:e,width:z,height:m}},g=(u)=>{let{left:w,top:e,width:z,height:m}=c(u);l.style.left=`${w}px`,l.style.top=`${e}px`,l.style.width=`${z}px`,l.style.height=`${m}px`},n=(u)=>{if(!s)return;g({x:u.clientX,y:u.clientY})},f=(u)=>{if(u.preventDefault(),!s){s={x:u.clientX,y:u.clientY};let M=k.fromScreenPosition(this.bot,s);i={x:M.globalX,y:M.globalY},g(s);return}let w={x:u.clientX,y:u.clientY},e=k.fromScreenPosition(this.bot,w);if(p(),!i){a(new Error("Capture anchor point unavailable"));return}let z=Math.min(i.x,e.globalX),m=Math.min(i.y,e.globalY),h=Math.max(i.x,e.globalX),b=Math.max(i.y,e.globalY);if(h-z<1||b-m<1){a(new Error("Capture area too small"));return}o({minGlobalX:z,minGlobalY:m,maxGlobalX:h,maxGlobalY:b})},t=(u)=>{if(u.key!=="Escape")return;p(),a(new Error("Capture cancelled"))};window.addEventListener("keydown",t,!0),r.addEventListener("pointermove",n),r.addEventListener("pointerdown",f)})}defaultImageScreenPosition(){let o=Math.round(this.element.getBoundingClientRect().width);return{x:Math.max(256,o),y:32}}async compressImageBeforeLoad(o){let a=new Image;if(a.src=o,await Q(a,["load"],["error"]),!(a.naturalWidth*a.naturalHeight>3000000||o.length>3000000))return o;let l=document.createElement("canvas");l.width=a.naturalWidth,l.height=a.naturalHeight;let s=l.getContext("2d");if(!s)return o;return s.drawImage(a,0,0),l.toDataURL("image/png")}async waitForStableViewportProjection(){let o=this.defaultImageScreenPosition(),a=0,r;for(let l=0;l<45;l++){await new Promise((n)=>requestAnimationFrame(()=>{n()}));let{anchorScreenPosition:{x:s,y:i},pixelSize:p}=this.bot.findAnchorsForScreen(o);if(!Number.isFinite(p)||p<=0){a=0;continue}let c={anchorX:s,anchorY:i,pixelSize:p};if(!r){r=c,a=1;continue}if(Math.abs(c.anchorX-r.anchorX)+Math.abs(c.anchorY-r.anchorY)+Math.abs(c.pixelSize-r.pixelSize)<0.0012)a++;else a=0;if(r=c,a>=3)return}}update(){this.$strategy.value=this.bot.strategy,this.refreshProgress(),this.$images.innerHTML="";let o=document.createDocumentFragment();for(let a=0;a<this.bot.images.length;a++){let r=this.bot.images[a],l=document.createElement("div");o.append(l),l.className="image",l.innerHTML=`<button class="preview" title="View preview">
  ...
  </div>`,l.querySelector(".preview").addEventListener("click",()=>{this.activeImageIndex=a,r.openPreviewPanel()}),l.querySelector(".colors").addEventListener("click",()=>{this.activeImageIndex=a,r.openColorPanel()}),l.querySelector(".preview-strategy").addEventListener("click",()=>{this.activeImageIndex=a,r.openPreviewPanel()}),l.querySelector(".download").addEventListener("click",()=>{r.exportImage()}),l.querySelector(".delete").addEventListener("click",()=>{r.destroy()}),l.querySelector(".up").addEventListener("click",()=>{io(this.bot.images,a,a-1),this.update(),H(this.bot)}),l.querySelector(".down").addEventListener("click",()=>{io(this.bot.images,a,a+1),this.update(),H(this.bot)})}this.$images.append(o)}refreshProgress(){let o=0,a=0;for(let s=0;s<this.bot.images.length;s++){let i=this.bot.images[s];o+=i.pixels.pixels.length*i.pixels.pixels[0].length,a+=i.tasks.length}let r=Math.max(0,o-a),l=o>0?r/o*100|0:0;this.$progressText.textContent=`${r}/${o} ${l}% ETA: ${a/120|0}h`,this.$progressLine.style.transform=`scaleX(${l/100})`}syncOverlayVisibilityFromStorage(){let o=localStorage.getItem(Qo)==="true";document.body.classList.toggle("overlay-hidden",o),this.refreshOverlayToggleText()}toggleOverlay(o){let a=o??!document.body.classList.contains("overlay-hidden");document.body.classList.toggle("overlay-hidden",a),localStorage.setItem(Qo,String(a)),this.refreshOverlayToggleText()}refreshOverlayToggleText(){let o=document.body.classList.contains("overlay-hidden")?d("disabled"):d("enabled");this.$toggleOverlay.innerHTML=`<i class="fa-solid fa-layer-group"></i><span>${d("toggleOverlay")} (${o})</span>`}applyLocaleToUI(o){ro(o),S(this.element);for(let a=0;a<this.bot.images.length;a++)this.bot.images[a].applyLocale();this.refreshOverlayToggleText(),this.refreshAutoFarmStatusText(),this.refreshAutoOverlayStatusText()}openSettingsModal(){let o=document.createElement("dialog");o.className="kgm-modal autofarm-dialog",o.innerHTML=`<form method="dialog" class="autofarm-form">
...
</form>`,document.body.append(o),S(o);let a=o.querySelector(".settings-locale");a.value=Y(),o.querySelector(".script-update").addEventListener("click",()=>{globalThis.open("https://github.com/robgallardof/kglacer-macro/raw/refs/heads/main/dist.user.js","_blank","noopener,noreferrer")}),a.addEventListener("change",()=>{this.applyLocaleToUI(a.value),S(o)});let r=JSON.parse(localStorage.getItem(qo)??"{}"),l=o.querySelector(".proxy-enabled"),s=o.querySelector(".proxy-host"),i=o.querySelector(".proxy-port"),p=o.querySelector(".proxy-user"),c=o.querySelector(".proxy-pass"),g=o.querySelector(".shield-enabled"),n=o.querySelector(".proxy-settings"),f=o.querySelector(".shield-settings"),t=o.querySelector(".shield-controls"),u=o.querySelector(".proxy-test"),w=o.querySelector(".proxy-test-output"),e=o.querySelector(".public-ip-value"),z=o.querySelector(".public-ip-route");l.checked=Boolean(r.enabled),g.checked=to(),n.open=l.checked,f.open=g.checked,this.renderShieldControls(t),s.value=r.host??"",i.value=r.port??"",p.value=r.username??"",c.value=r.password??"";let m=()=>{let b=l.checked,M=s.value.trim(),A=i.value.trim();localStorage.setItem(qo,JSON.stringify({enabled:b,host:M,port:A,username:p.value.trim(),password:c.value})),localStorage.setItem(Wo,b&&M&&A?`${M}:${A}`:"DIRECT/SHIELD")},h=async()=>{if(e)e.textContent=d("publicIpChecking");if(z)z.textContent=this.getPublicIpRouteLabel({enabled:l.checked,host:s.value.trim(),port:i.value.trim()});let b=await this.fetchPublicIp();if(e)e.textContent=b??d("publicIpUnavailable")};for(let b of[l,s,i,p,c])b.addEventListener("change",()=>{m(),h()});l.addEventListener("change",()=>{n.open=l.checked}),m(),h(),u.addEventListener("click",async()=>{m();let b=s.value.trim(),M=i.value.trim();if(u.disabled=!0,w)w.innerHTML=`<div class="pending">⏳ ${d("proxyTesting")}</div>`;let A=await this.testProxyConnection(b,M);if(await h(),w)w.innerHTML=`<div class="${A?"ok":"fail"}">${A?"✅":"❌"} ${A?d("proxyOk"):d("proxyFail")}</div>`;else alert(A?d("proxyOk"):d("proxyFail"));u.disabled=!1}),g.addEventListener("change",()=>{f.open=g.checked,this.renderShieldControls(t),So(g.checked),window.setTimeout(()=>{location.reload()},120)}),o.querySelector(".modal-close").onclick=()=>{o.close(),o.remove()},o.addEventListener("close",()=>{o.remove()}),o.showModal()}renderShieldControls(o){let s={navigator:d("shieldFeatureNavigator"),userAgentData:d("shieldFeatureUaData"),screen:d("shieldFeatureScreen"),timezone:d("shieldFeatureTimezone"),canvas:d("shieldFeatureCanvas"),webgl:d("shieldFeatureWebgl"),audio:d("shieldFeatureAudio"),plugins:d("shieldFeaturePlugins"),mediaDevices:d("shieldFeatureMediaDevices"),storageEstimate:d("shieldFeatureStorage"),battery:d("shieldFeatureBattery"),speechSynthesis:d("shieldFeatureSpeech"),fonts:d("shieldFeatureFonts"),matchMedia:d("shieldFeatureMatchMedia"),sharedArrayBuffer:d("shieldFeatureSharedArrayBuffer")},i=this.readStorageJson("__afm_profile",null),p="__afm_profile_choices",c=Number(localStorage.getItem("__afm_profile_expiry")??"0"),g=this.readStorageJson("__afm_settings",{}),n=this.readStorageJson("__afm_profile_choices",[]),t={...Object.fromEntries(Object.keys(s).map((m)=>[m,!0])),...g},u=c>0?new Date(c).toLocaleString():"—",w=i?.id??"Auto",e=n.map((m)=>`<option value="${m.id}" ${m.id===w?"selected":""}>${m.id}</option>`).join(""),z=Object.entries(s).map(([m,h])=>`<label class="kgm-switch-row"><span>${h}</span><span class="kgm-switch"><input type="checkbox" data-shield-key="${m}" ${t[m]?"checked":""}/><span class="kgm-switch-slider" aria-hidden="true"></span></span></label>`).join("");o.innerHTML=`<div class="shield-profile-row"><label>${d("shieldProfile")}</label><select class="shield-profile-select"><option value="">${d("shieldProfileAuto")}</option>${e}</select></div><div class="wp shield-expiry-line">${d("shieldExpires")}: <strong>${u}</strong></div><div class="widget-actions kgm-button-grid"><button type="button" class="challenge-button shield-refresh-profile"><i class="fa-solid fa-rotate"></i><span>${d("shieldRefreshProfile")}</span></button><button type="button" class="challenge-button shield-checker"><i class="fa-solid fa-shield-check"></i><span>${d("shieldChecker")}</span></button><button type="button" class="challenge-button shield-info"><i class="fa-solid fa-circle-info"></i><span>${d("shieldInfo")}</span></button></div><div class="shield-checker-output" aria-live="polite"></div><div class="shield-control-grid">${z}</div>`,o.querySelectorAll("input[data-shield-key]").forEach((m)=>{m.addEventListener("change",()=>{let h=m.dataset.shieldKey;t[h]=m.checked,localStorage.setItem("__afm_settings",JSON.stringify(t)),window.setTimeout(()=>{location.reload()},120)})}),o.querySelector(".shield-profile-select")?.addEventListener("change",(m)=>{let h=m.currentTarget.value;if(!h)localStorage.removeItem("__afm_profile");else{let b=n.find((M)=>M.id===h);localStorage.setItem("__afm_profile",JSON.stringify(b??{id:h}))}location.reload()}),o.querySelector(".shield-checker")?.addEventListener("click",()=>{let m=o.querySelector(".shield-checker-output");if(!m)return;let h=this.runShieldChecker();m.innerHTML=h.map((b)=>`<div class="${b.ok?"ok":"fail"}">${b.ok?"✅":"❌"} ${b.label}</div>`).join("")}),o.querySelector(".shield-info")?.addEventListener("click",()=>{this.openShieldInfoModal()}),o.querySelector(".shield-refresh-profile")?.addEventListener("click",()=>{localStorage.removeItem("__afm_profile"),localStorage.removeItem("__afm_profile_expiry"),location.reload()})}getShieldInfo(){let o=this.readStorageJson("__afm_profile",null),a=this.readStorageJson("__afm_settings",{}),r=this.readStorageJson("__afm_profile_choices",[]);return{injectedInfo:globalThis.__kgmShieldInfo,profile:o,settings:a,choices:r,expiry:Number(localStorage.getItem("__afm_profile_expiry")??"0"),enabled:localStorage.getItem("__afm_enabled")!=="false",proxyHint:localStorage.getItem(Wo)??"AUTO"}}readStorageJson(o,a){try{let r=localStorage.getItem(o);if(!r)return a;return JSON.parse(r)}catch{return a}}getPublicIpRouteLabel(o){if(o.enabled&&o.host&&o.port)return`${d("publicIpProxyRoute")} (${o.host}:${o.port})`;return d("publicIpShieldRoute")}async fetchPublicIp(){for(let o of fa)try{let a=await fetch(o,{cache:"no-store"});if(!a.ok)continue;if((a.headers.get("content-type")??"").includes("application/json")){let l=await a.json();if(typeof l.ip==="string"&&l.ip.trim())return l.ip.trim()}else{let l=(await a.text()).trim();if(l)return l}}catch{}return}openShieldInfoModal(){let o=this.getShieldInfo(),a=o.injectedInfo?.profile,r=typeof a==="object"&&a!==null?a:o.profile,l=o.injectedInfo?.settings??o.settings,s=Number(o.injectedInfo?.expiresAt??o.expiry),i=(t,u="—")=>this.stringifyShieldValue(r?.[t],u),p=r?`${i("screenWidth")}×${i("screenHeight")} @${i("devicePixelRatio")}`:"—",c=r?`${i("webglVendor")} / ${i("webglRenderer")}`:"—",g=[[d("shieldInfoInjected"),o.injectedInfo?d("enabled"):d("disabled")],[d("shieldInfoEnabled"),o.enabled?d("enabled"):d("disabled")],[d("shieldProfile"),i("id")],[d("shieldExpires"),s>0?new Date(s).toLocaleString():"—"],[d("shieldInfoBrowser"),this.stringifyShieldValue(o.injectedInfo?.detectedBrowser)],[d("shieldInfoProxyHint"),this.stringifyShieldValue(o.injectedInfo?.proxyHint,o.proxyHint)],[d("publicIpTitle"),d("publicIpChecking")],[d("shieldInfoProfiles"),o.choices.length>0?String(o.choices.length):"—"],["User-Agent",i("userAgent",navigator.userAgent)],["Platform",i("platform",navigator.platform)],["Language",i("language",navigator.language)],["Screen",p],["WebGL",c]],n=Object.entries(l).filter(([,t])=>t).map(([t])=>t).join(", "),f=document.createElement("dialog");f.className="kgm-modal shield-info-dialog",f.innerHTML=`<div class="kgm-modal-head"><strong>${d("shieldInfoTitle")}</strong><button type="button" class="modal-close" aria-label="${d("close")}"><span class="icon">×</span></button></div><div class="shield-info-grid">${g.map(([t,u])=>`<div class="shield-info-card"><span>${this.escapeHtml(t)}</span><strong${t===d("publicIpTitle")?' class="shield-info-public-ip"':""}>${this.escapeHtml(u)}</strong></div>`).join("")}</div><div class="shield-info-modules"><span>${d("shieldInfoModules")}</span><p>${this.escapeHtml(n.length>0?n:"—")}</p></div>`,document.body.append(f),this.fetchPublicIp().then((t)=>{let u=f.querySelector(".shield-info-public-ip");if(u)u.textContent=t??d("publicIpUnavailable")}),f.querySelector(".modal-close").onclick=()=>{f.close(),f.remove()},f.addEventListener("close",()=>{f.remove()}),f.showModal()}stringifyShieldValue(o,a="—"){if(o===void 0||o===null||o==="")return a;if(typeof o==="string"||typeof o==="number"||typeof o==="boolean")return String(o);return JSON.stringify(o)}escapeHtml(o){return String(o).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}async testProxyConnection(o,a){if(!o||!a)return!1;try{return await fetch(`http://${o}:${a}`,{method:"HEAD",mode:"no-cors"}),!0}catch{return!1}}runShieldChecker(){let o=this.getShieldInfo(),a=o.profile,r=o.injectedInfo?.settings,l=typeof r==="object"&&r!==null?r:o.settings,s=Boolean(o.injectedInfo??a);return[{label:d("shieldCheckInjected"),ok:s},{label:d("shieldCheckSettings"),ok:Object.keys(l).length>0},{label:d("shieldCheckProfile"),ok:Boolean(a?.id??o.injectedInfo?.profileId)},{label:d("shieldCheckChoices"),ok:o.choices.length>0},{label:d("shieldCheckNavigator"),ok:navigator.hardwareConcurrency!==0&&typeof navigator.platform==="string"}]}refreshAutoFarmStatusText(){if(!this.autoFarmConfig){this.$autofarmStatus.textContent=d("autoFarmNeedsConfig");return}this.$autofarmStatus.textContent=this.autoFarmIntervalId?`${d("autoFarmRunning")} (${this.formatAutoFarmDelay(this.autoFarmConfig.timerMs)}) · ${this.formatCountdown(this.autoFarmNextTickAt)}`:d("autoFarmStopped")}refreshAutoOverlayStatusText(){if(!this.autoOverlayConfig){this.$autoOverlayStatus.textContent=d("autoOverlayNeedsConfig");return}this.$autoOverlayStatus.textContent=this.autoOverlayIntervalId?`${d("autoOverlayRunning")} (${this.formatAutoFarmDelay(this.autoOverlayConfig.timerMs)}) · ${this.formatCountdown(this.autoOverlayNextTickAt)}`:d("autoOverlayStopped")}formatCountdown(o){if(!o)return"00:00";let a=Math.max(0,o-Date.now()),r=Math.ceil(a/1000),l=Math.floor(r/60),s=r%60;return`next in ${String(l).padStart(2,"0")}:${String(s).padStart(2,"0")}`}formatAutoFarmDelay(o){if(o%3600000===0)return`${o/3600000}h`;if(o%60000===0)return`${o/60000}m`;return`${o/1000}s`}stopAutoFarm(){if(!this.autoFarmIntervalId)return;clearInterval(this.autoFarmIntervalId),this.autoFarmIntervalId=void 0,this.autoFarmNextTickAt=void 0,this.refreshAutoFarmStatusText()}stopAutoOverlay(){if(!this.autoOverlayIntervalId)return;clearInterval(this.autoOverlayIntervalId),this.autoOverlayIntervalId=void 0,this.autoOverlayNextTickAt=void 0,this.refreshAutoOverlayStatusText()}startAutoFarm(){if(!this.autoFarmConfig){this.status=`⚠️ ${d("autoFarmNeedsConfig")}`,this.refreshAutoFarmStatusText();return}this.stopAutoFarm(),this.autoFarmNextTickAt=Date.now()+this.autoFarmConfig.timerMs,this.autoFarmIntervalId=window.setInterval(()=>{this.autoFarmNextTickAt=Date.now()+this.autoFarmConfig.timerMs,this.runAutoFarmCycle()},this.autoFarmConfig.timerMs),this.runAutoFarmCycle(),this.refreshAutoFarmStatusText()}startAutoOverlay(){if(!this.autoOverlayConfig){this.status=`⚠️ ${d("autoOverlayNeedsConfig")}`,this.refreshAutoOverlayStatusText();return}this.stopAutoOverlay(),this.autoOverlayNextTickAt=Date.now()+this.autoOverlayConfig.timerMs,this.autoOverlayIntervalId=window.setInterval(()=>{this.autoOverlayNextTickAt=Date.now()+this.autoOverlayConfig.timerMs,this.runAutoOverlayCycle()},this.autoOverlayConfig.timerMs),this.runAutoOverlayCycle(),this.refreshAutoOverlayStatusText()}async runAutoFarmCycle(){if(!this.autoFarmConfig||this.autoFarmTickRunning)return;this.autoFarmTickRunning=!0;try{if(!await this.bot.drawRandomPixelsBatch(this.autoFarmConfig.pixels,0)){this.status=`⚠️ ${d("autoFarmStopped")}: ${d("autoFarmTransparentUnavailable")}`,this.stopAutoFarm();return}await this.waitAndClickPaintButton()}finally{this.autoFarmTickRunning=!1}}async runAutoOverlayCycle(){if(!this.autoOverlayConfig||this.autoOverlayTickRunning)return;this.autoOverlayTickRunning=!0;try{if(!await this.bot.drawOverlayPixelsBatch(this.autoOverlayConfig.pixels)){this.status=`⚠️ ${d("autoOverlayStopped")}: ${d("autoOverlayNoTasks")}`,this.stopAutoOverlay();return}await this.waitAndClickPaintButton()}finally{this.autoOverlayTickRunning=!1}}saveAutoFarmConfig(o){this.autoFarmConfig=o,localStorage.setItem(Ko,JSON.stringify(o))}saveAutoOverlayConfig(o){this.autoOverlayConfig=o,localStorage.setItem(Go,JSON.stringify(o))}loadAutoFarmConfigFromStorage(){let o=localStorage.getItem(Ko);if(!o)return;try{let a=JSON.parse(o);if(typeof a.value!=="number"||!Number.isFinite(a.value)||a.value<1)return;let r=typeof a.pixels==="number"&&Number.isFinite(a.pixels)&&a.pixels>=1?Math.floor(a.pixels):60,l=a.unit==="hours"||a.unit==="minutes"||a.unit==="seconds"?a.unit:"minutes",s=typeof a.timerMs==="number"&&a.timerMs>0?a.timerMs:l==="hours"?a.value*3600000:l==="minutes"?a.value*60000:a.value*1000;this.autoFarmConfig={value:Math.max(1,Math.floor(a.value)),pixels:r,unit:l,timerMs:s}}catch{return}}loadAutoOverlayConfigFromStorage(){let o=localStorage.getItem(Go);if(!o)return;try{let a=JSON.parse(o);if(typeof a.value!=="number"||!Number.isFinite(a.value)||a.value<1)return;let r=typeof a.pixels==="number"&&Number.isFinite(a.pixels)&&a.pixels>=1?Math.floor(a.pixels):60,l=a.unit==="hours"||a.unit==="minutes"||a.unit==="seconds"?a.unit:"minutes",s=typeof a.timerMs==="number"&&a.timerMs>0?a.timerMs:l==="hours"?a.value*3600000:l==="minutes"?a.value*60000:a.value*1000;this.autoOverlayConfig={value:Math.max(1,Math.floor(a.value)),pixels:r,unit:l,timerMs:s}}catch{return}}openAutoFarmModal(){let o=document.createElement("dialog");o.className="kgm-modal autofarm-dialog";let a=this.autoFarmConfig?.unit??"minutes",r=this.autoFarmConfig?.value??1,l=this.autoFarmConfig?.pixels??60;o.innerHTML=`<form method="dialog" class="autofarm-form">
  <div class="kgm-modal-head">
...
</form>`,document.body.append(o),S(o);let s=o.querySelector(".autofarm-unit");s.value=a;let i=o.querySelector(".autofarm-value"),p=o.querySelector(".autofarm-pixels"),c=()=>{let g=Math.max(1,Number.parseInt(i.value||"1",10));if(s.value==="hours")return g*3600000;if(s.value==="minutes")return g*60000;return g*1000};o.querySelector(".autofarm-start").onclick=()=>{this.saveAutoFarmConfig({value:Math.max(1,Number.parseInt(i.value||"1",10)),pixels:Math.max(1,Number.parseInt(p.value||"60",10)),unit:s.value,timerMs:c()}),this.startAutoFarm(),o.close(),o.remove()},o.querySelector(".autofarm-stop").onclick=()=>{this.stopAutoFarm(),o.close(),o.remove()},o.querySelector(".modal-close").onclick=()=>{o.close(),o.remove()},o.addEventListener("close",()=>{o.remove()}),o.showModal()}openAutoOverlayModal(){let o=document.createElement("dialog");o.className="kgm-modal autofarm-dialog";let a=this.autoOverlayConfig?.unit??"minutes",r=this.autoOverlayConfig?.value??1,l=this.autoOverlayConfig?.pixels??60;o.innerHTML=`<form method="dialog" class="autofarm-form">
  <div class="kgm-modal-head">
...
</form>`,document.body.append(o),S(o);let s=o.querySelector(".autofarm-unit");s.value=a;let i=o.querySelector(".autofarm-value"),p=o.querySelector(".autofarm-pixels"),c=()=>{let g=Math.max(1,Number.parseInt(i.value||"1",10));if(s.value==="hours")return g*3600000;if(s.value==="minutes")return g*60000;return g*1000};o.querySelector(".autooverlay-start").onclick=()=>{this.saveAutoOverlayConfig({value:Math.max(1,Number.parseInt(i.value||"1",10)),pixels:Math.max(1,Number.parseInt(p.value||"60",10)),unit:s.value,timerMs:c()}),this.startAutoOverlay(),o.close(),o.remove()},o.querySelector(".autooverlay-stop").onclick=()=>{this.stopAutoOverlay(),o.close(),o.remove()},o.querySelector(".modal-close").onclick=()=>{o.close(),o.remove()},o.addEventListener("close",()=>{o.remove()}),o.showModal()}setDisabled(o,a){this.element.querySelector("."+o).disabled=a}async run(o,a,r,l="..."){console.log("[KGM][Widget] Task started",{status:o});let s=this.status;this.status=`${l} ${o}`;try{let i=await a();return this.status=s,console.log("[KGM][Widget] Task completed",{status:o}),i}catch(i){if(!(i instanceof so))console.error(i),this.status=`${d("taskErrorPrefix")}: ${o}`;throw console.error("[KGM][Widget] Task failed",{status:o,error:i}),i}finally{await r?.()}}handleKeyboard(o){if(Uo(o.target))return;if(N(o,F.toggleWidget)){o.preventDefault(),this.open=!this.open;return}if(N(o,F.minimizeWidget)){o.preventDefault(),this.open=!1;return}if(N(o,F.showWidgetPanel)){o.preventDefault(),this.open=!0;return}if(N(o,F.hideWidgetPanel)){o.preventDefault(),this.open=!1;return}if(N(o,F.showShortcuts)){o.preventDefault(),this.open=!0,this.openSettingsModal();return}if(N(o,F.toggleOverlay)){o.preventDefault(),this.toggleOverlay();return}if(N(o,F.focusNextImage)){o.preventDefault(),this.focusImageByStep(1);return}if(N(o,F.focusPreviousImage)){o.preventDefault(),this.focusImageByStep(-1);return}if(N(o,F.openColorPanel)){o.preventDefault(),this.openColorPanelForActiveImage();return}if(N(o,F.toggleImageLock)){o.preventDefault(),this.toggleLockForActiveImage();return}if(N(o,F.clickPaintWhenReady)){o.preventDefault(),this.drawAndClickPaintWhenReady();return}if(N(o,F.startAutoFarm)){o.preventDefault(),this.startAutoFarm();return}if(N(o,F.stopAutoFarm)){o.preventDefault(),this.stopAutoFarm();return}if(N(o,F.addImage)&&!this.$addImage.disabled){o.preventDefault(),this.addImage();return}if(N(o,F.draw)&&!this.$draw.disabled)o.preventDefault(),this.bot.draw()}focusImageByStep(o){if(!this.bot.images.length)return;if(this.activeImageIndex<0||this.activeImageIndex>=this.bot.images.length)this.activeImageIndex=o>0?0:this.bot.images.length-1;else this.activeImageIndex=(this.activeImageIndex+o+this.bot.images.length)%this.bot.images.length;this.bot.images[this.activeImageIndex].position.scrollScreenTo()}getActiveImage(){if(!this.bot.images.length)return;if(this.activeImageIndex<0||this.activeImageIndex>=this.bot.images.length)this.activeImageIndex=0;return this.bot.images[this.activeImageIndex]}openColorPanelForActiveImage(){let o=this.getActiveImage();if(!o)return;o.openColorPanel()}toggleLockForActiveImage(){let o=this.getActiveImage();if(!o)return;o.lock=!o.lock,o.update(),H(this.bot)}async waitAndClickPaintButton(){await this.run(d("taskWaitingPaintButton"),async()=>{for(;;){if(this.isChallengeBlockingPaint()){await this.waitForChallengeToResolve(),await new Promise((a)=>setTimeout(a,250));continue}let o=this.findNativePaintButton();if(o&&!o.disabled&&o.ariaDisabled!=="true"){await this.triggerNativePaintClickWithChallengeRecovery(o);return}await new Promise((a)=>setTimeout(a,500))}})}async drawAndClickPaintWhenReady(){if(!this.$draw.disabled)await this.bot.draw();await this.waitAndClickPaintButton()}findNativePaintButton(){return["button.btn.btn-primary.btn-lg.sm\\:btn-xl.relative","button.btn.btn-primary.btn-lg.relative","button.btn.btn-primary.btn-lg.relative.z-30","button.btn.btn-primary.btn-lg.sm\\:btn-xl.relative.z-30","div.absolute.bottom-0.left-1\\/2.-translate-x-1\\/2 button.btn.btn-primary"].flatMap((r)=>Array.from(document.querySelectorAll(r))).find((r)=>/pintar|paint/i.test(r.textContent))}triggerNativePaintClick(o){o.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,cancelable:!0,pointerType:"mouse",button:0})),o.dispatchEvent(new MouseEvent("mousedown",{bubbles:!0,cancelable:!0,button:0})),o.dispatchEvent(new PointerEvent("pointerup",{bubbles:!0,cancelable:!0,pointerType:"mouse",button:0})),o.dispatchEvent(new MouseEvent("mouseup",{bubbles:!0,cancelable:!0,button:0})),o.click()}async triggerNativePaintClickWithChallengeRecovery(o){for(let r=0;r<3;r++){let l=r===0?o:this.findNativePaintButton();if(!l)return;if(l.disabled||l.ariaDisabled==="true")return;this.triggerNativePaintClick(l);let s=await this.waitForPaintAttemptOutcome(6000);if(s==="painted")return;if(s==="challenge"){await this.waitForChallengeToResolve(),await new Promise((i)=>setTimeout(i,350));continue}await new Promise((i)=>setTimeout(i,350))}console.log("[KGM][Widget] Paint click finished without a clear success signal after retries")}async waitForPaintAttemptOutcome(o){let a=Date.now();while(Date.now()-a<=o){if(this.isChallengeBlockingPaint())return"challenge";let r=this.findNativePaintButton();if(r&&(r.disabled||r.ariaDisabled==="true"))return await this.waitForDelayedChallenge(1200)?"challenge":"painted";await new Promise((l)=>setTimeout(l,200))}return"unknown"}async waitForDelayedChallenge(o){let a=Date.now();while(Date.now()-a<=o){if(this.isChallengeBlockingPaint())return!0;await new Promise((r)=>setTimeout(r,150))}return!1}async waitForChallengeToResolve(){await this.run(d("taskWaitingChallengeResolve"),async()=>{let o=Date.now(),a=90000;while(this.isChallengeBlockingPaint()&&Date.now()-o<=90000)await new Promise((r)=>setTimeout(r,500))})}isChallengeBlockingPaint(){let r=Array.from(document.querySelectorAll('h-captcha, .h-captcha, iframe[src*="hcaptcha.com"], iframe[src*="newassets.hcaptcha.com"], iframe[src*="captcha"], [data-hcaptcha-widget-id]')).filter((i)=>{if(i.closest("dialog")?.matches("dialog:not([open])"))return!1;let p=globalThis.getComputedStyle(i);if(p.display==="none"||p.visibility==="hidden")return!1;let c=i.getBoundingClientRect();return c.width>0&&c.height>0});if(!r.length)return!1;let l=document.querySelector("dialog.modal[open], dialog[open]");if(l?.querySelector('h-captcha, .h-captcha, iframe[src*="hcaptcha.com"], iframe[src*="newassets.hcaptcha.com"], iframe[src*="captcha"], [data-hcaptcha-widget-id]')){if(!l)return!1;if(!Array.from(l.querySelectorAll('textarea[name="h-captcha-response"], textarea[name^="h-captcha-response-"]')).some((p)=>p.value.trim().length>0))return!0}return r.some((i)=>{let p=i.closest("h-captcha")??i.parentElement??document.documentElement,c=Array.from(p.querySelectorAll('textarea[name="h-captcha-response"], textarea[name^="h-captcha-response-"]'));if(!c.length)return!0;return c.every((g)=>g.value.trim().length===0)})}}var ta=2;function ua(){let o=globalThis;if(typeof o.fp_assemble_injection!=="function")o.fp_assemble_injection=()=>({});if(!o.__kgmUnhandledRejectionPatched)o.__kgmUnhandledRejectionPatched=!0,o.addEventListener("unhandledrejection",(a)=>{let r=a.reason,l=typeof r==="object"&&r!==null&&"name"in r&&typeof r.name==="string"?r.name:"",s=r instanceof Error?r.message:r;if(l==="NotAllowedError"&&s.includes("play() failed"))a.preventDefault()});if(!o.__kgmMediaPlayPatched&&"HTMLMediaElement"in o){o.__kgmMediaPlayPatched=!0;let a=Reflect.get(o.HTMLMediaElement.prototype,"play");o.HTMLMediaElement.prototype.play=function r(){return Reflect.apply(a,this,[]).catch((s)=>{let i=s instanceof Error?s.message:s;if((typeof s==="object"&&s!==null&&"name"in s&&typeof s.name==="string"?s.name:"")==="NotAllowedError"&&i.includes("play() failed"))return;throw s})}}}var Lo="[KGM]",Ro="kglacer-macro:access-ok",eo="S0dNLXlZUjhTMW81bEhVemVjS1RFMEhxRVB4OVFkcjgxaEVz",Zo="kgm-access-locked";class Co{unavailableColors=new Set;mapsCache=new Map;me;$stars=[];strategy="SEQUENTIAL";images=[];_widget;get widget(){if(!this._widget)throw new Error("Widget is not initialized yet");return this._widget}markerPixelPositionResolvers=[];lastColor;log(o,a){if(a===void 0)console.log(`${Lo} ${o}`);else console.log(`${Lo} ${o}`,a)}constructor(){this.log("Boot sequence started"),document.body.classList.add(Zo);let o=No();if(this.log("Save loaded",{hasSave:Boolean(o),imageCount:o?.images.length??0,strategy:o?.strategy}),o){for(let l=0;l<o.images.length;l++){let s=o.images[l];v({x:s.position[0]-1000,y:s.position[1]-1000}),v({x:s.position[0]+1000,y:s.position[1]+1000})}this.strategy=o.strategy}let a=JSON.parse(localStorage.getItem("kglacer-macro:proxy-config")??"{}");Do(a),this.registerFetchInterceptor(),this.log("Fetch interceptor registered");let r=document.createElement("style");r.textContent=Jo.replace("FAKE_FAVORITE_LOCATIONS",E.length.toString()),document.head.append(r),this.log("Styles injected",{fakeFavoriteLocations:E.length}),(async()=>{this.log("Widget initialization flow started"),await this.ensureAccessKey(),document.body.classList.remove(Zo),this._widget=new wo(this),await this.widget.run(d("taskInitializing"),async()=>{await this.waitForElement("login",".avatar.center-absolute.absolute"),await this.waitForElement("pixel count",".btn.btn-primary.btn-lg.relative.z-30 canvas");let l=await this.waitForElement("canvas",".maplibregl-canvas-container");if(new MutationObserver((s)=>{for(let i=0;i<s.length;i++)if(s[i].removedNodes.length!==0){this.updateStars();break}this.updateImages()}).observe(l,{attributes:!0,childList:!0,subtree:!0}),this.updateStars(),this.log("Stars updated after boot",{stars:this.$stars.length}),await D(500),await this.updateColors(),o)for(let s=0;s<o.images.length;s++){let i=await U.fromJSON(this,o.images[s]);this.images.push(i),i.update()}this.log("Saved images restored",{images:this.images.length}),await this.readMap(),this.updateTasks(),this.widget.setDisabled("draw",!1),this.widget.setDisabled("draw-and-paint",!1),this.widget.setDisabled("add-image",!1),this.widget.setDisabled("capture-template",!1),this.log("Initialization completed; controls enabled")})})()}async ensureAccessKey(){if(localStorage.getItem(Ro)===eo)return;await new Promise((o)=>{let a=document.createElement("dialog");a.className="kgm-modal access-dialog",a.innerHTML=`<form method="dialog" class="access-form">
  <div class="kgm-modal-head">
...
</form>`,document.body.append(a),S(a);let r=a.querySelector(".access-input"),l=a.querySelector(".access-error"),s=a.querySelector(".access-locale");s.innerHTML=Mo().map((i)=>`<option value="${i}" ${i===Y()?"selected":""}>${i.toUpperCase()}</option>`).join(""),s.addEventListener("change",()=>{ro(s.value),S(a)}),a.addEventListener("cancel",(i)=>{i.preventDefault()}),a.querySelector("form").addEventListener("submit",(i)=>{i.preventDefault();let p=atob(eo);if(r.value.trim()!==p){l.textContent=d("invalidAccessKey");return}localStorage.setItem(Ro,eo),a.close(),a.remove(),o()}),a.showModal(),r.focus()})}draw(){this.log("Draw requested",{strategy:this.strategy,images:this.images.length}),this.widget.setDisabled("draw",!0),this.widget.setDisabled("draw-and-paint",!0),this.widget.status="",this.mapsCache.clear();let o=document.querySelector(".maplibregl-canvas"),a=(r)=>{if(!r.shiftKey)r.stopPropagation()};return this.widget.run(d("taskDrawing"),async()=>{await this.widget.run(d("taskInitializingDraw"),()=>Promise.all([this.updateColors(),this.readMap()])),globalThis.addEventListener("mousemove",a,!0),o.addEventListener("wheel",a,!0),this.updateTasks();let r=await fetch("https://backend.wplace.live/me",{credentials:"include"}).then((i)=>i.json()),l=Math.floor(r.charges.count);this.log("Charges fetched",{charges:l});let s=0;for(let i=0;i<this.images.length;i++)s+=this.images[i].tasks.length;switch(this.log("Tasks prepared",{tasks:s}),this.strategy){case"ALL":{while(l>0){let i=!0;for(let p=0;p<this.images.length;p++){let c=this.images[p].tasks.shift();if(!c)continue;this.drawTask(c),l--,await D(1),i=!1}if(i)break}break}case"PERCENTAGE":{for(let i=0;i<s&&l>0;i++){let p=1,c;for(let g=0;g<this.images.length;g++){let n=this.images[g],f=1-n.tasks.length/(n.pixels.pixels.length*n.pixels.pixels[0].length);if(f<p)p=f,c=n}this.drawTask(c.tasks.shift()),l--,await D(1)}break}case"SEQUENTIAL":for(let i=0;i<this.images.length;i++){let p=this.images[i];for(let c=p.tasks.shift();c&&l>0;c=p.tasks.shift())this.drawTask(c),l--,await D(1)}}this.widget.update(),this.log("Draw flow finished",{remainingCharges:l})},()=>{globalThis.removeEventListener("mousemove",a,!0),o.removeEventListener("wheel",a,!0),this.widget.setDisabled("draw",!1),this.widget.setDisabled("draw-and-paint",!1)})}toJSON(){return{version:ta,images:this.images.map((o)=>o.toJSON()),strategy:this.strategy}}async updateColors(){this.log("Updating colors palette"),await this.openColors(),this.unavailableColors.clear();for(let o of document.querySelectorAll("button.btn.relative.w-full"))if(o.children.length!==0)this.unavailableColors.add(Math.abs(Number.parseInt(o.id.slice(6))));this.updateImageColors(),this.log("Colors updated",{unavailableColors:this.unavailableColors.size})}moveMap(o){let a=document.querySelector(".maplibregl-canvas"),r=window.innerWidth/2,l=window.innerHeight/2,s=r-o.x,i=l-o.y;function p(c,g,n){a.dispatchEvent(new MouseEvent(c,{bubbles:!0,cancelable:!0,clientX:g,clientY:n,buttons:1}))}p("mousedown",r,l),p("mousemove",s,i),p("mouseup",s,i)}readMap(){this.mapsCache.clear();let o=new Set;for(let r=0;r<this.images.length;r++){let l=this.images[r],{tileX:s,tileY:i}=new k(this,l.position.globalX+l.pixels.pixels[0].length,l.position.globalY+l.pixels.pixels.length);for(let p=l.position.tileX;p<=s;p++)for(let c=l.position.tileY;c<=i;c++)o.add(`${p}/${c}`)}let a=0;return this.log("Reading map tiles",{tileCount:o.size}),this.widget.run(`${d("taskReadingMap")} [0/${o.size}]`,()=>Promise.all([...o].map(async(r)=>{this.mapsCache.set(r,await K.fromJSON(this,{url:`https://backend.wplace.live/files/s0/tiles/${r}.png`,exactColor:!0})),this.widget.status=`⌛ ${d("taskReadingMap")} [${++a}/${o.size}]`})))}waitForUnfocus(){return this.widget.run("UNFOCUS WINDOW",()=>new Promise((o)=>{if(!document.hasFocus())o();window.addEventListener("blur",()=>{setTimeout(o,1)},{once:!0})}),void 0,"\uD83D\uDDB1️")}findAnchorsForScreen(o){let a=0,r=1,l=1/0,s=1/0;for(let c=0;c<this.$stars.length;c++){let{x:g,y:n}=R(this.$stars[c]);if(g<o.x&&n<o.y){let f=o.x-g+(o.y-n);if(f<l)l=f,a=c}else if(g>o.x&&n>o.y){let f=g-o.x+(n-o.y);if(f<s)s=f,r=c}}let i=R(this.$stars[a]),p=G[a];return{anchorScreenPosition:i,anchorWorldPosition:p,pixelSize:(R(this.$stars[r]).x-i.x)/(G[r].x-p.x)}}async openColors(){this.lastColor=void 0,document.querySelector(".flex.gap-2.px-3 > .btn-circle")?.click(),await D(1),document.querySelector(".btn.btn-primary.btn-lg.relative.z-30")?.click(),await D(1);let o=document.querySelector("button.bottom-0");if(o?.innerHTML==='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="size-5"><path d="M480-120 300-300l58-58 122 122 122-122 58 58-180 180ZM358-598l-58-58 180-180 180 180-58 58-122-122-122 122Z"></path></svg><!---->')o.click(),await D(1)}drawTask(o){if(this.lastColor!==o.color){let l=document.getElementById("color-"+o.color);if(!l){this.log("Skipped draw task: color button not found",{color:o.color,tileX:o.position.tileX,tileY:o.position.tileY,x:o.position.x,y:o.position.y});return}l.click(),this.lastColor=o.color,this.log("Color switched for draw task",{color:o.color})}let a=o.position.pixelSize/2,r=o.position.toScreenPosition();if(!Number.isFinite(r.x)||!Number.isFinite(r.y)){this.log("Skipped draw task: invalid screen position",{color:o.color});return}document.documentElement.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:r.x+a,clientY:r.y+a,shiftKey:!0})),document.documentElement.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,which:32,bubbles:!0,cancelable:!0})),document.documentElement.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,which:32,bubbles:!0,cancelable:!0})),o.position.setMapColor(o.color)}async paintRandomPixelInViewport(){try{await this.updateColors();let o=Array.from(document.querySelectorAll('button[id^="color-"]')).filter((u)=>!u.disabled&&u.getAttribute("aria-disabled")!=="true"&&u.offsetParent!==null);if(!o.length)return;let a=o[Math.floor(Math.random()*o.length)],r=Number.parseInt(a.id.slice(6),10);if(!Number.isFinite(r))return;let l=document.querySelector(".maplibregl-canvas");if(!l)return;let s=l.getBoundingClientRect(),i=24,p=s.left+i,c=s.right-i,g=s.top+i,n=s.bottom-i;if(c<=p||n<=g)return;let f=p+Math.random()*(c-p),t=g+Math.random()*(n-g);this.drawTask({color:r,position:k.fromScreenPosition(this,{x:f,y:t})})}catch(o){this.log("Auto farm tick failed",o)}}async drawRandomPixelsBatch(o,a){let r=Math.max(1,Math.floor(o)),l=0;return await this.widget.run(d("taskDrawingRandomPixels"),async()=>{await this.widget.run(d("taskInitializingDraw"),()=>this.updateColors());let s=Array.from(document.querySelectorAll('button[id^="color-"]')).filter((w)=>!w.disabled&&w.getAttribute("aria-disabled")!=="true"&&w.offsetParent!==null),i=document.querySelector(".maplibregl-canvas");if(!s.length||!i)return;let p=a===void 0?void 0:s.find((w)=>Number.parseInt(w.id.slice(6),10)===a);if(a!==void 0&&!p)return;let c=i.getBoundingClientRect(),g=24,n=c.left+g,f=c.right-g,t=c.top+g,u=c.bottom-g;if(f<=n||u<=t)return;for(let w=0;w<r;w++){let e=p??s[Math.floor(Math.random()*s.length)],z=Number.parseInt(e.id.slice(6),10);if(!Number.isFinite(z))continue;let m=n+Math.random()*(f-n),h=t+Math.random()*(u-t);this.drawTask({color:z,position:k.fromScreenPosition(this,{x:m,y:h})}),l++,await D(1)}}),l}async drawOverlayPixelsBatch(o){let a=Math.max(1,Math.floor(o)),r=0;return await this.widget.run(d("taskDrawingOverlayPixels"),async()=>{await this.widget.run(d("taskInitializingDraw"),()=>Promise.all([this.updateColors(),this.readMap()])),this.updateTasks();for(let l=0;l<a;l++){let s=this.takeNextTaskFromStrategy();if(!s)break;this.drawTask(s),r++,await D(1)}this.widget.update()}),r}takeNextTaskFromStrategy(){switch(this.strategy){case"ALL":case"SEQUENTIAL":{for(let o=0;o<this.images.length;o++){let a=this.images[o].tasks.shift();if(a)return a}return}case"PERCENTAGE":{let o,a=Number.POSITIVE_INFINITY;for(let r=0;r<this.images.length;r++){let l=this.images[r];if(!l.tasks.length)continue;let s=l.pixels.pixels.length*l.pixels.pixels[0].length,i=1-l.tasks.length/s;if(i<a)a=i,o=l}return o?.tasks.shift()}}}registerFetchInterceptor(){let o=globalThis.fetch,a=/https:\/\/backend.wplace.live\/s\d+\/pixel\/(-?\d+)\/(-?\d+)\?x=(-?\d+)&y=(-?\d+)/;globalThis.fetch=async(r,l)=>{let s=await o(r,l),i=s.clone(),p="";if(typeof r=="string")p=r;else if(r instanceof Request)p=r.url;else if(r instanceof URL)p=r.href;if(s.url==="https://backend.wplace.live/me")this.me=await i.json(),this.me.favoriteLocations.unshift(...E),this.me.maxFavoriteLocations=1/0,s.json=()=>Promise.resolve(this.me),this.log("Patched /me response with favorite locations",{totalFavorites:this.me.favoriteLocations.length});let c=a.exec(p);if(c){for(let g=0;g<this.markerPixelPositionResolvers.length;g++)this.markerPixelPositionResolvers[g](new k(this,+c[1],+c[2],+c[3],+c[4]));this.markerPixelPositionResolvers.length=0,this.log("Resolved marker pixel position from network event")}return s}}async closeAll(){for(let o of document.querySelectorAll("button"))if(o.innerHTML==="✕"||o.innerHTML==='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="size-4"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"></path></svg><!---->')o.click(),await D(1)}waitForElement(o,a){return this.log("Waiting for element",{name:o,selector:a}),this.widget.run(`${d("taskWaitingFor")} ${o}`,()=>{return new Promise((r)=>{let l=document.querySelector(a);if(l){r(l);return}let s=new MutationObserver(()=>{let i=document.querySelector(a);if(i)s.disconnect(),r(i)});s.observe(document.documentElement,{childList:!0,subtree:!0})})})}updateStars(){this.$stars=[...document.querySelectorAll(".text-yellow-400.cursor-pointer.z-10.maplibregl-marker.maplibregl-marker-anchor-center")].slice(0,E.length),this.log("Star cache updated",{stars:this.$stars.length})}updateImages(){for(let o=0;o<this.images.length;o++)this.images[o].position.updateAnchor(),this.images[o].update()}updateTasks(){for(let o=0;o<this.images.length;o++)this.images[o].updateTasks()}updateImageColors(){for(let o=0;o<this.images.length;o++)this.images[o].updateColors()}}ua();if(location.hostname.includes("hcaptcha.com"))ho();else globalThis.kglacerMacro=new Co,globalThis.kgm=globalThis.kglacerMacro,globalThis.wbot=globalThis.kglacerMacro;
