...
`;class W{bot;image;width;exactColor;static async fromJSON(o,a){let r=new Image;return r.src=a.url.startsWith("http")?await fetch(a.url,{cache:"no-store"}).then((l)=>l.blob()).then((l)=>URL.createObjectURL(l)):a.url,await q(r,["load"],["error"]),new W(o,r,a.width,a.exactColor)}canvas=document.createElement("canvas");context=this.canvas.getContext("2d");pixels;colors=new Map;resolution;get height(){return this.width/this.resolution|0}set height(o){this.width=o*this.resolution|0}constructor(o,a,r=a.naturalWidth,l=!1){this.bot=o;this.image=a;this.width=r;this.exactColor=l;if(l)this.resolution=1,this.width=1000;else this.resolution=this.image.naturalWidth/this.image.naturalHeight;this.update()}update(){this.canvas.width=this.width,this.canvas.height=this.height,this.colors.clear();let o=new Map;for(let r=1;r<64;r++)if(this.exactColor||!this.bot.unavailableColors.has(r))o.set(Z[r],[r,r]);this.context.imageSmoothingEnabled=!1,this.context.imageSmoothingQuality="low",this.context.drawImage(this.image,0,0,this.canvas.width,this.canvas.height),this.pixels=Array.from({length:this.canvas.height},()=>new Array(this.canvas.width));let a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(let r=0;r<this.canvas.height;r++)for(let l=0;l<this.canvas.width;l++){let p=(r*this.canvas.width+l)*4,g=a[p],f=a[p+1],c=a[p+2],s=a[p+3],w=g,u=f,i=c,d=`${w},${u},${i}`;if(this.exactColor){this.pixels[r][l]=s<100?0:Z.indexOf(d);continue}let b,m;if(s<100)b=m=0;else if(o.has(d))[b,m]=o.get(d);else{let z=1/0,H=1/0;for(let A=0;A<k.length;A++){let P=k[A],J=to(mo(w,u,i),P,0);if(!this.bot.unavailableColors.has(A)&&J<z)z=J,b=A;if(J<H)H=J,m=A}o.set(d,[b,m])}if(b!==0)this.context.fillStyle=`oklab(${k[b][0]*100}% ${k[b][1]} ${k[b][2]})`,this.context.fillRect(l,r,1,1);this.pixels[r][l]=b;let t=this.colors.get(m);if(t)t.amount++;else this.colors.set(m,{color:b,amount:1,realColor:m})}}toJSON(){let o=document.createElement("canvas");return o.width=this.image.naturalWidth,o.height=this.image.naturalHeight,o.getContext("2d").drawImage(this.image,0,0),{url:o.toDataURL("image/webp",1),width:this.width,exactColor:this.exactColor}}}var B="kglacer-macro-settings",Ao=["kglacermacro","wbot"],X="kgm";function Vo(){let o=[B,...Ao];for(let a=0;a<o.length;a++){let r=o[a],l=localStorage.getItem(r);if(!l)continue;return{json:l,key:r}}return}function Mo(){let o=Vo();if(!o)return;let a;try{if(a=JSON.parse(o.json),typeof a!=="object")throw new Error("NOT VALID SAVE");if(a.version===1){let r=a;a.images=r.widget.images,a.strategy=r.widget.strategy,delete r.widget}if(o.key!==B)localStorage.setItem(B,o.json)}catch{localStorage.removeItem(o.key),a=void 0}return a}var Ho;function N(o,a=!1){if(clearTimeout(Ho),a)localStorage.setItem(B,JSON.stringify(o));else Ho=setTimeout(()=>{localStorage.setItem(B,JSON.stringify(o))},600)}var M=1000,Bo=2048,L=M*Bo,h=[],T=[],Lo=Date.now();function I(o){h.push(o),T.push({id:Lo++,latitude:(2*Math.atan(Math.exp(-(o.y/L*(2*Math.PI)-Math.PI)))-Math.PI/2)*180/Math.PI,longitude:(o.x/L*(2*Math.PI)-Math.PI)*180/Math.PI,name:"KGLACER_MACRO_FAVORITE"})}I({x:L/3|0,y:L/3|0});I({x:L/3*2|0,y:L/3*2|0});function C(o){let[a,r]=o.style.transform.slice(32,-31).split(", ").map((l)=>Number.parseFloat(l));return{x:a,y:r}}class F{bot;static fromJSON(o,a){return new F(o,...a)}static fromScreenPosition(o,a){let{anchorScreenPosition:r,pixelSize:l,anchorWorldPosition:p}=o.findAnchorsForScreen(a);return new F(o,p.x+(a.x-r.x)/l|0,p.y+(a.y-r.y)/l|0)}globalX=0;globalY=0;get tileX(){return this.globalX/M|0}set tileX(o){this.globalX=o*M+this.x}get tileY(){return this.globalY/M|0}set tileY(o){this.globalY=o*M+this.y}get x(){return this.globalX%M}set x(o){this.globalX=this.tileX*M+o}get y(){return this.globalY%M}set y(o){this.globalY=this.tileY*M+o}anchor1Index;anchor2Index;get pixelSize(){return(C(this.bot.$stars[this.anchor2Index]).x-C(this.bot.$stars[this.anchor1Index]).x)/(h[this.anchor2Index].x-h[this.anchor1Index].x)}constructor(o,a,r,l,p){this.bot=o;if(l===void 0||p===void 0)this.globalX=a,this.globalY=r;else this.globalX=a*M+l,this.globalY=r*M+p;this.updateAnchor()}updateAnchor(){this.anchor1Index=0,this.anchor2Index=1;let o=1/0,a=1/0;for(let r=0;r<h.length;r++){let{x:l,y:p}=h[r];if(l<this.globalX&&p<this.globalY){let g=this.globalX-l+(this.globalY-p);if(g<o)o=g,this.anchor1Index=r}else if(l>this.globalX&&p>this.globalY){let g=l-this.globalX+(p-this.globalY);if(g<a)a=g,this.anchor2Index=r}}}toScreenPosition(){let o=h[this.anchor1Index],a=C(this.bot.$stars[this.anchor1Index]);return{x:(this.globalX-o.x)*this.pixelSize+a.x,y:(this.globalY-o.y)*this.pixelSize+a.y}}getMapColor(){return this.bot.mapsCache.get(this.tileX+"/"+this.tileY).pixels[this.y][this.x]}scrollScreenTo(){let{x:o,y:a}=this.toScreenPosition();this.bot.moveMap({x:o-window.innerWidth/3,y:a-window.innerHeight/3})}clone(){return new F(this.bot,this.tileX,this.tileY,this.x,this.y)}toJSON(){return[this.globalX,this.globalY]}}class S extends _{bot;position;pixels;strategy;opacity;drawTransparentPixels;drawColorsInOrder;colors;lock;static PREVIEW_MASK_BASE_WIDTH=96;static PREVIEW_MASK_BASE_HEIGHT=96;static async fromJSON(o,a){return new S(o,F.fromJSON(o,a.position),await W.fromJSON(o,a.pixels),a.strategy,a.opacity,a.drawTransparentPixels,a.drawColorsInOrder,a.colors,a.lock)}element=document.createElement("div");tasks=[];moveInfo;$canvas;$colorsDialog;$colorsDialogList;$colorSearch;$openColors;$openPreview;$closeColors;$closePreview;$delete;$drawColorsInOrder;$drawTransparent;$export;$lock;$opacity;$progressLine;$progressText;$previewDialog;$previewDialogList;$resetSize;$resetSizeSpan;$settings;$strategy;$topbar;$wrapper;colorDialogDragState;suppressNextColorDialogBackdropClick=!1;previewCacheSignature;previewSequenceCache=new Map;previewAnimations=new WeakMap;previewAnimationHandles=new Set;constructor(o,a,r,l="SPIRAL_FROM_CENTER",p=50,g=!1,f=!1,c=[],s=!1){super();this.bot=o;this.position=a;this.pixels=r;this.strategy=l;this.opacity=p;this.drawTransparentPixels=g;this.drawColorsInOrder=f;this.colors=c;this.lock=s;this.element.innerHTML=zo,this.element.classList.add("wimage"),D(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$colorsDialog:".colors-dialog",$colorsDialogList:".colors-dialog-list",$colorSearch:".color-search",$openColors:".open-colors",$openPreview:".open-preview",$closeColors:".close-colors",$closePreview:".close-preview",$delete:".delete",$drawColorsInOrder:".draw-colors-in-order",$drawTransparent:".draw-transparent",$export:".export",$lock:".lock",$opacity:".opacity",$progressLine:".wprogress div",$progressText:".wprogress span",$previewDialog:".preview-dialog",$previewDialogList:".preview-dialog-list",$resetSize:".reset-size",$settings:".wform",$strategy:".strategy",$topbar:".wtopbar",$wrapper:".wrapper"}),this.$resetSizeSpan=this.$resetSize.querySelector("span"),this.$canvas=this.pixels.canvas,this.$wrapper.prepend(this.pixels.canvas),document.body.append(this.$colorsDialog,this.$previewDialog),this.registerEvent(this.$strategy,"change",()=>{if(this.strategy=this.$strategy.value,this.$previewDialog.open)this.renderStrategyPreviewSamples();N(this.bot)}),this.registerEvent(this.$opacity,"input",()=>{this.opacity=this.$opacity.valueAsNumber,this.$opacity.style.setProperty("--val",this.opacity+"%"),this.update(),N(this.bot)}),this.$opacity.style.setProperty("--val",this.opacity+"%"),this.registerEvent(this.$resetSize,"click",()=>{this.pixels.width=this.pixels.image.naturalWidth,this.pixels.update(),this.updateColors(),this.update(),N(this.bot)}),this.registerEvent(this.$drawTransparent,"click",()=>{this.drawTransparentPixels=this.$drawTransparent.checked,N(this.bot)}),this.registerEvent(this.$drawColorsInOrder,"click",()=>{this.drawColorsInOrder=this.$drawColorsInOrder.checked,N(this.bot)}),this.registerEvent(this.$lock,"click",()=>{this.lock=!this.lock,this.update(),N(this.bot)}),this.registerEvent(this.$delete,"click",this.destroy.bind(this)),this.registerEvent(this.$openColors,"click",()=>{this.openColorPanel()}),this.registerEvent(this.$openPreview,"click",()=>{this.openPreviewPanel()}),this.registerEvent(this.$closeColors,"click",()=>{this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$closePreview,"click",()=>{this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorsDialog.querySelector(".colors-dialog-head"),"pointerdown",this.startColorDialogDrag.bind(this)),this.registerEvent(document,"pointermove",this.moveColorDialog.bind(this),{passive:!1}),this.registerEvent(document,"pointerup",this.stopColorDialogDrag.bind(this)),this.registerEvent(document,"pointercancel",this.stopColorDialogDrag.bind(this)),this.registerEvent(this.$colorsDialog,"click",(w)=>{if(this.suppressNextColorDialogBackdropClick){this.suppressNextColorDialogBackdropClick=!1;return}if(w.target===this.$colorsDialog)this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$previewDialog,"click",(w)=>{if(w.target===this.$previewDialog)this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorSearch,"input",()=>{this.updateColors()}),this.registerEvent(this.$export,"click",this.export.bind(this)),this.registerEvent(this.$topbar,"mousedown",this.moveStart.bind(this)),this.registerEvent(this.$canvas,"mousedown",this.moveStart.bind(this)),this.registerEvent(document,"mouseup",this.moveStop.bind(this)),this.registerEvent(document,"mousemove",this.move.bind(this));for(let w of this.element.querySelectorAll(".resize"))this.registerEvent(w,"mousedown",this.resizeStart.bind(this));this.update(),this.updateColors()}toJSON(){return{pixels:this.pixels.toJSON(),position:this.position.toJSON(),strategy:this.strategy,opacity:this.opacity,drawTransparentPixels:this.drawTransparentPixels,drawColorsInOrder:this.drawColorsInOrder,colors:this.colors,lock:this.lock}}updateTasks(){this.tasks.length=0;let o=this.position.clone(),a=new Set,r=new Map;for(let l=0;l<this.colors.length;l++){let p=this.colors[l];if(p.disabled)a.add(p.realColor);r.set(p.realColor,l)}for(let{x:l,y:p}of this.strategyPositionIterator()){let g=this.pixels.pixels[p][l];if(a.has(g))continue;o.globalX=this.position.globalX+l,o.globalY=this.position.globalY+p;let f=o.getMapColor();if(g!==f&&(this.drawTransparentPixels||g!==0))this.tasks.push({position:o.clone(),color:g})}if(this.drawColorsInOrder)this.tasks.sort((l,p)=>(r.get(l.color)??0)-(r.get(p.color)??0));this.update(),this.bot.widget.update()}update(){let{x:o,y:a}=this.position.toScreenPosition(),r=this.position.pixelSize*this.pixels.width,l=this.position.pixelSize*this.pixels.height;this.element.style.transform=`translate3d(${o.toFixed(3)}px, ${a.toFixed(3)}px, 0)`,this.element.style.width=`${r}px`,this.element.style.height=`${l}px`,this.$canvas.style.opacity=`${this.opacity}%`,this.element.classList.remove("hidden"),this.$resetSizeSpan.textContent=this.pixels.width.toString(),this.$strategy.value=this.strategy,this.$opacity.valueAsNumber=this.opacity,this.$drawTransparent.checked=this.drawTransparentPixels,this.$drawColorsInOrder.checked=this.drawColorsInOrder;let p=this.pixels.pixels.length*this.pixels.pixels[0].length,g=Math.max(0,p-this.tasks.length),f=p>0?g/p*100|0:0;this.$progressText.textContent=`${g}/${p} ${f}% ETA: ${this.tasks.length/120|0}h`,this.$progressLine.style.transform=`scaleX(${f/100})`,this.$canvas.classList[this.lock?"add":"remove"]("no-pointer-events");for(let c of this.element.querySelectorAll(".resize"))c.classList[this.lock?"add":"remove"]("no-pointer-events");this.$lock.classList[this.lock?"add":"remove"]("locked")}exportImage(){this.export()}destroy(){super.destroy(),this.element.remove(),this.$colorsDialog.remove(),this.$previewDialog.remove(),lo(this.bot.images,this),this.bot.widget.update(),N(this.bot)}openColorPanel(){if(this.$colorsDialog.open){this.$colorSearch.focus();return}this.$colorsDialog.style.position="fixed",this.$colorsDialog.style.left="",this.$colorsDialog.style.top="",this.$colorsDialog.style.margin="auto",this.$colorsDialog.showModal(),this.$colorSearch.focus()}openPreviewPanel(){if(this.$previewDialog.open){this.renderStrategyPreviewSamples();return}this.$previewDialog.style.position="fixed",this.$previewDialog.style.left="",this.$previewDialog.style.top="",this.$previewDialog.style.margin="auto",this.$previewDialog.showModal(),this.renderStrategyPreviewSamples()}closeDialog(o){if(!o.open)return;if(o===this.$previewDialog)this.stopPreviewAnimations();if(typeof o.requestClose==="function")o.requestClose();else o.close()}stopPreviewAnimations(){for(let o of this.previewAnimationHandles)cancelAnimationFrame(o);this.previewAnimationHandles.clear()}startColorDialogDrag(o){if(o.button!==0)return;if(o.target?.closest("button,input,select,textarea,a,label"))return;let r=this.$colorsDialog.getBoundingClientRect();this.colorDialogDragState={pointerId:o.pointerId,offsetX:o.clientX-r.left,offsetY:o.clientY-r.top,moved:!1},o.preventDefault()}moveColorDialog(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;let a=this.$colorsDialog.getBoundingClientRect(),r=Math.max(8,window.innerWidth-a.width-8),l=Math.max(8,window.innerHeight-a.height-8),p=Math.min(r,Math.max(8,o.clientX-this.colorDialogDragState.offsetX)),g=Math.min(l,Math.max(8,o.clientY-this.colorDialogDragState.offsetY));if(!this.colorDialogDragState.moved&&(Math.abs(o.movementX)>0||Math.abs(o.movementY)>0))this.colorDialogDragState.moved=!0;this.$colorsDialog.style.left=`${Math.round(p)}px`,this.$colorsDialog.style.top=`${Math.round(g)}px`,o.preventDefault()}stopColorDialogDrag(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;if(this.colorDialogDragState.moved)this.suppressNextColorDialogBackdropClick=!0;this.colorDialogDragState=void 0}renderStrategyPreviewSamples(){this.stopPreviewAnimations(),this.invalidatePreviewCacheIfNeeded();let o=this.$strategy.value;this.$previewDialogList.innerHTML="";let a=document.createDocumentFragment(),r=document.createElement("article");r.className="preview-card";let l=document.createElement("strong");l.textContent=this.getStrategyLabel(o);let p=document.createElement("canvas");p.className="preview-canvas",p.width=156,p.height=156,this.paintStrategyPreview(p,o),r.append(l,p),a.append(r),this.$previewDialogList.append(a)}invalidatePreviewCacheIfNeeded(){let o=this.colors.map((r,l)=>`${l}:${r.realColor}:${r.disabled?1:0}`).join("|"),a=`${this.pixels.width}x${this.pixels.height}:${this.pixels.image.src.length}:${this.drawColorsInOrder?1:0}:${o}`;if(this.previewCacheSignature===a)return;this.previewCacheSignature=a,this.previewSequenceCache.clear()}getStrategyLabel(o){switch(o){case"RANDOM":return n("random");case"HUMANIZED":return n("humanized");case"HUMAN_SOFT_DITHER":return n("humanSoftDither");case"HUMAN_PATCHY":return n("humanPatchy");case"HUMAN_SWEEP_ARCS":return n("humanSweepArcs");case"HUMAN_MICRO_CORRECTIONS":return n("humanMicroCorrections");case"HUMAN_JITTER_FILL":return n("humanJitterFill");case"HUMAN_CORNER_BIAS":return n("humanCornerBias");case"HUMAN_LONG_STROKES":return n("humanLongStrokes");case"HUMAN_TAP_CLUSTERS":return n("humanTapClusters");case"HUMAN_MESSY_SPIRAL":return n("humanMessySpiral");case"HUMAN_DRUNK_WALK":return n("humanDrunkWalk");case"HUMAN_NOISE_CLOUD":return n("humanNoiseCloud");case"HUMAN_PATCH_JUMP":return n("humanPatchJump");case"HUMAN_HESITANT_LINES":return n("humanHesitantLines");case"HUMAN_OVERLAP_SWEEPS":return n("humanOverlapSweeps");case"HUMAN_WOBBLE_DRIFT":return n("humanWobbleDrift");case"HUMAN_GAP_RECOVERY":return n("humanGapRecovery");case"HUMAN_STAIRCASE":return n("humanStaircase");case"HUMAN_EDGE_HUGGER":return n("humanEdgeHugger");case"HUMAN_BLOBS":return n("humanBlobs");case"HUMAN_BACKTRACK":return n("humanBacktrack");case"HUMAN_SHAKY_DIAGONAL":return n("humanShakyDiagonal");case"HUMAN_LATE_FIXES":return n("humanLateFixes");case"ZIGZAG":return n("zigzag");case"BRUSH_STROKES":return n("brushStrokes");case"DIAGONAL_BRUSH":return n("diagonalBrush");case"DOWN":return n("down");case"UP":return n("up");case"LEFT":return n("left");case"RIGHT":return n("right");case"SPIRAL_FROM_CENTER":return n("spiralOut");case"SPIRAL_TO_CENTER":return n("spiralIn");case"SCRIBBLE":return n("scribble");case"CROSSHATCH":return n("crosshatch");case"WAVE_SWEEP":return n("waveSweep");case"SCATTERED_LINES":return n("scatteredLines");case"CONTOUR_JITTER":return n("contourJitter");case"SPIRAL_WOBBLE":return n("spiralWobble");case"CLUSTER_BURSTS":return n("clusterBursts");case"ORBITAL":return n("orbital");case"FLOW_FIELD":return n("flowField");case"EDGE_IN":return n("edgeIn");default:return o}}paintStrategyPreview(o,a){let r=o.getContext("2d");if(!r)return;r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);let l=this.getSampledImagePreviewData(),p=this.getCachedPreviewSequence(a,l.mask,l.width,l.height),g=Math.min(o.width/l.width,o.height/l.height),f=(o.width-l.width*g)/2,c=(o.height-l.height*g)/2,s=this.previewAnimations.get(o);if(s)cancelAnimationFrame(s),this.previewAnimationHandles.delete(s);let w=(z)=>{let H=requestAnimationFrame((A)=>{this.previewAnimationHandles.delete(H),z(A)});return this.previewAnimationHandles.add(H),H},u=(z)=>{r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);for(let H=0;H<Math.min(z,p.length);H++){let A=p[H],P=l.colors.get(`${A.x}:${A.y}`)??0;if(!P)continue;r.fillStyle=fo(P),r.fillRect(f+A.x*g,c+A.y*g,Math.max(1,g),Math.max(1,g))}},i=Math.min(3400,Math.max(900,p.length*8)),b=i+220,m=(z,H)=>{if(!this.$previewDialog.open)return;let A=(H-z)%b,P=Math.min(1,A/i),J=P*P*(3-2*P);u(Math.floor(p.length*J));let K=w((R)=>{m(z,R)});this.previewAnimations.set(o,K)},t=performance.now();m(t,t)}getCachedPreviewSequence(o,a,r=this.pixels.width,l=this.pixels.height){let p=this.colors.map((s,w)=>`${w}:${s.realColor}:${s.disabled?1:0}`).join("|"),g=`${o}:${r}x${l}:${a.length}:${this.drawColorsInOrder?1:0}:${p}`,f=this.previewSequenceCache.get(g);if(f)return f;let c=r===this.pixels.width&&l===this.pixels.height?this.getExactPreviewSequence(o,a):this.getApproxPreviewSequence(o,a,r);if(this.drawColorsInOrder){let s=new Map;for(let w=0;w<this.colors.length;w++)s.set(this.colors[w].realColor,w);c.sort((w,u)=>(s.get(this.pixels.pixels[w.y]?.[w.x]??0)??0)-(s.get(this.pixels.pixels[u.y]?.[u.x]??0)??0))}return this.previewSequenceCache.set(g,c),c}getExactPreviewSequence(o,a){let r=this.strategy;this.strategy=o;let l=[...this.strategyPositionIterator()];this.strategy=r;let p=new Set(a.map(({x:g,y:f})=>`${g}:${f}`));return l.filter(({x:g,y:f})=>p.has(`${g}:${f}`))}getApproxPreviewSequence(o,a,r){let l=[...a],p=(c,s,w)=>{return(c*73856093+s*19349663+w*83492791>>>0)/4294967296},g=(c,s)=>l.sort((w,u)=>w.x*c+w.y*s-(u.x*c+u.y*s)||w.y-u.y||w.x-u.x),f=l.sort((c,s)=>{if(c.y!==s.y)return c.y-s.y;let w=c.y%2===0?c.x:r-c.x,u=s.y%2===0?s.x:r-s.x;return w-u});switch(o){case"UP":return g(0,-1);case"LEFT":return g(-1,0);case"RIGHT":return g(1,0);case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let c=r/2,s=Math.max(1,Math.round(l.reduce((w,u)=>w+u.y,0)/Math.max(1,l.length)));return l.sort((w,u)=>{let i=(w.x-c)**2+(w.y-s)**2,d=(u.x-c)**2+(u.y-s)**2;return o==="SPIRAL_FROM_CENTER"?i-d:d-i}),l}case"RANDOM":case"HUMANIZED":case"HUMAN_SOFT_DITHER":case"HUMAN_PATCHY":case"HUMAN_SWEEP_ARCS":case"HUMAN_MICRO_CORRECTIONS":case"HUMAN_JITTER_FILL":case"HUMAN_CORNER_BIAS":case"HUMAN_LONG_STROKES":case"HUMAN_TAP_CLUSTERS":case"HUMAN_MESSY_SPIRAL":case"HUMAN_DRUNK_WALK":case"HUMAN_NOISE_CLOUD":case"HUMAN_PATCH_JUMP":case"HUMAN_HESITANT_LINES":case"HUMAN_OVERLAP_SWEEPS":case"HUMAN_WOBBLE_DRIFT":case"HUMAN_GAP_RECOVERY":case"HUMAN_STAIRCASE":case"HUMAN_EDGE_HUGGER":case"HUMAN_BLOBS":case"HUMAN_BACKTRACK":case"HUMAN_SHAKY_DIAGONAL":case"HUMAN_LATE_FIXES":return l.sort((c,s)=>p(c.x,c.y,o.length)-p(s.x,s.y,o.length));default:return f}}getSampledImagePreviewData(){let o=this.pixels.width,a=this.pixels.height,r=S.PREVIEW_MASK_BASE_WIDTH,l=S.PREVIEW_MASK_BASE_HEIGHT,p=Math.min(1,r/Math.max(1,o),l/Math.max(1,a)),g=Math.max(1,Math.round(o*p)),f=Math.max(1,Math.round(a*p)),c=new Set;for(let i=0;i<this.colors.length;i++){let d=this.colors[i];if(d.disabled)c.add(d.realColor)}let s=new Map,w=new Map;for(let i=0;i<a;i++)for(let d=0;d<o;d++){let b=this.pixels.pixels[i]?.[d]??0;if(!b||c.has(b))continue;let m=Math.min(g-1,Math.floor(d/o*g)),t=Math.min(f-1,Math.floor(i/a*f)),z=`${m}:${t}`;if(!s.has(z))s.set(z,{x:m,y:t});if(!w.has(z))w.set(z,b)}let u=[...s.values()];if(!u.length){let i=this.fallbackPreviewMask();return{width:o,height:a,mask:i,colors:new Map(i.map((d)=>[`${d.x}:${d.y}`,this.pixels.pixels[d.y]?.[d.x]??0]))}}return{width:g,height:f,mask:u,colors:w}}getImagePreviewMask(){let o=this.pixels.width,a=this.pixels.height,r=new Set;for(let p=0;p<this.colors.length;p++){let g=this.colors[p];if(g.disabled)r.add(g.realColor)}let l=[];for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=this.pixels.pixels[p]?.[g]??0;if(f!==0&&!r.has(f))l.push({x:g,y:p})}return l.length?l:this.fallbackPreviewMask()}fallbackPreviewMask(){let o=[],a=this.pixels.width/2,r=this.pixels.height/2,l=Math.max(4,Math.min(this.pixels.width,this.pixels.height)/2.5);for(let p=0;p<this.pixels.height;p++)for(let g=0;g<this.pixels.width;g++)if((g-a)**2+(p-r)**2<=l**2)o.push({x:g,y:p});return o}applyLocale(){if(D(this.element),this.updateColors(),this.$previewDialog.open)this.renderStrategyPreviewSamples()}colorHex(o){let a=Z[o]??"0,0,0",[r=0,l=0,p=0]=a.split(",").map((g)=>Number.parseInt(g,10));return`#${[r,l,p].map((g)=>g.toString(16).padStart(2,"0")).join("")}`}colorKeywords(o){let a=Z[o]??"0,0,0",[r=0,l=0,p=0]=a.split(",").map((s)=>Number.parseInt(s,10)),g=Math.max(r,l,p),f=Math.min(r,l,p);if(g-f<15)return["gray","grey","gris","neutral","neutro"];if(r>l+30&&r>p+30)return["red","rojo"];if(l>r+30&&l>p+30)return["green","verde"];if(p>r+30&&p>l+30)return["blue","azul"];if(r>170&&l>120&&p<130)return["orange","naranja"];if(r>170&&l>110&&p>140)return["pink","rosa"];if(r>120&&l<100&&p>120)return["purple","violet","morado"];if(r>130&&l>130&&p<90)return["yellow","amarillo"];return["brown","cafe","marron"]}updateColors(){this.$colorsDialogList.innerHTML="";let o=this.pixels.pixels.length*this.pixels.pixels[0].length;this.$colorsDialogList.setAttribute("aria-label",n("colorPanelResults"));let a=this.$colorSearch.value.trim().toLowerCase();if(this.colors.length!==this.pixels.colors.size||this.colors.some((r)=>!this.pixels.colors.has(r.realColor)))this.colors=this.pixels.colors.values().toArray().sort((r,l)=>l.amount-r.amount).map((r)=>({realColor:r.realColor,disabled:!1})),N(this.bot);for(let r=0;r<this.colors.length;r++){let l=this.colors[r],p=this.pixels.colors.get(l.realColor),g=!1,f=p.realColor!==p.color,c=p.amount/o*100,s=this.colorHex(p.realColor),w=this.colorKeywords(p.realColor),u=()=>{l.disabled=l.disabled?void 0:!0,i.classList.toggle("disabled",Boolean(l.disabled));let b=i.querySelector(".state");if(b)b.textContent=l.disabled?n("disabled"):n("enabled");N(this.bot)},i=document.createElement("button");if(i.className=`color-chip ${l.disabled?"disabled":""}`,i.draggable=!0,i.setAttribute("aria-label",`${n("overlayColors")} #${r+1}: ${s.toUpperCase()}`),i.innerHTML=`<span class="order-index">#${r+1}</span>
<span class="drag" title="${n("up")} / ${n("down")}">⋮⋮</span>
<span class="swatch"></span>
<span class="meta">
  <span class="coverage">${c.toFixed(1)}%</span>
  <span class="hex">${s.toUpperCase()}</span>
  <span class="state">${l.disabled?n("disabled"):n("enabled")}</span>
</span>
<span class="premium ${f?"on":""}">${f?n("premium"):""}</span>`,i.querySelector(".swatch").style.setProperty("--swatch-color",fo(p.realColor)),i.addEventListener("click",()=>{if(g){g=!1;return}u()}),i.addEventListener("dragstart",(b)=>{g=!0,i.classList.add("dragging"),b.dataTransfer?.setData("text/plain",String(r)),b.dataTransfer.effectAllowed="move"}),i.addEventListener("dragend",()=>{i.classList.remove("dragging")}),i.addEventListener("dragover",(b)=>{b.preventDefault(),i.classList.add("drag-target")}),i.addEventListener("dragleave",()=>{i.classList.remove("drag-target")}),i.addEventListener("drop",(b)=>{b.preventDefault(),i.classList.remove("drag-target");let m=Number.parseInt(b.dataTransfer?.getData("text/plain")??"-1",10);if(m<0||m===r||m>=this.colors.length)return;this.colors.splice(r,0,...this.colors.splice(m,1)),N(this.bot),this.updateColors()}),f){let b=document.createElement("button");b.textContent=n("buy"),b.className="buy-chip",b.addEventListener("click",(m)=>{m.stopPropagation(),document.getElementById("color-"+p.realColor)?.click()}),i.append(b)}let d=`${s} ${w.join(" ")} ${p.realColor} ${Z[p.realColor]}`;if(!a||d.toLowerCase().includes(a))this.$colorsDialogList.append(i)}}*strategyPositionIterator(){let o=this.pixels.pixels[0].length,a=this.pixels.pixels.length;switch(this.strategy){case"DOWN":{for(let r=0;r<a;r++)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"UP":{for(let r=a-1;r>=0;r--)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"LEFT":{for(let r=0;r<o;r++)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RIGHT":{for(let r=o-1;r>=0;r--)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RANDOM":{let r=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++)r.push({x:p,y:l});for(let l=r.length-1;l>=0;l--){let p=Math.floor(Math.random()*(l+1)),g=r[l];r[l]=r[p],r[p]=g}yield*r;break}case"ZIGZAG":{for(let r=0;r<a;r++)if(r%2===0)for(let l=0;l<o;l++)yield{x:l,y:r};else for(let l=o-1;l>=0;l--)yield{x:l,y:r};break}case"HUMANIZED":{let r=Math.max(4,Math.floor(Math.min(o,a)/10)),l=[];for(let p=0;p<a;p+=r)for(let g=0;g<o;g+=r)l.push({x:g,y:p});for(let p=l.length-1;p>=0;p--){let g=Math.floor(Math.random()*(p+1)),f=l[p];l[p]=l[g],l[g]=f}for(let p=0;p<l.length;p++){let g=l[p],f=Math.min(a,g.y+r),c=Math.min(o,g.x+r);for(let s=g.y;s<f;s++)if(Math.random()>0.35)for(let u=g.x;u<c;u++)yield{x:u,y:s};else for(let u=c-1;u>=g.x;u--)yield{x:u,y:s}}break}case"HUMAN_SOFT_DITHER":{let r=new Set;for(let l=0;l<a;l++){let p=Math.floor(Math.random()*3)-1;if((l+p)%2===0)for(let f=0;f<o;f+=2)r.add(`${f},${l}`),yield{x:f,y:l};else for(let f=1;f<o;f+=2)r.add(`${f},${l}`),yield{x:f,y:l}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let g=`${p},${l}`;if(r.has(g))continue;yield{x:p,y:l}}break}case"HUMAN_PATCHY":{let r=new Set,l=o*a;while(r.size<l){let p=Math.floor(Math.random()*o),g=Math.floor(Math.random()*a),f=1+Math.floor(Math.random()*5);for(let c=g-f;c<=g+f;c++)for(let s=p-f;s<=p+f;s++){if(s<0||s>=o||c<0||c>=a)continue;if(Math.hypot(s-p,c-g)>f+Math.random()*1.2)continue;let w=`${s},${c}`;if(r.has(w))continue;r.add(w),yield{x:s,y:c}}}break}case"HUMAN_SWEEP_ARCS":{let r=new Set,l=(o-1)/2,p=(a-1)/2,g=Math.hypot(l,p);for(let f=0;f<4;f++){let c=Math.random()*Math.PI*2;for(let s=0;s<=g;s+=0.35){let w=Math.PI/2+Math.random()*(Math.PI/1.5),u=Math.max(10,Math.floor(s*8));for(let i=0;i<u;i++){let d=c+w*i/u+Math.sin(s)*0.08,b=Math.round(l+Math.cos(d)*s),m=Math.round(p+Math.sin(d)*s);if(b<0||b>=o||m<0||m>=a)continue;let t=`${b},${m}`;if(r.has(t))continue;r.add(t),yield{x:b,y:m}}}}for(let f=0;f<a;f++)for(let c=0;c<o;c++){let s=`${c},${f}`;if(r.has(s))continue;yield{x:c,y:f}}break}case"HUMAN_MICRO_CORRECTIONS":{let r=new Set;for(let l=0;l<a;l++){let p=l%2===0?1:-1,g=p>0?0:o-1;for(let f=0;f<o;f++){let c=g+(Math.random()>0.82?p:0),s=l+(Math.random()>0.9?1:0);for(let w of[{x:g,y:l},{x:c,y:l},{x:g,y:s}]){if(w.x<0||w.x>=o||w.y<0||w.y>=a)continue;let u=`${w.x},${w.y}`;if(r.has(u))continue;r.add(u),yield w}g+=p}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let g=`${p},${l}`;if(r.has(g))continue;yield{x:p,y:l}}break}case"HUMAN_JITTER_FILL":{let r=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++)r.push({x:p,y:l});r.sort((l,p)=>{let g=l.y+(Math.random()-0.5)*1.8,f=p.y+(Math.random()-0.5)*1.8;if(g!==f)return g-f;return l.x+(Math.random()-0.5)*2-(p.x+(Math.random()-0.5)*2)}),yield*r;break}case"HUMAN_CORNER_BIAS":{let r=[{x:0,y:0},{x:o-1,y:0},{x:0,y:a-1},{x:o-1,y:a-1}],l=r[Math.floor(Math.random()*r.length)],p=[];for(let g=0;g<a;g++)for(let f=0;f<o;f++){let s=Math.hypot(f-l.x,g-l.y)+Math.random()*3.5;p.push({point:{x:f,y:g},score:s})}p.sort((g,f)=>g.score-f.score);for(let g of p)yield g.point;break}case"HUMAN_LONG_STROKES":{let r=new Set,l=o*a;while(r.size<l){let p=Math.floor(Math.random()*o),g=Math.floor(Math.random()*a),f=Math.random()*Math.PI*2,c=Math.sign(Math.cos(f)),s=Math.sign(Math.sin(f)),w=10+Math.floor(Math.random()*40);for(let u=0;u<w;u++){if(p<0||p>=o||g<0||g>=a)break;let i=`${p},${g}`;if(!r.has(i))r.add(i),yield{x:p,y:g};if(Math.random()>0.78)p+=s,g+=c;else p+=c,g+=s}}break}case"HUMAN_TAP_CLUSTERS":{let r=new Set,l=o*a;while(r.size<l){let p=Math.floor(Math.random()*o),g=Math.floor(Math.random()*a),f=3+Math.floor(Math.random()*10);for(let c=0;c<f;c++){let s=Math.round(p+(Math.random()-0.5)*6),w=Math.round(g+(Math.random()-0.5)*6);if(s<0||s>=o||w<0||w>=a)continue;let u=`${s},${w}`;if(r.has(u))continue;r.add(u),yield{x:s,y:w}}}break}case"HUMAN_MESSY_SPIRAL":{let r=new Set,l=(o-1)/2,p=(a-1)/2,g=Math.hypot(l,p)+2;for(let f=0;r.size<o*a;f++){let c=f/3,s=Math.min(g,c*0.18),w=c*0.29+Math.sin(c*0.13)*0.8,u=Math.round(l+Math.cos(w)*s+Math.sin(c)*0.7),i=Math.round(p+Math.sin(w)*s+Math.cos(c)*0.7);if(u<0||u>=o||i<0||i>=a){if(f>o*a*18)break;continue}let d=`${u},${i}`;if(r.has(d)){if(Math.random()>0.9)continue}else r.add(d),yield{x:u,y:i};if(f>o*a*18)break}for(let f=0;f<a;f++)for(let c=0;c<o;c++){let s=`${c},${f}`;if(r.has(s))continue;yield{x:c,y:f}}break}case"HUMAN_DRUNK_WALK":{let r=new Set,l=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),g=[{x:-1,y:0},{x:1,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:-1},{x:1,y:-1},{x:-1,y:1},{x:1,y:1}];while(r.size<o*a){let f=`${l},${p}`;if(!r.has(f))r.add(f),yield{x:l,y:p};let c=[];for(let u of g){let i=l+u.x,d=p+u.y;if(i<0||i>=o||d<0||d>=a)continue;c.push({x:i,y:d})}if(!c.length)break;let s=c.filter((u)=>{return!r.has(`${u.x},${u.y}`)});if(s.length&&Math.random()>0.2){let u=s[Math.floor(Math.random()*s.length)];l=u.x,p=u.y;continue}let w=c[Math.floor(Math.random()*c.length)];l=w.x,p=w.y}for(let f=0;f<a;f++)for(let c=0;c<o;c++){let s=`${c},${f}`;if(r.has(s))continue;yield{x:c,y:f}}break}case"HUMAN_NOISE_CLOUD":{let r=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++){let g=Math.sin((p+1)*0.93+Math.random()*0.8)+Math.cos((l+1)*1.17+Math.random()*0.8),f=(Math.random()-0.5)*2.6,c=Math.hypot(p-o/2,l-a/2)*0.08;r.push({point:{x:p,y:l},score:g+f+c})}r.sort((l,p)=>l.score-p.score);for(let l of r)yield l.point;break}case"HUMAN_PATCH_JUMP":{let r=new Set,l=[];for(let p=0;p<Math.max(6,o*a/18);p++)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});while(r.size<o*a){let p=l[Math.floor(Math.random()*l.length)],g=1+Math.floor(Math.random()*3),f=1+Math.floor(Math.random()*3);for(let c=p.y-f;c<=p.y+f;c++)for(let s=p.x-g;s<=p.x+g;s++){if(s<0||s>=o||c<0||c>=a)continue;if(Math.random()>0.86)continue;let w=`${s},${c}`;if(r.has(w))continue;r.add(w),yield{x:s,y:c}}if(Math.random()>0.72&&l.length<o*a/2)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});if(r.size>o*a*0.92)break}for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=`${g},${p}`;if(r.has(f))continue;yield{x:g,y:p}}break}case"HUMAN_HESITANT_LINES":{let r=new Set;for(let l=0;l<a;l++){let p=l%2===0;for(let g=0;g<o;g++){let f=p?g:o-1-g,c=`${f},${l}`;if(!r.has(c))r.add(c),yield{x:f,y:l};if(Math.random()>0.7){let s=Math.max(0,Math.min(o-1,f+(Math.random()>0.5?1:-1))),w=Math.max(0,Math.min(a-1,l+(Math.random()>0.65?1:0))),u=`${s},${w}`;if(!r.has(u))r.add(u),yield{x:s,y:w}}}}for(let l=0;l<a;l++)for(let p=0;p<o;p++){let g=`${p},${l}`;if(r.has(g))continue;yield{x:p,y:l}}break}case"HUMAN_OVERLAP_SWEEPS":{let r=[],l=Math.random()*Math.PI*2;for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=Math.sin((g+p)*0.42+l)*2.2,c=Math.cos((g-p)*0.3+l)*1.4;r.push({point:{x:g,y:p},score:p+f+c+(Math.random()-0.5)*3.4})}r.sort((p,g)=>p.score-g.score);for(let p of r)yield p.point;break}case"HUMAN_WOBBLE_DRIFT":{let r=[],l=o/2,p=a/2;for(let g=0;g<a;g++)for(let f=0;f<o;f++){let c=Math.hypot(f-l,g-p)*0.25,s=Math.sin((f+1)*0.9)*1.8+Math.cos((g+1)*1.1)*1.8+Math.sin((f+g)*0.35)*1.4;r.push({point:{x:f,y:g},score:c+s+(Math.random()-0.5)*2.8})}r.sort((g,f)=>g.score-f.score);for(let g of r)yield g.point;break}case"HUMAN_GAP_RECOVERY":{let r=new Set,l=[];for(let p=0;p<a;p++)for(let g=0;g<o;g++){if(Math.random()>0.87){l.push({x:g,y:p});continue}r.add(`${g},${p}`),yield{x:g,y:p}}l.sort((p,g)=>Math.hypot(p.x-o/2,p.y-a/2)-Math.hypot(g.x-o/2,g.y-a/2));for(let p of l){let g=`${p.x},${p.y}`;if(r.has(g))continue;r.add(g),yield p}break}case"HUMAN_STAIRCASE":{let r=new Set,l=o+a-1;for(let p=0;p<l;p++){let g=Math.max(0,p-o+1),f=Math.min(a-1,p);for(let c=g;c<=f;c++){let s=p-c,w=[{x:s,y:c},{x:s+(Math.random()>0.5?1:-1),y:c},{x:s,y:c+(Math.random()>0.5?1:-1)}];for(let u of w){if(u.x<0||u.x>=o||u.y<0||u.y>=a)continue;let i=`${u.x},${u.y}`;if(r.has(i))continue;r.add(i),yield u}}}for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=`${g},${p}`;if(r.has(f))continue;yield{x:g,y:p}}break}case"HUMAN_EDGE_HUGGER":{let r=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++){let g=Math.min(p,l,o-1-p,a-1-l);r.push({point:{x:p,y:l},score:g*3.5+(Math.random()-0.5)*5.5})}r.sort((l,p)=>l.score-p.score);for(let l of r)yield l.point;break}case"HUMAN_BLOBS":{let r=new Set,l=o*a;while(r.size<l){let p=Math.floor(Math.random()*o),g=Math.floor(Math.random()*a),f=1+Math.floor(Math.random()*4);for(let c=g-f;c<=g+f;c++)for(let s=p-f;s<=p+f;s++){if(s<0||s>=o||c<0||c>=a)continue;let w=Math.atan2(c-g,s-p),u=f+Math.sin(w*3+Math.random())*0.8;if(Math.hypot(s-p,c-g)>u)continue;let i=`${s},${c}`;if(r.has(i))continue;r.add(i),yield{x:s,y:c}}}break}case"HUMAN_BACKTRACK":{let r=new Set,l=[];for(let p=0;p<a;p++)for(let g=0;g<o;g++)l.push({x:g,y:p});l.sort((p,g)=>p.y-g.y+(Math.random()-0.5)*2.2+(p.x-g.x)*0.04);for(let p=0;p<l.length;p++){let g=l[p],f=`${g.x},${g.y}`;if(r.has(f))continue;if(r.add(f),yield g,p>1&&Math.random()>0.74){let c=l[p-1],s=`${c.x},${c.y}`;if(!r.has(s))r.add(s),yield c}}for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=`${g},${p}`;if(r.has(f))continue;yield{x:g,y:p}}break}case"HUMAN_SHAKY_DIAGONAL":{let r=[];for(let l=0;l<a;l++)for(let p=0;p<o;p++){let g=Math.abs(p-l)*0.6,f=Math.sin(p*1.4+l*0.8)*1.8+Math.cos(l*1.1+p*0.5)*1.5;r.push({point:{x:p,y:l},score:g+f+(Math.random()-0.5)*3.2})}r.sort((l,p)=>l.score-p.score);for(let l of r)yield l.point;break}case"HUMAN_LATE_FIXES":{let r=[],l=[];for(let p=0;p<a;p++)for(let g=0;g<o;g++)if(Math.random()>0.9)l.push({x:g,y:p});else r.push({x:g,y:p});r.sort((p,g)=>p.y-g.y+(Math.random()-0.5)*1.5+(Math.random()>0.85?p.x-g.x:0)),l.sort((p,g)=>Math.hypot(g.x-o/2,g.y-a/2)-Math.hypot(p.x-o/2,p.y-a/2)),yield*r,yield*l;break}case"DIAGONAL_BRUSH":{for(let r=0;r<o+a-1;r++){let l=r%2===0,p=[],g=Math.max(0,r-o+1),f=Math.min(a-1,r);for(let c=g;c<=f;c++){let s=r-c;if(s>=0&&s<o)p.push({x:s,y:c})}if(Math.random()>0.55)p.reverse();if(l)for(let c=p.length-1;c>=0;c--)yield p[c];else yield*p}break}case"BRUSH_STROKES":{let r=Array.from({length:a},()=>Array(o).fill(!1)),l=[{x:1,y:0},{x:-1,y:0},{x:0,y:1},{x:0,y:-1},{x:1,y:1},{x:1,y:-1},{x:-1,y:1},{x:-1,y:-1}],p=(c,s)=>c>=0&&c<o&&s>=0&&s<a,g=0,f=o*a;for(let c=0;c<f*6&&g<f;c++){let s=Math.floor(Math.random()*o),w=Math.floor(Math.random()*a),u=l[Math.floor(Math.random()*l.length)],i=3+Math.floor(Math.random()*16);for(let d=0;d<i;d++){if(!p(s,w))break;if(!r[w][s])r[w][s]=!0,g++,yield{x:s,y:w};if(Math.random()>0.72)u=l[Math.floor(Math.random()*l.length)];s+=u.x,w+=u.y}}for(let c=0;c<a;c++)for(let s=0;s<o;s++)if(!r[c][s])yield{x:s,y:c};break}case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let r=new Set,l=o*a,p=Math.floor(o/2),g=Math.floor(a/2),f=[[1,0],[0,1],[-1,0],[0,-1]],c=0,s=1,w=(i,d)=>i>=0&&i<o&&d>=0&&d<a,u=function*(){let i=0;while(i<l){for(let d=0;d<2;d++){for(let b=0;b<s;b++){if(w(p,g)){let m=`${p},${g}`;if(!r.has(m)){if(r.add(m),yield{x:p,y:g},i++,i>=l)return}}p+=f[c][0],g+=f[c][1]}c=(c+1)%4}s++}};if(this.strategy==="SPIRAL_FROM_CENTER")yield*u();else{let i=[...u()];for(let d=i.length-1;d>=0;d--)yield i[d]}break}case"SCRIBBLE":{let r=new Set,l=o*a,p=Math.floor(o/2),g=Math.floor(a/2);for(let f=0;r.size<l&&f<l*24;f++){let c=`${p},${g}`;if(!r.has(c))r.add(c),yield{x:p,y:g};if(p+=Math.floor(Math.random()*3)-1,g+=Math.floor(Math.random()*3)-1,p<0||p>=o||g<0||g>=a)p=Math.floor(Math.random()*o),g=Math.floor(Math.random()*a)}for(let f=0;f<a;f++)for(let c=0;c<o;c++){let s=`${c},${f}`;if(r.has(s))continue;r.add(s),yield{x:c,y:f}}break}case"CROSSHATCH":{let r=[];for(let g=0;g<o+a-1;g++)for(let f=Math.max(0,g-o+1);f<=Math.min(a-1,g);f++){let c=g-f;r.push({x:c,y:f})}let l=[];for(let g=-a+1;g<o;g++)for(let f=0;f<a;f++){let c=f+g;if(c>=0&&c<o)l.push({x:c,y:f})}let p=new Set;for(let g of[...r,...l]){let f=`${g.x},${g.y}`;if(p.has(f))continue;p.add(f),yield g}break}case"WAVE_SWEEP":{let r=new Set;for(let l=0;l<o;l++){let g=(Math.sin(l/Math.max(1,o-1)*Math.PI*4)+1)*0.5*(a-1)|0;for(let f=0;f<a;f++){let c=g+f,s=g-f;for(let w of[c,s]){if(w<0||w>=a)continue;let u=`${l},${w}`;if(r.has(u))continue;r.add(u),yield{x:l,y:w}}}}break}case"SCATTERED_LINES":{let r=new Set,l=o*a;for(let p=0;r.size<l&&p<l*14;p++){let g=Math.floor(Math.random()*o),f=Math.floor(Math.random()*a),c=Math.random()*Math.PI*2,s=Math.round(Math.cos(c)),w=Math.round(Math.sin(c)),u=6+Math.floor(Math.random()*28);for(let i=0;i<u;i++){if(g<0||g>=o||f<0||f>=a)break;let d=`${g},${f}`;if(!r.has(d))r.add(d),yield{x:g,y:f};g+=s,f+=w}}for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=`${g},${p}`;if(r.has(f))continue;r.add(f),yield{x:g,y:p}}break}case"CONTOUR_JITTER":{let r=new Set;for(let l=0;l<Math.ceil(Math.min(o,a)/2);l++){let p=[],g=l,f=l,c=o-l-1,s=a-l-1;for(let w=g;w<=c;w++)p.push({x:w,y:f});for(let w=f+1;w<=s;w++)p.push({x:c,y:w});for(let w=c-1;w>=g;w--)p.push({x:w,y:s});for(let w=s-1;w>f;w--)p.push({x:g,y:w});for(let w=p.length-1;w>0;w--){let u=Math.floor(Math.random()*(w+1)),i=p[w];p[w]=p[u],p[u]=i}for(let w of p){let u=`${w.x},${w.y}`;if(r.has(u))continue;r.add(u),yield w}}break}case"SPIRAL_WOBBLE":{let r=new Set,l=o/2,p=a/2,g=Math.hypot(l,p);for(let f=0;r.size<o*a&&f<o*a*9;f++){let c=f/(o*a*9)*g,s=f*0.31+Math.sin(f*0.07)*0.7,w=Math.round(l+Math.cos(s)*c),u=Math.round(p+Math.sin(s)*c);if(w<0||w>=o||u<0||u>=a)continue;let i=`${w},${u}`;if(r.has(i))continue;r.add(i),yield{x:w,y:u}}for(let f=0;f<a;f++)for(let c=0;c<o;c++){let s=`${c},${f}`;if(r.has(s))continue;yield{x:c,y:f}}break}case"CLUSTER_BURSTS":{let r=new Set,l=o*a;for(let p=0;r.size<l&&p<l*12;p++){let g=Math.floor(Math.random()*o),f=Math.floor(Math.random()*a),c=2+Math.floor(Math.random()*10);for(let s=f-c;s<=f+c;s++)for(let w=g-c;w<=g+c;w++){if(w<0||w>=o||s<0||s>=a)continue;if(Math.hypot(w-g,s-f)>c)continue;let u=`${w},${s}`;if(r.has(u))continue;r.add(u),yield{x:w,y:s}}}for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=`${g},${p}`;if(r.has(f))continue;r.add(f),yield{x:g,y:p}}break}case"ORBITAL":{let r=new Set,l=(o-1)/2,p=(a-1)/2,g=Math.ceil(Math.max(l,p));for(let f=0;f<=g;f++){let c=Math.max(16,Math.ceil(2*Math.PI*Math.max(1,f)*2));for(let s=0;s<c;s++){let w=s/c*Math.PI*2+(f%2?0.3:-0.3),u=Math.round(l+Math.cos(w)*f),i=Math.round(p+Math.sin(w)*f);if(u<0||u>=o||i<0||i>=a)continue;let d=`${u},${i}`;if(r.has(d))continue;r.add(d),yield{x:u,y:i}}}for(let f=0;f<a;f++)for(let c=0;c<o;c++){let s=`${c},${f}`;if(r.has(s))continue;yield{x:c,y:f}}break}case"FLOW_FIELD":{let r=new Set,l=o*a;for(let p=0;r.size<l&&p<l*18;p++){let g=Math.floor(Math.random()*o),f=Math.floor(Math.random()*a);for(let c=0;c<120;c++){if(g<0||g>=o||f<0||f>=a)break;let s=`${g},${f}`;if(!r.has(s))r.add(s),yield{x:g,y:f};let w=Math.sin(g*0.09)*1.8+Math.cos(f*0.08)*1.6+Math.sin((g+f)*0.05);g+=Math.round(Math.cos(w)),f+=Math.round(Math.sin(w))}}for(let p=0;p<a;p++)for(let g=0;g<o;g++){let f=`${g},${p}`;if(r.has(f))continue;r.add(f),yield{x:g,y:p}}break}case"EDGE_IN":{let r=new Set,l=Math.ceil(Math.min(o,a)/2);for(let p=0;p<l;p++){let g=p,f=o-1-p,c=p,s=a-1-p;for(let w=g;w<=f;w++)for(let u of[c,s]){let i=`${w},${u}`;if(r.has(i))continue;r.add(i),yield{x:w,y:u}}for(let w=c+1;w<=s-1;w++)for(let u of[g,f]){let i=`${u},${w}`;if(r.has(i))continue;r.add(i),yield{x:u,y:w}}}break}}}moveStart(o){if(o.button!==0)return;if(o.preventDefault(),o.stopPropagation(),!this.lock)this.moveInfo={globalX:this.position.globalX,globalY:this.position.globalY,clientX:o.clientX,clientY:o.clientY}}moveStop(){if(this.moveInfo)this.moveInfo=void 0,this.position.updateAnchor(),this.pixels.update(),this.updateColors(),N(this.bot)}move(o){if(!this.moveInfo)return;let a=Math.round((o.clientX-this.moveInfo.clientX)/this.position.pixelSize),r=Math.round((o.clientY-this.moveInfo.clientY)/this.position.pixelSize);if(this.moveInfo.globalX!==void 0){if(this.position.globalX=a+this.moveInfo.globalX,this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,this.moveInfo.width-a)}else if(this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,a+this.moveInfo.width);if(this.moveInfo.globalY!==void 0){if(this.position.globalY=r+this.moveInfo.globalY,this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,this.moveInfo.height-r)}else if(this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,r+this.moveInfo.height);this.update(),N(this.bot)}resizeStart(o){if(this.lock||o.button!==0)return;o.preventDefault(),o.stopPropagation(),this.moveInfo={clientX:o.clientX,clientY:o.clientY};let a=o.target;if(a.classList.contains("n"))this.moveInfo.height=this.pixels.height,this.moveInfo.globalY=this.position.globalY;if(a.classList.contains("e"))this.moveInfo.width=this.pixels.width;if(a.classList.contains("s"))this.moveInfo.height=this.pixels.height;if(a.classList.contains("w"))this.moveInfo.width=this.pixels.width,this.moveInfo.globalX=this.position.globalX}export(){let o=document.createElement("a");document.body.append(o),o.href=URL.createObjectURL(new Blob([JSON.stringify(this.toJSON())],{type:"application/json"})),o.download=`${this.pixels.width}x${this.pixels.height}.${X}`,o.click(),URL.revokeObjectURL(o.href),o.href=this.pixels.canvas.toDataURL("image/webp",1),o.download=`${this.pixels.width}x${this.pixels.height}.webp`,o.click(),URL.revokeObjectURL(o.href),o.remove()}}var Po=`/* stylelint-disable declaration-no-important */
...
.wwidget .shortcuts .shortcut-item:nth-child(3n + 1) .shortcut-label i {
  background: linear-gradient(180deg, #3f7cff, #2552d3);
}

.wwidget .shortcuts .shortcut-item:nth-child(3n + 2) .shortcut-label i {
  background: linear-gradient(180deg, #17b26a, #14804e);
}

.wwidget .shortcuts .shortcut-item:nth-child(3n) .shortcut-label i {
...
.wwidget .widget-section-autofarm .wprogress {
  margin-top: 6px;
}
...
`;var Jo="kglacer-macro:overlay-hidden",Do="kglacer-macro:auto-farm-config",Uo="kglacer-macro:auto-overlay-config",Eo="https://raw.githubusercontent.com/robgallardof/kglacer-macro/refs/heads/main/src/img/logo.svg";class so extends _{bot;element=document.createElement("div");get status(){return this.$status.innerHTML}set status(o){this.$status.innerHTML=o}get open(){return this.element.classList.contains("wopen")}set open(o){if(o)this.element.classList.add("wopen");else this.element.classList.remove("wopen")}$settings;$status;$openConfig;$topbar;$draw;$drawAndPaint;$addImage;$captureTemplate;$toggleOverlay;$autofarmConfig;$autofarmStart;$autofarmStop;$autofarmStatus;$autoOverlayConfig;$autoOverlayStart;$autoOverlayStop;$autoOverlayStatus;$strategy;$progressLine;$progressText;$images;$wopenButton;$widgetLogo;activeImageIndex=-1;autoFarmIntervalId;autoFarmConfig;autoFarmTickRunning=!1;autoFarmNextTickAt;autoOverlayIntervalId;autoOverlayConfig;autoOverlayTickRunning=!1;autoOverlayNextTickAt;statusRefreshIntervalId;constructor(o){super();this.bot=o;this.element.classList.add("wwidget"),this.element.innerHTML=Fo,D(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$wopenButton:".wopen-button",$widgetLogo:".widget-logo",$settings:".wform",$status:".wstatus",$openConfig:".open-config",$topbar:".wtopbar",$draw:".draw",$drawAndPaint:".draw-and-paint",$addImage:".add-image",$captureTemplate:".capture-template",$toggleOverlay:".toggle-overlay",$autofarmConfig:".autofarm-config",$autofarmStart:".autofarm-start",$autofarmStop:".autofarm-stop",$autofarmStatus:".autofarm-status",$autoOverlayConfig:".autooverlay-config",$autoOverlayStart:".autooverlay-start",$autoOverlayStop:".autooverlay-stop",$autoOverlayStatus:".autooverlay-status",$strategy:".strategy",$progressLine:".wprogress div",$progressText:".wprogress span",$images:".images"}),this.$widgetLogo.src=Eo,this.$wopenButton.addEventListener("click",()=>this.open=!this.open),this.$draw.addEventListener("click",()=>this.bot.draw()),this.$drawAndPaint.addEventListener("click",()=>{this.drawAndClickPaintWhenReady()}),this.$addImage.addEventListener("click",()=>this.addImage()),this.$openConfig.addEventListener("click",()=>{this.openSettingsModal()}),this.$captureTemplate.addEventListener("click",()=>{this.captureTemplate()}),this.$toggleOverlay.addEventListener("click",()=>{this.toggleOverlay()}),this.$autofarmConfig.addEventListener("click",()=>{this.openAutoFarmModal()}),this.$autofarmStart.addEventListener("click",()=>{this.startAutoFarm()}),this.$autofarmStop.addEventListener("click",()=>{this.stopAutoFarm()}),this.$autoOverlayConfig.addEventListener("click",()=>{this.openAutoOverlayModal()}),this.$autoOverlayStart.addEventListener("click",()=>{this.startAutoOverlay()}),this.$autoOverlayStop.addEventListener("click",()=>{this.stopAutoOverlay()}),this.$strategy.addEventListener("change",()=>{this.bot.strategy=this.$strategy.value}),this.registerEvent(document,"keydown",this.handleKeyboard.bind(this),{passive:!1}),this.update(),this.syncOverlayVisibilityFromStorage(),this.loadAutoFarmConfigFromStorage(),this.loadAutoOverlayConfigFromStorage(),this.refreshAutoFarmStatusText(),this.refreshAutoOverlayStatusText(),this.statusRefreshIntervalId=window.setInterval(()=>{this.refreshAutoFarmStatusText(),this.refreshAutoOverlayStatusText(),this.refreshProgress()},1000),this.open=!0,console.log("[KGM][Widget] Widget mounted and opened")}addImage(){return console.log("[KGM][Widget] Add image flow started"),this.setDisabled("add-image",!0),this.run(n("taskAddingImage"),async()=>{await this.bot.updateColors();let o=document.createElement("input");o.type="file",o.accept=`image/*,.${X}`,o.click(),await q(o,["change"],["cancel","error"]);let a=o.files?.[0];if(!a)throw new co(this.bot);console.log("[KGM][Widget] File selected",{name:a.name,size:a.size,type:a.type});let r;if(a.name.endsWith(`.${X}`))r=await S.fromJSON(this.bot,JSON.parse(await a.text()));else{let l=new FileReader;l.readAsDataURL(a),await q(l,["load"],["error"]);let p=await this.compressImageBeforeLoad(l.result),g=new Image;g.src=p,await q(g,["load"],["error"]),await this.waitForStableViewportProjection(),r=new S(this.bot,F.fromScreenPosition(this.bot,this.defaultImageScreenPosition()),new W(this.bot,g))}this.bot.images.push(r),console.log("[KGM][Widget] Image instance added",{images:this.bot.images.length}),await this.bot.readMap(),r.updateTasks(),N(this.bot,!0),this.bot.updateTasks(),this.update(),globalThis.location.reload()},()=>{this.setDisabled("add-image",!1)})}captureTemplate(){return this.setDisabled("capture-template",!0),this.run(n("taskCapturingMapImage"),async()=>{let o=await this.resolveCaptureBounds(),{minGlobalX:a,minGlobalY:r,maxGlobalX:l,maxGlobalY:p}=o,g=document.createElement("canvas");g.width=Math.max(1,l-a+1),g.height=Math.max(1,p-r+1);let f=g.getContext("2d");if(!f)throw new Error("Capture context unavailable");f.imageSmoothingEnabled=!1;let c=Math.floor(a/M),s=Math.floor(r/M),w=Math.floor(l/M),u=Math.floor(p/M),i=(w-c+1)*(u-s+1),d=0;for(let m=c;m<=w;m++)for(let t=s;t<=u;t++){this.status=`⌛ ${n("taskReadingTiles")} [${++d}/${i}]`;let z=await this.loadTileImage(m,t),H=m*M,A=t*M,P=Math.max(a,H),J=Math.min(l,H+M-1),K=Math.max(r,A),R=Math.min(p,A+M-1),O=P-H,v=K-A,E=J-P+1,G=R-K+1,$=P-a,e=K-r;f.drawImage(z,O,v,E,G,$,e,E,G)}let b=Date.now();await this.downloadCapture(g,"png",b)},()=>{this.setDisabled("capture-template",!1)})}async downloadCapture(o,a,r){let l=a==="webp"?"image/webp":"image/png",p=await new Promise((c,s)=>{o.toBlob((w)=>{if(!w){s(new Error(`Failed to create ${a.toUpperCase()} capture file`));return}c(w)},l)}),g=URL.createObjectURL(p),f=document.createElement("a");f.href=g,f.download=`wplace-capture-${r}.${a}`,f.click(),URL.revokeObjectURL(g)}async loadTileImage(o,a){let r;for(let l=1;l<=3;l++)try{let p=new Image;return p.crossOrigin="anonymous",p.referrerPolicy="no-referrer",p.src=`https://backend.wplace.live/files/s0/tiles/${o}/${a}.png?ts=${Date.now()}-${l}`,await q(p,["load"],["error"]),p}catch(p){if(r=p,l<3)await new Promise((g)=>setTimeout(g,l*200))}throw r instanceof Error?r:new Error(`Tile fetch failed (${o}/${a})`)}async resolveCaptureBounds(){return this.selectCaptureBounds()}selectCaptureBounds(){return new Promise((o,a)=>{let r=document.createElement("div");r.className="kgm-capture-overlay",r.innerHTML=`<div class="kgm-capture-hint">${n("captureHintSelectArea")}: A → B</div><div class="kgm-capture-box"></div>`;let l=r.querySelector(".kgm-capture-box");document.body.append(r);let p,g,f=()=>{window.removeEventListener("keydown",i,!0),r.removeEventListener("pointermove",w),r.removeEventListener("pointerdown",u),r.remove()},c=(d)=>{let b=Math.min(p.x,d.x),m=Math.min(p.y,d.y),t=Math.abs(p.x-d.x)+1,z=Math.abs(p.y-d.y)+1;return{left:b,top:m,width:t,height:z}},s=(d)=>{let{left:b,top:m,width:t,height:z}=c(d);l.style.left=`${b}px`,l.style.top=`${m}px`,l.style.width=`${t}px`,l.style.height=`${z}px`},w=(d)=>{if(!p)return;s({x:d.clientX,y:d.clientY})},u=(d)=>{if(d.preventDefault(),!p){p={x:d.clientX,y:d.clientY};let P=F.fromScreenPosition(this.bot,p);g={x:P.globalX,y:P.globalY},s(p);return}let b={x:d.clientX,y:d.clientY},m=F.fromScreenPosition(this.bot,b);if(f(),!g){a(new Error("Capture anchor point unavailable"));return}let t=Math.min(g.x,m.globalX),z=Math.min(g.y,m.globalY),H=Math.max(g.x,m.globalX),A=Math.max(g.y,m.globalY);if(H-t<1||A-z<1){a(new Error("Capture area too small"));return}o({minGlobalX:t,minGlobalY:z,maxGlobalX:H,maxGlobalY:A})},i=(d)=>{if(d.key!=="Escape")return;f(),a(new Error("Capture cancelled"))};window.addEventListener("keydown",i,!0),r.addEventListener("pointermove",w),r.addEventListener("pointerdown",u)})}defaultImageScreenPosition(){let o=Math.round(this.element.getBoundingClientRect().width);return{x:Math.max(256,o),y:32}}async compressImageBeforeLoad(o){let a=new Image;if(a.src=o,await q(a,["load"],["error"]),!(a.naturalWidth*a.naturalHeight>3000000||o.length>3000000))return o;let l=document.createElement("canvas");l.width=a.naturalWidth,l.height=a.naturalHeight;let p=l.getContext("2d");if(!p)return o;return p.drawImage(a,0,0),l.toDataURL("image/png")}async waitForStableViewportProjection(){let o=this.defaultImageScreenPosition(),a=0,r;for(let l=0;l<45;l++){await new Promise((w)=>requestAnimationFrame(()=>{w()}));let{anchorScreenPosition:{x:p,y:g},pixelSize:f}=this.bot.findAnchorsForScreen(o);if(!Number.isFinite(f)||f<=0){a=0;continue}let c={anchorX:p,anchorY:g,pixelSize:f};if(!r){r=c,a=1;continue}if(Math.abs(c.anchorX-r.anchorX)+Math.abs(c.anchorY-r.anchorY)+Math.abs(c.pixelSize-r.pixelSize)<0.0012)a++;else a=0;if(r=c,a>=3)return}}update(){this.$strategy.value=this.bot.strategy,this.refreshProgress(),this.$images.innerHTML="";let o=document.createDocumentFragment();for(let a=0;a<this.bot.images.length;a++){let r=this.bot.images[a],l=document.createElement("div");o.append(l),l.className="image",l.innerHTML=`<button class="preview" title="View preview">
...
</form>`,document.body.append(o),D(o);let p=o.querySelector(".autofarm-unit");p.value=a;let g=o.querySelector(".autofarm-value"),f=o.querySelector(".autofarm-pixels"),c=()=>{let s=Math.max(1,Number.parseInt(g.value||"1",10));if(p.value==="hours")return s*3600000;if(p.value==="minutes")return s*60000;return s*1000};o.querySelector(".autooverlay-start").onclick=()=>{this.saveAutoOverlayConfig({value:Math.max(1,Number.parseInt(g.value||"1",10)),pixels:Math.max(1,Number.parseInt(f.value||"60",10)),unit:p.value,timerMs:c()}),this.startAutoOverlay(),o.close(),o.remove()},o.querySelector(".autooverlay-stop").onclick=()=>{this.stopAutoOverlay(),o.close(),o.remove()},o.querySelector(".modal-close").onclick=()=>{o.close(),o.remove()},o.addEventListener("close",()=>{o.remove()}),o.showModal()}setDisabled(o,a){this.element.querySelector("."+o).disabled=a}async run(o,a,r,l="..."){console.log("[KGM][Widget] Task started",{status:o});let p=this.status;this.status=`${l} ${o}`;try{let g=await a();return this.status=p,console.log("[KGM][Widget] Task completed",{status:o}),g}catch(g){if(!(g instanceof ao))console.error(g),this.status=`${n("taskErrorPrefix")}: ${o}`;throw console.error("[KGM][Widget] Task failed",{status:o,error:g}),g}finally{await r?.()}}handleKeyboard(o){if(No(o.target))return;if(Q(o,U.toggleWidget)){o.preventDefault(),this.open=!this.open;return}if(Q(o,U.showShortcuts)){o.preventDefault(),this.open=!0,this.openSettingsModal();return}if(Q(o,U.toggleOverlay)){o.preventDefault(),this.toggleOverlay();return}if(Q(o,U.focusNextImage)){o.preventDefault(),this.focusImageByStep(1);return}if(Q(o,U.focusPreviousImage)){o.preventDefault(),this.focusImageByStep(-1);return}if(Q(o,U.openColorPanel)){o.preventDefault(),this.openColorPanelForActiveImage();return}if(Q(o,U.toggleImageLock)){o.preventDefault(),this.toggleLockForActiveImage();return}if(Q(o,U.clickPaintWhenReady)){o.preventDefault(),this.drawAndClickPaintWhenReady();return}if(Q(o,U.startAutoFarm)){o.preventDefault(),this.startAutoFarm();return}if(Q(o,U.stopAutoFarm)){o.preventDefault(),this.stopAutoFarm();return}if(Q(o,U.addImage)&&!this.$addImage.disabled){o.preventDefault(),this.addImage();return}if(Q(o,U.draw)&&!this.$draw.disabled)o.preventDefault(),this.bot.draw()}focusImageByStep(o){if(!this.bot.images.length)return;if(this.activeImageIndex<0||this.activeImageIndex>=this.bot.images.length)this.activeImageIndex=o>0?0:this.bot.images.length-1;else this.activeImageIndex=(this.activeImageIndex+o+this.bot.images.length)%this.bot.images.length;this.bot.images[this.activeImageIndex].position.scrollScreenTo()}getActiveImage(){if(!this.bot.images.length)return;if(this.activeImageIndex<0||this.activeImageIndex>=this.bot.images.length)this.activeImageIndex=0;return this.bot.images[this.activeImageIndex]}openColorPanelForActiveImage(){let o=this.getActiveImage();if(!o)return;o.openColorPanel()}toggleLockForActiveImage(){let o=this.getActiveImage();if(!o)return;o.lock=!o.lock,o.update(),N(this.bot)}async waitAndClickPaintButton(){await this.run(n("taskWaitingPaintButton"),async()=>{for(;;){let o=this.findNativePaintButton();if(o&&!o.disabled&&o.ariaDisabled!=="true"){this.triggerNativePaintClick(o);return}await new Promise((a)=>setTimeout(a,500))}})}async drawAndClickPaintWhenReady(){if(!this.$draw.disabled)await this.bot.draw();await this.waitAndClickPaintButton()}findNativePaintButton(){return["button.btn.btn-primary.btn-lg.sm\\:btn-xl.relative","button.btn.btn-primary.btn-lg.relative","button.btn.btn-primary.btn-lg.relative.z-30","button.btn.btn-primary.btn-lg.sm\\:btn-xl.relative.z-30","div.absolute.bottom-0.left-1\\/2.-translate-x-1\\/2 button.btn.btn-primary"].flatMap((r)=>Array.from(document.querySelectorAll(r))).find((r)=>/pintar|paint/i.test(r.textContent??""))}triggerNativePaintClick(o){o.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,cancelable:!0,pointerType:"mouse",button:0})),o.dispatchEvent(new MouseEvent("mousedown",{bubbles:!0,cancelable:!0,button:0})),o.dispatchEvent(new PointerEvent("pointerup",{bubbles:!0,cancelable:!0,pointerType:"mouse",button:0})),o.dispatchEvent(new MouseEvent("mouseup",{bubbles:!0,cancelable:!0,button:0})),o.click()}}var Yo=2,Qo="[KGM]",jo="kglacer-macro:access-ok",wo="S0dNLXlZUjhTMW81bEhVemVjS1RFMEhxRVB4OVFkcjgxaEVz",Ko="kgm-access-locked";class Go{unavailableColors=new Set;mapsCache=new Map;me;$stars=[];strategy="SEQUENTIAL";images=[];_widget;get widget(){if(!this._widget)throw new Error("Widget is not initialized yet");return this._widget}markerPixelPositionResolvers=[];lastColor;log(o,a){if(a===void 0)console.log(`${Qo} ${o}`);else console.log(`${Qo} ${o}`,a)}constructor(){this.log("Boot sequence started"),document.body.classList.add(Ko);let o=Mo();if(this.log("Save loaded",{hasSave:Boolean(o),imageCount:o?.images.length??0,strategy:o?.strategy}),o){for(let r=0;r<o.images.length;r++){let l=o.images[r];I({x:l.position[0]-1000,y:l.position[1]-1000}),I({x:l.position[0]+1000,y:l.position[1]+1000})}this.strategy=o.strategy}this.registerFetchInterceptor(),this.log("Fetch interceptor registered");let a=document.createElement("style");a.textContent=Po.replace("FAKE_FAVORITE_LOCATIONS",T.length.toString()),document.head.append(a),this.log("Styles injected",{fakeFavoriteLocations:T.length}),(async()=>{this.log("Widget initialization flow started"),await this.ensureAccessKey(),document.body.classList.remove(Ko),this._widget=new so(this),await this.widget.run(n("taskInitializing"),async()=>{await this.waitForElement("login",".avatar.center-absolute.absolute"),await this.waitForElement("pixel count",".btn.btn-primary.btn-lg.relative.z-30 canvas");let r=await this.waitForElement("canvas",".maplibregl-canvas-container");if(new MutationObserver((l)=>{for(let p=0;p<l.length;p++)if(l[p].removedNodes.length!==0){this.updateStars();break}this.updateImages()}).observe(r,{attributes:!0,childList:!0,subtree:!0}),this.updateStars(),this.log("Stars updated after boot",{stars:this.$stars.length}),await j(500),await this.updateColors(),o)for(let l=0;l<o.images.length;l++){let p=await S.fromJSON(this,o.images[l]);this.images.push(p),p.update()}this.log("Saved images restored",{images:this.images.length}),await this.readMap(),this.updateTasks(),this.widget.setDisabled("draw",!1),this.widget.setDisabled("draw-and-paint",!1),this.widget.setDisabled("add-image",!1),this.widget.setDisabled("capture-template",!1),this.log("Initialization completed; controls enabled")})})()}async ensureAccessKey(){if(localStorage.getItem(jo)===wo)return;await new Promise((o)=>{let a=document.createElement("dialog");a.className="kgm-modal access-dialog",a.innerHTML=`<form method="dialog" class="access-form">
  <div class="kgm-modal-head">
...
</form>`,document.body.append(a),D(a);let r=a.querySelector(".access-input"),l=a.querySelector(".access-error"),p=a.querySelector(".access-locale");p.innerHTML=bo().map((g)=>`<option value="${g}" ${g===Y()?"selected":""}>${g.toUpperCase()}</option>`).join(""),p.addEventListener("change",()=>{oo(p.value),D(a)}),a.addEventListener("cancel",(g)=>{g.preventDefault()}),a.querySelector("form").addEventListener("submit",(g)=>{g.preventDefault();let f=atob(wo);if(r.value.trim()!==f){l.textContent=n("invalidAccessKey");return}localStorage.setItem(jo,wo),a.close(),a.remove(),o()}),a.showModal(),r.focus()})}draw(){this.log("Draw requested",{strategy:this.strategy,images:this.images.length}),this.widget.setDisabled("draw",!0),this.widget.setDisabled("draw-and-paint",!0),this.widget.status="",this.mapsCache.clear();let o=document.querySelector(".maplibregl-canvas"),a=(r)=>{if(!r.shiftKey)r.stopPropagation()};return this.widget.run(n("taskDrawing"),async()=>{await this.widget.run(n("taskInitializingDraw"),()=>Promise.all([this.updateColors(),this.readMap()])),globalThis.addEventListener("mousemove",a,!0),o.addEventListener("wheel",a,!0),this.updateTasks();let r=await fetch("https://backend.wplace.live/me",{credentials:"include"}).then((g)=>g.json()),l=Math.floor(r.charges.count);this.log("Charges fetched",{charges:l});let p=0;for(let g=0;g<this.images.length;g++)p+=this.images[g].tasks.length;switch(this.log("Tasks prepared",{tasks:p}),this.strategy){case"ALL":{while(l>0){let g=!0;for(let f=0;f<this.images.length;f++){let c=this.images[f].tasks.shift();if(!c)continue;this.drawTask(c),l--,await j(1),g=!1}if(g)break}break}case"PERCENTAGE":{for(let g=0;g<p&&l>0;g++){let f=1,c;for(let s=0;s<this.images.length;s++){let w=this.images[s],u=1-w.tasks.length/(w.pixels.pixels.length*w.pixels.pixels[0].length);if(u<f)f=u,c=w}this.drawTask(c.tasks.shift()),l--,await j(1)}break}case"SEQUENTIAL":for(let g=0;g<this.images.length;g++){let f=this.images[g];for(let c=f.tasks.shift();c&&l>0;c=f.tasks.shift())this.drawTask(c),l--,await j(1)}}this.widget.update(),this.log("Draw flow finished",{remainingCharges:l})},()=>{globalThis.removeEventListener("mousemove",a,!0),o.removeEventListener("wheel",a,!0),this.widget.setDisabled("draw",!1),this.widget.setDisabled("draw-and-paint",!1)})}toJSON(){return{version:Yo,images:this.images.map((o)=>o.toJSON()),strategy:this.strategy}}async updateColors(){this.log("Updating colors palette"),await this.openColors(),this.unavailableColors.clear();for(let o of document.querySelectorAll("button.btn.relative.w-full"))if(o.children.length!==0)this.unavailableColors.add(Math.abs(Number.parseInt(o.id.slice(6))));this.updateImageColors(),this.log("Colors updated",{unavailableColors:this.unavailableColors.size})}moveMap(o){let a=document.querySelector(".maplibregl-canvas"),r=window.innerWidth/2,l=window.innerHeight/2,p=r-o.x,g=l-o.y;function f(c,s,w){a.dispatchEvent(new MouseEvent(c,{bubbles:!0,cancelable:!0,clientX:s,clientY:w,buttons:1}))}f("mousedown",r,l),f("mousemove",p,g),f("mouseup",p,g)}readMap(){this.mapsCache.clear();let o=new Set;for(let r=0;r<this.images.length;r++){let l=this.images[r],{tileX:p,tileY:g}=new F(this,l.position.globalX+l.pixels.pixels[0].length,l.position.globalY+l.pixels.pixels.length);for(let f=l.position.tileX;f<=p;f++)for(let c=l.position.tileY;c<=g;c++)o.add(`${f}/${c}`)}let a=0;return this.log("Reading map tiles",{tileCount:o.size}),this.widget.run(`${n("taskReadingMap")} [0/${o.size}]`,()=>Promise.all([...o].map(async(r)=>{this.mapsCache.set(r,await W.fromJSON(this,{url:`https://backend.wplace.live/files/s0/tiles/${r}.png`,exactColor:!0})),this.widget.status=`⌛ ${n("taskReadingMap")} [${++a}/${o.size}]`})))}waitForUnfocus(){return this.widget.run("UNFOCUS WINDOW",()=>new Promise((o)=>{if(!document.hasFocus())o();window.addEventListener("blur",()=>{setTimeout(o,1)},{once:!0})}),void 0,"\uD83D\uDDB1️")}findAnchorsForScreen(o){let a=0,r=1,l=1/0,p=1/0;for(let c=0;c<this.$stars.length;c++){let{x:s,y:w}=C(this.$stars[c]);if(s<o.x&&w<o.y){let u=o.x-s+(o.y-w);if(u<l)l=u,a=c}else if(s>o.x&&w>o.y){let u=s-o.x+(w-o.y);if(u<p)p=u,r=c}}let g=C(this.$stars[a]),f=h[a];return{anchorScreenPosition:g,anchorWorldPosition:f,pixelSize:(C(this.$stars[r]).x-g.x)/(h[r].x-f.x)}}async openColors(){this.lastColor=void 0,document.querySelector(".flex.gap-2.px-3 > .btn-circle")?.click(),await j(1),document.querySelector(".btn.btn-primary.btn-lg.relative.z-30")?.click(),await j(1);let o=document.querySelector("button.bottom-0");if(o?.innerHTML==='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="size-5"><path d="M480-120 300-300l58-58 122 122 122-122 58 58-180 180ZM358-598l-58-58 180-180 180 180-58 58-122-122-122 122Z"></path></svg><!---->')o.click(),await j(1)}drawTask(o){if(this.lastColor!==o.color){let l=document.getElementById("color-"+o.color);if(!l){this.log("Skipped draw task: color button not found",{color:o.color,tileX:o.position.tileX,tileY:o.position.tileY,x:o.position.x,y:o.position.y});return}l.click(),this.lastColor=o.color,this.log("Color switched for draw task",{color:o.color})}let a=o.position.pixelSize/2,r=o.position.toScreenPosition();if(!Number.isFinite(r.x)||!Number.isFinite(r.y)){this.log("Skipped draw task: invalid screen position",{color:o.color});return}document.documentElement.dispatchEvent(new MouseEvent("mousemove",{bubbles:!0,clientX:r.x+a,clientY:r.y+a,shiftKey:!0})),document.documentElement.dispatchEvent(new KeyboardEvent("keydown",{key:" ",code:"Space",keyCode:32,which:32,bubbles:!0,cancelable:!0})),document.documentElement.dispatchEvent(new KeyboardEvent("keyup",{key:" ",code:"Space",keyCode:32,which:32,bubbles:!0,cancelable:!0}))}async paintRandomPixelInViewport(){try{await this.updateColors();let o=Array.from(document.querySelectorAll('button[id^="color-"]')).filter((d)=>!d.disabled&&d.getAttribute("aria-disabled")!=="true"&&d.offsetParent!==null);if(!o.length)return;let a=o[Math.floor(Math.random()*o.length)],r=Number.parseInt(a.id.slice(6),10);if(!Number.isFinite(r))return;let l=document.querySelector(".maplibregl-canvas");if(!l)return;let p=l.getBoundingClientRect(),g=24,f=p.left+g,c=p.right-g,s=p.top+g,w=p.bottom-g;if(c<=f||w<=s)return;let u=f+Math.random()*(c-f),i=s+Math.random()*(w-s);this.drawTask({color:r,position:F.fromScreenPosition(this,{x:u,y:i})})}catch(o){this.log("Auto farm tick failed",o)}}async drawRandomPixelsBatch(o,a){let r=Math.max(1,Math.floor(o)),l=0;return await this.widget.run(n("taskDrawingRandomPixels"),async()=>{await this.widget.run(n("taskInitializingDraw"),()=>this.updateColors());let p=Array.from(document.querySelectorAll('button[id^="color-"]')).filter((b)=>!b.disabled&&b.getAttribute("aria-disabled")!=="true"&&b.offsetParent!==null),g=document.querySelector(".maplibregl-canvas");if(!p.length||!g)return;let f=a===void 0?void 0:p.find((b)=>Number.parseInt(b.id.slice(6),10)===a);if(a!==void 0&&!f)return;let c=g.getBoundingClientRect(),s=24,w=c.left+s,u=c.right-s,i=c.top+s,d=c.bottom-s;if(u<=w||d<=i)return;for(let b=0;b<r;b++){let m=f??p[Math.floor(Math.random()*p.length)],t=Number.parseInt(m.id.slice(6),10);if(!Number.isFinite(t))continue;let z=w+Math.random()*(u-w),H=i+Math.random()*(d-i);this.drawTask({color:t,position:F.fromScreenPosition(this,{x:z,y:H})}),l++,await j(1)}}),l}async drawOverlayPixelsBatch(o){let a=Math.max(1,Math.floor(o)),r=0;return await this.widget.run(n("taskDrawingOverlayPixels"),async()=>{await this.widget.run(n("taskInitializingDraw"),()=>Promise.all([this.updateColors(),this.readMap()])),this.updateTasks();for(let l=0;l<a;l++){let p=this.takeNextTaskFromStrategy();if(!p)break;this.drawTask(p),r++,await j(1)}this.widget.update()}),r}takeNextTaskFromStrategy(){switch(this.strategy){case"ALL":case"SEQUENTIAL":{for(let o=0;o<this.images.length;o++){let a=this.images[o].tasks.shift();if(a)return a}return}case"PERCENTAGE":{let o,a=Number.POSITIVE_INFINITY;for(let r=0;r<this.images.length;r++){let l=this.images[r];if(!l.tasks.length)continue;let p=l.pixels.pixels.length*l.pixels.pixels[0].length,g=1-l.tasks.length/p;if(g<a)a=g,o=l}return o?.tasks.shift()}}}registerFetchInterceptor(){let o=globalThis.fetch,a=/https:\/\/backend.wplace.live\/s\d+\/pixel\/(-?\d+)\/(-?\d+)\?x=(-?\d+)&y=(-?\d+)/;globalThis.fetch=async(r,l)=>{let p=await o(r,l),g=p.clone(),f="";if(typeof r=="string")f=r;else if(r instanceof Request)f=r.url;else if(r instanceof URL)f=r.href;if(p.url==="https://backend.wplace.live/me")this.me=await g.json(),this.me.favoriteLocations.unshift(...T),this.me.maxFavoriteLocations=1/0,p.json=()=>Promise.resolve(this.me),this.log("Patched /me response with favorite locations",{totalFavorites:this.me.favoriteLocations.length});let c=a.exec(f);if(c){for(let s=0;s<this.markerPixelPositionResolvers.length;s++)this.markerPixelPositionResolvers[s](new F(this,+c[1],+c[2],+c[3],+c[4]));this.markerPixelPositionResolvers.length=0,this.log("Resolved marker pixel position from network event")}return p}}async closeAll(){for(let o of document.querySelectorAll("button"))if(o.innerHTML==="✕"||o.innerHTML==='<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" fill="currentColor" class="size-4"><path d="m256-200-56-56 224-224-224-224 56-56 224 224 224-224 56 56-224 224 224 224-56 56-224-224-224 224Z"></path></svg><!---->')o.click(),await j(1)}waitForElement(o,a){return this.log("Waiting for element",{name:o,selector:a}),this.widget.run(`${n("taskWaitingFor")} ${o}`,()=>{return new Promise((r)=>{let l=document.querySelector(a);if(l){r(l);return}let p=new MutationObserver(()=>{let g=document.querySelector(a);if(g)p.disconnect(),r(g)});p.observe(document.documentElement,{childList:!0,subtree:!0})})})}updateStars(){this.$stars=[...document.querySelectorAll(".text-yellow-400.cursor-pointer.z-10.maplibregl-marker.maplibregl-marker-anchor-center")].slice(0,T.length),this.log("Star cache updated",{stars:this.$stars.length})}updateImages(){for(let o=0;o<this.images.length;o++)this.images[o].position.updateAnchor(),this.images[o].update()}updateTasks(){for(let o=0;o<this.images.length;o++)this.images[o].updateTasks()}updateImageColors(){for(let o=0;o<this.images.length;o++)this.images[o].updateColors()}}globalThis.kglacerMacro=new Go;globalThis.kgm=globalThis.kglacerMacro;globalThis.wbot=globalThis.kglacerMacro;
