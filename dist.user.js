...
`;class G{bot;image;width;exactColor;static async fromJSON(o,a){let r=new Image;return r.src=a.url.startsWith("http")?await fetch(a.url,{cache:"no-store"}).then((l)=>l.blob()).then((l)=>URL.createObjectURL(l)):a.url,await q(r,["load"],["error"]),new G(o,r,a.width,a.exactColor)}canvas=document.createElement("canvas");context=this.canvas.getContext("2d");pixels;colors=new Map;resolution;get height(){return this.width/this.resolution|0}set height(o){this.width=o*this.resolution|0}constructor(o,a,r=a.naturalWidth,l=!1){this.bot=o;this.image=a;this.width=r;this.exactColor=l;if(l)this.resolution=1,this.width=1000;else this.resolution=this.image.naturalWidth/this.image.naturalHeight;this.update()}update(){this.canvas.width=this.width,this.canvas.height=this.height,this.colors.clear();let o=new Map;for(let r=1;r<64;r++)if(this.exactColor||!this.bot.unavailableColors.has(r))o.set(S[r],[r,r]);this.context.imageSmoothingEnabled=!1,this.context.imageSmoothingQuality="low",this.context.drawImage(this.image,0,0,this.canvas.width,this.canvas.height),this.pixels=Array.from({length:this.canvas.height},()=>new Array(this.canvas.width));let a=this.context.getImageData(0,0,this.canvas.width,this.canvas.height).data;for(let r=0;r<this.canvas.height;r++)for(let l=0;l<this.canvas.width;l++){let s=(r*this.canvas.width+l)*4,p=a[s],c=a[s+1],g=a[s+2],f=a[s+3],n=p,u=c,i=g,t=`${n},${u},${i}`;if(this.exactColor){this.pixels[r][l]=f<100?0:S.indexOf(t);continue}let m,b;if(f<100)m=b=0;else if(o.has(t))[m,b]=o.get(t);else{let z=1/0,h=1/0;for(let A=0;A<Z.length;A++){let e=Z[A],N=eo(Mo(n,u,i),e,0);if(!this.bot.unavailableColors.has(A)&&N<z)z=N,m=A;if(N<h)h=N,b=A}o.set(t,[m,b])}if(m!==0)this.context.fillStyle=`oklab(${Z[m][0]*100}% ${Z[m][1]} ${Z[m][2]})`,this.context.fillRect(l,r,1,1);this.pixels[r][l]=m;let d=this.colors.get(b);if(d)d.amount++;else this.colors.set(b,{color:m,amount:1,realColor:b})}}toJSON(){let o=document.createElement("canvas");return o.width=this.image.naturalWidth,o.height=this.image.naturalHeight,o.getContext("2d").drawImage(this.image,0,0),{url:o.toDataURL("image/webp",1),width:this.width,exactColor:this.exactColor}}}var T="kglacer-macro-settings",No=["kglacermacro","wbot"],X="kgm";function ra(){let o=[T,...No];for(let a=0;a<o.length;a++){let r=o[a],l=localStorage.getItem(r);if(!l)continue;return{json:l,key:r}}return}function Fo(){let o=ra();if(!o)return;let a;try{if(a=JSON.parse(o.json),typeof a!=="object")throw new Error("NOT VALID SAVE");if(a.version===1){let r=a;a.images=r.widget.images,a.strategy=r.widget.strategy,delete r.widget}if(o.key!==T)localStorage.setItem(T,o.json)}catch{localStorage.removeItem(o.key),a=void 0}return a}var Po;function H(o,a=!1){if(clearTimeout(Po),a)localStorage.setItem(T,JSON.stringify(o));else Po=setTimeout(()=>{localStorage.setItem(T,JSON.stringify(o))},600)}var M=1000,la=2048,V=M*la,Q=[],B=[],sa=Date.now();function v(o){Q.push(o),B.push({id:sa++,latitude:(2*Math.atan(Math.exp(-(o.y/V*(2*Math.PI)-Math.PI)))-Math.PI/2)*180/Math.PI,longitude:(o.x/V*(2*Math.PI)-Math.PI)*180/Math.PI,name:"KGLACER_MACRO_FAVORITE"})}v({x:V/3|0,y:V/3|0});v({x:V/3*2|0,y:V/3*2|0});function L(o){let[a,r]=o.style.transform.slice(32,-31).split(", ").map((l)=>Number.parseFloat(l));return{x:a,y:r}}class k{bot;static fromJSON(o,a){return new k(o,...a)}static fromScreenPosition(o,a){let{anchorScreenPosition:r,pixelSize:l,anchorWorldPosition:s}=o.findAnchorsForScreen(a);return new k(o,s.x+(a.x-r.x)/l|0,s.y+(a.y-r.y)/l|0)}globalX=0;globalY=0;get tileX(){return this.globalX/M|0}set tileX(o){this.globalX=o*M+this.x}get tileY(){return this.globalY/M|0}set tileY(o){this.globalY=o*M+this.y}get x(){return this.globalX%M}set x(o){this.globalX=this.tileX*M+o}get y(){return this.globalY%M}set y(o){this.globalY=this.tileY*M+o}anchor1Index;anchor2Index;get pixelSize(){return(L(this.bot.$stars[this.anchor2Index]).x-L(this.bot.$stars[this.anchor1Index]).x)/(Q[this.anchor2Index].x-Q[this.anchor1Index].x)}constructor(o,a,r,l,s){this.bot=o;if(l===void 0||s===void 0)this.globalX=a,this.globalY=r;else this.globalX=a*M+l,this.globalY=r*M+s;this.updateAnchor()}updateAnchor(){this.anchor1Index=0,this.anchor2Index=1;let o=1/0,a=1/0;for(let r=0;r<Q.length;r++){let{x:l,y:s}=Q[r];if(l<this.globalX&&s<this.globalY){let p=this.globalX-l+(this.globalY-s);if(p<o)o=p,this.anchor1Index=r}else if(l>this.globalX&&s>this.globalY){let p=l-this.globalX+(s-this.globalY);if(p<a)a=p,this.anchor2Index=r}}}toScreenPosition(){let o=Q[this.anchor1Index],a=L(this.bot.$stars[this.anchor1Index]);return{x:(this.globalX-o.x)*this.pixelSize+a.x,y:(this.globalY-o.y)*this.pixelSize+a.y}}getMapColor(){return this.bot.mapsCache.get(this.tileX+"/"+this.tileY).pixels[this.y][this.x]}scrollScreenTo(){let{x:o,y:a}=this.toScreenPosition();this.bot.moveMap({x:o-window.innerWidth/3,y:a-window.innerHeight/3})}clone(){return new k(this.bot,this.tileX,this.tileY,this.x,this.y)}toJSON(){return[this.globalX,this.globalY]}}class K extends Y{bot;position;pixels;strategy;opacity;drawTransparentPixels;drawColorsInOrder;skipUnavailableColors;smartReplaceMode;colors;lock;static PREVIEW_MASK_BASE_WIDTH=96;static PREVIEW_MASK_BASE_HEIGHT=96;static async fromJSON(o,a){return new K(o,k.fromJSON(o,a.position),await G.fromJSON(o,a.pixels),a.strategy,a.opacity,a.drawTransparentPixels,a.drawColorsInOrder,a.skipUnavailableColors,a.smartReplaceMode,a.colors,a.lock)}element=document.createElement("div");tasks=[];moveInfo;$canvas;$colorsDialog;$colorsDialogList;$colorSearch;$openColors;$openPreview;$enableAllColors;$disableAllColors;$closeColors;$closePreview;$delete;$drawColorsInOrder;$drawTransparent;$skipUnavailable;$smartReplaceMode;$export;$lock;$opacity;$progressLine;$progressText;$previewDialog;$previewDialogList;$resetSize;$resetSizeSpan;$settings;$strategy;$topbar;$wrapper;colorDialogDragState;suppressNextColorDialogBackdropClick=!1;previewCacheSignature;previewSequenceCache=new Map;previewAnimations=new WeakMap;previewAnimationHandles=new Set;constructor(o,a,r,l="SPIRAL_FROM_CENTER",s=50,p=!1,c=!1,g=!1,f=!1,n=[],u=!1){super();this.bot=o;this.position=a;this.pixels=r;this.strategy=l;this.opacity=s;this.drawTransparentPixels=p;this.drawColorsInOrder=c;this.skipUnavailableColors=g;this.smartReplaceMode=f;this.colors=n;this.lock=u;this.element.innerHTML=ko,this.element.classList.add("wimage"),P(this.element),document.body.append(this.element),this.populateElementsWithSelector(this.element,{$colorsDialog:".colors-dialog",$colorsDialogList:".colors-dialog-list",$colorSearch:".color-search",$openColors:".open-colors",$openPreview:".open-preview",$enableAllColors:".enable-all-colors",$disableAllColors:".disable-all-colors",$closeColors:".close-colors",$closePreview:".close-preview",$delete:".delete",$drawColorsInOrder:".draw-colors-in-order",$drawTransparent:".draw-transparent",$skipUnavailable:".skip-unavailable",$smartReplaceMode:".smart-replace-mode",$export:".export",$lock:".lock",$opacity:".opacity",$progressLine:".wprogress div",$progressText:".wprogress span",$previewDialog:".preview-dialog",$previewDialogList:".preview-dialog-list",$resetSize:".reset-size",$settings:".wform",$strategy:".strategy",$topbar:".wtopbar",$wrapper:".wrapper"}),this.$resetSizeSpan=this.$resetSize.querySelector("span"),this.$canvas=this.pixels.canvas,this.$wrapper.prepend(this.pixels.canvas),document.body.append(this.$colorsDialog,this.$previewDialog),this.registerEvent(this.$strategy,"change",()=>{if(this.strategy=this.$strategy.value,this.$previewDialog.open)this.renderStrategyPreviewSamples();H(this.bot)}),this.registerEvent(this.$opacity,"input",()=>{this.opacity=this.$opacity.valueAsNumber,this.$opacity.style.setProperty("--val",this.opacity+"%"),this.update(),H(this.bot)}),this.$opacity.style.setProperty("--val",this.opacity+"%"),this.registerEvent(this.$resetSize,"click",()=>{this.pixels.width=this.pixels.image.naturalWidth,this.pixels.update(),this.updateColors(),this.update(),H(this.bot)}),this.registerEvent(this.$drawTransparent,"click",()=>{this.drawTransparentPixels=this.$drawTransparent.checked,H(this.bot)}),this.registerEvent(this.$skipUnavailable,"click",()=>{this.skipUnavailableColors=this.$skipUnavailable.checked,this.updateTasks(),H(this.bot)}),this.registerEvent(this.$drawColorsInOrder,"click",()=>{this.drawColorsInOrder=this.$drawColorsInOrder.checked,H(this.bot)}),this.registerEvent(this.$lock,"click",()=>{this.lock=!this.lock,this.update(),H(this.bot)}),this.registerEvent(this.$delete,"click",this.destroy.bind(this)),this.registerEvent(this.$openColors,"click",()=>{this.openColorPanel()}),this.registerEvent(this.$openPreview,"click",()=>{this.openPreviewPanel()}),this.registerEvent(this.$closeColors,"click",()=>{this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$closePreview,"click",()=>{this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorsDialog.querySelector(".colors-dialog-head"),"pointerdown",this.startColorDialogDrag.bind(this)),this.registerEvent(document,"pointermove",this.moveColorDialog.bind(this),{passive:!1}),this.registerEvent(document,"pointerup",this.stopColorDialogDrag.bind(this)),this.registerEvent(document,"pointercancel",this.stopColorDialogDrag.bind(this)),this.registerEvent(this.$colorsDialog,"click",(i)=>{if(this.suppressNextColorDialogBackdropClick){this.suppressNextColorDialogBackdropClick=!1;return}if(i.target===this.$colorsDialog)this.closeDialog(this.$colorsDialog)}),this.registerEvent(this.$previewDialog,"click",(i)=>{if(i.target===this.$previewDialog)this.closeDialog(this.$previewDialog)}),this.registerEvent(this.$colorSearch,"input",()=>{this.updateColors()}),this.registerEvent(this.$enableAllColors,"click",()=>{for(let i of this.colors)i.disabled=void 0;this.updateTasks(),this.updateColors(),H(this.bot)}),this.registerEvent(this.$disableAllColors,"click",()=>{for(let i of this.colors)i.disabled=!0;this.updateTasks(),this.updateColors(),H(this.bot)}),this.registerEvent(this.$export,"click",this.export.bind(this)),this.registerEvent(this.$topbar,"mousedown",this.moveStart.bind(this)),this.registerEvent(this.$canvas,"mousedown",this.moveStart.bind(this)),this.registerEvent(document,"mouseup",this.moveStop.bind(this)),this.registerEvent(document,"mousemove",this.move.bind(this));for(let i of this.element.querySelectorAll(".resize"))this.registerEvent(i,"mousedown",this.resizeStart.bind(this));this.update(),this.updateColors()}toJSON(){return{pixels:this.pixels.toJSON(),position:this.position.toJSON(),strategy:this.strategy,opacity:this.opacity,drawTransparentPixels:this.drawTransparentPixels,drawColorsInOrder:this.drawColorsInOrder,skipUnavailableColors:this.skipUnavailableColors,smartReplaceMode:this.smartReplaceMode,colors:this.colors,lock:this.lock}}updateTasks(){this.tasks.length=0;let o=this.position.clone(),a=new Set,r=new Map;for(let l=0;l<this.colors.length;l++){let s=this.colors[l];if(s.disabled)a.add(s.realColor);r.set(s.replacementColor??s.realColor,l)}for(let{x:l,y:s}of this.strategyPositionIterator()){let p=this.pixels.pixels[s][l],g=this.colors.find((n)=>n.realColor===p)?.replacementColor??p;if(a.has(p))continue;o.globalX=this.position.globalX+l,o.globalY=this.position.globalY+s;let f=o.getMapColor();if(g!==f&&(this.drawTransparentPixels||g!==0))this.tasks.push({position:o.clone(),color:g})}if(this.drawColorsInOrder)this.tasks.sort((l,s)=>(r.get(l.color)??0)-(r.get(s.color)??0));this.update(),this.bot.widget.update()}update(){let{x:o,y:a}=this.position.toScreenPosition(),r=this.position.pixelSize*this.pixels.width,l=this.position.pixelSize*this.pixels.height;this.element.style.transform=`translate3d(${o.toFixed(3)}px, ${a.toFixed(3)}px, 0)`,this.element.style.width=`${r}px`,this.element.style.height=`${l}px`,this.$canvas.style.opacity=`${this.opacity}%`,this.element.classList.remove("hidden"),this.$resetSizeSpan.textContent=this.pixels.width.toString(),this.$strategy.value=this.strategy,this.$opacity.valueAsNumber=this.opacity,this.$drawTransparent.checked=this.drawTransparentPixels,this.$drawColorsInOrder.checked=this.drawColorsInOrder,this.$skipUnavailable.checked=this.skipUnavailableColors,this.$smartReplaceMode.checked=this.smartReplaceMode;let s=this.pixels.pixels.length*this.pixels.pixels[0].length,p=Math.max(0,s-this.tasks.length),c=s>0?p/s*100|0:0;this.$progressText.textContent=`${p}/${s} ${c}% ETA: ${this.tasks.length/120|0}h`,this.$progressLine.style.transform=`scaleX(${c/100})`,this.$canvas.classList[this.lock?"add":"remove"]("no-pointer-events");for(let g of this.element.querySelectorAll(".resize"))g.classList[this.lock?"add":"remove"]("no-pointer-events");this.$lock.classList[this.lock?"add":"remove"]("locked")}exportImage(){this.export()}destroy(){super.destroy(),this.element.remove(),this.$colorsDialog.remove(),this.$previewDialog.remove(),co(this.bot.images,this),this.bot.widget.update(),H(this.bot)}openColorPanel(){if(this.$colorsDialog.open){this.$colorSearch.focus();return}this.$colorsDialog.style.position="fixed",this.$colorsDialog.style.left="",this.$colorsDialog.style.top="",this.$colorsDialog.style.margin="auto",this.$colorsDialog.showModal(),this.$colorSearch.focus()}openPreviewPanel(){if(this.$previewDialog.open){this.renderStrategyPreviewSamples();return}this.$previewDialog.style.position="fixed",this.$previewDialog.style.left="",this.$previewDialog.style.top="",this.$previewDialog.style.margin="auto",this.$previewDialog.showModal(),this.renderStrategyPreviewSamples()}closeDialog(o){if(!o.open)return;if(o===this.$previewDialog)this.stopPreviewAnimations();if(typeof o.requestClose==="function")o.requestClose();else o.close()}stopPreviewAnimations(){for(let o of this.previewAnimationHandles)cancelAnimationFrame(o);this.previewAnimationHandles.clear()}startColorDialogDrag(o){if(o.button!==0)return;if(o.target?.closest("button,input,select,textarea,a,label"))return;let r=this.$colorsDialog.getBoundingClientRect();this.colorDialogDragState={pointerId:o.pointerId,offsetX:o.clientX-r.left,offsetY:o.clientY-r.top,moved:!1},o.preventDefault()}moveColorDialog(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;let a=this.$colorsDialog.getBoundingClientRect(),r=Math.max(8,window.innerWidth-a.width-8),l=Math.max(8,window.innerHeight-a.height-8),s=Math.min(r,Math.max(8,o.clientX-this.colorDialogDragState.offsetX)),p=Math.min(l,Math.max(8,o.clientY-this.colorDialogDragState.offsetY));if(!this.colorDialogDragState.moved&&(Math.abs(o.movementX)>0||Math.abs(o.movementY)>0))this.colorDialogDragState.moved=!0;this.$colorsDialog.style.left=`${Math.round(s)}px`,this.$colorsDialog.style.top=`${Math.round(p)}px`,o.preventDefault()}stopColorDialogDrag(o){if(!this.colorDialogDragState)return;if(o.pointerId!==this.colorDialogDragState.pointerId)return;if(this.colorDialogDragState.moved)this.suppressNextColorDialogBackdropClick=!0;this.colorDialogDragState=void 0}renderStrategyPreviewSamples(){this.stopPreviewAnimations(),this.invalidatePreviewCacheIfNeeded();let o=this.$strategy.value;this.$previewDialogList.innerHTML="";let a=document.createDocumentFragment(),r=document.createElement("article");r.className="preview-card";let l=document.createElement("strong");l.textContent=this.getStrategyLabel(o);let s=document.createElement("canvas");s.className="preview-canvas",s.width=156,s.height=156,this.paintStrategyPreview(s,o),r.append(l,s),a.append(r),this.$previewDialogList.append(a)}invalidatePreviewCacheIfNeeded(){let o=this.colors.map((r,l)=>`${l}:${r.realColor}:${r.disabled?1:0}`).join("|"),a=`${this.pixels.width}x${this.pixels.height}:${this.pixels.image.src.length}:${this.drawColorsInOrder?1:0}:${o}`;if(this.previewCacheSignature===a)return;this.previewCacheSignature=a,this.previewSequenceCache.clear()}getStrategyLabel(o){switch(o){case"RANDOM":return w("random");case"HUMANIZED":return w("humanized");case"HUMAN_SOFT_DITHER":return w("humanSoftDither");case"HUMAN_PATCHY":return w("humanPatchy");case"HUMAN_SWEEP_ARCS":return w("humanSweepArcs");case"HUMAN_MICRO_CORRECTIONS":return w("humanMicroCorrections");case"HUMAN_JITTER_FILL":return w("humanJitterFill");case"HUMAN_CORNER_BIAS":return w("humanCornerBias");case"HUMAN_LONG_STROKES":return w("humanLongStrokes");case"HUMAN_TAP_CLUSTERS":return w("humanTapClusters");case"HUMAN_MESSY_SPIRAL":return w("humanMessySpiral");case"HUMAN_DRUNK_WALK":return w("humanDrunkWalk");case"HUMAN_NOISE_CLOUD":return w("humanNoiseCloud");case"HUMAN_PATCH_JUMP":return w("humanPatchJump");case"HUMAN_HESITANT_LINES":return w("humanHesitantLines");case"HUMAN_OVERLAP_SWEEPS":return w("humanOverlapSweeps");case"HUMAN_WOBBLE_DRIFT":return w("humanWobbleDrift");case"HUMAN_GAP_RECOVERY":return w("humanGapRecovery");case"HUMAN_STAIRCASE":return w("humanStaircase");case"HUMAN_EDGE_HUGGER":return w("humanEdgeHugger");case"HUMAN_BLOBS":return w("humanBlobs");case"HUMAN_BACKTRACK":return w("humanBacktrack");case"HUMAN_SHAKY_DIAGONAL":return w("humanShakyDiagonal");case"HUMAN_LATE_FIXES":return w("humanLateFixes");case"ZIGZAG":return w("zigzag");case"BRUSH_STROKES":return w("brushStrokes");case"DIAGONAL_BRUSH":return w("diagonalBrush");case"DOWN":return w("down");case"UP":return w("up");case"LEFT":return w("left");case"RIGHT":return w("right");case"SPIRAL_FROM_CENTER":return w("spiralOut");case"SPIRAL_TO_CENTER":return w("spiralIn");case"SCRIBBLE":return w("scribble");case"CROSSHATCH":return w("crosshatch");case"WAVE_SWEEP":return w("waveSweep");case"SCATTERED_LINES":return w("scatteredLines");case"CONTOUR_JITTER":return w("contourJitter");case"SPIRAL_WOBBLE":return w("spiralWobble");case"CLUSTER_BURSTS":return w("clusterBursts");case"ORBITAL":return w("orbital");case"FLOW_FIELD":return w("flowField");case"EDGE_IN":return w("edgeIn");default:return o}}paintStrategyPreview(o,a){let r=o.getContext("2d");if(!r)return;r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);let l=this.getSampledImagePreviewData(),s=this.getCachedPreviewSequence(a,l.mask,l.width,l.height),p=Math.min(o.width/l.width,o.height/l.height),c=(o.width-l.width*p)/2,g=(o.height-l.height*p)/2,f=this.previewAnimations.get(o);if(f)cancelAnimationFrame(f),this.previewAnimationHandles.delete(f);let n=(z)=>{let h=requestAnimationFrame((A)=>{this.previewAnimationHandles.delete(h),z(A)});return this.previewAnimationHandles.add(h),h},u=(z)=>{r.fillStyle="#0f1526",r.fillRect(0,0,o.width,o.height);for(let h=0;h<Math.min(z,s.length);h++){let A=s[h],e=l.colors.get(`${A.x}:${A.y}`)??0;if(!e)continue;r.fillStyle=uo(e),r.fillRect(c+A.x*p,g+A.y*p,Math.max(1,p),Math.max(1,p))}},i=Math.min(3400,Math.max(900,s.length*8)),m=i+220,b=(z,h)=>{if(!this.$previewDialog.open)return;let A=(h-z)%m,e=Math.min(1,A/i),N=e*e*(3-2*e);u(Math.floor(s.length*N));let U=n((W)=>{b(z,W)});this.previewAnimations.set(o,U)},d=performance.now();b(d,d)}getCachedPreviewSequence(o,a,r=this.pixels.width,l=this.pixels.height){let s=this.colors.map((f,n)=>`${n}:${f.realColor}:${f.disabled?1:0}`).join("|"),p=`${o}:${r}x${l}:${a.length}:${this.drawColorsInOrder?1:0}:${s}`,c=this.previewSequenceCache.get(p);if(c)return c;let g=r===this.pixels.width&&l===this.pixels.height?this.getExactPreviewSequence(o,a):this.getApproxPreviewSequence(o,a,r);if(this.drawColorsInOrder){let f=new Map;for(let n=0;n<this.colors.length;n++)f.set(this.colors[n].realColor,n);g.sort((n,u)=>(f.get(this.pixels.pixels[n.y]?.[n.x]??0)??0)-(f.get(this.pixels.pixels[u.y]?.[u.x]??0)??0))}return this.previewSequenceCache.set(p,g),g}getExactPreviewSequence(o,a){let r=this.strategy;this.strategy=o;let l=[...this.strategyPositionIterator()];this.strategy=r;let s=new Set(a.map(({x:p,y:c})=>`${p}:${c}`));return l.filter(({x:p,y:c})=>s.has(`${p}:${c}`))}getApproxPreviewSequence(o,a,r){let l=[...a],s=(g,f,n)=>{return(g*73856093+f*19349663+n*83492791>>>0)/4294967296},p=(g,f)=>l.sort((n,u)=>n.x*g+n.y*f-(u.x*g+u.y*f)||n.y-u.y||n.x-u.x),c=l.sort((g,f)=>{if(g.y!==f.y)return g.y-f.y;let n=g.y%2===0?g.x:r-g.x,u=f.y%2===0?f.x:r-f.x;return n-u});switch(o){case"UP":return p(0,-1);case"LEFT":return p(-1,0);case"RIGHT":return p(1,0);case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let g=r/2,f=Math.max(1,Math.round(l.reduce((n,u)=>n+u.y,0)/Math.max(1,l.length)));return l.sort((n,u)=>{let i=(n.x-g)**2+(n.y-f)**2,t=(u.x-g)**2+(u.y-f)**2;return o==="SPIRAL_FROM_CENTER"?i-t:t-i}),l}case"RANDOM":case"HUMANIZED":case"HUMAN_SOFT_DITHER":case"HUMAN_PATCHY":case"HUMAN_SWEEP_ARCS":case"HUMAN_MICRO_CORRECTIONS":case"HUMAN_JITTER_FILL":case"HUMAN_CORNER_BIAS":case"HUMAN_LONG_STROKES":case"HUMAN_TAP_CLUSTERS":case"HUMAN_MESSY_SPIRAL":case"HUMAN_DRUNK_WALK":case"HUMAN_NOISE_CLOUD":case"HUMAN_PATCH_JUMP":case"HUMAN_HESITANT_LINES":case"HUMAN_OVERLAP_SWEEPS":case"HUMAN_WOBBLE_DRIFT":case"HUMAN_GAP_RECOVERY":case"HUMAN_STAIRCASE":case"HUMAN_EDGE_HUGGER":case"HUMAN_BLOBS":case"HUMAN_BACKTRACK":case"HUMAN_SHAKY_DIAGONAL":case"HUMAN_LATE_FIXES":return l.sort((g,f)=>s(g.x,g.y,o.length)-s(f.x,f.y,o.length));default:return c}}getSampledImagePreviewData(){let o=this.pixels.width,a=this.pixels.height,r=K.PREVIEW_MASK_BASE_WIDTH,l=K.PREVIEW_MASK_BASE_HEIGHT,s=Math.min(1,r/Math.max(1,o),l/Math.max(1,a)),p=Math.max(1,Math.round(o*s)),c=Math.max(1,Math.round(a*s)),g=new Set;for(let i=0;i<this.colors.length;i++){let t=this.colors[i];if(t.disabled)g.add(t.realColor)}let f=new Map,n=new Map;for(let i=0;i<a;i++)for(let t=0;t<o;t++){let m=this.pixels.pixels[i]?.[t]??0;if(!m||g.has(m))continue;let b=Math.min(p-1,Math.floor(t/o*p)),d=Math.min(c-1,Math.floor(i/a*c)),z=`${b}:${d}`;if(!f.has(z))f.set(z,{x:b,y:d});if(!n.has(z))n.set(z,m)}let u=[...f.values()];if(!u.length){let i=this.fallbackPreviewMask();return{width:o,height:a,mask:i,colors:new Map(i.map((t)=>[`${t.x}:${t.y}`,this.pixels.pixels[t.y]?.[t.x]??0]))}}return{width:p,height:c,mask:u,colors:n}}getImagePreviewMask(){let o=this.pixels.width,a=this.pixels.height,r=new Set;for(let s=0;s<this.colors.length;s++){let p=this.colors[s];if(p.disabled)r.add(p.realColor)}let l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=this.pixels.pixels[s]?.[p]??0;if(c!==0&&!r.has(c))l.push({x:p,y:s})}return l.length?l:this.fallbackPreviewMask()}fallbackPreviewMask(){let o=[],a=this.pixels.width/2,r=this.pixels.height/2,l=Math.max(4,Math.min(this.pixels.width,this.pixels.height)/2.5);for(let s=0;s<this.pixels.height;s++)for(let p=0;p<this.pixels.width;p++)if((p-a)**2+(s-r)**2<=l**2)o.push({x:p,y:s});return o}applyLocale(){if(P(this.element),this.updateColors(),this.$previewDialog.open)this.renderStrategyPreviewSamples()}colorHex(o){let a=S[o]??"0,0,0",[r=0,l=0,s=0]=a.split(",").map((p)=>Number.parseInt(p,10));return`#${[r,l,s].map((p)=>p.toString(16).padStart(2,"0")).join("")}`}colorKeywords(o){let a=S[o]??"0,0,0",[r=0,l=0,s=0]=a.split(",").map((f)=>Number.parseInt(f,10)),p=Math.max(r,l,s),c=Math.min(r,l,s);if(p-c<15)return["gray","grey","gris","neutral","neutro"];if(r>l+30&&r>s+30)return["red","rojo"];if(l>r+30&&l>s+30)return["green","verde"];if(s>r+30&&s>l+30)return["blue","azul"];if(r>170&&l>120&&s<130)return["orange","naranja"];if(r>170&&l>110&&s>140)return["pink","rosa"];if(r>120&&l<100&&s>120)return["purple","violet","morado"];if(r>130&&l>130&&s<90)return["yellow","amarillo"];return["brown","cafe","marron"]}colorFamily(o){let[a=0,r=0,l=0]=(S[o]??"0,0,0").split(",").map((s)=>Number.parseInt(s,10));if(a>r+35&&a>l+35)return"red";if(r>a+25&&r>l+20)return a>90?"olive":"green";if(l>a+25&&l>r+25)return"blue";if(a>120&&l>120)return"wine";return"neutral"}replacementCandidates(o){let a=this.colorFamily(o);return Array.from({length:S.length-1},(r,l)=>l+1).filter((r)=>!this.bot.unavailableColors.has(r)&&this.colorFamily(r)===a)}updateColors(){this.$colorsDialogList.innerHTML="";let o=this.pixels.pixels.length*this.pixels.pixels[0].length;this.$colorsDialogList.setAttribute("aria-label",w("colorPanelResults"));let a=this.$colorSearch.value.trim().toLowerCase();if(this.colors.length!==this.pixels.colors.size||this.colors.some((r)=>!this.pixels.colors.has(r.realColor))){let r=new Map(this.colors.map((l)=>[l.realColor,l]));this.colors=this.pixels.colors.values().toArray().sort((l,s)=>s.amount-l.amount).map((l)=>({realColor:l.realColor,disabled:r.get(l.realColor)?.disabled,replacementColor:r.get(l.realColor)?.replacementColor})),H(this.bot)}for(let r=0;r<this.colors.length;r++){let l=this.colors[r],s=this.pixels.colors.get(l.realColor),p=!1,c=s.realColor!==s.color;if(this.skipUnavailableColors&&c)l.disabled=!0;let g=s.amount/o*100,f=this.colorHex(s.realColor),n=this.colorKeywords(s.realColor),u=()=>{l.disabled=l.disabled?void 0:!0,i.classList.toggle("disabled",Boolean(l.disabled));let d=i.querySelector(".state");if(d)d.textContent=l.disabled?w("disabled"):w("enabled");H(this.bot)},i=document.createElement("button");i.className=`color-chip ${l.disabled?"disabled":""}`,i.draggable=!0,i.setAttribute("aria-label",`${w("overlayColors")} #${r+1}: ${f.toUpperCase()}`);let t=l.replacementColor??s.color,m=`#${t} ${this.colorHex(t).toUpperCase()}`;if(i.innerHTML=`<span class="order-index">#${r+1}</span>
<span class="drag" title="${w("up")} / ${w("down")}">⋮⋮</span>
<span class="swatch"></span>
<span class="meta">
  <span class="coverage">${g.toFixed(1)}%</span>
  <span class="hex">${f.toUpperCase()}</span>
  <span class="state">${l.disabled?w("disabled"):w("enabled")}</span>
  <span class="replacement">${w("replaceWith")}: ${m}</span>
</span>
<span class="premium ${c?"on":""}">${c?w("premium"):""}</span>`,i.querySelector(".swatch").style.setProperty("--swatch-color",uo(s.realColor)),i.addEventListener("click",()=>{if(p){p=!1;return}u(),this.updateTasks()}),i.addEventListener("dragstart",(d)=>{p=!0,i.classList.add("dragging"),d.dataTransfer?.setData("text/plain",String(r)),d.dataTransfer.effectAllowed="move"}),i.addEventListener("dragend",()=>{i.classList.remove("dragging")}),i.addEventListener("dragover",(d)=>{d.preventDefault(),i.classList.add("drag-target")}),i.addEventListener("dragleave",()=>{i.classList.remove("drag-target")}),i.addEventListener("drop",(d)=>{d.preventDefault(),i.classList.remove("drag-target");let z=Number.parseInt(d.dataTransfer?.getData("text/plain")??"-1",10);if(z<0||z===r||z>=this.colors.length)return;this.colors.splice(r,0,...this.colors.splice(z,1)),H(this.bot),this.updateColors()}),c||this.smartReplaceMode){let d=document.createElement("select");d.className="replacement-select";let z=this.smartReplaceMode?this.replacementCandidates(s.realColor):Array.from({length:S.length-1},(h,A)=>A+1);for(let h of z){if(this.bot.unavailableColors.has(h))continue;let A=document.createElement("option");if(A.value=String(h),A.textContent=`#${h} ${this.colorHex(h).toUpperCase()}`,h===t)A.selected=!0;d.append(A)}d.addEventListener("click",(h)=>{h.stopPropagation()}),d.addEventListener("change",()=>{l.replacementColor=d.valueAsNumber||Number.parseInt(d.value,10),this.updateTasks(),this.updateColors(),H(this.bot)}),i.append(d)}if(c||this.smartReplaceMode){let d=document.createElement("button");d.textContent=w("buy"),d.className="buy-chip",d.addEventListener("click",(z)=>{z.stopPropagation(),document.getElementById("color-"+s.realColor)?.click()}),i.append(d)}let b=`${f} ${n.join(" ")} ${s.realColor} ${S[s.realColor]}`;if(!a||b.toLowerCase().includes(a))this.$colorsDialogList.append(i)}}*strategyPositionIterator(){let o=this.pixels.pixels[0].length,a=this.pixels.pixels.length;switch(this.strategy){case"DOWN":{for(let r=0;r<a;r++)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"UP":{for(let r=a-1;r>=0;r--)for(let l=0;l<o;l++)yield{x:l,y:r};break}case"LEFT":{for(let r=0;r<o;r++)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RIGHT":{for(let r=o-1;r>=0;r--)for(let l=0;l<a;l++)yield{x:r,y:l};break}case"RANDOM":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++)r.push({x:s,y:l});for(let l=r.length-1;l>=0;l--){let s=Math.floor(Math.random()*(l+1)),p=r[l];r[l]=r[s],r[s]=p}yield*r;break}case"ZIGZAG":{for(let r=0;r<a;r++)if(r%2===0)for(let l=0;l<o;l++)yield{x:l,y:r};else for(let l=o-1;l>=0;l--)yield{x:l,y:r};break}case"HUMANIZED":{let r=Math.max(4,Math.floor(Math.min(o,a)/10)),l=[];for(let s=0;s<a;s+=r)for(let p=0;p<o;p+=r)l.push({x:p,y:s});for(let s=l.length-1;s>=0;s--){let p=Math.floor(Math.random()*(s+1)),c=l[s];l[s]=l[p],l[p]=c}for(let s=0;s<l.length;s++){let p=l[s],c=Math.min(a,p.y+r),g=Math.min(o,p.x+r);for(let f=p.y;f<c;f++)if(Math.random()>0.35)for(let u=p.x;u<g;u++)yield{x:u,y:f};else for(let u=g-1;u>=p.x;u--)yield{x:u,y:f}}break}case"HUMAN_SOFT_DITHER":{let r=new Set;for(let l=0;l<a;l++){let s=Math.floor(Math.random()*3)-1;if((l+s)%2===0)for(let c=0;c<o;c+=2)r.add(`${c},${l}`),yield{x:c,y:l};else for(let c=1;c<o;c+=2)r.add(`${c},${l}`),yield{x:c,y:l}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=`${s},${l}`;if(r.has(p))continue;yield{x:s,y:l}}break}case"HUMAN_PATCHY":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*5);for(let g=p-c;g<=p+c;g++)for(let f=s-c;f<=s+c;f++){if(f<0||f>=o||g<0||g>=a)continue;if(Math.hypot(f-s,g-p)>c+Math.random()*1.2)continue;let n=`${f},${g}`;if(r.has(n))continue;r.add(n),yield{x:f,y:g}}}break}case"HUMAN_SWEEP_ARCS":{let r=new Set,l=(o-1)/2,s=(a-1)/2,p=Math.hypot(l,s);for(let c=0;c<4;c++){let g=Math.random()*Math.PI*2;for(let f=0;f<=p;f+=0.35){let n=Math.PI/2+Math.random()*(Math.PI/1.5),u=Math.max(10,Math.floor(f*8));for(let i=0;i<u;i++){let t=g+n*i/u+Math.sin(f)*0.08,m=Math.round(l+Math.cos(t)*f),b=Math.round(s+Math.sin(t)*f);if(m<0||m>=o||b<0||b>=a)continue;let d=`${m},${b}`;if(r.has(d))continue;r.add(d),yield{x:m,y:b}}}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"HUMAN_MICRO_CORRECTIONS":{let r=new Set;for(let l=0;l<a;l++){let s=l%2===0?1:-1,p=s>0?0:o-1;for(let c=0;c<o;c++){let g=p+(Math.random()>0.82?s:0),f=l+(Math.random()>0.9?1:0);for(let n of[{x:p,y:l},{x:g,y:l},{x:p,y:f}]){if(n.x<0||n.x>=o||n.y<0||n.y>=a)continue;let u=`${n.x},${n.y}`;if(r.has(u))continue;r.add(u),yield n}p+=s}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=`${s},${l}`;if(r.has(p))continue;yield{x:s,y:l}}break}case"HUMAN_JITTER_FILL":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++)r.push({x:s,y:l});r.sort((l,s)=>{let p=l.y+(Math.random()-0.5)*1.8,c=s.y+(Math.random()-0.5)*1.8;if(p!==c)return p-c;return l.x+(Math.random()-0.5)*2-(s.x+(Math.random()-0.5)*2)}),yield*r;break}case"HUMAN_CORNER_BIAS":{let r=[{x:0,y:0},{x:o-1,y:0},{x:0,y:a-1},{x:o-1,y:a-1}],l=r[Math.floor(Math.random()*r.length)],s=[];for(let p=0;p<a;p++)for(let c=0;c<o;c++){let f=Math.hypot(c-l.x,p-l.y)+Math.random()*3.5;s.push({point:{x:c,y:p},score:f})}s.sort((p,c)=>p.score-c.score);for(let p of s)yield p.point;break}case"HUMAN_LONG_STROKES":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=Math.random()*Math.PI*2,g=Math.sign(Math.cos(c)),f=Math.sign(Math.sin(c)),n=10+Math.floor(Math.random()*40);for(let u=0;u<n;u++){if(s<0||s>=o||p<0||p>=a)break;let i=`${s},${p}`;if(!r.has(i))r.add(i),yield{x:s,y:p};if(Math.random()>0.78)s+=f,p+=g;else s+=g,p+=f}}break}case"HUMAN_TAP_CLUSTERS":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=3+Math.floor(Math.random()*10);for(let g=0;g<c;g++){let f=Math.round(s+(Math.random()-0.5)*6),n=Math.round(p+(Math.random()-0.5)*6);if(f<0||f>=o||n<0||n>=a)continue;let u=`${f},${n}`;if(r.has(u))continue;r.add(u),yield{x:f,y:n}}}break}case"HUMAN_MESSY_SPIRAL":{let r=new Set,l=(o-1)/2,s=(a-1)/2,p=Math.hypot(l,s)+2;for(let c=0;r.size<o*a;c++){let g=c/3,f=Math.min(p,g*0.18),n=g*0.29+Math.sin(g*0.13)*0.8,u=Math.round(l+Math.cos(n)*f+Math.sin(g)*0.7),i=Math.round(s+Math.sin(n)*f+Math.cos(g)*0.7);if(u<0||u>=o||i<0||i>=a){if(c>o*a*18)break;continue}let t=`${u},${i}`;if(r.has(t)){if(Math.random()>0.9)continue}else r.add(t),yield{x:u,y:i};if(c>o*a*18)break}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"HUMAN_DRUNK_WALK":{let r=new Set,l=Math.floor(Math.random()*o),s=Math.floor(Math.random()*a),p=[{x:-1,y:0},{x:1,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:-1},{x:1,y:-1},{x:-1,y:1},{x:1,y:1}];while(r.size<o*a){let c=`${l},${s}`;if(!r.has(c))r.add(c),yield{x:l,y:s};let g=[];for(let u of p){let i=l+u.x,t=s+u.y;if(i<0||i>=o||t<0||t>=a)continue;g.push({x:i,y:t})}if(!g.length)break;let f=g.filter((u)=>{return!r.has(`${u.x},${u.y}`)});if(f.length&&Math.random()>0.2){let u=f[Math.floor(Math.random()*f.length)];l=u.x,s=u.y;continue}let n=g[Math.floor(Math.random()*g.length)];l=n.x,s=n.y}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"HUMAN_NOISE_CLOUD":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=Math.sin((s+1)*0.93+Math.random()*0.8)+Math.cos((l+1)*1.17+Math.random()*0.8),c=(Math.random()-0.5)*2.6,g=Math.hypot(s-o/2,l-a/2)*0.08;r.push({point:{x:s,y:l},score:p+c+g})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_PATCH_JUMP":{let r=new Set,l=[];for(let s=0;s<Math.max(6,o*a/18);s++)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});while(r.size<o*a){let s=l[Math.floor(Math.random()*l.length)],p=1+Math.floor(Math.random()*3),c=1+Math.floor(Math.random()*3);for(let g=s.y-c;g<=s.y+c;g++)for(let f=s.x-p;f<=s.x+p;f++){if(f<0||f>=o||g<0||g>=a)continue;if(Math.random()>0.86)continue;let n=`${f},${g}`;if(r.has(n))continue;r.add(n),yield{x:f,y:g}}if(Math.random()>0.72&&l.length<o*a/2)l.push({x:Math.floor(Math.random()*o),y:Math.floor(Math.random()*a)});if(r.size>o*a*0.92)break}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;yield{x:p,y:s}}break}case"HUMAN_HESITANT_LINES":{let r=new Set;for(let l=0;l<a;l++){let s=l%2===0;for(let p=0;p<o;p++){let c=s?p:o-1-p,g=`${c},${l}`;if(!r.has(g))r.add(g),yield{x:c,y:l};if(Math.random()>0.7){let f=Math.max(0,Math.min(o-1,c+(Math.random()>0.5?1:-1))),n=Math.max(0,Math.min(a-1,l+(Math.random()>0.65?1:0))),u=`${f},${n}`;if(!r.has(u))r.add(u),yield{x:f,y:n}}}}for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=`${s},${l}`;if(r.has(p))continue;yield{x:s,y:l}}break}case"HUMAN_OVERLAP_SWEEPS":{let r=[],l=Math.random()*Math.PI*2;for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=Math.sin((p+s)*0.42+l)*2.2,g=Math.cos((p-s)*0.3+l)*1.4;r.push({point:{x:p,y:s},score:s+c+g+(Math.random()-0.5)*3.4})}r.sort((s,p)=>s.score-p.score);for(let s of r)yield s.point;break}case"HUMAN_WOBBLE_DRIFT":{let r=[],l=o/2,s=a/2;for(let p=0;p<a;p++)for(let c=0;c<o;c++){let g=Math.hypot(c-l,p-s)*0.25,f=Math.sin((c+1)*0.9)*1.8+Math.cos((p+1)*1.1)*1.8+Math.sin((c+p)*0.35)*1.4;r.push({point:{x:c,y:p},score:g+f+(Math.random()-0.5)*2.8})}r.sort((p,c)=>p.score-c.score);for(let p of r)yield p.point;break}case"HUMAN_GAP_RECOVERY":{let r=new Set,l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++){if(Math.random()>0.87){l.push({x:p,y:s});continue}r.add(`${p},${s}`),yield{x:p,y:s}}l.sort((s,p)=>Math.hypot(s.x-o/2,s.y-a/2)-Math.hypot(p.x-o/2,p.y-a/2));for(let s of l){let p=`${s.x},${s.y}`;if(r.has(p))continue;r.add(p),yield s}break}case"HUMAN_STAIRCASE":{let r=new Set,l=o+a-1;for(let s=0;s<l;s++){let p=Math.max(0,s-o+1),c=Math.min(a-1,s);for(let g=p;g<=c;g++){let f=s-g,n=[{x:f,y:g},{x:f+(Math.random()>0.5?1:-1),y:g},{x:f,y:g+(Math.random()>0.5?1:-1)}];for(let u of n){if(u.x<0||u.x>=o||u.y<0||u.y>=a)continue;let i=`${u.x},${u.y}`;if(r.has(i))continue;r.add(i),yield u}}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;yield{x:p,y:s}}break}case"HUMAN_EDGE_HUGGER":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=Math.min(s,l,o-1-s,a-1-l);r.push({point:{x:s,y:l},score:p*3.5+(Math.random()-0.5)*5.5})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_BLOBS":{let r=new Set,l=o*a;while(r.size<l){let s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a),c=1+Math.floor(Math.random()*4);for(let g=p-c;g<=p+c;g++)for(let f=s-c;f<=s+c;f++){if(f<0||f>=o||g<0||g>=a)continue;let n=Math.atan2(g-p,f-s),u=c+Math.sin(n*3+Math.random())*0.8;if(Math.hypot(f-s,g-p)>u)continue;let i=`${f},${g}`;if(r.has(i))continue;r.add(i),yield{x:f,y:g}}}break}case"HUMAN_BACKTRACK":{let r=new Set,l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++)l.push({x:p,y:s});l.sort((s,p)=>s.y-p.y+(Math.random()-0.5)*2.2+(s.x-p.x)*0.04);for(let s=0;s<l.length;s++){let p=l[s],c=`${p.x},${p.y}`;if(r.has(c))continue;if(r.add(c),yield p,s>1&&Math.random()>0.74){let g=l[s-1],f=`${g.x},${g.y}`;if(!r.has(f))r.add(f),yield g}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;yield{x:p,y:s}}break}case"HUMAN_SHAKY_DIAGONAL":{let r=[];for(let l=0;l<a;l++)for(let s=0;s<o;s++){let p=Math.abs(s-l)*0.6,c=Math.sin(s*1.4+l*0.8)*1.8+Math.cos(l*1.1+s*0.5)*1.5;r.push({point:{x:s,y:l},score:p+c+(Math.random()-0.5)*3.2})}r.sort((l,s)=>l.score-s.score);for(let l of r)yield l.point;break}case"HUMAN_LATE_FIXES":{let r=[],l=[];for(let s=0;s<a;s++)for(let p=0;p<o;p++)if(Math.random()>0.9)l.push({x:p,y:s});else r.push({x:p,y:s});r.sort((s,p)=>s.y-p.y+(Math.random()-0.5)*1.5+(Math.random()>0.85?s.x-p.x:0)),l.sort((s,p)=>Math.hypot(p.x-o/2,p.y-a/2)-Math.hypot(s.x-o/2,s.y-a/2)),yield*r,yield*l;break}case"DIAGONAL_BRUSH":{for(let r=0;r<o+a-1;r++){let l=r%2===0,s=[],p=Math.max(0,r-o+1),c=Math.min(a-1,r);for(let g=p;g<=c;g++){let f=r-g;if(f>=0&&f<o)s.push({x:f,y:g})}if(Math.random()>0.55)s.reverse();if(l)for(let g=s.length-1;g>=0;g--)yield s[g];else yield*s}break}case"BRUSH_STROKES":{let r=Array.from({length:a},()=>Array(o).fill(!1)),l=[{x:1,y:0},{x:-1,y:0},{x:0,y:1},{x:0,y:-1},{x:1,y:1},{x:1,y:-1},{x:-1,y:1},{x:-1,y:-1}],s=(g,f)=>g>=0&&g<o&&f>=0&&f<a,p=0,c=o*a;for(let g=0;g<c*6&&p<c;g++){let f=Math.floor(Math.random()*o),n=Math.floor(Math.random()*a),u=l[Math.floor(Math.random()*l.length)],i=3+Math.floor(Math.random()*16);for(let t=0;t<i;t++){if(!s(f,n))break;if(!r[n][f])r[n][f]=!0,p++,yield{x:f,y:n};if(Math.random()>0.72)u=l[Math.floor(Math.random()*l.length)];f+=u.x,n+=u.y}}for(let g=0;g<a;g++)for(let f=0;f<o;f++)if(!r[g][f])yield{x:f,y:g};break}case"SPIRAL_FROM_CENTER":case"SPIRAL_TO_CENTER":{let r=new Set,l=o*a,s=Math.floor(o/2),p=Math.floor(a/2),c=[[1,0],[0,1],[-1,0],[0,-1]],g=0,f=1,n=(i,t)=>i>=0&&i<o&&t>=0&&t<a,u=function*(){let i=0;while(i<l){for(let t=0;t<2;t++){for(let m=0;m<f;m++){if(n(s,p)){let b=`${s},${p}`;if(!r.has(b)){if(r.add(b),yield{x:s,y:p},i++,i>=l)return}}s+=c[g][0],p+=c[g][1]}g=(g+1)%4}f++}};if(this.strategy==="SPIRAL_FROM_CENTER")yield*u();else{let i=[...u()];for(let t=i.length-1;t>=0;t--)yield i[t]}break}case"SCRIBBLE":{let r=new Set,l=o*a,s=Math.floor(o/2),p=Math.floor(a/2);for(let c=0;r.size<l&&c<l*24;c++){let g=`${s},${p}`;if(!r.has(g))r.add(g),yield{x:s,y:p};if(s+=Math.floor(Math.random()*3)-1,p+=Math.floor(Math.random()*3)-1,s<0||s>=o||p<0||p>=a)s=Math.floor(Math.random()*o),p=Math.floor(Math.random()*a)}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;r.add(f),yield{x:g,y:c}}break}case"CROSSHATCH":{let r=[];for(let p=0;p<o+a-1;p++)for(let c=Math.max(0,p-o+1);c<=Math.min(a-1,p);c++){let g=p-c;r.push({x:g,y:c})}let l=[];for(let p=-a+1;p<o;p++)for(let c=0;c<a;c++){let g=c+p;if(g>=0&&g<o)l.push({x:g,y:c})}let s=new Set;for(let p of[...r,...l]){let c=`${p.x},${p.y}`;if(s.has(c))continue;s.add(c),yield p}break}case"WAVE_SWEEP":{let r=new Set;for(let l=0;l<o;l++){let p=(Math.sin(l/Math.max(1,o-1)*Math.PI*4)+1)*0.5*(a-1)|0;for(let c=0;c<a;c++){let g=p+c,f=p-c;for(let n of[g,f]){if(n<0||n>=a)continue;let u=`${l},${n}`;if(r.has(u))continue;r.add(u),yield{x:l,y:n}}}}break}case"SCATTERED_LINES":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*14;s++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),g=Math.random()*Math.PI*2,f=Math.round(Math.cos(g)),n=Math.round(Math.sin(g)),u=6+Math.floor(Math.random()*28);for(let i=0;i<u;i++){if(p<0||p>=o||c<0||c>=a)break;let t=`${p},${c}`;if(!r.has(t))r.add(t),yield{x:p,y:c};p+=f,c+=n}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;r.add(c),yield{x:p,y:s}}break}case"CONTOUR_JITTER":{let r=new Set;for(let l=0;l<Math.ceil(Math.min(o,a)/2);l++){let s=[],p=l,c=l,g=o-l-1,f=a-l-1;for(let n=p;n<=g;n++)s.push({x:n,y:c});for(let n=c+1;n<=f;n++)s.push({x:g,y:n});for(let n=g-1;n>=p;n--)s.push({x:n,y:f});for(let n=f-1;n>c;n--)s.push({x:p,y:n});for(let n=s.length-1;n>0;n--){let u=Math.floor(Math.random()*(n+1)),i=s[n];s[n]=s[u],s[u]=i}for(let n of s){let u=`${n.x},${n.y}`;if(r.has(u))continue;r.add(u),yield n}}break}case"SPIRAL_WOBBLE":{let r=new Set,l=o/2,s=a/2,p=Math.hypot(l,s);for(let c=0;r.size<o*a&&c<o*a*9;c++){let g=c/(o*a*9)*p,f=c*0.31+Math.sin(c*0.07)*0.7,n=Math.round(l+Math.cos(f)*g),u=Math.round(s+Math.sin(f)*g);if(n<0||n>=o||u<0||u>=a)continue;let i=`${n},${u}`;if(r.has(i))continue;r.add(i),yield{x:n,y:u}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"CLUSTER_BURSTS":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*12;s++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a),g=2+Math.floor(Math.random()*10);for(let f=c-g;f<=c+g;f++)for(let n=p-g;n<=p+g;n++){if(n<0||n>=o||f<0||f>=a)continue;if(Math.hypot(n-p,f-c)>g)continue;let u=`${n},${f}`;if(r.has(u))continue;r.add(u),yield{x:n,y:f}}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;r.add(c),yield{x:p,y:s}}break}case"ORBITAL":{let r=new Set,l=(o-1)/2,s=(a-1)/2,p=Math.ceil(Math.max(l,s));for(let c=0;c<=p;c++){let g=Math.max(16,Math.ceil(2*Math.PI*Math.max(1,c)*2));for(let f=0;f<g;f++){let n=f/g*Math.PI*2+(c%2?0.3:-0.3),u=Math.round(l+Math.cos(n)*c),i=Math.round(s+Math.sin(n)*c);if(u<0||u>=o||i<0||i>=a)continue;let t=`${u},${i}`;if(r.has(t))continue;r.add(t),yield{x:u,y:i}}}for(let c=0;c<a;c++)for(let g=0;g<o;g++){let f=`${g},${c}`;if(r.has(f))continue;yield{x:g,y:c}}break}case"FLOW_FIELD":{let r=new Set,l=o*a;for(let s=0;r.size<l&&s<l*18;s++){let p=Math.floor(Math.random()*o),c=Math.floor(Math.random()*a);for(let g=0;g<120;g++){if(p<0||p>=o||c<0||c>=a)break;let f=`${p},${c}`;if(!r.has(f))r.add(f),yield{x:p,y:c};let n=Math.sin(p*0.09)*1.8+Math.cos(c*0.08)*1.6+Math.sin((p+c)*0.05);p+=Math.round(Math.cos(n)),c+=Math.round(Math.sin(n))}}for(let s=0;s<a;s++)for(let p=0;p<o;p++){let c=`${p},${s}`;if(r.has(c))continue;r.add(c),yield{x:p,y:s}}break}case"EDGE_IN":{let r=new Set,l=Math.ceil(Math.min(o,a)/2);for(let s=0;s<l;s++){let p=s,c=o-1-s,g=s,f=a-1-s;for(let n=p;n<=c;n++)for(let u of[g,f]){let i=`${n},${u}`;if(r.has(i))continue;r.add(i),yield{x:n,y:u}}for(let n=g+1;n<=f-1;n++)for(let u of[p,c]){let i=`${u},${n}`;if(r.has(i))continue;r.add(i),yield{x:u,y:n}}}break}}}moveStart(o){if(o.button!==0)return;if(o.preventDefault(),o.stopPropagation(),!this.lock)this.moveInfo={globalX:this.position.globalX,globalY:this.position.globalY,clientX:o.clientX,clientY:o.clientY}}moveStop(){if(this.moveInfo)this.moveInfo=void 0,this.position.updateAnchor(),this.pixels.update(),this.updateColors(),H(this.bot)}move(o){if(!this.moveInfo)return;let a=Math.round((o.clientX-this.moveInfo.clientX)/this.position.pixelSize),r=Math.round((o.clientY-this.moveInfo.clientY)/this.position.pixelSize);if(this.moveInfo.globalX!==void 0){if(this.position.globalX=a+this.moveInfo.globalX,this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,this.moveInfo.width-a)}else if(this.moveInfo.width!==void 0)this.pixels.width=Math.max(1,a+this.moveInfo.width);if(this.moveInfo.globalY!==void 0){if(this.position.globalY=r+this.moveInfo.globalY,this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,this.moveInfo.height-r)}else if(this.moveInfo.height!==void 0)this.pixels.height=Math.max(1,r+this.moveInfo.height);this.update(),H(this.bot)}resizeStart(o){if(this.lock||o.button!==0)return;o.preventDefault(),o.stopPropagation(),this.moveInfo={clientX:o.clientX,clientY:o.clientY};let a=o.target;if(a.classList.contains("n"))this.moveInfo.height=this.pixels.height,this.moveInfo.globalY=this.position.globalY;if(a.classList.contains("e"))this.moveInfo.width=this.pixels.width;if(a.classList.contains("s"))this.moveInfo.height=this.pixels.height;if(a.classList.contains("w"))this.moveInfo.width=this.pixels.width,this.moveInfo.globalX=this.position.globalX}export(){let o=document.createElement("a");document.body.append(o),o.href=URL.createObjectURL(new Blob([JSON.stringify(this.toJSON())],{type:"application/json"})),o.download=`${this.pixels.width}x${this.pixels.height}.${X}`,o.click(),URL.revokeObjectURL(o.href),o.href=this.pixels.canvas.toDataURL("image/webp",1),o.download=`${this.pixels.width}x${this.pixels.height}.webp`,o.click(),URL.revokeObjectURL(o.href),o.remove()}}var Do=`/* stylelint-disable declaration-no-important */
