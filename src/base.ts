...
export class Base {
	...
	protected populateElementsWithSelector(element: HTMLElement, selectors: Record<string, string>) {
		for (const key in selectors) {
			(this as unknown as Record<string, HTMLElement>)[key] = element.querySelector(selectors[key]!)!;
		}
	}
