...
const MESSAGES = {
  en: {
    ...
    shortcutsHelp:
      'Shift+B toggle widget · Shift+M hide/show panel · Shift+S show panel · Shift+H hide panel · Shift+Enter draw · Shift+I add image · Shift+/ shortcuts · Shift+N next image · Shift+P previous image',
    language: 'Language',
  ...
  es: {
    ...
    shortcutsHelp:
      'Shift+B mostrar widget · Shift+M ocultar/mostrar panel · Shift+S mostrar panel · Shift+H ocultar panel · Shift+Enter dibujar · Shift+I agregar imagen · Shift+/ atajos · Shift+N siguiente imagen · Shift+P imagen anterior',
    language: 'Idioma',
